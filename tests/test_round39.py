...
class Round39ExactChecks(unittest.TestCase):
    ...
    def test_principal_theorem_labels_are_present(self) -> None:
        expectations = {
            ...
            "round39/filter_memory.tex": ["thm:filter-jets", "cor:memory-posterior"],
    ...
    def test_source_manifest_hashes_and_sizes(self) -> None:
        manifest = json.loads((ROOT / "round39/SOURCE_MANIFEST.json").read_text(encoding="utf-8"))
