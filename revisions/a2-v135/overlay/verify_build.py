...
for name in ['geometry','supplement','complete']:
    ...
    logchecks[name+'_title_revision135']='Revision 135' in first
...
scripts=['exact_k3','exact_corank_two','stratified_rank_two','boundary_atlas','generic_boundary_atlas',
 'revision131_exact','revision132_exact','revision133_exact','revision134_exact','revision135_exact']
checks={**logchecks,
 'focused_article_under_35_pages':pdf_info['geometry']['pages']<35,
 'complete_mathematics_retained':pdf_info['complete']['pages']>=81,
 ...
 'accepted_readout_and_common_g_byte_identical':all(sha(ROOT/n)==m['unchanged_inherited_tex_sha256'][n] for n in ['parts/12a-universal-readout.tex','parts/12b-functoriality.tex']),
 ...
 'all_ten_script_execution_logs_present':all((ROOT/'evidence'/(n+'.log')).exists() for n in scripts),
 'new135_exact_checks':r135['ok'] and r135['SO4_invariant_multiplicity']==0,
...
receipt={'revision':135,'source_commit':m['assembly_commit'],'reviewed_commit':m['reviewed_commit'],
 ...
 'new_exact_result':r135,
 'overfull_box_warnings':{n:[l for l in log.splitlines() if 'Overfull' in l] for n,log in logs.items()},
 'evidence_scope':{'structural_proofs_not_machine_certified':r135['structural_proofs_not_machine_certified']+r134['structural_proofs_not_machine_certified'],
 'documentary_open':['M134.1: complete theorem-level comparison with Ballico 1993'],
 ...
 'classification of the entire ambient binary-Jacobian boundary']}}
...
if not receipt['ok']:raise SystemExit('v135 verification failed')
