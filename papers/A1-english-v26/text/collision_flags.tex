...
The following acquisition argument supplies positive mass in every
initial flag. The direct classification in Section~\ref{sec:direct-classification}
uses this mass together with a cover of the entire attainable image.
