...
prior moment strata, covariance geometry, exponent collisions}
...
acquisition rank under every full-support prior. For sparse monomial
...
prior-uniform attainment in the square pairing regime. Two multi-step
...
inputs, not separate novelty claims. The structural result identifies
...
and universal pairing criterion first, then the complete monomial and
