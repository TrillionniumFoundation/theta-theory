...
Generated files in build/ only relocate two complete lemmas and the resource
model; the special-case proofs stay intact. Use --prepare-only without TeX.
"""
import argparse
...
def prepare():
    ...
    report={'pinned_v9_body_files':len(EXPECTED),'retained_named_results':len(old_labels),
