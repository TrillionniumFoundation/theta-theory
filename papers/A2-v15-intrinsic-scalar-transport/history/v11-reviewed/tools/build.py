#!/usr/bin/env python3
"""Clean-build the A2 v11 article and companion; record actual diagnostics.
...
def main() -> None:
    ...
    result={'schema':'a2-v11-clean-build-v1','clean_auxiliary_state':True,
            'order':['two_collision','main'],'documents':{},
            'remote_ci':False,'formal_proof_verification':False}
    with tempfile.TemporaryDirectory(prefix='a2-v11-clean-') as tmp:
        work=Path(tmp)
        for p in root.rglob('*'):
