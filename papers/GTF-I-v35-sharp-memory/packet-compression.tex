...
Let $Y_0$ be a fixed unit vector. Each command packet is sampled
independently of the earlier process, with its full word law fixed in
advance. Write $G_i$ for its product and $\mu_i$ for the induced law.
Between packets one may insert fixed commands. A finite stochastic register processes the
