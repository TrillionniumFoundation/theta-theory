...
triple with the circular reference alone. The additional amplitude which
resolves this problem is $C_4$. It allows the area normalizer to be
recovered at the same time, without separating repeated nodes.
...
shape coordinate in that geometric family.
...
\eqref{eq:v5-symmetric-jets} are $-3/A_0^2,1/A_0,-1/A_0,1/(2A_0)$,
