# Principal article: theorem inputs and comparison references — v57

This is the current reading-based dependency ledger. It supersedes the v56 classification of all full-only labels as comparisons. The old map and response are retained as historical records. Literal reference occurrences and declared roles are in `DEPENDENCY_MAP_V57.json`. Neither ledger is a formal proof certificate.
