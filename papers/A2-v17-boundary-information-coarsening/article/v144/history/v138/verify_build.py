...
for name in ['geometry','supplement','complete']:
    ...
    logchecks[name+'_title_revision138']='revision 138' in fitz.open(p).metadata.get('title','').lower()
...
scripts=['exact_k3','exact_corank_two','stratified_rank_two','boundary_atlas','generic_boundary_atlas',
 'revision131_exact','revision132_exact','revision133_exact','revision134_exact','revision135_exact','revision136_exact','revision137_exact','revision138_exact']
checks={**logchecks,
 'focused_article_under_50_pages':pdf_info['geometry']['pages']<50,
 'complete_mathematics_retained':pdf_info['complete']['pages']>=92,
 ...
 'all_thirteen_script_execution_logs_present':all((ROOT/'evidence'/(n+'.log')).exists() for n in scripts),
...
receipt={'revision':138,'source_commit':m['assembly_commit'],'reviewed_commit':m['reviewed_commit'],
 ...
 'new_exact_result':r138,
 'overfull_box_warnings':{n:[l for l in log.splitlines() if 'Overfull' in l] for n,log in logs.items()},
 'evidence_scope':{'structural_proofs_not_machine_certified':r138['structural_proofs_not_machine_certified']+r137['structural_proofs_not_machine_certified']+r136['structural_proofs_not_machine_certified']+r135['structural_proofs_not_machine_certified']+r134['structural_proofs_not_machine_certified'],
...
if not receipt['ok']:raise SystemExit('v138 verification failed')
