\section{An intrinsic coefficient principle and a second family}
...
quadratic multiplication.  We state that formulation and then verify it
for linear systems of hypersurfaces in every dimension.  In particular,
the extension in this section concerns intrinsic scheme reconstruction,
not only the recombination of an already supplied component pair.
...
This is a second verified instance of the intrinsic mechanism, not a
claim that the original cube-zero web theorem holds in every dimension.
