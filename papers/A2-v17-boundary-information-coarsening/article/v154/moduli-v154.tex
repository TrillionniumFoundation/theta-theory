...
Finally apply Theorem~\ref{thm:pencil-stack-equivalence-v149} and the
...
therefore determines the full Segre symbol, and conversely that
symbol determines the tower up to projective change of the line.
...
factor $(\det T)^{n-1}$, by Lemma~\ref{lem:primitive-pencil-v149}.
