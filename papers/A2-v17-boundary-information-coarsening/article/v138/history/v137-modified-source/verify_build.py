...
for name in ['geometry','supplement','complete']:
    ...
    logchecks[name+'_title_revision137']='Revision 137' in first
...
scripts=['exact_k3','exact_corank_two','stratified_rank_two','boundary_atlas','generic_boundary_atlas',
 'revision131_exact','revision132_exact','revision133_exact','revision134_exact','revision135_exact','revision136_exact','revision137_exact']
checks={**logchecks,
 ...
 'all_twelve_script_execution_logs_present':all((ROOT/'evidence'/(n+'.log')).exists() for n in scripts),
 'new137_exact_checks':r137['ok'],
...
receipt={'revision':137,'source_commit':m['assembly_commit'],'reviewed_commit':m['reviewed_commit'],
 ...
 'new_exact_result':r137,
 'overfull_box_warnings':{n:[l for l in log.splitlines() if 'Overfull' in l] for n,log in logs.items()},
 'evidence_scope':{'structural_proofs_not_machine_certified':r137['structural_proofs_not_machine_certified']+r136['structural_proofs_not_machine_certified']+r135['structural_proofs_not_machine_certified']+r134['structural_proofs_not_machine_certified'],
 'documentary_open':['B136.1: complete theorem-level comparison with Ballico 1993'],
...
if not receipt['ok']:raise SystemExit('v137 verification failed')
