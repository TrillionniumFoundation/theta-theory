...
\[
                 \mathscr L/\{\text{common positive reweightings}\}
                         \simeq \mathscr W.
\]
On each bounded set with the denominator margins of
Theorem~\ref{thm:v77-clock}, this identification and recovery of
$a/a(z_0)$ are locally Lipschitz in every fixed $C^m$ norm.
\end{theorem}
\begin{proof}
