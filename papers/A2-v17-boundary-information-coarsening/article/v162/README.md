# A2 revision 162 — controlling review entry

Branch: `revision/a2-v162-versal-contact-neighborhoods-2026-09-25`.
Authored source commit: `5f0cb5538faddf20af4ebea70615058677f1c9df`.
...
commit is recorded in `papers/A2-v17-boundary-information-coarsening/article/v162/PUBLICATION_SEAL_V162.json`. The seal is not
