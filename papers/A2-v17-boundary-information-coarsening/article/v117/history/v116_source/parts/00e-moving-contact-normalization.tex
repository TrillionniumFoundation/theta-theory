...
in Theorem~\ref{thm:conductor-reduction}. It is smooth and irreducible
...
Each component downstairs is a prime Cartier divisor in the smooth
ambient space. Pulling its reduced ideal back to the labelled cover
...
For $d\ge4$, $n\ge2d-1$, and $m\ge d-1$, the schemes $Y_m$
...
\end{theorem}
\begin{proof}
Theorem~\ref{thm:conductor-reduction} applies on the whole relative
...
Theorem~\ref{thm:conductor-reduction}, or by specializing the
...
of Theorem~\ref{thm:conductor-reduction}.
\end{proof}
