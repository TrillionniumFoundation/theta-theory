...
component theorem stated in the introduction. Theorem~\ref{thm:all-dimension}
...
unverified. In particular bibliographic confirmation of \cite{Ballico93}
is not presented as a completed theorem-by-theorem priority comparison.
