...
in the preceding revision.  We record that structure before passing
...
\(\mathfrak m\)-saturated.  Put \(\mathscr C_H=V(I_H)\) for the affine contact cone.  Its
...
support \(E_R\).  Thus \(\mathscr C_H\) is its scheme-theoretic closure away
