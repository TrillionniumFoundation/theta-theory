...
It does not assert that each configuration occurs on the smooth
Jacobian open, nor compute the irreducible components or codimensions
of its exceptional subloci.  It separates positive-dimensional flag
...
In the monomial notation of the preceding subsection put
\[
