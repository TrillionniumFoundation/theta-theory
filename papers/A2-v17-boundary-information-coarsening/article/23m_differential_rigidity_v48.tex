...
Fix a table in $\mathscr A_N$ and a skeleton
...
$u$.  The two positive-density squares $Q_{e,b}$ and their nonzero
anchors can be fixed on a parameter neighborhood.  Write
\[
...
The differentiated relative construction of
...
$T_0\in\mathscr A_N$, with a persistent selected skeleton and fixed
...
$\theta_0$ is injective and $T_{\theta_0}\in\mathscr A_N$.
