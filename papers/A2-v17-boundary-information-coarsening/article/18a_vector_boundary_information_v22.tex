\section{Vector boundary information for a non-dominated local family}
\label{sec:v22-vector-information}

We formulate the moving-support experiment without introducing a
finite-sample likelihood ratio where none exists.  The original local family
is generally non-dominated.  We first separate its support-exclusive mass,
then apply a parameter-independent common-collar censoring.  The censored
family is genuinely dominated and satisfies a uniform LAN expansion.  The
original family is uniformly asymptotically equivalent to that representative
on every compact local set.  We distinguish this equivalence statement from
finite-subexperiment convergence to the Gaussian shift and formulate singular
information on its identifiable quotient.
...
\subsection{A genuinely dominated common-collar representative}
...
$o(1)$ Le Cam distance from the dominated common-collar representative, by
...
We reserve ``LAN expansion'' for the dominated common-collar representative.
...
contiguity, and minimax consequences.  This keeps finite-sample domination,
local asymptotic normality, and convergence of experiments logically
separate.
\end{remark}
