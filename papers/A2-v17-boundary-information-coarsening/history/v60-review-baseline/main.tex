% A2 revision 60. Complete native manuscript; all inherited proofs are retained.
\input{preamble}
...
\hypersetup{pdftitle={Boundary laws and rigidity of periodic dispersing billiards},pdfauthor={Qian Qi},pdfsubject={A2 revision 60; complete native manuscript}}
\begin{document}
\begin{abstract}
