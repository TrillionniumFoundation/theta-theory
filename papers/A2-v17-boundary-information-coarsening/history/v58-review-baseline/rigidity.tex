% A2 v58. Principal journal article; shared complete proofs, no excerpted proof bodies.
\input{preamble}
...
pdfauthor={Qian Qi},pdfsubject={A2 revision 58; principal journal article}}
\begin{document}
