% A2 v61. Principal journal article; shared complete proofs, no excerpted proof bodies.
\input{preamble}
...
pdfauthor={Qian Qi},pdfsubject={A2 revision 61; principal journal article}}
\begin{document}
