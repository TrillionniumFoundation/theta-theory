% A2 v64. Principal journal article; shared complete proofs, no excerpted proof bodies.
\input{preamble}
...
pdfauthor={Qian Qi},pdfsubject={A2 revision 64; principal journal article}}
\begin{document}
...
nonlinear transmission coordinates.  For alternating channels, fixed
