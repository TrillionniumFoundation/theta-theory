% A2 v57. Principal journal article; shared complete proofs, no excerpted proof bodies.
\input{preamble}
...
pdfauthor={Qian Qi},pdfsubject={A2 revision 57; principal journal article}}
\begin{document}
