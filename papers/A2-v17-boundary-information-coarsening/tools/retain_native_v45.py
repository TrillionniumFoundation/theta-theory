#!/usr/bin/env python3
"""v45-only CLI for the preserved native-artifact and Git-object verifier."""
...
def main() -> None:
    ...
    require(re.fullmatch(r'deliveries/a2-v45/[0-9a-f]{40}',args.destination.as_posix()) is not None,
    ...
    if args.operation=='prepare':
        ...
        readme.write_text(readme.read_text().replace('v44 verification ledger','v45 verification ledger'))
    else:
