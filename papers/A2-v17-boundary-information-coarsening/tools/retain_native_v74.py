#!/usr/bin/env python3
"""Version-scoped publication of the three complete source-matched v74 entries.
...
def main() -> None:
    ...
    require(re.fullmatch(r'deliveries/a2-v74/[0-9a-f]{40}',args.destination.as_posix()) is not None,
    ...
    if args.operation=='prepare':
        ...
        readme.write_text(readme.read_text().replace('v56 review ledger','v74 review ledger'))
    else:
