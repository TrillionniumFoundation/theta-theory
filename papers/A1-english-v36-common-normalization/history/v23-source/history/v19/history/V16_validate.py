#!/usr/bin/env python3
"""Execute all six inherited author suites and the complete v16 build.
...
def main():
    ...
    report = {'version': 16, 'python': platform.python_version(),
              'source_files_verified': verify(),
              'controlling_review': 'd89bc35dc5d50240c8ae3c82aa251437dcc2165a',
              'submission_basis': 'e1d0ff2ef04a8641ac77923b664c4d3e8386f212',
    ...
    old = json.loads((ROOT/'history/V15_SOURCE_MANIFEST.json').read_text())
    old_files = old['files']
