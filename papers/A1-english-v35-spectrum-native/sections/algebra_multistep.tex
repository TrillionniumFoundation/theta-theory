...
alternative in Section~\ref{sec:algebra-transfer-alternative}. We give an experiment-level criterion: neither the
...
\input{sections/algebra_saturated_geometry}
