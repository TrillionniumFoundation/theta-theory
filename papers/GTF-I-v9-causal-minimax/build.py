...
REPO=HERE.parents[1]
REVIEW='1e2ad3c7c5687e9cc9c0e7e0b37e983795f9f4c5'
MUTANTS=('task_after_encoder','convexify_private','free_seed_index','drop_prediction',
         'drop_likelihood','omit_action','mix_logarithms')
...
def main()->None:
    ...
    if not args.skip_diagnostics:
        ...
        for edition,path in [('v8','GTF-I-v8-decision-spectrum/verify.py'),('v7','GTF-I-v7-structural/verify.py'),('v6','GTF-I-v6-markov/verify.py'),('v5','GTF-I-v5-intrinsic/verify.py'),('v4','GTF-I-v4/verify.py'),('v3','GTF-I-v3/verify.py'),('v2','GTF-I-v2/verify.py'),('v1','GTF-I-v2/legacy/tools/verify.py')]:
    ...
    with tempfile.TemporaryDirectory(prefix='gtf-v9-build-') as work:
        work=Path(work)
    ...
    receipt={'edition':'General Theta Foundations I, ninth controlled common-encoder revision','review_commit':REVIEW,'source_commit':source_commit,'checkout_kind':checkout_kind,
