...
\newcommand{\Qstar}{Q_*}
\title[Intrinsic continuation geometry]{General Theta Foundations I:\\
Intrinsic Continuation Geometry and Causal Memory}
\author{Qian Qi}
\date{September 24, 2026. Revision 29}
...
\input{intrinsic-continuation}
\input{tensor-continuation}
\input{streaming-access}
\input{contact-application}
\input{literature-theorems}
