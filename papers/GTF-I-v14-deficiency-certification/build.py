...
REPO=HERE.parents[1]
REVIEW='a03a574936230aedbe1a8d3f4cb5b1fbd9c8ceb3'
MUTANTS=('missing_cell','false_lower','false_upper','repeated_row','visible_selector_modulus',
         'omit_graph_residual','omit_kick_residual','reverse_word','drop_reset_tail')
...
def main()->None:
    ...
    if not args.skip_diagnostics:
        ...
        for edition,path in [('v13','GTF-I-v13-intrinsic-deficiency/verify.py'),('v12','GTF-I-v12-causal-completion/verify.py'),('v11','GTF-I-v11-resource-comparison/verify.py'),('v10','GTF-I-v10-marked-duality/verify.py'),('v9','GTF-I-v9-causal-minimax/verify.py'),('v8','GTF-I-v8-decision-spectrum/verify.py'),('v7','GTF-I-v7-structural/verify.py'),('v6','GTF-I-v6-markov/verify.py'),('v5','GTF-I-v5-intrinsic/verify.py'),('v4','GTF-I-v4/verify.py'),('v3','GTF-I-v3/verify.py'),('v2','GTF-I-v2/verify.py'),('v1','GTF-I-v2/legacy/tools/verify.py')]:
    ...
    with tempfile.TemporaryDirectory(prefix='gtf-v14-build-') as work:
        work=Path(work)
    ...
    require(set(predecessor)<=set(maps['complete-development']),'Missing v13 companion labels: '+str(set(predecessor)-set(maps['complete-development'])))
    for rel,digest in {**inherited,**new}.items():
    ...
    receipt={'edition':'General Theta Foundations I, fourteenth deficiency-certification revision','review_commit':REVIEW,'source_commit':source_commit,'checkout_kind':checkout_kind,
             ...
             'source_manifest_sha256':sha(HERE/'SOURCE_MANIFEST.json'),'preserved_v13_companion_labels':len(predecessor),'retained_labels_resolved':len(retained),'shared_canonical_labels_same_numbers':len(core),
