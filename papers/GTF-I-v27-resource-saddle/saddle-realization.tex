...
\begin{theorem}[Saddle-face realization and exact resource loss]
...
\end{theorem}
\begin{proof}
For every $C$, its prior average is at most $U$ and at least its minimum
...
then proves the realization criterion. Compactness makes nonintersection
