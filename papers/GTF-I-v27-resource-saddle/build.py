...
E=H/'evidence'
BASE='6018ed8f31d758b35eacc48079104e5895fc9591'
PREVIOUS='466bfcdcb8b7d594d3924dbfa82b4c6e29368858'
...
def main()->None:
    ...
    regression={}
    versions=[('v27',H),('v26',O),('v25',V25),('v24',V24)]
    ...
    controls=[('v27',H,['free-tie','face-overlap','residual-vertex','anticipating-action','nearest-value','mark-cost']),
              ('v26',O,['cubic','coin','response','free-selector','unbalanced-minimax','calibration-register']),
    ...
    with tempfile.TemporaryDirectory(prefix='gtf27-latex-') as td:
        work=Path(td)
    ...
    for lab in ['thm:saddle-realization','lem:face-packing','thm:five-memory','cor:strict-four','thm:serial-twelve','thm:prior-localization','thm:marked-contact-geometry','cor:marked-prior-limit','thm:two-family']:
    ...
    receipt={'schema':'gtf27.build/1','source_commit':os.environ.get('GTF_SOURCE_COMMIT','local-uncommitted'),
    ...
    (H.parent.parent/'GENERAL_THETA_FOUNDATIONS_I_V27_REVIEW_READY.md').write_text(
        '# General Theta Foundations I — revision 27\n\n'
        '**Saddle Geometry and the Memory of Causal Experiments**\n\n'
        f"Native source commit: `{receipt['source_commit']}`. Controlling r10 review: `{BASE}`.\n\n"
        ...
        'Saddle-face contact and compatible positive realization; exact decision width five; exact peak twelve for candidate-first serial validation; all-N value endpoint and least-favorable-prior localization with intrinsic marked contact geometry.\n\n'
        'The twelve-state peak theorem is explicitly candidate-first serial, not an optimum over all validation orders. The decision count is order-independent. Sharp all-N rates and historical A2/B4/C2 aggregate closure are not inferred.\n')
