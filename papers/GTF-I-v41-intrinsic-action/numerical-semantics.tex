...
Theorem~\ref{thm:intrinsic-width41}, numerical width is of order
...
We fix the version before comparing its theorem. The primary arXiv
submission record inspected on September 26, 2026 lists version 1 dated
April 8 and version 2 dated August 27, 2026. In version 1
\cite{CWaprV1}, Proposition 3.1 is the $q^2$-dimensional mixed-state
linearization, Theorem 3.2 gives $2k+6$ PFA states from a $k$-state
GFA, and Corollary 3.3 gives $2q^2+6$. In the explicitly versioned
version 2, the title and theorem numbering change. The PDF's printed
pages 4 and 5 contain, respectively, Proposition 3.1 and Theorem 3.2
with the improved constants used below. These are distinct primary
versions, not interchangeable theorem numbers. We make no inference
about why an earlier access exposed only one version.

Chen--Wu's version-2 generalized-automaton conversion
