# Appendix H — Compact moving-family high-frequency BDL

This appendix is normative for `P2-BDL-HF-FAMILY`.  The full proof is

```text
../../maximal-strengthening/MOVING_FAMILY_HIGH_FREQUENCY_BDL.md
```

## H.1 Uniform family packet
...
A smooth quadratic partition on the finite parameter atlas gives maps
`J_a,R_a` with
