...
| Bounded geometric sensitivity incorrectly treated as belief independence | Vanishing slow initial layer plus `q^{ell_epsilon}` contraction | CLOSED_BY_CORRECTION |
