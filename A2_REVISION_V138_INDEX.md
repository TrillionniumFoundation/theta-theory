...
<!-- REMOTE_BUILD_START -->
Remote execution has not yet been verified at the source-transport commit. The branch workflow records the executed run and publishes native sources, PDFs, and evidence here only after all checks pass.
<!-- REMOTE_BUILD_END -->
