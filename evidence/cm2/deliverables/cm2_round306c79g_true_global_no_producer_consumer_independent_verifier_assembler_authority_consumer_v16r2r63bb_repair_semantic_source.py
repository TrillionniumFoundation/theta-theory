...
SOURCE_BASENAME = "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63bb_repair_semantic_source.py"
...
V16_TO_V16R2_TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r62_to_v16r2r63bb_repair_static_launch_transition_receipt_v1.json"
STATIC_AUDIT_V16R2 = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r63bb_repair.json"
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r63bb_repair_semantic_source.py"
COLD_LAUNCHER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r63bb_repair_semantic_source.py"
COLD_LAUNCH_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r63bb_runtime_repair.sha256"
COLD_LAUNCH_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63bb_runtime_repair.json"
...
V16R2_DRAFT_RUNTIME_DISABLED = True
FINAL_CURRENT_V16R2_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "67f7bd1031f955a3bd87bc1de96fed1626fe9b4d88e13decd4c4c7d92b13798f"
CONTRACT_OBJECT_PIN = "f843f92b32444a2c29709e64d7af239b37cc6aaf3c52ff934b5c550ddcc6dc53"
...
PRODUCER_SOURCE_PIN = "1726217b308017e25dce5404cd35bb9661293664b143694064ba029bb189e421"
...
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63bb_runtime_repair.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v16r2r63bb-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v16r2r63bb-candidate-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v16r2r63bb-verification-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v16r2r63bb-verification-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v16r2r63bb-committed-completion-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v16r2r63bb-" + UPSTREAM_CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v16r2r63bb-rejections-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v16r2r63bb-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v16r2-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v16r2r63bb-verification-stage-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v16r2r63bb-verification-stage-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v16r2r63bb-candidate-stage-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v16r2r63bb-candidate-stage-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63bb_repair_semantic_source.py",
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v16r2r63bb-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v16r2r63bb-candidate-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v16r2r63bb-verification-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v16r2r63bb-verification-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v16r2r63bb-committed-completion-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
...
# _R63BB_STATIC_FREEZE_SCHEMA_PROJECTION_APPLIED_
def _r63bb_schema_later_rejection_projection(self_guard, freeze_proof):
...
_r63bb_raw_static_freeze_proof = static_freeze_proof


def static_freeze_proof(*args, **kwargs):
    proof = _r63bb_raw_static_freeze_proof(*args, **kwargs)
    self_guard = args[1] if len(args) > 1 else kwargs.get("self_guard")
    if self_guard is None:
        raise RuntimeError("r63bb static-freeze self guard missing")
    if not isinstance(proof, dict):
        raise RuntimeError("r63bb static-freeze proof is not an object")
    ...
    proof["v8_official_rejection"] = _r63bb_schema_later_rejection_projection(
        self_guard, proof)
    return proof


def _r63bb_project_v4_proof_for_schema(freeze_proof):
    proof = v4_rejection_supersession_proof(freeze_proof)
    if not isinstance(proof, dict):
        raise RuntimeError("r63bb v4 proof is not an object")
    raw = proof.get("ordered_provisional_exact8")
    if not isinstance(raw, list) or len(raw) != 8:
        raise RuntimeError("r63bb v4 exact8 historical shape drift")
    projected = []
    for member in raw:
        if not isinstance(member, dict):
            raise RuntimeError("r63bb v4 exact8 member is not an object")
        if "mode" not in member or "nlink" not in member:
            raise RuntimeError("r63bb v4 historical mode/nlink witness missing")
...
def authority_root(
    ...
    body: dict[str, Any] = {
        ...
        "v4_rejection_supersession":
            _r63bb_project_v4_proof_for_schema(freeze_proof),
        "published_then_officially_rejected_predecessor_v5": copy.deepcopy(
            freeze_proof[
                "published_then_officially_rejected_predecessor_v5"]),
        "published_then_officially_rejected_predecessor_v6": copy.deepcopy(
...
def _committed_context(
    ...
    _r63bb_recorded_stage = install_proof["staging_path"]
    need(_r63bb_recorded_stage == DECLARED_COMPLETION_STAGE,
