...
V14_EXACT10_FD_ENV_ORDER = tuple(
    (role, "CM2_c79g-v16r2_V14_" + role.upper() + "_FD")
    for role, _, _, _ in V14_PUBLISHED_EXACT10_WITNESS)
V14_OFFICIAL_REJECTION_FD_ENV = "CM2_c79g-v16r2_V14_OFFICIAL_REJECTION_FD"
V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_FD_ENV = (
    "CM2_c79g-v16r2_V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_FD")
...
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v16r2_semantic_source"
LAUNCHER_RELATIVE = Path("deliverables") / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r3_semantic_source.py"
...
ROOT = Path("/__c79g-v16r2_UNCONFIGURED_ROOT__")
OUT = ROOT / "deliverables"

ACTIVE_PREDECESSOR_SUPERSESSION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16_semantic_rejection_supersession_receipt_v1.json"
ACTIVE_SUCCESSOR_NAMESPACE = "v16r2r2-semantic-regeneration"
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r2_to_v16r2r3_semantic_source_rejection_supersession_receipt_v1.json"
RUNTIME = ROOT / ".cm2-runtime"
SELF = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r3_semantic_source.py"
...
SCHEMA = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2.json"
CONTRACT = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2.json"
PRODUCER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r3_semantic_source.py"
CONSUMER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r3_semantic_source.py"
TRANSITION = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16_to_v16r2_static_launch_transition_receipt_v1.json"
AUDIT = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2.json"
MANIFEST = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2.sha256"
OUTER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2.json"
MANIFEST = OUTER = SELF
...
BASE7_PINS = {}
EXACT8: tuple[Path, ...] = (    ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16_semantic_rejection_supersession_receipt_v1.json",
    SCHEMA,
    CONTRACT,
    PRODUCER,
    CONSUMER,
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2.json"
    CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2.json"
    PRODUCER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r3_semantic_source.py"
    CONSUMER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r3_semantic_source.py"
    TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16_to_v16r2_static_launch_transition_receipt_v1.json"
    AUDIT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2.json"
    MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2.sha256"
    OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2.json"
    BASE7_PINS.clear()
    EXACT8 = (    ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16_semantic_rejection_supersession_receipt_v1.json",
        SCHEMA,
        CONTRACT,
        PRODUCER,
        CONSUMER,
...
COLD_ROOT_DOMAIN = b"CM2_c79g-v16r2_COLD_LAUNCHED_AUTHORITY_ROOT_V1\0"
LIVE_PROTOCOL = "CM2_c79g-v16r2_COLD_TWO_PHASE_LIVE_ACK_V1"
LIVE_REQUEST_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v16r2."
...
PREWRAPPER_BODY_DOMAIN = "CM2_c79g-v16r2_COLD_PREWRAPPER_BODY_V1"
TRANSACTION_BINDING_DOMAIN = "CM2_c79g-v16r2_COLD_TRANSACTION_BINDING_V1"
LIVE_ACK_BINDING_DOMAIN = "CM2_c79g-v16r2_COLD_LIVE_ACK_BINDING_V1"
SOURCE_FD_ENV = "CM2_c79g-v16r2_COLD_SOURCE_FD"
EXEC_FD_ENV = "CM2_c79g-v16r2_COLD_EXEC_FD"
COORDINATION_PARENT_FD_ENV = "CM2_c79g-v16r2_COORDINATION_PARENT_FD"
WORKSPACE_ROOT_ENV = "CM2_c79g-v16r2_COLD_WORKSPACE_ROOT"
WORKSPACE_ROOT_FD_ENV = "CM2_c79g-v16r2_COLD_WORKSPACE_ROOT_FD"
LAUNCHER_SHA_ENV = "CM2_c79g-v16r2_COLD_LAUNCHER_FILE_SHA256"
HELD_V10_PRODUCER_FD_ENV = "CM2_c79g-v16r2_V10_PRODUCER_FD"
HELD_V9_LAUNCHER_FD_ENV = "CM2_c79g-v16r2_V9_LAUNCHER_FD"
HELD_V11_PRODUCER_FD_ENV = "CM2_c79g-v16r2_V11_PRODUCER_FD"
HELD_V11_LAUNCHER_FD_ENV = "CM2_c79g-v16r2_V11_LAUNCHER_FD"
HELD_V11_REJECTION_FD_ENV = "CM2_c79g-v16r2_V11_REJECTION_FD"
HELD_V12_PRODUCER_FD_ENV = "CM2_c79g-v16r2_V12_PRODUCER_FD"
HELD_V12_CONSUMER_FD_ENV = "CM2_c79g-v16r2_V12_CONSUMER_FD"
HELD_V12_LAUNCHER_FD_ENV = "CM2_c79g-v16r2_V12_LAUNCHER_FD"
HELD_V5_REJECTION_FD_ENV = "CM2_c79g-v16r2_V5_REJECTION_FD"
HELD_V12_REJECTION_FD_ENV = "CM2_c79g-v16r2_V12_REJECTION_FD"
HELD_V13_PRODUCER_FD_ENV = "CM2_c79g-v16r2_V13_PRODUCER_FD"
HELD_V13_CONSUMER_FD_ENV = "CM2_c79g-v16r2_V13_CONSUMER_FD"
HELD_V13_LAUNCHER_FD_ENV = "CM2_c79g-v16r2_V13_LAUNCHER_FD"
HELD_V13_PRODUCER_PYC_FD_ENV = "CM2_c79g-v16r2_V13_PRODUCER_PYC_FD"
HELD_V13_CONSUMER_PYC_FD_ENV = "CM2_c79g-v16r2_V13_CONSUMER_PYC_FD"
HELD_V13_LAUNCHER_PYC_FD_ENV = "CM2_c79g-v16r2_V13_LAUNCHER_PYC_FD"
HELD_V13_SUPERSESSION_RECEIPT_FD_ENV = (
    "CM2_c79g-v16r2_V13_SUPERSESSION_RECEIPT_FD")
...
def construct_launcher_native_rejection(
    ...
    return close_object({
        ...
        "rejection_reason": "ORPHANED_OR_INCOMPLETE_c79g-v16r2_SURFACE",
    ...
    def _initialize(self, expected_launcher_sha256: str,
        ...
        need(set(self.base_objects[CONTRACT]) == {
             ...
             self.base_objects[TRANSITION].get("status") ==
                 "STATIC_BYTES_CLOSED_v16-to-v16r2__PHYSICAL_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED" and
...
def child_environment(bundle: HeldBundle, child_exec: HeldSealedChildExec,
    ...
    need(len(authority_environment) == 12 and
         ...
         all(env_name.startswith("CM2_c79g-v16r2_V14_") and
