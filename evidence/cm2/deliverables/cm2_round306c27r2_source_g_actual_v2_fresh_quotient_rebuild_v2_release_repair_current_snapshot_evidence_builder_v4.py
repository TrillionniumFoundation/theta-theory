...
This is Stage A of the append-only v4 repair.  It consumes one externally
...
SNAPSHOT_STATUS = (
    "PASS_C27R2_RELEASE_REPAIR_V4_CORE_FRESH_COLD_BOUNDARY_TRUST_"
...
def verify_plan_contract(plan: dict[str, Any], plan_path: Path) -> list[dict[str, Any]]:
    ...
    for ordinal, spec in enumerate(authority):
        ...
        body = {"schema": BASE + "snapshot-member-row.v4", "ordinal": ordinal,
...
def self_test() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(dir=ROOT / ".cm2-runtime",
            prefix="c27r2-snapshot-v4-selftest-") as raw:
        ...
        row_body = {"schema": BASE + "snapshot-member-row.v4", "ordinal": 0,
    ...
    return {"status": "PASS_C27R2_RELEASE_REPAIR_SNAPSHOT_V4_SELF_TEST"}
