#!/usr/bin/env python3
"""Close every expanded R174--R204/R208 curved full-signature face.
...
def main() -> int:
    ...
    parser.add_argument("--seed", type=int, default=266_071)
    ...
    result = build(producer_sha256, arguments.processes)
    document = {
        "schema": SCHEMA,
        "result": result,
    ...
    print(
        "curved_faces=2652 corridors=5304 rank=588 "
        "components=63812->63224"
    )
    print("frontiers=63224/126468/116/133284/259752")
    return 0
