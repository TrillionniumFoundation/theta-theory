#!/usr/bin/env python3
"""Externally pinned cold launcher for the C79g v9 exact10 static bundle.
...
LAUNCHER_RELATIVE = Path("deliverables") / (BASE + "_cold_launch_v9.py")
...
ROOT = Path("/__C79G_V9_UNCONFIGURED_ROOT__")
...
V9_REJECTION_NAMESPACE = ROOT / "__unconfigured_v9_rejections__"
V9_LATER_REJECTION = V9_REJECTION_NAMESPACE / "rejection.json"
...
def configure_workspace_paths(root: Path) -> None:
    ...
    global V8_OFFICIAL_REJECTION
    global V9_REJECTION_NAMESPACE
    global V9_LATER_REJECTION, SCHEMA, CONTRACT, PRODUCER, CONSUMER
    ...
    global V8_FORBIDDEN_RUNTIME_PATHS
    ROOT = root
    OUT = ROOT / "deliverables"
    RUNTIME = ROOT / ".cm2-runtime"
    SELF = ROOT / LAUNCHER_RELATIVE
    ...
    V9_REJECTION_NAMESPACE = RUNTIME / ("c79g-v9-rejections-" + CHECKPOINT)
    V9_LATER_REJECTION = V9_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / (BASE + "_schema_v9.json")
    CONTRACT = OUT / (BASE + "_contract_v9.json")
    PRODUCER = OUT / (BASE + "_v9.py")
    CONSUMER = OUT / (BASE + "_independent_verifier_assembler_authority_consumer_v9.py")
    TRANSITION = OUT / (BASE + "_v8_to_v9_static_launch_transition_receipt_v1.json")
    AUDIT = OUT / (BASE + "_static_audit_v9.json")
    MANIFEST = OUT / (BASE + "_cold_launch_manifest_v9.sha256")
    OUTER = OUT / (BASE + "_cold_launch_outer_receipt_v9.json")
    BASE7_PINS = {
    ...
    EXACT8 = (V8_OFFICIAL_REJECTION, SCHEMA, CONTRACT, PRODUCER,
...
INNER_SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v9.inner-composite"
COLD_ROOT_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v9."
    "cold-launched-committed-authority"
)
COLD_ROOT_DOMAIN = b"CM2_C79G_V9_COLD_LAUNCHED_AUTHORITY_ROOT_V1\0"
LIVE_PROTOCOL = "CM2_C79G_V9_COLD_TWO_PHASE_LIVE_ACK_V1"
LIVE_REQUEST_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v9."
    "cold-live-commit-request"
)
LIVE_ACK_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v9.cold-live-ack"
)
LIVE_RELEASE_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v9.cold-live-release"
)
PREWRAPPER_BODY_DOMAIN = "CM2_C79G_V9_COLD_PREWRAPPER_BODY_V1"
TRANSACTION_BINDING_DOMAIN = "CM2_C79G_V9_COLD_TRANSACTION_BINDING_V1"
LIVE_ACK_BINDING_DOMAIN = "CM2_C79G_V9_COLD_LIVE_ACK_BINDING_V1"
SOURCE_FD_ENV = "CM2_C79G_V9_COLD_SOURCE_FD"
EXEC_FD_ENV = "CM2_C79G_V9_COLD_EXEC_FD"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V9_COORDINATION_PARENT_FD"
WORKSPACE_ROOT_ENV = "CM2_C79G_V9_COLD_WORKSPACE_ROOT"
WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V9_COLD_WORKSPACE_ROOT_FD"
LAUNCHER_SHA_ENV = "CM2_C79G_V9_COLD_LAUNCHER_FILE_SHA256"
...
def expected_v5_published_rejected_segment() -> dict[str, Any]:
    """Construct the one exact v5 regression shape shared by v9 proofs."""
    names = (
    ...
    return {
        ...
        "held_self_identity_defect": {
            ...
            "target_structural_comprehension_ast_sha256":
                V6_TARGET_IDENTITY_COMPREHENSION_AST_SHA256,
            "normalized_frozen_source_ast_sha256": V6_NORMALIZED_AST_SHA256,
...
PIN_NORMALIZED_AST_ALGORITHM = (
    ...
    "CURRENT_V9_SIX_BASE7_FILE_F64_OBJECT_E64_OR_NONE__"
    "PRESERVE_V8_AND_ALL_HISTORICAL_PINS_V1"
)
...
def pin_normalized_launcher_ast_sha256(raw: bytes, label: str) -> str:
    ...
    six current-v9 BASE7 values are replaced by fixed draft sentinels.  The v8
    ...
    expected_key_names = [
        "V8_OFFICIAL_REJECTION", *PIN_NORMALIZED_CURRENT_BASE7_KEY_ORDER,
    ]
    need(key_names == expected_key_names and
         len(base7.values) == len(expected_key_names),
         label + ":exact ordered v8-plus-current-v9 BASE7 key census")
    v8_before = ast.dump(
    ...
    need(ast.dump(
             ...
             include_attributes=False) == v8_before,
         label + ":v8 official-rejection BASE7 value preserved")
...
def v6_held_self_identity_defect_regression(raw: bytes) -> dict[str, Any]:
    """Prove the frozen v6 defect by structure, never by a global line count."""
    try:
    ...
    return expected_v6_published_rejected_segment()["held_self_identity_defect"]
...
def validate_final_static_audit(
    ...
    audit_keys = {
        ...
        "audited_v9_bundle", "predecessor_v3_exact10_regression",
    ...
    need(set(audit) == audit_keys and
         audit.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer.static-audit.v9" and
         audit.get("audit_path") == str(AUDIT.relative_to(ROOT)) and
         audit.get("effective_checkpoint_object_sha256") == CHECKPOINT and
         audit.get("status") ==
         "PASS_DUAL_STATIC_PIN_NORMALIZED_AST_GO_V9__"
         "PHYSICAL_COLD_FREEZE_PENDING__"
         "RUNTIME_NOT_AUTHORIZED",
         "final static audit exact top-level closure and PASS_V9 status")
    ...
    dual_keys = {
        ...
        "pin_normalization_preserves_v8_and_all_historical_pins",
    ...
    need(isinstance(input_a, dict) and set(input_a) == input_keys and
         ...
         "final static audit exact equal twenty-two-pin A/B input census")
    expected_inputs = {
        ...
        "launcher_template": pin_normalized_launcher_ast_sha256(
            launcher_source_raw, "held_v9_launcher_source"),
    ...
    need(isinstance(kind_census, dict) and set(kind_census) == kind_keys and
         ...
         dual.get(
             "pin_normalization_preserves_v8_and_all_historical_pins") is True and
         dual.get(
    ...
    expected_shapes = {
        "selfIdentity": 33, "independentConsumerProof": 54,
        "staticFreezeProof": 69, "coldLaunchProof": 100,
        "laterRejection": 48,
        "producerSourceRegistry": 50, "liveRequest": 15,
        "liveACK": 32, "liveACKCensus": 33,
    }
    need(isinstance(closure, dict) and set(closure) == closure_keys and
         ...
         closure.get("schema_definition_count") == 41 ==
             len(schema.get("$defs", {})) and
         type(closure.get("schema_ref_count")) is int and
         closure.get("schema_ref_count") == 221 ==
         ...
         closure.get("closed_object_count") == 47 == len(closed_nodes) and
    ...
    need(isinstance(no_run, dict) and set(no_run) == {
             "C79_entrypoint_executed", "C79_v9_runtime_artifact_count",
             "C79_v9_process_count", "pyc_or___pycache___created",
             "cold_manifest_or_outer_created_before_dual_GO",
         } and no_run.get("C79_entrypoint_executed") is False and
         type(no_run.get("C79_v9_runtime_artifact_count")) is int and
         no_run.get("C79_v9_runtime_artifact_count") == 0 and
         type(no_run.get("C79_v9_process_count")) is int and
         no_run.get("C79_v9_process_count") == 0 and
    ...
    def __init__(self, source: HeldFile) -> None:
        ...
        try:
            self.fd = os.memfd_create(
                "c79g-v9-child-exec", MFD_CLOEXEC | MFD_ALLOW_SEALING)
        except OSError as exc:
...
class HeldEmptyRejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent) -> None:
        coordination.verify()
        name = V9_REJECTION_NAMESPACE.name
        ...
        try:
            try:
                ...
                state = os.stat(name, dir_fd=coordination.fd,
                                follow_symlinks=False)
            self.path = V9_REJECTION_NAMESPACE
...
def construct_launcher_native_rejection(
    ...
    return close_object({
        ...
        "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
        "effective_checkpoint_object_sha256": CHECKPOINT,
        "namespace_exact_path": str(V9_REJECTION_NAMESPACE.relative_to(ROOT)),
        "target_exact_path": str(V9_LATER_REJECTION.relative_to(ROOT)),
        "rejection_reason": "ORPHANED_OR_INCOMPLETE_C79G_V9_SURFACE",
...
def install_or_replay_launcher_native_rejection(
    ...
    try:
        try:
            ...
            namespace_fd = openat2_beneath(
                V9_REJECTION_NAMESPACE, os.O_RDONLY | os.O_DIRECTORY)
    except BaseException:
        if namespace_fd >= 0:
    ...
    try:
        ...
        path_before = root_lstat(V9_REJECTION_NAMESPACE)
        ...
        target = os.stat(V9_LATER_REJECTION.name, dir_fd=namespace_fd,
                         follow_symlinks=False) if V9_LATER_REJECTION.name in universe else None
        if target is not None:
            need(universe == {V9_LATER_REJECTION.name},
                 "idempotent rejection exact singleton")
            rejection_guard = HeldFile(
                V9_LATER_REJECTION, "existing launcher-native v9 rejection")
        else:
            ...
            try:
                ...
                os.fsync(namespace_fd)
            rejection_guard = HeldFile(
                V9_LATER_REJECTION, "new launcher-native v9 rejection")
        need(rejection_guard is not None,
             "launcher-native rejection file held")
        value = strict_json(rejection_guard.raw, "launcher-native v9 rejection")
        need(isinstance(value, dict), "launcher-native rejection mapping")
        verify_object(value, "launcher-native v9 rejection")
        os.fsync(rejection_guard.fd)
        os.fsync(namespace_fd)
        os.fsync(coordination.fd)
        after = os.fstat(namespace_fd)
        path_after = root_lstat(V9_REJECTION_NAMESPACE)
        need(value == expected and rejection_guard.raw == expected_raw and
             set(os.listdir(namespace_fd)) == {V9_LATER_REJECTION.name} and
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str,
                    ...
                    bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / (BASE + "_cold_launch_v9.py"),
        ...
        for path in (V8_OFFICIAL_REJECTION, CONTRACT, TRANSITION, AUDIT):
        ...
        need(self.base_objects[CONTRACT].get("status") ==
             ...
             self.base_objects[TRANSITION].get("status") ==
                 "STATIC_BYTES_CLOSED_V8_TO_V9__PHYSICAL_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED" and
        ...
        # Current exact8 owns the sole v8-rejection fd.  Each frozen exact10
        # owns the preceding rejection fd; v3 keeps its separate singleton.
        self.predecessor_v8 = HeldV8PredecessorExact10(
            coordination, self.by_path[V8_OFFICIAL_REJECTION])
        ...
        need(self.predecessor_v6.held_self_identity_defect.get(
                 "guard_identity_structural_census") ==
                 V8_LAUNCHER_REGRESSION_DEFECT["actual_guard_identity_census"] and
             self.predecessor_v6.held_self_identity_defect.get(
                 "target_structural_comprehension_count") == 1 and
             V8_LAUNCHER_REGRESSION_DEFECT["old_global_count_expectation"] == 1,
             "v8 launcher regression defect joins pinned v6 three-use census")
        ...
        all_history_identities = (
            current_identities | predecessor_v8_identities |
            predecessor_v7_identities |
        ...
        need(len(all_history_identities) == 68 and
             ...
             self.by_path[V8_OFFICIAL_REJECTION].identity not in
             ...
             "current v9 exact10, v8/v7/v6/v5/v3 exact10, v3 rejection and "
             "v4 draft7 are 68 unique live files on one mount")
        validate_final_static_audit(
            ...
            self.predecessor_v8, self.by_path[SELF].raw)
    ...
    def terminal_replay(self) -> None:
        ...
        self.predecessor_v8.terminal_replay(
            self.by_path[V8_OFFICIAL_REJECTION])
...
def cold_root(bundle: HeldBundle, coordination: HeldCoordinationParent,
    ...
    need(bundle.predecessor_v5 is not None and
         ...
         bundle.predecessor_v8 is not None,
         "v8 direct predecessor and v7/v6/v5 history remain held for cold root")
    ...
    proof = {
        ...
        "current_exact8_first_member_is_v8_official_rejection":
            EXACT8[0] == V8_OFFICIAL_REJECTION,
        ...
        "current_v9_and_all_predecessor_unique_file_identity_count": 68,
        "current_v9_and_all_predecessor_same_statx_mount": True,
        **bundle.chronology,
        ...
        "reject_command_exempts_only_fresh_empty_v9_rejection_namespace": True,
...
def _validate_live_ack(
    ...
    expected_keys = {
        ...
        "static_v9_exact10_with_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request",
    ...
    expected_census = {
        ...
        "v8_official_rejection_in_static_policy_held_file_count": 1,
    ...
    need(set(ack) == expected_keys and ack.get("schema") == LIVE_ACK_SCHEMA and
         ...
         ack.get("static_v9_exact10_with_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
...
def run_authorize_child(
    ...
    try:
        ...
        request = close_object({
            ...
            "wrapper_body_excludes_transaction_binding_request_ACK_and_RELEASE_to_avoid_hash_cycle": True,
            "transaction_binding_is_replay_identical_not_fresh_or_random": True,
            "static_v9_exact10_with_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request": True,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "reject":
            ...
            return 0
        # Every positive-capable command holds the exact-empty v9 rejection
