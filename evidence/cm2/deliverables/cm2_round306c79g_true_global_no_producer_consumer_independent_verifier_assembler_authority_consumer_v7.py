#!/usr/bin/env python3
"""Independent C79g v7 verifier, assembler, and authority consumer.
...
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V7_COORDINATION_PARENT_FD"
...
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v7.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v7.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v7.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v7.json")
...
# the final current-v7 pins and flips the explicit finalization bit.
FINAL_CURRENT_V7_PINS_INSTALLED = True
...
PRODUCER_SOURCE_PIN = "67670681481cf372f775ad39a9f8d8b2459a77ef708e2f4da14ca114ac0f0d95"
TERMINALS = {
...
VERIFICATION_FILE = BASE + "_independent_verification_v7.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v7.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v7.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v7.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v7.json"
...
VERIFICATION_A = RUNTIME / ("c79g-v7-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v7-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v7-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v7-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v7-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v7-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v7-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v7-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v7-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v7-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v7-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V7_SURFACE"
COLD_ROOT_SCHEMA = SCHEMA + ".cold-launched-committed-authority"
LIVE_PROTOCOL = "CM2_C79G_V7_COLD_TWO_PHASE_LIVE_ACK_V1"
...
PREWRAPPER_BODY_DOMAIN = "CM2_C79G_V7_COLD_PREWRAPPER_BODY_V1"
TRANSACTION_BINDING_DOMAIN = "CM2_C79G_V7_COLD_TRANSACTION_BINDING_V1"
LIVE_ACK_BINDING_DOMAIN = "CM2_C79G_V7_COLD_LIVE_ACK_BINDING_V1"
V3_FROZEN_FILES = {
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v7.py",
             "SELF exact frozen v7 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V7_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V7_PINS_INSTALLED is True,
         "v7 final current pins are not installed; every command is disabled")
    ...
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              ...
              V6_OFFICIAL_REJECTION_OBJECT_PIN, PRODUCER_SOURCE_PIN)),
         "all v7 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v7-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v7-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v7-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v7-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v7-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v7-" +
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V6_OFFICIAL_REJECTION,
             V6_TO_V7_TRANSITION, STATIC_AUDIT_V7,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v7 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v7 schema root is cold-launched wrapper over zero-credit inner composite")
    ...
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        policy_guard, v6_guard, v6_source_metadata)
    ...
    # shared by current policy/v6 proof.  These are single held identities.
    need(len(current_policy_identities) == 10 and
         len(predecessor_identities) == 38 and
         current_policy_identities.isdisjoint(predecessor_identities) and
         len(current_policy_identities | predecessor_identities) == 48 and
         len({item.mount_id for item in policy_guard.files} |
             ...
             {item.mount_id for item in v6_source_metadata}) == 1,
         "current v7 exact10 plus v3/v4/v5/v6 predecessor exact identities "
         "close as exact48 on one mount")
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
         ...
         registry["append_only_history_unique_file_identity_count"] == 48 and
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v6_to_v7_transition_receipt", "static_audit_v7", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v6_to_v7_transition_receipt", {}).get("path") ==
             str(V6_TO_V7_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v6_to_v7_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v6_to_v7_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v7", {}).get("path") ==
             str(STATIC_AUDIT_V7.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v7", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v7", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            V6_OFFICIAL_REJECTION, "official v6 rejection shared with predecessor", 0o444,
            V6_OFFICIAL_REJECTION_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v7 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v7 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V6_TO_V7_TRANSITION, "post-source v6-to-v7 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V7, "post-source v7 static audit", 0o444),
        ...
        0o555, 2, "official v6 rejection exact singleton namespace")])
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v7 contract", CONTRACT_OBJECT_PIN)
    ...
    expected_paths = {
        ...
        "v7_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v7_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v7-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v7-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v6_to_v7_transition_path") ==
             str(V6_TO_V7_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V7.relative_to(ROOT)),
         "contract exact acyclic v7 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    need(audit.get("status") ==
         ...
         "final static audit exact full v7 GO/pre-freeze status")
    ...
    need(type(closure.get("schema_definition_count")) is int and
         closure.get("schema_definition_count") == definition_count == 38 and
         type(closure.get("schema_ref_count")) is int and
         closure.get("schema_ref_count") == reference_count == 191 and
         ...
         closure.get("closed_object_count") == closed_count == 44 and
         ...
         "final schema closure actual 38/191/44/0 counts")
    actual_keywords = [
    ...
    expected_shapes = {
        "selfIdentity": 33, "independentConsumerProof": 48,
        "staticFreezeProof": 53, "coldLaunchProof": 86,
        "laterRejection": 43, "producerSourceRegistry": 41,
        "liveRequest": 15, "liveACK": 32, "liveACKCensus": 27}
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v7 contract")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v7 closed schema")
    transition = strict_json(
        by_path[V6_TO_V7_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V7].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        v6_guard, v5_guard, v5_source_metadata)
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        policy_guard, v6_guard, v6_source_metadata)
    ...
    transition_file_sha256 = sha(by_path[V6_TO_V7_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V7].raw)
    ...
    exact8_stats = [
        by_path[V6_OFFICIAL_REJECTION].before,
        by_path[CLOSED_SCHEMA].before,
        by_path[CONTRACT].before,
        producer_guard.before,
        self_guard.before,
        by_path[V6_TO_V7_TRANSITION].before,
        by_path[STATIC_AUDIT_V7].before,
    ...
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V6_TO_V7_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v7_path", "contract",
             "draft_pin_sentinels_are_non_authoritative",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v7_path",
         ...
         transition_v5.get("official_later_rejection", {}).get("object_sha256") ==
             V5_OFFICIAL_REJECTION_OBJECT_PIN and
         transition_v6 == _expected_published_then_rejected_v6_proof(),
         "transition pins current bundle and append-only v3/v4/v5/v6 predecessors")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         ...
         audited.get("v6_to_v7_transition_receipt", {}).get("path") ==
             str(V6_TO_V7_TRANSITION.relative_to(ROOT)) and
         audited.get("v6_to_v7_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v6_to_v7_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        {"file_sha256": V6_OFFICIAL_REJECTION_FILE_PIN,
         "entry_name": str(V6_OFFICIAL_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V6_TO_V7_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V7.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V6_TO_V7_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V7])
    ...
    v6_rejection_identity = _one_identity(
        held_v6_official_rejection(policy_guard))
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v6_to_v7_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v6_to_v7_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v6_to_v7_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "current_exact8_first_member_is_shared_v6_official_rejection":
            cold_manifest[0] == {
                "file_sha256": V6_OFFICIAL_REJECTION_FILE_PIN,
                "entry_name": str(V6_OFFICIAL_REJECTION.relative_to(ROOT))} and
            transition_v4.get("ordered_provisional_exact8") ==
                v4_supersession["frozen_v4_provisional_exact8"]["ordered_members"],
        ...
        "v6_official_rejection_object_sha256":
            V6_OFFICIAL_REJECTION_OBJECT_PIN,
        "v6_official_rejection_shared_current_policy_held_fd":
            held_v6_official_rejection(policy_guard).fd ==
                by_path[V6_OFFICIAL_REJECTION].fd,
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V6_TO_V7_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V7].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "v6_official_rejection_file_sha256",
        "v6_official_rejection_object_sha256",
        "v6_to_v7_transition_identity", "static_audit_identity",
        ...
        proof.get("v6_to_v7_transition_identity", {}).get("file_sha256") is not None and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V7_PRESEAL_ROOT_V2",
    }
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "v6_to_v7_transition_file_sha256":
            freeze_proof["v6_to_v7_transition_identity"]["file_sha256"],
        "v6_to_v7_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v6_to_v7_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v6_to_v7_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v6_to_v7_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V7_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V7_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v6_to_v7_transition_file_sha256") ==
             freeze_proof.get("v6_to_v7_transition_identity", {}).get("file_sha256") and
         seal.get("v6_to_v7_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V7_AUTHORITY_ROOT_V1",
    }
...
def cold_authorize_live_protocol(
    ...
    request_keys = {
        ...
        "static_v7_exact10_with_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request",
    ...
    need(request.get("transaction_binding_domain") ==
         ...
         request.get(
             "static_v7_exact10_with_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
         request.get(
    ...
    ack = close_object({
        ...
        "final_dynamic_replay_census": {
            ...
            "v6_official_rejection_in_static_policy_held_file_count": 1,
        ...
        "transaction_binding_is_replay_identical_not_fresh_or_random": True,
        "static_v7_exact10_with_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request": True,
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v7 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v7 authority seal")
            verify_object(seal, "C79g v7 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v6_official_rejection_object_sha256") ==
                     V6_OFFICIAL_REJECTION_OBJECT_PIN and
                 seal.get("v6_to_v7_transition_file_sha256") ==
                     freeze_proof["v6_to_v7_transition_identity"]["file_sha256"] and
                 seal.get("v6_to_v7_transition_object_sha256") ==
