#!/usr/bin/env python3
"""Independently verify complete local occurrence-carrier assignment."""
...
OUTPUT = HERE / "cm2_round256_source_g_local_occurrence_carrier_completion_verification.json"
SCHEMA = "cm2.round256.source-g-local-occurrence-carrier-completion.verification.v1"
CANDIDATE = HERE / "cm2_round256_source_g_local_occurrence_carrier_completion_certificate.json"
CANDIDATE_SHA256 = (
...
def main() -> int:
    ...
    need(
        ...
        == "cm2.round256.source-g-local-occurrence-carrier-completion.v1"
    ...
    result = {
        "status": "PASS_INDEPENDENT_ROUND256",
        "producer_imported_or_executed": False,
        "candidate_result_sha256": candidate["result_sha256"],
        "verified_new_local_carrier_count":
            census["new_local_occurrence_carrier_component_count"],
        "verified_occurrence_assignment_count":
        ...
        "verified_remaining_occurrence_count":
            census["occurrences_without_quotient_assignment"],
        "verified_post_component_count":
            census["post_Round256_unified_quotient_component_count"],
