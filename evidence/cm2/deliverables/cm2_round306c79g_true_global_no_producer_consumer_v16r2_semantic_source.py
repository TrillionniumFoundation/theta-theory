...
SELF = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2_semantic_source.py"
...
COLD_EXACT8 = (    OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16_semantic_rejection_supersession_receipt_v1.json",
    ...
    SELF,
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2_semantic_source.py",
    ...
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2_semantic_source.py",
)
...
def hold_static_freeze_trust(self_guard: HeldSelf) -> dict[str, Any]:
    ...
    transition_guard = by_path[v16-to-v16r2_TRANSITION]
        ...
        **self_guard.execution_proof(),
        ...
        "post_source_static_freeze_trust": {
            "v16-to-v16r2_transition_receipt": {
                "path": str(v16-to-v16r2_TRANSITION.relative_to(ROOT)),
