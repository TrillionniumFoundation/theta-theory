#!/usr/bin/env python3
"""Independently verify Round252 wall s/t-face saturation."""
...
OUTPUT = HERE / "cm2_round252_source_g_wall_s_t_face_patch_saturation_verification.json"
SCHEMA = "cm2.round252.source-g-wall-s-t-face-patch-saturation.verification.v1"
CANDIDATE = (
    HERE / "cm2_round252_source_g_wall_s_t_face_patch_saturation_certificate.json"
)
CANDIDATE_SHA256 = (
...
def main() -> int:
    ...
    result = {
        "status": "PASS_INDEPENDENT_ROUND252",
        "producer_imported_or_executed": False,
        "candidate_result_sha256": candidate["result_sha256"],
        "verified_candidate_contact_count": 22_264,
        "verified_strict_patch_count":
            census["strict_same_signature_axis_face_patch_count"],
        "verified_rejected_contact_count":
            census["rejected_axis_face_contact_count"],
        "verified_rank_reduction_count":
            census["Round252_mixed_sheet_quotient_component_reduction"],
        "verified_post_Round252_component_count":
            census["post_Round252_mixed_sheet_quotient_component_count"],
        "verified_exact_key_quotient_fibre_inventory_count":
            census["quotient_fibre_inventory_complete_count"],
        "verified_occurrences_without_known_block_incidence":
            census["post_Round252_occurrences_without_known_block_incidence"],
