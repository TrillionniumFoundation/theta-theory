#!/usr/bin/env python3
"""Independent C79g v3 verifier, assembler, and authority consumer.
...
COLD_SOURCE_FD_ENV = "CM2_C79G_V3_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V3_COLD_WORKSPACE_ROOT"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V3_COLD_LAUNCHER_FILE_SHA256"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v3"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v3"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v3.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v3.json"
V2_REJECTION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v2_rejection_supersession_receipt_v1.json"
V2_TO_V3_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v2_to_v3_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V3 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v3.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v3.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v3.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v3.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v3.json")
# Static-freeze pins.  The append-only launch transition fills these exact
# 64-hex placeholders; every command rejects a zero or malformed pin.
CONTRACT_FILE_PIN = "ee2a969b5d3ae28dfc116fc24ab6bee6c3983d64db183641981108481c05ae7d"
CONTRACT_OBJECT_PIN = "fe82dcf80e8dd856390b694e8a286abc3087f33d0a2b4bebda1a01836b796a6b"
CLOSED_SCHEMA_FILE_PIN = "275a86286480f915af69e18d81d7032140e3db6982d32679206a6a5b88fee036"
V2_REJECTION_FILE_PIN = "fdd1921afda98a34c87ae20094e60fca1b75c8f233cf37890e7817fe35d82408"
V2_REJECTION_OBJECT_PIN = "518cbc5b30fc62d55291feef407c5677b880a05cb9a5b9f51404c79381c648fa"
...
PRODUCER_SOURCE_PIN = "587933a52505488fd87b1c4f99d5659df6f3c3e9557c0a77edd642e6e4dde0ab"
TERMINALS = {
...
VERIFICATION_FILE = BASE + "_independent_verification_v3.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v3.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v3.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v3.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v3.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v3-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v3-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v3-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v3-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v3-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v3-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v3-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v3-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v3-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v3-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v3-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v3-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v3-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V3_SURFACE"
...
V2_FROZEN_FILES = {
    "contract": (OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v2.json",
                 "2430c5ef5ddbd375770258c0149d9c3b6eb87064f972ef35c576152e094e2497"),
    "closed_schema": (OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v2.json",
                      "0d3ad29b9080a4b613c9a668d2484760c98c93f95b4a4e91d96a75346909e14e"),
    "build_only_producer": (OUT / "cm2_round306c79g_true_global_no_producer_consumer_v2.py",
                            "771fbaf2e0d52a0bf47c7d7093be42a8fb9da0a86ca0bad9c844fb35625a23ae"),
    "independent_verifier_finalizer":
        (OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_v2.py",
         "0d292626416eeb9c21da3d0891adea065f332485b63853d9db5c4556f0800c1c"),
    "v1_to_v2_transition_receipt":
        (OUT / "cm2_round306c79g_true_global_no_producer_consumer_v1_to_v2_static_launch_transition_receipt_v1.json",
         "ec3ba25f49364ca29b965d12b10cddedc6eec1f24c7966daa3ee66e9e05a2f22"),
    "static_audit":
        (OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v2.json",
         "53e8e6ab4cd37f9cd20087c463e553ae972a340e44ae453c9493bfa1eda14e23"),
}
V2_FROZEN_OBJECTS = {
    "contract": "89704a2cb453311f0199ffff1e04764e9df63a8ea035f6e7e91019841bd2bae8",
    "v1_to_v2_transition_receipt": "49e45b0a9ec609435097d919645874e817df384d890c18004e161aaca3f10687",
    "static_audit": "15430a0d0aba98c3f0aae50f20da6713f71d19eaa052a9fd5cca234f4cbeeae2",
}
...
class HeldSelf:
    """Hold one O_NOFOLLOW SELF fd across the entire command."""
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v3.py",
             "SELF exact frozen v3 verifier/assembler/authority-consumer path")
        fd_text = os.environ.get(COLD_SOURCE_FD_ENV, "")
        need(fd_text.isascii() and fd_text.isdecimal(),
             "cold launcher inherited source-fd environment")
        inherited_fd = int(fd_text)
        need(str(EXECUTED_SOURCE_PATH) == "/proc/self/fd/" + str(inherited_fd),
             "combined source executed only through exact inherited /proc/self/fd/N")
        ...
        need(stat.S_ISREG(self.before.st_mode) and
             stat.S_IMODE(self.before.st_mode) == 0o444 and self.before.st_nlink == 1 and
        ...
        need(fingerprint(initial_post) == fingerprint(initial_path_post) ==
             fingerprint(self.before), "SELF initial read-bracket stability")
    ...
    def terminal_replay(self) -> None:
        ...
        path_post = SELF.lstat()
        fingerprint = lambda value: (
            value.st_dev, value.st_ino, value.st_mode, value.st_size,
            value.st_mtime_ns, value.st_ctime_ns, value.st_nlink)
        need(replay == self.raw and
             fingerprint(pre) == fingerprint(path_pre) ==
             fingerprint(post) == fingerprint(path_post) ==
             fingerprint(self.before),
             "SELF same-fd terminal replay and path identity")
        need(statx_mount_id(self.fd) == self.mount_id,
             "SELF same-fd terminal statx mount identity")
...
def ensure_configuration() -> None:
    ...
    need(fd_text.isascii() and fd_text.isdecimal() and
         coordination_fd_text.isascii() and coordination_fd_text.isdecimal() and
         int(coordination_fd_text) != int(fd_text) and
         os.environ.get(COLD_WORKSPACE_ROOT_ENV) == str(ROOT) and
         _nonzero_sha256(os.environ.get(COLD_LAUNCHER_SHA_ENV)),
         "four mandatory frozen cold-launch environment/fd bindings")
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              V2_REJECTION_FILE_PIN, V2_REJECTION_OBJECT_PIN, PRODUCER_SOURCE_PIN)),
         "all v3 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v3-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v3-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v3-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v3-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v3-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v3-" +
...
class HeldPinnedInput:
    """Retain a regular 0444/nlink1 input fd and terminally replay it."""
    def __init__(self, path: Path, label: str, expected_sha256: str | None = None) -> None:
        self.path = path
        self.label = label
        ...
        need(stat.S_ISREG(self.before.st_mode) and
             ...
             label + ":initial exact regular 0444/nlink1 identity")
        self.raw = self._read()
        initial_post = os.fstat(self.fd)
...
class HeldOpaqueMetadata:
    ...
    def __init__(self, path: Path, label: str) -> None:
        ...
        self.fd = openat2_beneath(
            path, getattr(os, "O_PATH", os.O_RDONLY) | getattr(os, "O_NOFOLLOW", 0))
        self.before = os.fstat(self.fd)
        self.mount_id = statx_mount_id(self.fd)
    ...
    def terminal_replay(self) -> None:
        ...
        need(fingerprint(pre) == fingerprint(pre_path) ==
             fingerprint(post) == fingerprint(post_path) ==
             fingerprint(self.before) and statx_mount_id(self.fd) == self.mount_id,
...
class HeldDirectory:
    def __init__(self, path: Path, names: set[str], required_mode: int, label: str) -> None:
        self.path = path
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v3-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def hold_c42_full10_union_candidate9() -> HeldInputSet:
    """Hold the exact full10 authority set plus the complete C42 candidate9."""
    directory = HeldDirectory(C42_CANDIDATE_DIR,
                              C42_CANDIDATE_MANIFEST_MEMBERS | {"root_manifest.sha256"},
                              0o555, "C42 candidate exact9")
    files: list[HeldPinnedInput] = []
    by_path: dict[Path, HeldPinnedInput] = {}
    for name in C42_C53_PATHS:
        path = C42_C53_PATHS[name]
        held = HeldPinnedInput(path, "C42 full10:" + name, C42_C53_PINS[name])
        files.append(held)
        by_path[path] = held
    ...
    for name in C42_CANDIDATE_MANIFEST_MEMBERS:
        ...
        if path in by_path:
            ...
            continue
        held = HeldPinnedInput(path, "C42 candidate9:" + name, manifest[name])
        files.append(held)
        by_path[path] = held
    need(len(files) == 16 and len(by_path) == 16,
         "C42 full10 union candidate9 exact16 unique paths")
    return HeldInputSet(files, [directory])
...
def hold_surfaces(specifications: list[tuple[Path, tuple[str, ...], str]]) -> HeldInputSet:
    ...
    for directory_path, names, label in specifications:
        directories.append(HeldDirectory(directory_path, set(names), 0o555, label))
        for name in names:
            files.append(HeldPinnedInput(directory_path / name, label + ":" + name))
    return HeldInputSet(files, directories)


def hold_v2_historical_surfaces(
        ) -> tuple[HeldInputSet, list[HeldOpaqueMetadata]]:
    source_names = {"build_only_producer", "independent_verifier_finalizer"}
    files = [
        HeldPinnedInput(path, "frozen v2 held:" + name, file_sha256)
        for name, (path, file_sha256) in V2_FROZEN_FILES.items()
        if name not in source_names
    ]
    source_metadata = [
        HeldOpaqueMetadata(V2_FROZEN_FILES[name][0],
                           "frozen v2 source metadata-only held:" + name)
        for name in sorted(source_names)
    ]
    need(len(files) == 4 and len(source_metadata) == 2 and
         len({item.path for item in files}) == 4 and
         len({item.path for item in source_metadata}) == 2,
         "frozen v2 exact4 readable plus exact2 metadata-only sources")
    return HeldInputSet(files, []), source_metadata


def terminal_replay_v2_historical_surfaces(
        guard: HeldInputSet,
...
def exact_v2_rejection(
        receipt_guard: HeldPinnedInput,
        v2_guard: HeldInputSet,
        v2_source_metadata: list[HeldOpaqueMetadata]) -> dict[str, Any]:
    need(receipt_guard.path == V2_REJECTION and
         sha(receipt_guard.raw) == V2_REJECTION_FILE_PIN,
         "exact full-run held v2 rejection/supersession receipt")
    raw = receipt_guard.raw
    value = strict_json(raw, "C79g v2 rejection/supersession")
    verify_object(value, "C79g v2 rejection/supersession", V2_REJECTION_OBJECT_PIN)
    rejection = value.get("rejection")
    supersession = value.get("supersession")
    reader_rule = value.get("reader_migration_rule")
    frozen = value.get("frozen_v2_bundle")
    need(value.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer.v2-rejection-supersession-receipt.v1" and
         value.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         isinstance(rejection, dict) and
         rejection.get("v2_execution_allowed_after_frozen_publication") is False and
         rejection.get("v2_producer_invocation_allowed") is False and
         rejection.get("v2_verifier_invocation_allowed") is False and
         rejection.get("v2_finalizer_invocation_allowed") is False and
         rejection.get("v2_final_outer_authoritative") is False and
         rejection.get("v2_final_outer_exact_rejection_reason") == "CREDIT_OUTER_PRECOMMIT" and
         rejection.get("v2_final_outer_formal_global_closure_credit") == 0 and
         rejection.get("v2_final_outer_D02_unlock") is False and
         rejection.get("v2_formal_pending_task_count_unchanged") == PENDING_D02 and
         isinstance(supersession, dict) and supersession.get("successor_version") == 3 and
         supersession.get("standalone_successor_outer_authoritative") is False and
         supersession.get("standalone_successor_seal_authoritative") is False and
         supersession.get(
             "only_externally_pinned_cold_launcher_wrapper_may_be_authoritative") is True and
         supersession.get("direct_independent_source_inner_composite_credit") == 0 and
         supersession.get(
             "direct_independent_source_inner_composite_D02_unlock") is False and
         supersession.get("successor_root_schema") == COLD_ROOT_SCHEMA and
         supersession.get("successor_committed_completion_path") ==
             str(COMMITTED_COMPLETION.relative_to(ROOT)) and
         supersession.get("successor_authority_seal_path") ==
             str(AUTHORITY_SEAL.relative_to(ROOT)) and
         isinstance(reader_rule, dict) and
         reader_rule.get(
             "all_readers_must_require_v3_cold_launched_root_wrapper_validation") is True and
         reader_rule.get("direct_inner_composite_is_never_authoritative") is True and
         reader_rule.get("all_v3_composite_conjuncts_recomputed_on_every_read") is True and
         reader_rule.get("later_v3_rejection_revokes_authority_immediately") is True and
         isinstance(frozen, dict) and frozen.get("all_members_required_mode") == "0444" and
         frozen.get("all_members_required_nlink") == 1,
         "exact frozen v2 rejection and v3 composite supersession semantics")
    members = frozen.get("members", frozen)
    by_path = {item.path: item for item in v2_guard.files}
    source_by_path = {item.path: item for item in v2_source_metadata}
    source_names = {"build_only_producer", "independent_verifier_finalizer"}
    need(set(by_path) == {
             path for name, (path, _) in V2_FROZEN_FILES.items()
             if name not in source_names} and
         set(source_by_path) == {
             path for name, (path, _) in V2_FROZEN_FILES.items()
             if name in source_names},
         "v2 rejection exact full-run held six-member partition")
    for name, (path, file_pin) in V2_FROZEN_FILES.items():
        if name in source_names:
            ...
            need(stat.S_ISREG(source_info.st_mode) and
                 ...
                 source_info.st_nlink == 1 and
                 isinstance(members.get(name), dict) and
                 members[name].get("path") == str(path.relative_to(ROOT)) and
                 members[name].get("file_sha256") == file_pin,
                 "v2 rejection held O_PATH source metadata/pin declaration without content open:" + name)
            continue
        raw_member = by_path[path].raw
        need(sha(raw_member) == file_pin and isinstance(members.get(name), dict) and
             members[name].get("path") == str(path.relative_to(ROOT)) and
             members[name].get("file_sha256") == file_pin,
             "v2 rejection frozen member:" + name)
        if name in V2_FROZEN_OBJECTS:
            member_value = strict_json(raw_member, "frozen v2 object:" + name)
            verify_object(member_value, "frozen v2 object:" + name,
                          V2_FROZEN_OBJECTS[name])
            need(members[name].get("object_sha256") == V2_FROZEN_OBJECTS[name],
                 "v2 rejection frozen object pin:" + name)
    return value
...
def validate_c42_c53_kraft(
    ...
    need(len(full10_paths) == 10 and len(candidate9_paths) == 9 and
         ...
         set(by_directory) == {C42_CANDIDATE_DIR} and
         by_directory[C42_CANDIDATE_DIR].names == c42_candidate_universe,
...
def hold_c78_upstream_surfaces() -> HeldInputSet:
    ...
    for directory in (C78L_A, C78L_B):
        directories.append(HeldDirectory(
            directory, set(C78L_NAMES.values()), 0o755,
            "C78l historical exact10 held surface"))
        for key, name in C78L_NAMES.items():
            files.append(HeldPinnedInput(
                directory / name, "C78l held:" + key, C78L_PINS[key]))
    files.extend([
        HeldPinnedInput(C78L_VERIFY_A, "C78l held verification A", C78L_VERIFY_FILE),
        HeldPinnedInput(C78L_VERIFY_B, "C78l held verification B", C78L_VERIFY_FILE),
    ])
    directories.append(HeldDirectory(
    ...
    for directory in (c78s_a, c78s_b):
        directories.append(HeldDirectory(
            directory, exact13, 0o555, "C78s exact13 held surface"))
    ...
    for path, label, pin in (
        ...
        files.append(HeldPinnedInput(path, label, str(pin)))
...
def hold_fixed_evidence_surfaces() -> HeldInputSet:
    ...
    files = [
        HeldPinnedInput(path, "fixed evidence held:" + key, FIXED_PINS[key])
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V2_REJECTION,
             V2_TO_V3_TRANSITION, STATIC_AUDIT_V3,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         contract.get("append_only_predecessor_v2", {}).get("execution_allowed") is False and
         contract.get("append_only_predecessor_v2", {}).get("runtime_surfaces_authoritative") is False and
         ...
         "v3 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v3 schema root is cold-launched wrapper over zero-credit inner composite")
    exact_v2_rejection(
        policy_by_path[V2_REJECTION], v2_guard, v2_source_metadata)
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
             ...
             "v2_rejection_supersession_receipt",
         ...
         registry["v2_rejection_supersession_receipt"] == {
             "path": str(V2_REJECTION.relative_to(ROOT)),
             "file_sha256": V2_REJECTION_FILE_PIN,
             "object_sha256": V2_REJECTION_OBJECT_PIN,
             "reason": "CREDIT_OUTER_PRECOMMIT"} and
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V3__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT",
        ...
        "v2_rejection_supersession_object_sha256": V2_REJECTION_OBJECT_PIN,
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(CONTRACT, "v3 contract", CONTRACT_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v3 closed schema", CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(V2_REJECTION, "v2 rejection/supersession", V2_REJECTION_FILE_PIN),
        HeldPinnedInput(
            V2_TO_V3_TRANSITION, "post-source v2-to-v3 transition receipt"),
        HeldPinnedInput(STATIC_AUDIT_V3, "post-source v3 static audit"),
        HeldPinnedInput(COLD_LAUNCHER, "frozen cold launcher"),
        HeldPinnedInput(COLD_LAUNCH_MANIFEST, "frozen cold-launch exact8 manifest"),
        HeldPinnedInput(COLD_LAUNCH_OUTER, "frozen cold-launch outer-last receipt"),
    ], [])


def _expected_frozen_v2_bundle() -> dict[str, Any]:
    ...
    for name, (path, file_sha256) in V2_FROZEN_FILES.items():
        ...
        if name in V2_FROZEN_OBJECTS:
            entry["object_sha256"] = V2_FROZEN_OBJECTS[name]
        expected[name] = entry
    return expected


def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v3 contract", CONTRACT_OBJECT_PIN)
    need(contract.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN,
         "contract exact effective checkpoint")
    ...
    expected_paths = {
        ...
        "v3_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v3_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v3-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v3-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    predecessor = contract.get("append_only_predecessor_v2")
    need(isinstance(predecessor, dict) and
         predecessor.get("frozen_bundle") == _expected_frozen_v2_bundle(),
         "contract exact frozen predecessor-v2 six-member map")
    rejection = predecessor.get("rejection_supersession_receipt")
    need(isinstance(rejection, dict) and
         rejection.get("path") == str(V2_REJECTION.relative_to(ROOT)) and
         rejection.get("file_sha256") == V2_REJECTION_FILE_PIN and
         rejection.get("object_sha256") == V2_REJECTION_OBJECT_PIN and
         predecessor.get("execution_allowed") is False and
         predecessor.get("runtime_surfaces_authoritative") is False,
         "contract exact v2 rejection/supersession binding")
    bundle = contract.get("v3_bundle")
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v2_to_v3_transition_path") ==
             str(V2_TO_V3_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V3.relative_to(ROOT)),
         "contract exact acyclic v3 bundle and post-source trust-anchor paths")
...
def static_freeze_proof(
        ...
        producer_guard: HeldOpaqueMetadata) -> dict[str, Any]:
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v3 contract")
    transition = strict_json(
        by_path[V2_TO_V3_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V3].raw, "post-source static audit")
    cold_outer = strict_json(
        by_path[COLD_LAUNCH_OUTER].raw, "cold-launch outer-last receipt")
    need(isinstance(contract, dict) and isinstance(transition, dict) and
    ...
    transition_file_sha256 = sha(by_path[V2_TO_V3_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V3].raw)
    ...
    exact8_stats = [
        by_path[V2_REJECTION].before,
        by_path[CLOSED_SCHEMA].before,
        by_path[CONTRACT].before,
        producer_guard.before,
        self_guard.before,
        by_path[V2_TO_V3_TRANSITION].before,
        by_path[STATIC_AUDIT_V3].before,
    ...
    successor = transition.get("successor_v3_static_bundle")
    transition_predecessor = transition.get("frozen_predecessor_v2")
    transition_rejection = transition.get("v2_rejection_supersession")
    need(isinstance(successor, dict) and isinstance(transition_predecessor, dict) and
         isinstance(transition_rejection, dict),
         "transition exact bundle/predecessor/rejection objects")
    need(transition.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         transition.get("receipt_path") == str(V2_TO_V3_TRANSITION.relative_to(ROOT)) and
         successor.get("independent_verifier_assembler_authority_consumer", {}).get(
         ...
         transition_predecessor.get("frozen_bundle") == _expected_frozen_v2_bundle() and
         transition_rejection.get("path") == str(V2_REJECTION.relative_to(ROOT)) and
         transition_rejection.get("file_sha256") == V2_REJECTION_FILE_PIN and
         transition_rejection.get("object_sha256") == V2_REJECTION_OBJECT_PIN,
         "transition pins current SELF plus exact producer/schema/contract/v2 freeze")
    audited = audit.get("audited_v3_bundle")
    audit_rejection = audit.get("v2_rejection_regression")
    attack_census = audit.get("coherent_attack_static_census")
    acceptance = audit.get("final_audit_acceptance")
    need(isinstance(audited, dict) and isinstance(audit_rejection, dict) and
         isinstance(attack_census, dict) and isinstance(acceptance, dict),
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         audit.get("audit_path") == str(STATIC_AUDIT_V3.relative_to(ROOT)) and
         ...
         audited.get("v2_to_v3_transition_receipt", {}).get("path") ==
             str(V2_TO_V3_TRANSITION.relative_to(ROOT)) and
         audited.get("v2_to_v3_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v2_to_v3_transition_receipt", {}).get("object_sha256") ==
             transition_object_sha256 and
         audit_rejection.get("path") == str(V2_REJECTION.relative_to(ROOT)) and
         audit_rejection.get("file_sha256") == V2_REJECTION_FILE_PIN and
         audit_rejection.get("object_sha256") == V2_REJECTION_OBJECT_PIN and
         ...
         "PENDING" not in str(transition.get("status")) and
         "DRAFT" not in str(audit.get("status")) and
         "PENDING" not in str(audit.get("status")) and
         _no_zero_hash_placeholder(transition) and
         _no_zero_hash_placeholder(audit),
         "static audit pins SELF/transition/producer/schema/contract/rejection and is final")
    exact8_expected = [
        {"file_sha256": V2_REJECTION_FILE_PIN,
         "entry_name": str(V2_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V2_TO_V3_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V3.relative_to(ROOT))},
    ...
    need(set(cold_outer) == {
         ...
         cold_outer.get("sole_external_trust_anchor_is_launcher_sha256") is True and
    ...
    transition_identity = _one_identity(by_path[V2_TO_V3_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V3])
    ...
    return {
        "v2_to_v3_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v2_to_v3_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v2_to_v3_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
            ...
            audit_rejection["file_sha256"] == V2_REJECTION_FILE_PIN and
            audit_rejection["object_sha256"] == V2_REJECTION_OBJECT_PIN and
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V2_TO_V3_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V3].fd >= 0,
        ...
        **chronology,
        "sole_external_launcher_hash_equals_actual_held_launcher_and_outer_reconstructed":
            os.environ.get(COLD_LAUNCHER_SHA_ENV) == launcher_file_sha256 and
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        "v2_to_v3_transition_identity", "static_audit_identity",
        ...
        proof.get("v2_to_v3_transition_identity", {}).get("file_sha256") is not None and
...
def build_verification(
    ...
    v2_guard, v2_source_metadata = hold_v2_historical_surfaces()
    ...
    try:
        ...
        context = reconstruct_publication_context(
            primary, peer, self_guard, candidate_guard,
            c78_guard, c42_guard, fixed_guard, policy_guard,
            v2_guard, v2_source_metadata)
        ...
        terminal_replay_v2_historical_surfaces(
            v2_guard, v2_source_metadata)
        ...
        policy_guard.close()
        v2_guard.close()
        for item in reversed(v2_source_metadata):
            item.close()
        c42_guard.close()
...
def read_verification_surface(
    ...
    need(set(value) == {
             ...
             "v2_rejection_supersession_object_sha256", "verification_credit",
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V3__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT" and
         ...
         value.get("formal_credit_authority") ==
             "ONLY_EXTERNALLY_PINNED_COLD_LAUNCHER_WRAPPER_AFTER_HELD_CHILD_AND_POST_CHILD_TERMINAL_REPLAY" and
         value.get("v2_rejection_supersession_object_sha256") == V2_REJECTION_OBJECT_PIN and
...
def _standalone_outer_proof(completion_objects: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return close_object({
        ...
        "non_authoritative_reason": "CREDIT_OUTER_PRECOMMIT",
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V3_PRESEAL_ROOT_V2",
    }
    rejection_object = rejection.get("object_sha256")
    need(rejection_object == V2_REJECTION_OBJECT_PIN,
         "preseal binds exact v2 rejection object")
...
def _self_identity(self_guard: HeldSelf) -> dict[str, Any]:
    ...
    return {
        ...
        "mode": "0444",
        "nlink": 1,
        "received_from_cold_launcher_as_inherited_source_fd": True,
        "inherited_source_fd_duplicated_before_any_evidence_or_output_access": True,
        "executed_via_exact_proc_self_fd_path":
            str(EXECUTED_SOURCE_PATH) ==
                "/proc/self/fd/" + os.environ[COLD_SOURCE_FD_ENV],
        "fixed_SELF_path_identity_equals_inherited_fd_identity": True,
        "statx_mount_id_stable": True,
        "initial_fd_identity_equals_terminal_fd_identity": True,
        "initial_bytes_equal_terminal_same_fd_bytes": True,
        "terminal_fd_identity_equals_terminal_path_lstat_identity": True,
...
def independent_consumer_proof(preseal: Mapping[str, Any],
                               self_guard: HeldSelf) -> dict[str, Any]:
    return close_object({
        ...
        "frozen_v2_exact4_readable_and_exact2_source_metadata_only_held_across_full_command": True,
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "contract_object_sha256": CONTRACT_OBJECT_PIN,
        "closed_schema_file_sha256": CLOSED_SCHEMA_FILE_PIN,
        "v2_to_v3_transition_file_sha256":
            freeze_proof["v2_to_v3_transition_identity"]["file_sha256"],
        "v2_to_v3_transition_object_sha256":
...
def v2_rejection_proof(rejection: Mapping[str, Any],
    ...
    return {
        ...
        "receipt_path": str(V2_REJECTION.relative_to(ROOT)),
        "effective_checkpoint_object_sha256": CHECKPOINT_OBJECT_PIN,
        "all_six_frozen_v2_pins_match_contract": True,
        "v2_files_immutable": True,
        "v2_execution_allowed": False,
        "v2_runtime_surfaces_authoritative": False,
        "v2_final_outer_rejection_reason": "CREDIT_OUTER_PRECOMMIT",
        "v2_credit": dict(ZERO),
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v2_to_v3_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "v2_supersession_receipt_hashes_equal_contract":
            sha(receipt_guard.raw) == V2_REJECTION_FILE_PIN and
            rejection.get("object_sha256") == V2_REJECTION_OBJECT_PIN,
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v2_to_v3_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v2_to_v3_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V3_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V3_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         seal.get("closed_schema_file_sha256") == CLOSED_SCHEMA_FILE_PIN and
         seal.get("v2_to_v3_transition_file_sha256") ==
             freeze_proof.get("v2_to_v3_transition_identity", {}).get("file_sha256") and
         seal.get("v2_to_v3_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
    ...
    body: dict[str, Any] = {
        ...
        "effective_checkpoint_object_sha256": CHECKPOINT_OBJECT_PIN,
        "exact_paths": exact_paths_object(),
        "v2_rejection_supersession": v2_rejection_proof(rejection, receipt_guard),
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V3_AUTHORITY_ROOT_V1",
    }
...
def assemble(
    ...
    try:
        ...
        context = reconstruct_publication_context(
            CANDIDATE_A, CANDIDATE_B, self_guard, public_guard,
            c78_guard, c42_guard, fixed_guard, policy_guard,
            v2_guard, v2_source_metadata)
        ...
        stage_writer.terminal_identity()
        stage_directory_guard = HeldDirectory(
            stage, set(COMPLETION_MEMBERS), 0o555,
...
def reject_checkpoint(
        ...
        producer_guard: HeldOpaqueMetadata) -> None:
    """Permanently revoke this checkpoint without touching dynamic evidence."""
    policy_guard = _static_policy_guards()
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v3 rejection")
            value = strict_json(rejection_guard.raw, "permanent C79g v3 rejection")
            verify_object(value, "permanent C79g v3 rejection")
        ...
        final_directory = HeldDirectory(
            REJECTION_NAMESPACE, {LATER_REJECTION.name}, 0o555,
...
def _committed_context(
        ...
        policy_guard: HeldInputSet, v2_guard: HeldInputSet,
        v2_source_metadata: list[HeldOpaqueMetadata]
    ...
    receipt_guard = next(
        item for item in policy_guard.files if item.path == V2_REJECTION)
    rejection = exact_v2_rejection(
        receipt_guard, v2_guard, v2_source_metadata)
...
def cold_authorize_live_protocol(
    ...
    need(request.get("transaction_binding_domain") ==
         ...
         request.get(
             "static_cold_exact10_terminal_replay_completed_by_launcher_before_request") is True and
         request.get(
    ...
    c78_guard.terminal_replay()
    fixed_guard.terminal_replay()
    terminal_replay_v2_historical_surfaces(v2_guard, v2_source_metadata)
    producer_guard.terminal_replay()
    self_guard.terminal_replay()
    policy_guard.terminal_replay()
...
def authorize(
    ...
    try:
        ...
        consumer_proof = independent_consumer_proof(preseal, self_guard)
        receipt_guard = next(
            item for item in policy_guard.files if item.path == V2_REJECTION)
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v3 zero-credit authority seal")
            seal = strict_json(seal_guard.raw, "C79g v3 authority seal")
            verify_object(seal, "C79g v3 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("closed_schema_file_sha256") == CLOSED_SCHEMA_FILE_PIN and
                 seal.get("v2_to_v3_transition_file_sha256") ==
                     freeze_proof["v2_to_v3_transition_identity"]["file_sha256"] and
                 seal.get("v2_to_v3_transition_object_sha256") ==
            ...
            cold_authorize_live_protocol(
                ...
                v2_guard, v2_source_metadata, c78_guard, fixed_guard,
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Constant-only gates, then mandatory SELF hold before any evidence/output.
    ensure_configuration()
    self_guard = HeldSelf()
    producer_guard = HeldOpaqueMetadata(
        PRODUCER_SOURCE, "C79g producer metadata-only full-run hold")
    ...
    if args.command == "reject":
        try:
            ...
            runtime_parent.close()
            producer_guard.close()
            self_guard.close()
        return 0
    # Dynamic/upstream evidence is intentionally opened only after the reject
    # branch.  A partial or drifting evidence surface must never prevent the
    # official cold path from permanently revoking this checkpoint.
