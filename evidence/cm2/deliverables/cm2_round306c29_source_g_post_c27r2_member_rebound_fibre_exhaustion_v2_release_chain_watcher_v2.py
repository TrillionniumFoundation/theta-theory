...
PROGRAMS = {
    "cold": ROOT / f"deliverables/{PREFIX}_release_cold_replay_runner_v2.py",
...
PINS = {
    "cold": "6e98f5e88502c08b13723cf1258fbaee33f89d4610e5e11b376df7236b787762",
...
def self_test() -> dict[str, Any]:
    ...
    need(len(test) == 11 and all(valid_sha(value) for value in PINS.values()),
         "watcher fixtures")
    return {"status": "PASS_C29_V2_RELEASE_CHAIN_WATCHER_V2_SELF_TEST",
