#!/usr/bin/env python3
"""Externally pinned cold launcher for the C79g v7 exact10 static bundle.
...
LAUNCHER_RELATIVE = Path("deliverables") / (BASE + "_cold_launch_v7.py")
...
ROOT = Path("/__C79G_V7_UNCONFIGURED_ROOT__")
...
V7_REJECTION_NAMESPACE = ROOT / "__unconfigured_v7_rejections__"
V7_LATER_REJECTION = V7_REJECTION_NAMESPACE / "rejection.json"
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V7_REJECTION_NAMESPACE = RUNTIME / ("c79g-v7-rejections-" + CHECKPOINT)
    V7_LATER_REJECTION = V7_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / (BASE + "_schema_v7.json")
    CONTRACT = OUT / (BASE + "_contract_v7.json")
    PRODUCER = OUT / (BASE + "_v7.py")
    CONSUMER = OUT / (BASE + "_independent_verifier_assembler_authority_consumer_v7.py")
    TRANSITION = OUT / (BASE + "_v6_to_v7_static_launch_transition_receipt_v1.json")
    AUDIT = OUT / (BASE + "_static_audit_v7.json")
    MANIFEST = OUT / (BASE + "_cold_launch_manifest_v7.sha256")
    OUTER = OUT / (BASE + "_cold_launch_outer_receipt_v7.json")
    BASE7_PINS = {
        V6_OFFICIAL_REJECTION:
            (V6_REJECTION_FILE_PIN, V6_REJECTION_OBJECT_PIN),
        SCHEMA: ("edcdbb568044d04fc7c86b4c4e64fdb7b12b3841f1e93092694ebc3177b6fe18", None),
        CONTRACT: ("041ca2567f81c148f765dd85e3515a6ac01295bca06c3032b027459eceb2c014", "a87f7434b32a96923ee81f7761efab9b0937f15103c2fa9b47e8402104b612a5"),
        PRODUCER: ("67670681481cf372f775ad39a9f8d8b2459a77ef708e2f4da14ca114ac0f0d95", None),
        CONSUMER: ("3ee9f2c666b7297a23faa31d39d5ea66b708d545120b1aeb93f77ac9ef704f8a", None),
        TRANSITION: ("e732442e16a3a1f66629562af4cae72d9ae3e78b511f67ee22aa84869b90bec8", "0f1f240b6a61a6774991b8355c6132c1a9ae30b15690e8c058f88206db69453e"),
        AUDIT: ("74c72540bd66b5929fa30ec554207db21f40999484752340f0294590d407a667", "efd83fae1a716c864e8bb61238370e10b9ebf54444f023b902c7cef2a41a6766"),
    }
    EXACT8 = (V6_OFFICIAL_REJECTION, SCHEMA, CONTRACT, PRODUCER,
...
INNER_SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v7.inner-composite"
COLD_ROOT_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v7."
    "cold-launched-committed-authority"
)
COLD_ROOT_DOMAIN = b"CM2_C79G_V7_COLD_LAUNCHED_AUTHORITY_ROOT_V1\0"
...
LIVE_ACK_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v7.cold-live-ack"
)
LIVE_RELEASE_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v7.cold-live-release"
)
...
SOURCE_FD_ENV = "CM2_C79G_V7_COLD_SOURCE_FD"
EXEC_FD_ENV = "CM2_C79G_V7_COLD_EXEC_FD"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V7_COORDINATION_PARENT_FD"
WORKSPACE_ROOT_ENV = "CM2_C79G_V7_COLD_WORKSPACE_ROOT"
WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V7_COLD_WORKSPACE_ROOT_FD"
LAUNCHER_SHA_ENV = "CM2_C79G_V7_COLD_LAUNCHER_FILE_SHA256"
...
def expected_v5_published_rejected_segment() -> dict[str, Any]:
    """Construct the one exact v5 regression shape shared by v7 proofs."""
    names = (
...
def validate_final_static_audit(
        ...
        predecessor_v6: "HeldV6PredecessorExact10") -> None:
    ...
    audit_keys = {
        ...
        "audited_v7_bundle", "predecessor_v3_exact10_regression",
    ...
    need(set(audit) == audit_keys and
         audit.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer.static-audit.v7" and
         ...
         "final static audit exact top-level closure and PASS_V7 status")
    ...
    need(isinstance(input_a, dict) and set(input_a) == input_keys and
         ...
         "final static audit exact equal fourteen-pin A/B input census")
    expected_inputs = {
        ...
        "v6_rejection_file": held_by_path[V6_OFFICIAL_REJECTION].file_sha256,
    ...
    expected_shapes = {
        ...
        "laterRejection": 43,
        "producerSourceRegistry": 41, "liveRequest": 15,
        "liveACK": 32, "liveACKCensus": 27,
    }
    need(isinstance(closure, dict) and set(closure) == closure_keys and
         ...
         closure.get("schema_definition_count") == 38 ==
             len(schema.get("$defs", {})) and
         type(closure.get("schema_ref_count")) is int and
         closure.get("schema_ref_count") == 191 ==
         ...
         closure.get("closed_object_count") == 44 == len(closed_nodes) and
    ...
    need(isinstance(no_run, dict) and set(no_run) == {
             "C79_entrypoint_executed", "C79_v7_runtime_artifact_count",
             "C79_v7_process_count", "pyc_or___pycache___created",
             "cold_manifest_or_outer_created_before_dual_GO",
         } and no_run.get("C79_entrypoint_executed") is False and
         type(no_run.get("C79_v7_runtime_artifact_count")) is int and
         no_run.get("C79_v7_runtime_artifact_count") == 0 and
         type(no_run.get("C79_v7_process_count")) is int and
         no_run.get("C79_v7_process_count") == 0 and
    ...
    def __init__(self, source: HeldFile) -> None:
        ...
        try:
            self.fd = os.memfd_create(
                "c79g-v7-child-exec", MFD_CLOEXEC | MFD_ALLOW_SEALING)
        except OSError as exc:
...
class HeldEmptyRejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent) -> None:
        coordination.verify()
        name = V7_REJECTION_NAMESPACE.name
        ...
        try:
            try:
                ...
                state = os.stat(name, dir_fd=coordination.fd,
                                follow_symlinks=False)
            self.path = V7_REJECTION_NAMESPACE
...
def construct_launcher_native_rejection(
    ...
    return close_object({
        ...
        "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
        "effective_checkpoint_object_sha256": CHECKPOINT,
        "namespace_exact_path": str(V7_REJECTION_NAMESPACE.relative_to(ROOT)),
        "target_exact_path": str(V7_LATER_REJECTION.relative_to(ROOT)),
        "rejection_reason": "ORPHANED_OR_INCOMPLETE_C79G_V7_SURFACE",
...
def install_or_replay_launcher_native_rejection(
    ...
    try:
        try:
            ...
            namespace_fd = openat2_beneath(
                V7_REJECTION_NAMESPACE, os.O_RDONLY | os.O_DIRECTORY)
    except BaseException:
        if namespace_fd >= 0:
    ...
    try:
        ...
        path_before = root_lstat(V7_REJECTION_NAMESPACE)
        ...
        target = os.stat(V7_LATER_REJECTION.name, dir_fd=namespace_fd,
                         follow_symlinks=False) if V7_LATER_REJECTION.name in universe else None
        if target is not None:
            need(universe == {V7_LATER_REJECTION.name},
                 "idempotent rejection exact singleton")
            rejection_guard = HeldFile(
                V7_LATER_REJECTION, "existing launcher-native v7 rejection")
        else:
            ...
            try:
                ...
                os.fsync(namespace_fd)
            rejection_guard = HeldFile(
                V7_LATER_REJECTION, "new launcher-native v7 rejection")
        need(rejection_guard is not None,
             "launcher-native rejection file held")
        value = strict_json(rejection_guard.raw, "launcher-native v7 rejection")
        need(isinstance(value, dict), "launcher-native rejection mapping")
        verify_object(value, "launcher-native v7 rejection")
        os.fsync(rejection_guard.fd)
        os.fsync(namespace_fd)
        os.fsync(coordination.fd)
        after = os.fstat(namespace_fd)
        path_after = root_lstat(V7_REJECTION_NAMESPACE)
        need(value == expected and rejection_guard.raw == expected_raw and
             set(os.listdir(namespace_fd)) == {V7_LATER_REJECTION.name} and
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str,
                    ...
                    bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / (BASE + "_cold_launch_v7.py"),
        ...
        for path in (V6_OFFICIAL_REJECTION, CONTRACT, TRANSITION, AUDIT):
        ...
        need(self.base_objects[CONTRACT].get("status") ==
             ...
             self.base_objects[AUDIT].get("status") ==
                 "PASS_DUAL_STATIC_BYTES_GO_V7__PHYSICAL_COLD_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED",
        ...
        # Current exact8 owns the sole v6-rejection fd.  The frozen v6 exact10
        # owns the shared v5-rejection fd; frozen v5 owns the v4 supersession.
        # v3 keeps its separate singleton rejection.
        self.predecessor_v6 = HeldV6PredecessorExact10(
            coordination, self.by_path[V6_OFFICIAL_REJECTION])
        ...
        need(len(predecessor_v3_identities) == 10 and
             ...
             self.by_path[V6_OFFICIAL_REJECTION].identity not in
             ...
             "current v7 exact10, v6/v5/v3 exact10, v3 rejection and v4 "
             "draft7 are 48 unique live files on one mount")
        validate_final_static_audit(
            self.base_objects[AUDIT], self.schema, self.schema_keywords,
            self.by_path, self.base_objects,
            self.predecessor_v5, self.predecessor_v6)
    ...
    def terminal_replay(self) -> None:
        ...
        self.predecessor_v6.terminal_replay(
            self.by_path[V6_OFFICIAL_REJECTION])
...
def cold_root(bundle: HeldBundle, coordination: HeldCoordinationParent,
    ...
    need(bundle.predecessor_v5 is not None and
         bundle.predecessor_v6 is not None,
         "v6 direct predecessor and v5 history remain held for cold root")
    ...
    proof = {
        ...
        "current_exact8_first_member_is_v6_official_rejection":
            EXACT8[0] == V6_OFFICIAL_REJECTION,
        "v6_official_rejection_identity": {
            **bundle.by_path[V6_OFFICIAL_REJECTION].identity_object(),
            "object_sha256": V6_REJECTION_OBJECT_PIN,
        },
        "v6_official_rejection_file_sha256": V6_REJECTION_FILE_PIN,
        "v6_official_rejection_object_sha256": V6_REJECTION_OBJECT_PIN,
        ...
        "all_current_and_historical_48_identities_globally_unique_on_one_statx_mount": True,
        "current_v7_and_all_predecessor_unique_file_identity_count": 48,
        "current_v7_and_all_predecessor_same_statx_mount": True,
        **bundle.chronology,
        ...
        "reject_command_exempts_only_fresh_empty_v7_rejection_namespace": True,
...
def _validate_live_ack(
    ...
    need(set(ack) == expected_keys and ack.get("schema") == LIVE_ACK_SCHEMA and
         ...
         ack.get("static_v7_exact10_with_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "reject":
            ...
            return 0
        # Every positive-capable command holds the exact-empty v7 rejection
