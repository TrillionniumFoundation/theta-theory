#!/usr/bin/env python3
"""Independent C79g v4 verifier, assembler, and authority consumer.
...
COLD_SOURCE_FD_ENV = "CM2_C79G_V4_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V4_COLD_WORKSPACE_ROOT"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V4_COLD_LAUNCHER_FILE_SHA256"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V4_COORDINATION_PARENT_FD"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v4"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v4"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v4.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v4.json"
V3_REJECTION = ROOT / (
    ".cm2-runtime/c79g-v3-rejections-"
    "b58d68a0234b8a7de0e9147f891d37910476d622b840cfa073aed7ff3b4382ab/"
    "rejection.json")
V3_TO_V4_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v3_to_v4_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V4 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v4.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v4.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v4.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v4.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v4.json")
...
CONTRACT_FILE_PIN = "84608ada466fb9aa3d99adfd34662e9af02dfd009d8eb185374c065a6da0c23c"
CONTRACT_OBJECT_PIN = "62609ff0809ba9439be07a215ece772262f30ead7d87fda92a6e4e23bb5895b7"
CLOSED_SCHEMA_FILE_PIN = "b2cb58e88b66daed7d0449d11a4441095179b7e537a48a35ee9c630f76beca6a"
...
PRODUCER_SOURCE_PIN = "968e401852f45d5104f48526b50d4f59a86bb1fed8e7af23782c5f6d447d1cf1"
TERMINALS = {
...
VERIFICATION_FILE = BASE + "_independent_verification_v4.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v4.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v4.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v4.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v4.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v4-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v4-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v4-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v4-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v4-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v4-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v4-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v4-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v4-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v4-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v4-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v4-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v4-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V4_SURFACE"
COLD_ROOT_SCHEMA = SCHEMA + ".cold-launched-committed-authority"
LIVE_PROTOCOL = "CM2_C79G_V4_COLD_TWO_PHASE_LIVE_ACK_V1"
...
PREWRAPPER_BODY_DOMAIN = "CM2_C79G_V4_COLD_PREWRAPPER_BODY_V1"
TRANSACTION_BINDING_DOMAIN = "CM2_C79G_V4_COLD_TRANSACTION_BINDING_V1"
LIVE_ACK_BINDING_DOMAIN = "CM2_C79G_V4_COLD_LIVE_ACK_BINDING_V1"
V3_FROZEN_FILES = {
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v4.py",
             "SELF exact frozen v4 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> None:
    ...
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              V3_REJECTION_FILE_PIN, V3_REJECTION_OBJECT_PIN, PRODUCER_SOURCE_PIN)),
         "all v4 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v4-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v4-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v4-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v4-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v4-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v4-" +
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v4-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def hold_v3_predecessor_exact10(
    ...
    need(len(files) == 7 and len(source_metadata) == 3 and
         ...
         "frozen v3 exact7 readable plus exact3 metadata-only source members")
...
def exact_v3_rejection(
    ...
    need(receipt_guard.path == V3_REJECTION and
         sha(receipt_guard.raw) == V3_REJECTION_FILE_PIN,
         "exact full-run held official v3 later rejection")
    value = strict_json(receipt_guard.raw, "official v3 later rejection")
    verify_object(value, "official v3 later rejection", V3_REJECTION_OBJECT_PIN)
    need(value.get("schema") ==
         ...
         value.get("target_exact_path") == str(V3_REJECTION.relative_to(ROOT)) and
         value.get("namespace_exact_path") ==
             str(V3_REJECTION.parent.relative_to(ROOT)) and
    ...
    need(set(by_path) == {
         ...
         "frozen v3 exact10 readable/metadata-only partition")
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V3_REJECTION,
             V3_TO_V4_TRANSITION, STATIC_AUDIT_V4,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v4 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v4 schema root is cold-launched wrapper over zero-credit inner composite")
    exact_v3_rejection(
        policy_by_path[V3_REJECTION], v3_guard, v3_source_metadata)
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
         ...
         registry["v3_official_later_rejection_receipt"] == {
             "path": str(V3_REJECTION.relative_to(ROOT)),
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V4__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT",
        ...
        "v3_official_later_rejection_object_sha256": V3_REJECTION_OBJECT_PIN,
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(CONTRACT, "v4 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v4 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(V3_REJECTION, "official v3 later rejection", 0o444,
                        V3_REJECTION_FILE_PIN),
        HeldPinnedInput(
            V3_TO_V4_TRANSITION, "post-source v3-to-v4 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V4, "post-source v4 static audit", 0o444),
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v4 contract", CONTRACT_OBJECT_PIN)
    ...
    expected_paths = {
        ...
        "v4_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v4_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v4-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v4-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    need(isinstance(rejection, dict) and
         rejection.get("path") == str(V3_REJECTION.relative_to(ROOT)) and
         rejection.get("namespace_path") ==
             str(V3_REJECTION.parent.relative_to(ROOT)) and
         rejection.get("file_sha256") == V3_REJECTION_FILE_PIN and
         rejection.get("object_sha256") == V3_REJECTION_OBJECT_PIN and
    ...
    need(isinstance(bundle, dict) and
         ...
         bundle.get("closed_schema_validator_policy") == {
             ...
             "optional_object_sha256_is_expressed_as_optional_closed_object_property": True,
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v3_to_v4_transition_path") ==
             str(V3_TO_V4_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V4.relative_to(ROOT)),
         "contract exact acyclic v4 bundle and post-source trust-anchor paths")
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v4 contract")
    transition = strict_json(
        by_path[V3_TO_V4_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V4].raw, "post-source static audit")
    ...
    transition_file_sha256 = sha(by_path[V3_TO_V4_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V4].raw)
    ...
    exact8_stats = [
        by_path[V3_REJECTION].before,
        by_path[CLOSED_SCHEMA].before,
        by_path[CONTRACT].before,
        producer_guard.before,
        self_guard.before,
        by_path[V3_TO_V4_TRANSITION].before,
        by_path[STATIC_AUDIT_V4].before,
    ...
    successor = transition.get("successor_v4_static_bundle")
    transition_predecessor = transition.get("frozen_predecessor_v3")
    ...
    need(transition.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         transition.get("receipt_path") == str(V3_TO_V4_TRANSITION.relative_to(ROOT)) and
         ...
         transition_rejection.get("path") == str(V3_REJECTION.relative_to(ROOT)) and
         transition_rejection.get("file_sha256") == V3_REJECTION_FILE_PIN and
         transition_rejection.get("object_sha256") == V3_REJECTION_OBJECT_PIN,
         transition_rejection.get("chronology_required") ==
             "MAX_V3_OUTER_MTIME_CTIME_LT_MIN_REJECTION_MTIME_CTIME" and
         transition_rejection.get("chronology_validated") is True,
         "transition pins current SELF plus exact producer/schema/contract/v3 predecessor")
    audited = audit.get("audited_v4_bundle")
    ...
    need(isinstance(audited, dict) and isinstance(audit_predecessor, dict) and
         isinstance(audit_rejection, dict) and
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         audit.get("audit_path") == str(STATIC_AUDIT_V4.relative_to(ROOT)) and
         ...
         audited.get("v3_to_v4_transition_receipt", {}).get("path") ==
             str(V3_TO_V4_TRANSITION.relative_to(ROOT)) and
         audited.get("v3_to_v4_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v3_to_v4_transition_receipt", {}).get("object_sha256") ==
         ...
         audit_rejection.get("path") == str(V3_REJECTION.relative_to(ROOT)) and
         ...
         schema_closure.get(
             "oneOf_keyword_absent_after_optional_object_sha256_normalization") is True and
    ...
    exact8_expected = [
        {"file_sha256": V3_REJECTION_FILE_PIN,
         "entry_name": str(V3_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V3_TO_V4_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V4.relative_to(ROOT))},
    ...
    need(set(cold_outer) == {
         ...
         cold_outer.get("schema") ==
             ...
             "cold-launch-outer-receipt.v4" and
    ...
    transition_identity = _one_identity(by_path[V3_TO_V4_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V4])
    ...
    return {
        "v3_to_v4_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v3_to_v4_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v3_to_v4_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
            ...
            audit_rejection["file_sha256"] == V3_REJECTION_FILE_PIN and
            audit_rejection["object_sha256"] == V3_REJECTION_OBJECT_PIN and
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V3_TO_V4_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V4].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        "v3_to_v4_transition_identity", "static_audit_identity",
        ...
        proof.get("v3_to_v4_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V4__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT" and
         ...
         value.get("formal_credit_authority") ==
             "ONLY_EXTERNALLY_PINNED_COLD_LAUNCHER_WRAPPER_AFTER_HELD_CHILD_AND_POST_CHILD_TERMINAL_REPLAY" and
         value.get("v3_official_later_rejection_object_sha256") == V3_REJECTION_OBJECT_PIN and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V4_PRESEAL_ROOT_V2",
    }
    rejection_object = rejection.get("object_sha256")
    need(rejection_object == V3_REJECTION_OBJECT_PIN,
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "contract_object_sha256": CONTRACT_OBJECT_PIN,
        "closed_schema_file_sha256": CLOSED_SCHEMA_FILE_PIN,
        "v3_to_v4_transition_file_sha256":
            freeze_proof["v3_to_v4_transition_identity"]["file_sha256"],
        "v3_to_v4_transition_object_sha256":
...
def v3_official_later_rejection_proof(
    ...
    return {
        ...
        "receipt_path": str(V3_REJECTION.relative_to(ROOT)),
        "namespace_path": str(V3_REJECTION.parent.relative_to(ROOT)),
        "effective_checkpoint_object_sha256": CHECKPOINT_OBJECT_PIN,
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v3_to_v4_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "v3_official_later_rejection_hashes_equal_contract":
            sha(receipt_guard.raw) == V3_REJECTION_FILE_PIN and
            rejection.get("object_sha256") == V3_REJECTION_OBJECT_PIN,
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v3_to_v4_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v3_to_v4_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V4_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V4_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         seal.get("closed_schema_file_sha256") == CLOSED_SCHEMA_FILE_PIN and
         seal.get("v3_to_v4_transition_file_sha256") ==
             freeze_proof.get("v3_to_v4_transition_identity", {}).get("file_sha256") and
         seal.get("v3_to_v4_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
         ...
         sha(receipt_guard.raw) == V3_REJECTION_FILE_PIN and
         rejection.get("object_sha256") == V3_REJECTION_OBJECT_PIN and
         receipt_guard.path == V3_REJECTION,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V4_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v4 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v4 rejection")
            verify_object(value, "permanent C79g v4 rejection")
...
def _committed_context(
    ...
    receipt_guard = next(
        item for item in policy_guard.files if item.path == V3_REJECTION)
...
def cold_authorize_live_protocol(
    ...
    request_keys = {
        ...
        "static_v4_exact10_v3_exact10_and_official_rejection_namespace_terminal_replay_completed_by_launcher_before_request",
    ...
    need(request.get("transaction_binding_domain") ==
         ...
         request.get(
             "static_v4_exact10_v3_exact10_and_official_rejection_namespace_terminal_replay_completed_by_launcher_before_request") is True and
         request.get(
    ...
    ack = close_object({
        ...
        "transaction_binding_is_replay_identical_not_fresh_or_random": True,
        "static_v4_exact10_v3_exact10_and_official_rejection_namespace_terminal_replay_completed_by_launcher_before_request": True,
...
def authorize(
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v4 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v4 authority seal")
            verify_object(seal, "C79g v4 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("closed_schema_file_sha256") == CLOSED_SCHEMA_FILE_PIN and
                 seal.get("v3_to_v4_transition_file_sha256") ==
                     freeze_proof["v3_to_v4_transition_identity"]["file_sha256"] and
                 seal.get("v3_to_v4_transition_object_sha256") ==
            ...
            cold_authorize_live_protocol(
                ...
                v3_guard, v3_source_metadata, c78_guard, fixed_guard,
