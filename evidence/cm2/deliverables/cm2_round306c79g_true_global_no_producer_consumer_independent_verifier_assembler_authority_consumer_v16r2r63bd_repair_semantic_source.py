...
SOURCE_BASENAME = "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63bd_repair_semantic_source.py"
...
V16_TO_V16R2_TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r62_to_v16r2r63bd_repair_static_launch_transition_receipt_v1.json"
STATIC_AUDIT_V16R2 = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r63bd_repair.json"
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r63bd_repair_semantic_source.py"
COLD_LAUNCHER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r63bd_repair_semantic_source.py"
COLD_LAUNCH_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r63bd_runtime_repair.sha256"
COLD_LAUNCH_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63bd_runtime_repair.json"
...
V16R2_DRAFT_RUNTIME_DISABLED = True
FINAL_CURRENT_V16R2_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "02e8685553c7c66eea4cf5a999d1813b3d87d48d15543d9576e0ea7e8bf12088"
CONTRACT_OBJECT_PIN = "2099a583f67a15075890c75f8774af11554697964a3b52c9e1d2b6cef8820293"
...
PRODUCER_SOURCE_PIN = "f553bf606126ef1345c3fc296c228d0e8a7f32a73008ce9742e0f663f3516933"
...
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63bd_runtime_repair.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v16r2r63bd-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v16r2r63bd-candidate-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v16r2r63bd-verification-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v16r2r63bd-verification-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v16r2r63bd-committed-completion-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v16r2r63bd-" + UPSTREAM_CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v16r2r63bd-rejections-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v16r2r63bd-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v16r2-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v16r2r63bd-verification-stage-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v16r2r63bd-verification-stage-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v16r2r63bd-candidate-stage-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v16r2r63bd-candidate-stage-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63bd_repair_semantic_source.py",
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v16r2r63bd-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v16r2r63bd-candidate-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v16r2r63bd-verification-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v16r2r63bd-verification-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v16r2r63bd-committed-completion-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v16r2r63bd-" +
...
# _R63BD_STATIC_FREEZE_SCHEMA_PROJECTION_APPLIED_
def _r63bd_schema_later_rejection_projection(self_guard, freeze_proof):
...
_r63bd_raw_static_freeze_proof = static_freeze_proof


def static_freeze_proof(*args, **kwargs):
    proof = _r63bd_raw_static_freeze_proof(*args, **kwargs)
    self_guard = args[1] if len(args) > 1 else kwargs.get("self_guard")
    if self_guard is None:
        raise RuntimeError("r63bd static-freeze self guard missing")
    if not isinstance(proof, dict):
        raise RuntimeError("r63bd static-freeze proof is not an object")
    ...
    proof["v8_official_rejection"] = _r63bd_schema_later_rejection_projection(
        self_guard, proof)
    return proof


def _r63bd_project_v4_proof_for_schema(freeze_proof):
    proof = v4_rejection_supersession_proof(freeze_proof)
    if not isinstance(proof, dict):
        raise RuntimeError("r63bd v4 proof is not an object")
    raw = proof.get("ordered_provisional_exact8")
    if not isinstance(raw, list) or len(raw) != 8:
        raise RuntimeError("r63bd v4 exact8 historical shape drift")
    projected = []
    for member in raw:
        if not isinstance(member, dict):
            raise RuntimeError("r63bd v4 exact8 member is not an object")
        if "mode" not in member or "nlink" not in member:
            raise RuntimeError("r63bd v4 historical mode/nlink witness missing")
...
def authority_root(
    ...
    body: dict[str, Any] = {
        ...
        "v4_rejection_supersession":
            _r63bd_project_v4_proof_for_schema(freeze_proof),
        "published_then_officially_rejected_predecessor_v5": copy.deepcopy(
            freeze_proof[
                "published_then_officially_rejected_predecessor_v5"]),
        "published_then_officially_rejected_predecessor_v6": copy.deepcopy(
...
def _committed_context(
    ...
    _r63bd_recorded_stage = install_proof["staging_path"]
    need(_r63bd_recorded_stage == DECLARED_COMPLETION_STAGE,
