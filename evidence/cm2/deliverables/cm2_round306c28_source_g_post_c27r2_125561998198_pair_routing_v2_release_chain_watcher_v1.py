...
PROGRAMS = {
    ...
    "attacks": ROOT / ("deliverables/" + BASE_NAME
                       + "_release_only_attack_harness_v1.py"),
...
PROGRAM_PINS = {
    ...
    "attacks": "10ce14bf4698251b6beff6108da45a8b5ed130ee8cb84382c9643ae5bb83ce9b",
...
def self_test() -> dict[str, Any]:
    ...
    return {"status": "PASS_C28_RELEASE_CHAIN_WATCHER_SELF_TEST",
