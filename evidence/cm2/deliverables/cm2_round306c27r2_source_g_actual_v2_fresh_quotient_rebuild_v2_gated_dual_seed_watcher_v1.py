...
TRANSACTION_SCHEMA = (
    "cm2.round306c27r2.source-g-actual-v2-fresh-quotient-rebuild.v2."
    "gated-dual-seed-transaction-receipt.v1"
)
FAILURE_SCHEMA = (
    "cm2.round306c27r2.source-g-actual-v2-fresh-quotient-rebuild.v2."
    "gated-dual-seed-failure-receipt.v1"
)
OUTPUT_FILES = {
...
def parse_manifest(payload: bytes, label: str) -> dict[str, str]:
    ...
    for ordinal, line in enumerate(payload.decode("ascii", "strict").splitlines()):
        pieces = line.split("  ", 1)
        need(len(pieces) == 2 and valid_sha(pieces[0]) and pieces[1],
        ...
        if args.run_attacks:
            ...
            attack_spec = command_spec(
                ...
                [{
                    ...
                    "kind": "directory", "exact_inventory": None,
