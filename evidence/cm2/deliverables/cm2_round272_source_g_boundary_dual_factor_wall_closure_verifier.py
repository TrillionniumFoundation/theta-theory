#!/usr/bin/env python3
"""Independent full-recomputation verifier for Round272."""
...
VERIFICATION_SCHEMA="cm2.round272.source-g-boundary-dual-factor-wall-closure-verification.v1"
PRODUCER_SHA256="ea2af5da7162216cce64e058515b2160bb2a96b03dbbb8c7454819d33b5ebeda"
CANDIDATE_SHA256="16050c7087deb546d39b2c7922274ccae7cec24a799ecafd9a8304ae1186d8f2"
CANDIDATE_RESULT_SHA256="96eb126f34d819c97b9d50857d3207efad013a3c4e65d085f5b55270e8522354"
CANDIDATE_SIZE=1_250_159
...
def main():
 ...
 attacks=[]
 for label,path,value in (("signed-count",("census","materialized_side_signature_count"),719),("residual-count",("census","remaining_closed_leaf_count"),1),("component-credit",("strict_nonpromotion","new_component_union_credit"),1),("jxjy-credit",("strict_nonpromotion","Jx_Jy_same_point_glue_credit"),1),("cm2-status",("strict_nonpromotion","CM2"),"GO_FOR_CLAIM")):
 ...
 verification={"status":"PASS_INDEPENDENT_ROUND272","schema":VERIFICATION_SCHEMA,"producer_sha256":PRODUCER_SHA256,"candidate_sha256":CANDIDATE_SHA256,"candidate_size":CANDIDATE_SIZE,"candidate_result_sha256":CANDIDATE_RESULT_SHA256,"independent_result_sha256":eh,"full_496_parent_recomputation":True,"exact_candidate_result_equality":True,"attack_tests":attacks,"attack_tests_rejected":len(attacks),"strict_nonpromotion_reconfirmed":True};b=canonical(verification)+b"\n";write(b);print(verification["status"]);print("verification_sha256="+hashlib.sha256(b).hexdigest());return 0
