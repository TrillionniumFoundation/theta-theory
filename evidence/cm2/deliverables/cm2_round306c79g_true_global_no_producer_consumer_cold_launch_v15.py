#!/usr/bin/env python3
"""Externally pinned cold launcher for the C79g v15 exact10 static bundle.
...
# credit into v15.  Runtime consumers must supply these bytes from distinct
...
V14_OFFICIAL_REJECTION_FD_ENV = "CM2_C79G_V15_V14_OFFICIAL_REJECTION_FD"
V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_FD_ENV = (
    "CM2_C79G_V15_V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_FD")
...
V15_BOOTSTRAP_DESCRIPTOR_COUNT = 4
V15_CHILD_AUTHORITY_DESCRIPTOR_COUNT = 12
V15_CHILD_PASS_FD_COUNT = 16
V14_RUNTIME_REGISTRY_SHAPE_DRIFT_INCIDENT = {
    ...
    "v14_credit_may_transfer_to_v15": False,
}
BASE = "cm2_round306c79g_true_global_no_producer_consumer"
LAUNCHER_RELATIVE = Path("deliverables") / (BASE + "_cold_launch_v15.py")
...
ROOT = Path("/__C79G_V15_UNCONFIGURED_ROOT__")
...
V15_REJECTION_NAMESPACE = ROOT / "__unconfigured_v15_rejections__"
V15_LATER_REJECTION = V15_REJECTION_NAMESPACE / "rejection.json"
...
V15_DRAFT_RUNTIME_DISABLED = True
...
def configure_workspace_paths(root: Path) -> None:
    ...
    global V15_REJECTION_NAMESPACE
    global V15_LATER_REJECTION, SCHEMA, CONTRACT, PRODUCER, CONSUMER
    ...
    V15_REJECTION_NAMESPACE = RUNTIME / ("c79g-v15-rejections-" + CHECKPOINT)
    V15_LATER_REJECTION = V15_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / (BASE + "_schema_v15.json")
    CONTRACT = OUT / (BASE + "_contract_v15.json")
    PRODUCER = OUT / (BASE + "_v15.py")
    CONSUMER = OUT / (BASE + "_independent_verifier_assembler_authority_consumer_v15.py")
    TRANSITION = OUT / (BASE + "_v14_to_v15_static_launch_transition_receipt_v1.json")
    AUDIT = OUT / (BASE + "_static_audit_v15.json")
    MANIFEST = OUT / (BASE + "_cold_launch_manifest_v15.sha256")
    OUTER = OUT / (BASE + "_cold_launch_outer_receipt_v15.json")
    BASE7_PINS = {
...
INNER_SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v15.inner-composite"
COLD_ROOT_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v15."
    "cold-launched-committed-authority"
)
COLD_ROOT_DOMAIN = b"CM2_C79G_V15_COLD_LAUNCHED_AUTHORITY_ROOT_V1\0"
LIVE_PROTOCOL = "CM2_C79G_V15_COLD_TWO_PHASE_LIVE_ACK_V1"
LIVE_REQUEST_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v15."
    "cold-live-commit-request"
)
LIVE_ACK_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v15.cold-live-ack"
)
LIVE_RELEASE_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v15.cold-live-release"
)
PREWRAPPER_BODY_DOMAIN = "CM2_C79G_V15_COLD_PREWRAPPER_BODY_V1"
TRANSACTION_BINDING_DOMAIN = "CM2_C79G_V15_COLD_TRANSACTION_BINDING_V1"
LIVE_ACK_BINDING_DOMAIN = "CM2_C79G_V15_COLD_LIVE_ACK_BINDING_V1"
SOURCE_FD_ENV = "CM2_C79G_V15_COLD_SOURCE_FD"
EXEC_FD_ENV = "CM2_C79G_V15_COLD_EXEC_FD"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V15_COORDINATION_PARENT_FD"
WORKSPACE_ROOT_ENV = "CM2_C79G_V15_COLD_WORKSPACE_ROOT"
WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V15_COLD_WORKSPACE_ROOT_FD"
LAUNCHER_SHA_ENV = "CM2_C79G_V15_COLD_LAUNCHER_FILE_SHA256"
HELD_V10_PRODUCER_FD_ENV = "CM2_C79G_V15_V10_PRODUCER_FD"
HELD_V9_LAUNCHER_FD_ENV = "CM2_C79G_V15_V9_LAUNCHER_FD"
HELD_V11_PRODUCER_FD_ENV = "CM2_C79G_V15_V11_PRODUCER_FD"
HELD_V11_LAUNCHER_FD_ENV = "CM2_C79G_V15_V11_LAUNCHER_FD"
HELD_V11_REJECTION_FD_ENV = "CM2_C79G_V15_V11_REJECTION_FD"
HELD_V12_PRODUCER_FD_ENV = "CM2_C79G_V15_V12_PRODUCER_FD"
HELD_V12_CONSUMER_FD_ENV = "CM2_C79G_V15_V12_CONSUMER_FD"
HELD_V12_LAUNCHER_FD_ENV = "CM2_C79G_V15_V12_LAUNCHER_FD"
HELD_V5_REJECTION_FD_ENV = "CM2_C79G_V15_V5_REJECTION_FD"
HELD_V12_REJECTION_FD_ENV = "CM2_C79G_V15_V12_REJECTION_FD"
HELD_V13_PRODUCER_FD_ENV = "CM2_C79G_V15_V13_PRODUCER_FD"
HELD_V13_CONSUMER_FD_ENV = "CM2_C79G_V15_V13_CONSUMER_FD"
HELD_V13_LAUNCHER_FD_ENV = "CM2_C79G_V15_V13_LAUNCHER_FD"
HELD_V13_PRODUCER_PYC_FD_ENV = "CM2_C79G_V15_V13_PRODUCER_PYC_FD"
HELD_V13_CONSUMER_PYC_FD_ENV = "CM2_C79G_V15_V13_CONSUMER_PYC_FD"
HELD_V13_LAUNCHER_PYC_FD_ENV = "CM2_C79G_V15_V13_LAUNCHER_PYC_FD"
HELD_V13_SUPERSESSION_RECEIPT_FD_ENV = (
    "CM2_C79G_V15_V13_SUPERSESSION_RECEIPT_FD")
...
def validate_v13_supersession_receipt(
    ...
    need(value.get("schema") ==
         ...
         value.get("status") ==
             ...
             "REJECTION__V15_SUCCESSOR_ONLY" and
         ...
         successor.get("v15_current_exact8_first_member_must_be_this_receipt")
             is True and
         successor.get("v15_must_preserve_v12_exact10_and_official_rejection")
             is True and
         successor.get("v15_predecessor_unique_live_identity_count") == 105 and
         successor.get("v15_prepublication_unique_live_identity_count") == 113 and
         successor.get("v15_terminal_unique_live_identity_count") == 115 and
         successor.get("v15_terminal_group_vector") ==
             [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 7, 1, 3, 3, 1] and
         inherited.get("v15_must_live_hold_and_terminally_replay_exact16_plus_this_receipt")
             is True,
...
def expected_v5_published_rejected_segment() -> dict[str, Any]:
    """Construct the one exact v5 regression shape shared by v15 proofs."""
    names = (
...
def pin_normalized_launcher_ast_sha256(raw: bytes, label: str) -> str:
    ...
    six current-v15 BASE7 values are replaced by fixed draft sentinels.  The
    ...
    need(key_names == expected_key_names and
         ...
         label + ":exact ordered v14-receipt-plus-current-v15 BASE7 key census")
...
def producer_source_registry_shape_from_ast(raw: bytes) -> int:
    ...
    try:
        tree = ast.parse(raw.decode("utf-8"), filename="producer_v15",
                         mode="exec")
    except (UnicodeDecodeError, SyntaxError) as exc:
        raise Reject("current v15 producer registry AST parse") from exc
    ...
    need(isinstance(registry_function,
         ...
         "current v15 input_registry and HeldSelf.execution_proof")
    registry_returns = [
    ...
    need(len(registry_returns) == 1 and len(proof_returns) == 1,
         "unique current v15 registry/proof return dicts")
    ...
    need(len(explicit_keys) == len(set(explicit_keys)) == 67 and
         ...
         "current v15 registry explicit67 plus exact execution-proof7")
    shape = len(explicit_keys) + len(proof_dict.keys) + 1
    need(shape == 75,
         "current v15 producerSourceRegistry exact explicit67 plus "
...
def validate_final_static_audit(
    ...
    need(set(audit) == audit_keys and
         audit.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer.static-audit.v15" and
         ...
         "final static audit exact top-level closure and PASS_V15 status")
    ...
    expected_inputs = {
        ...
        "launcher_template": pin_normalized_launcher_ast_sha256(
            launcher_source_raw, "held_v15_launcher_source"),
    ...
    need(isinstance(no_producer, dict) and
         ...
         no_producer.get(
             "consumer_current_v15_producer_content_open_read_hash_decode_compile_import_or_execute_allowed") is False and
         ...
         "final static audit exact current-v15 no-producer and inherited incident evidence policy")
    ...
    need(isinstance(no_run, dict) and set(no_run) == {
             "C79_entrypoint_executed", "C79_v15_runtime_artifact_count",
             "C79_v15_process_count", "pyc_or___pycache___created",
             "cold_manifest_or_outer_created_before_dual_GO",
         } and no_run.get("C79_entrypoint_executed") is False and
         type(no_run.get("C79_v15_runtime_artifact_count")) is int and
         no_run.get("C79_v15_runtime_artifact_count") == 0 and
         type(no_run.get("C79_v15_process_count")) is int and
         no_run.get("C79_v15_process_count") == 0 and
    ...
    def __init__(self, source: HeldFile) -> None:
        ...
        try:
            self.fd = os.memfd_create(
                "c79g-v15-child-exec", MFD_CLOEXEC | MFD_ALLOW_SEALING)
        except OSError as exc:
...
class HeldEmptyRejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent) -> None:
        coordination.verify()
        name = V15_REJECTION_NAMESPACE.name
        ...
        try:
            try:
                ...
                state = os.stat(name, dir_fd=coordination.fd,
                                follow_symlinks=False)
            self.path = V15_REJECTION_NAMESPACE
...
def construct_launcher_native_rejection(
    ...
    return close_object({
        ...
        "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
        "effective_checkpoint_object_sha256": CHECKPOINT,
        "namespace_exact_path": str(V15_REJECTION_NAMESPACE.relative_to(ROOT)),
        "target_exact_path": str(V15_LATER_REJECTION.relative_to(ROOT)),
        "rejection_reason": "ORPHANED_OR_INCOMPLETE_C79G_V15_SURFACE",
...
def install_or_replay_launcher_native_rejection(
    ...
    try:
        try:
            ...
            namespace_fd = openat2_beneath(
                V15_REJECTION_NAMESPACE, os.O_RDONLY | os.O_DIRECTORY)
    except BaseException:
        if namespace_fd >= 0:
    ...
    try:
        ...
        path_before = root_lstat(V15_REJECTION_NAMESPACE)
        ...
        target = os.stat(V15_LATER_REJECTION.name, dir_fd=namespace_fd,
                         follow_symlinks=False) if V15_LATER_REJECTION.name in universe else None
        if target is not None:
            need(universe == {V15_LATER_REJECTION.name},
                 "idempotent rejection exact singleton")
            rejection_guard = HeldFile(
                V15_LATER_REJECTION, "existing launcher-native v15 rejection")
        else:
            ...
            try:
                ...
                os.fsync(namespace_fd)
            rejection_guard = HeldFile(
                V15_LATER_REJECTION, "new launcher-native v15 rejection")
        need(rejection_guard is not None,
             "launcher-native rejection file held")
        value = strict_json(rejection_guard.raw, "launcher-native v15 rejection")
        need(isinstance(value, dict), "launcher-native rejection mapping")
        verify_object(value, "launcher-native v15 rejection")
        os.fsync(rejection_guard.fd)
        os.fsync(namespace_fd)
        os.fsync(coordination.fd)
        after = os.fstat(namespace_fd)
        path_after = root_lstat(V15_REJECTION_NAMESPACE)
        need(value == expected and rejection_guard.raw == expected_raw and
             set(os.listdir(namespace_fd)) == {V15_LATER_REJECTION.name} and
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str,
                    ...
                    bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / (BASE + "_cold_launch_v15.py"),
        ...
        supersession = self.base_objects[
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT]
        successor_contract = supersession.get("v15_successor_contract", {})
        ...
        need(self.by_path[
             ...
             supersession.get("status") ==
                 ...
                 "REJECTION__ZERO_CREDIT__V15_SUCCESSOR_ONLY" and
             ...
             successor_contract.get("v15_current_exact8_first_member_must_be_this_receipt")
                 is True and
        ...
        need(set(self.base_objects[TRANSITION]) == {
                 ...
                 "published_then_officially_rejected_predecessor_v12",
                 "rejected_prepublication_v13_supersession_receipt",
                 "successor_v15_static_bundle", "physical_mode_policy",
             ...
             self.base_objects[TRANSITION].get("schema") ==
                 "cm2.round306c79g.true-global-no-producer-consumer."
                 "v13-to-v15-static-launch-transition.v1" and
             self.base_objects[TRANSITION].get("transition_kind") ==
                 "APPEND_ONLY_V13_PREPUBLICATION_PYC_CONTAMINATION_REJECTION_"
                 "TO_ZERO_CREDIT_V15_STATIC_SUCCESSOR",
             "transition exact top-level v13-to-v15 closed shape")
        need(set(self.base_objects[CONTRACT]) == {
                 ...
                 "v15_bundle", "object_sha256",
             } and
             self.base_objects[CONTRACT].get("schema") ==
                 "cm2.round306c79g.true-global-no-producer-consumer.v15.contract" and
        ...
        need(set(self.outer_object) == {
             ...
             self.outer_object.get("schema") ==
                 "cm2.round306c79g.true-global-no-producer-consumer."
                 "cold-launch-outer-receipt.v15" and
        ...
        contract_static_census = self.base_objects[CONTRACT].get(
            "v15_bundle", {}).get("cold_launch_outer_closure", {})
        need(self.global_identity_census == {
                 "v15_predecessor_unique_live_identity_count": 116,
                 "v15_prepublication_unique_live_identity_count": 124,
                 "v15_terminal_unique_live_identity_count": 126,
             ...
             contract_static_census.get(
                 "current_v15_exact10_plus_all_append_only_predecessors_"
                 "unique_file_identity_count") ==
                 self.global_identity_census[
                     "v15_terminal_unique_live_identity_count"] and
             all(contract_static_census.get(key) ==
                     self.global_identity_census[key]
                 for key in (
                     "v15_predecessor_unique_live_identity_count",
                     "v15_prepublication_unique_live_identity_count",
                     "v15_terminal_unique_live_identity_count",
                     "v15_terminal_group_vector",
             ...
             "current v15 exact10 plus all predecessors are an exact "
    ...
    def _global_identity_census(self) -> dict[str, Any]:
        ...
        return {
            ...
            "v15_terminal_group_vector": terminal_group_vector,
    ...
    def _hold_v14_inherited_authority_exact12(
        ...
        The final receipt is already the first current-v15 exact8 guard and is
...
def child_environment(bundle: HeldBundle, child_exec: HeldSealedChildExec,
    ...
    need(len(authority_environment) == 12 and
         ...
         all(env_name.startswith("CM2_C79G_V15_V14_") and
...
def child_pass_fds(bundle: HeldBundle, child_exec: HeldSealedChildExec,
    ...
    need(len(result) == len(set(result)) ==
             V15_CHILD_PASS_FD_COUNT ==
             V15_BOOTSTRAP_DESCRIPTOR_COUNT +
             V15_CHILD_AUTHORITY_DESCRIPTOR_COUNT == 16,
...
def cold_root(bundle: HeldBundle, coordination: HeldCoordinationParent,
    ...
    proof = {
        ...
        **bundle.chronology,
        ...
        "reject_command_exempts_only_fresh_empty_v15_rejection_namespace": True,
...
def _validate_live_ack(
    ...
    expected_keys = {
        ...
        "static_v15_exact10_with_v11_exact10_and_official_rejection_v10_exact10_and_official_rejection_v9_exact10_and_official_rejection_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request",
    ...
    need(set(ack) == expected_keys and ack.get("schema") == LIVE_ACK_SCHEMA and
         ...
         ack.get("static_v15_exact10_with_v11_exact10_and_official_rejection_v10_exact10_and_official_rejection_v9_exact10_and_official_rejection_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
...
def terminal_replay_v14_exact10_and_official_rejection(
    ...
    return {
        ...
        "D02_task_credit": 0,
        "D02_formal_pending_task_count": 33_638,
        "v14_credit_transferred_to_v15": False,
    }


def v14_inherited_authority_draft_state(
        supersession_receipt_exists: bool) -> dict[str, Any]:
    """Prove the legal v15 draft state without opening the frozen receipt."""
    need(V15_DRAFT_RUNTIME_DISABLED is True and
         ...
         "v15 draft requires frozen pinned v14 receipt and uninstalled v15 base7 pins")
    return {
        "status": "V15_DRAFT_RUNTIME_DISABLED__V14_SUPERSESSION_RECEIPT_FROZEN_PINNED",
        "receipt_path":
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_RELATIVE_PATH,
...
def terminal_replay_v14_inherited_authority_exact12(
    ...
    need(tuple(held_raw_by_role) == V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER and
         len(held_raw_by_role) == V15_CHILD_AUTHORITY_DESCRIPTOR_COUNT == 12,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if V15_DRAFT_RUNTIME_DISABLED and not FINAL_BASE7_PINS_INSTALLED:
        raise Reject(
            "C79g v15 successor is a sentinel draft; runtime is disabled")
    need(FINAL_BASE7_PINS_INSTALLED is True,
         "C79g v15 launcher requires final base7 pins")
    ...
    try:
        ...
        if args.command == "reject":
            ...
            return 0
        # Every positive-capable command holds the exact-empty v15 rejection
