#!/usr/bin/env python3
"""Independent C79g v6 verifier, assembler, and authority consumer.
...
COLD_EXEC_FD_ENV = "CM2_C79G_V6_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V6_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V6_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V6_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V6_COLD_LAUNCHER_FILE_SHA256"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v6"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v6"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v6.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v6.json"
...
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v6.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v6.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v6.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v6.json")
...
# the final current-v6 pins and flips the explicit finalization bit.
FINAL_CURRENT_V6_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "6e4f7f4693b759397c8775f8d943048c867b3c460c27f5cb3d9681a0fefee30c"
CONTRACT_OBJECT_PIN = "58ae6e3c9912294cc89b6804741e56b373a143d16a5fa2547325989fa1af2546"
CLOSED_SCHEMA_FILE_PIN = "250e27777e3ffdaf159a19c00ae683a4ef079f6e785f0b37d003a724099419bc"
...
PRODUCER_SOURCE_PIN = "f48982effd6a1068c50260d0d419b281a3fa8c614e4ca76c3b8ee2a48e8afb56"
TERMINALS = {
...
VERIFICATION_FILE = BASE + "_independent_verification_v6.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v6.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v6.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v6.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v6.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v6-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v6-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v6-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v6-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v6-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v6-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v6-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v6-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v6-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v6-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v6-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v6-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v6-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V6_SURFACE"
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v6.py",
             "SELF exact frozen v6 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V6_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V6_PINS_INSTALLED is True,
         "v6 final current pins are not installed; every command is disabled")
    ...
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              ...
              V5_OFFICIAL_REJECTION_OBJECT_PIN, PRODUCER_SOURCE_PIN)),
         "all v6 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v6-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v6-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v6-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v6-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v6-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v6-" +
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v6-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V5_OFFICIAL_REJECTION,
             V5_TO_V6_TRANSITION, STATIC_AUDIT_V6,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v6 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v6 schema root is cold-launched wrapper over zero-credit inner composite")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        policy_guard, v5_guard, v5_source_metadata)
    ...
    current_policy_identities = {item.identity for item in policy_guard.files}
    ...
    # v4/v5 proofs; v5 rejection is shared by current policy/v5 proof.  These
    # are single held identities, never reopened aliases.
    need(len(current_policy_identities) == 8 and
         len(predecessor_identities) == 28 and
         current_policy_identities.isdisjoint(predecessor_identities) and
         len(current_policy_identities | predecessor_identities) == 36 and
         len({item.mount_id for item in policy_guard.files} |
             ...
             {item.mount_id for item in v5_source_metadata}) == 1,
         "current policy and v3/v4/v5 predecessor held identities close on one mount")
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v5_to_v6_transition_receipt", "static_audit_v6", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v5_to_v6_transition_receipt", {}).get("path") ==
             str(V5_TO_V6_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v5_to_v6_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v5_to_v6_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v6", {}).get("path") ==
             str(STATIC_AUDIT_V6.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v6", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v6", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V6__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            V5_OFFICIAL_REJECTION, "official v5 rejection shared with predecessor", 0o444,
            V5_OFFICIAL_REJECTION_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v6 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v6 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V5_TO_V6_TRANSITION, "post-source v5-to-v6 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V6, "post-source v6 static audit", 0o444),
        ...
        0o555, 2, "official v5 rejection exact singleton namespace")])
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v6 contract", CONTRACT_OBJECT_PIN)
    ...
    expected_paths = {
        ...
        "v6_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v6_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v6-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v6-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v5_to_v6_transition_path") ==
             str(V5_TO_V6_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V6.relative_to(ROOT)),
         "contract exact acyclic v6 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    need(audit.get("status") == "PASS_V6",
         "final static audit top-level PASS_V6")
    ...
    need(type(closure.get("schema_definition_count")) is int and
         closure.get("schema_definition_count") == definition_count == 37 and
         type(closure.get("schema_ref_count")) is int and
         closure.get("schema_ref_count") == reference_count == 179 and
         ...
         closure.get("closed_object_count") == closed_count == 43 and
         ...
         "final schema closure actual 37/179/43/0 counts")
    actual_keywords = [
    ...
    need(closure.get("actual_schema_keyword_universe") == actual_keywords and
         closure.get("actual_schema_keyword_universe_sha256") ==
             _line_sequence_sha256(actual_keywords) and
         ...
         closure.get("cold_launcher_supported_schema_keyword_universe_sha256") ==
             _line_sequence_sha256(supported_keywords),
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v6 contract")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v6 closed schema")
    transition = strict_json(
        by_path[V5_TO_V6_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V6].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        policy_guard, v5_guard, v5_source_metadata)
    ...
    transition_file_sha256 = sha(by_path[V5_TO_V6_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V6].raw)
    ...
    need(isinstance(successor, dict) and isinstance(successor_consumer, dict) and
         ...
         "transition exact bundle/v3/v4/v5 predecessor objects")
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V5_TO_V6_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v6_path", "contract",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v6_path",
         ...
         transition_v5.get("official_later_rejection", {}).get("object_sha256") ==
             V5_OFFICIAL_REJECTION_OBJECT_PIN,
         "transition pins current bundle and append-only v3/v4/v5 predecessors")
    audited = audit.get("audited_v6_bundle")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         audit.get("audit_path") == str(STATIC_AUDIT_V6.relative_to(ROOT)) and
         ...
         audited.get("v5_to_v6_transition_receipt", {}).get("path") ==
             str(V5_TO_V6_TRANSITION.relative_to(ROOT)) and
         audited.get("v5_to_v6_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v5_to_v6_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        {"file_sha256": V5_OFFICIAL_REJECTION_FILE_PIN,
         "entry_name": str(V5_OFFICIAL_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V5_TO_V6_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V6.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V5_TO_V6_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V6])
    ...
    v5_rejection_identity = _one_identity(
        held_v5_official_rejection(policy_guard))
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v5_to_v6_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v5_to_v6_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v5_to_v6_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "current_exact8_first_member_is_shared_v5_official_rejection":
            cold_manifest[0] == {
                "file_sha256": V5_OFFICIAL_REJECTION_FILE_PIN,
                "entry_name": str(V5_OFFICIAL_REJECTION.relative_to(ROOT))} and
            transition_v4.get("ordered_provisional_exact8") ==
                v4_supersession["frozen_v4_provisional_exact8"]["ordered_members"],
        "published_then_officially_rejected_predecessor_v5_validated":
            ...
            transition_v5.get("official_later_rejection", {}).get(
                "object_sha256") == V5_OFFICIAL_REJECTION_OBJECT_PIN,
        "v5_official_rejection_shared_current_policy_held_fd":
            held_v5_official_rejection(policy_guard).fd ==
                by_path[V5_OFFICIAL_REJECTION].fd,
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V5_TO_V6_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V6].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "v4_rejection_supersession_file_sha256",
        "v4_rejection_supersession_object_sha256",
        "v5_to_v6_transition_identity", "static_audit_identity",
        ...
        proof.get("v5_to_v6_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V6__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V6_PRESEAL_ROOT_V2",
    }
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "v5_to_v6_transition_file_sha256":
            freeze_proof["v5_to_v6_transition_identity"]["file_sha256"],
        "v5_to_v6_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v5_to_v6_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v5_to_v6_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v5_to_v6_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V6_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V6_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v5_to_v6_transition_file_sha256") ==
             freeze_proof.get("v5_to_v6_transition_identity", {}).get("file_sha256") and
         seal.get("v5_to_v6_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V6_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v6 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v6 rejection")
            verify_object(value, "permanent C79g v6 rejection")
...
def cold_authorize_live_protocol(
    ...
    need(request.get("transaction_binding_domain") ==
         ...
         request.get(
             "static_v6_exact10_with_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
         request.get(
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v6 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v6 authority seal")
            verify_object(seal, "C79g v6 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v5_official_rejection_object_sha256") ==
                     V5_OFFICIAL_REJECTION_OBJECT_PIN and
                 seal.get("v5_to_v6_transition_file_sha256") ==
                     freeze_proof["v5_to_v6_transition_identity"]["file_sha256"] and
                 seal.get("v5_to_v6_transition_object_sha256") ==
