...
HISTORICAL_BASE = 'cm2_round306c79g_true_global_no_producer_consumer'
BASE = 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r58_semantic_source'
LAUNCHER_RELATIVE = Path('deliverables') / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r58_semantic_source.py'
...
ACTIVE_PREDECESSOR_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r58_active_predecessor_supersession_receipt_v1.json'
ACTIVE_SUCCESSOR_NAMESPACE = 'v16r2r58_semantic_source'
ACTIVE_SUCCESSOR_NAMESPACE_TAG = 'v16r2r58-semantic-regeneration'
ACTIVE_PREDECESSOR_SUPERSESSION_FILE_PIN = '75ed65910e2aeffeb588ddc553dafc91116a9a6d6bee23074b58d0be34f78ed9'
ACTIVE_PREDECESSOR_SUPERSESSION_OBJECT_PIN = '66b599ff985334ec95ea24367b5dee8ddfe5509c2322f5c3d09c18c217914d69'
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r58_active_predecessor_supersession_receipt_v1.json'
RUNTIME = ROOT / '.cm2-runtime'
SELF = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r58_semantic_source.py'
...
SCHEMA = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r58.json'
CONTRACT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r58.json'
PRODUCER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r58_semantic_source.py'
CONSUMER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r58_semantic_source.py'
TRANSITION = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r57_to_v16r2r58_static_launch_transition_receipt_v1.json'
AUDIT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r58.json'
MANIFEST = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r58.sha256'
OUTER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r58.json'
MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r58.sha256'
OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r58.json'
V16R2_DRAFT_RUNTIME_DISABLED = True
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / 'rejection.json'
    SCHEMA = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r58.json'
    CONTRACT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r58.json'
    PRODUCER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r58_semantic_source.py'
    CONSUMER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r58_semantic_source.py'
    TRANSITION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r57_to_v16r2r58_static_launch_transition_receipt_v1.json'
    AUDIT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r58.json'
    MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r58.sha256'
    OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r58.json'
    BASE7_PINS = {V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT: ('aa4323027e2313f8a2eda0d6ffc039a537afe342d496d1f75cd73fcd47446c01', '93689e62ae36f405f045a769f4dc6f6e6fd83a16605d08299d5c3397ad657e2e'), SCHEMA: ('82a7ff395ec10fa3b2916808fb5c6dd979e59b62f239983caf580e6a91d38ccc', None), CONTRACT: ('6e4829dcf14cf6c7420da81702a3e10db4b4a251a251dc9e0899746d9179d7e8', '30e87fd03e72385eb9fb9da1465e81dca5d9f15117352e80b52ae31e59c9a92a'), PRODUCER: ('0c1789d05cbb1d99c5c56707ab2bfd2bb7def9560d032062617beb2d0b015f39', None), CONSUMER: ('fcfddc117c8ac7c3b0e747a47e31fe9d073617452b7fd87edf6790fca65b4b05', None), TRANSITION: ('7760bc0ffbe050cfaa426273d9f2085848cf5c32c17cae035399026f7037eec6', '17e3b395ac5e2cb18ac65518f551eeb53334c71dea83bf14bdf260b19190e03c'), AUDIT: ('5f8d101d5d8375f234a47abff61ebfd2674466053a579844f5a4c55412f921e9', '9ae8389270ec47019595067eb8f1477fd6553adc4ad3a43b14c1ae263daf9752')}
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str, coordination: HeldCoordinationParent, bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r58_semantic_source.py', 'exact cold launcher path')
