...
PROGRAMS = {
    "cold": ROOT / f"deliverables/{PREFIX}_release_cold_replay_runner_v3.py",
...
PINS = {
    "cold": "c4e34f2d9ad5dad508facdef417040bf749b89392e50ee77ec252d73561d51b3",
...
def self_test() -> dict[str, Any]:
    ...
    need(len(test) == 11 and all(valid_sha(value) for value in PINS.values()),
         "watcher fixtures")
    return {"status": "PASS_C29_V2_RELEASE_CHAIN_WATCHER_V3_SELF_TEST",
