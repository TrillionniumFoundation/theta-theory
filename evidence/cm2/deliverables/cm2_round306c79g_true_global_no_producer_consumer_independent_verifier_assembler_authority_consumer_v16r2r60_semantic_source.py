...
SOURCE_BASENAME = "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r60_semantic_source.py"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v16r2r60"
...
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r60.json"
...
V16_TO_V16R2_TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r59_to_v16r2r60_static_launch_transition_receipt_v1.json"
STATIC_AUDIT_V16R2 = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r60.json"
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r60_semantic_source.py"
COLD_LAUNCHER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r60_semantic_source.py"
COLD_LAUNCH_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r60.sha256"
COLD_LAUNCH_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r60.json"
...
V16R2_DRAFT_RUNTIME_DISABLED = True
FINAL_CURRENT_V16R2_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "730ddbc5b6681b001160280651ee46aab0c381a417ad90ea7a1fdd4c6dab1cff"
CONTRACT_OBJECT_PIN = "452ddf6e1edebfea35058bedbe84d7c8cd025ef46f10042c7b83d6e6f5bf90f0"
CLOSED_SCHEMA_FILE_PIN = "9478f184ce1ff6c87bad06d56f3d170feca0ea732ca075cd9f36d1da3953453a"
...
PRODUCER_SOURCE_PIN = "b2269e6ba4f4c45b4d292017d087b587b7d107f765c161506e16ab187ff5507b"
...
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r60.json"
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r60_semantic_source.py",
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    ...
    need(set(contract) == {
         ...
         contract.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer.v16r2r60.contract" and
