#!/usr/bin/env python3
"""Independent C79g v13 verifier, assembler, and authority consumer.

The verifier never content-opens, reads, hashes, imports, compiles, decodes,
or executes the current C79g v13 producer source.  Frozen predecessor source
bytes are readable only through the launcher's inherited exact-ten held fds,
solely to rederive noncredit incident authority; no predecessor source is
reopened by pathname.  It reconstructs the complete
...
COLD_EXEC_FD_ENV = "CM2_C79G_V13_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V13_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V13_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V13_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V13_COLD_LAUNCHER_FILE_SHA256"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V13_COORDINATION_PARENT_FD"
V10_PRODUCER_FD_ENV = "CM2_C79G_V13_V10_PRODUCER_FD"
V9_LAUNCHER_FD_ENV = "CM2_C79G_V13_V9_LAUNCHER_FD"
V11_PRODUCER_FD_ENV = "CM2_C79G_V13_V11_PRODUCER_FD"
V11_LAUNCHER_FD_ENV = "CM2_C79G_V13_V11_LAUNCHER_FD"
V11_REJECTION_FD_ENV = "CM2_C79G_V13_V11_REJECTION_FD"
V12_PRODUCER_FD_ENV = "CM2_C79G_V13_V12_PRODUCER_FD"
V12_CONSUMER_FD_ENV = "CM2_C79G_V13_V12_CONSUMER_FD"
V12_LAUNCHER_FD_ENV = "CM2_C79G_V13_V12_LAUNCHER_FD"
V5_REJECTION_FD_ENV = "CM2_C79G_V13_V5_REJECTION_FD"
V12_REJECTION_FD_ENV = "CM2_C79G_V13_V12_REJECTION_FD"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v13"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v13"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v13.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v13.json"
...
V12_TO_V13_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v12_to_v13_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V13 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v13.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v13.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v13.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v13.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v13.json")
# Final current-v13 static-freeze pins.  The historical draft sentinels remain
...
VERIFICATION_FILE = BASE + "_independent_verification_v13.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v13.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v13.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v13.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v13.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v13-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v13-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v13-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v13-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v13-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v13-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v13-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v13-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v13-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v13-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v13-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v13-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v13-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V13_SURFACE"
...
# v13 base7 and is therefore shared with the current static-policy holder.  The
...
# official rejection bytes are also read from the inherited exact-ten fds,
# only for pinned noncredit incident authority and never by pathname reopen.
V11_FROZEN_FILES = {
...
STATIC_AUDIT_INPUT_EXACT44_ORDER_SHA256 = (
    "ba349a7f67b7269f6b0b9b0267ab5fdfd90cfc3cea58532382028031b33a4b45")
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v13.py",
             "SELF exact frozen v13 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V13_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V13_PINS_INSTALLED is True,
         "v13 final current pins are not installed; every command is disabled")
    need(all(value not in V13_DRAFT_CURRENT_CORE_PINS for value in (
             CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
             PRODUCER_SOURCE_PIN)),
         "v13 draft current-core sentinels must be replaced before execution")
    ...
    incident_fd_texts = tuple(
        os.environ.get(env_name, "")
        for env_name, _, _ in INCIDENT_AUTHORITY_INHERITED_EXACT10)
    all_fd_texts = (
    ...
    need(all(value.isascii() and value.isdecimal() and len(value) <= 10 and
         ...
         len(all_fd_texts) == len({int(value) for value in all_fd_texts}) == 14 and
         ...
         "four bootstrap plus ten incident pairwise-distinct fds and mandatory "
    ...
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              ...
              V12_OFFICIAL_REJECTION_OBJECT_PIN,
              PRODUCER_SOURCE_PIN)),
         "all v13 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v13-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v13-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v13-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v13-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v13-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v13-" +
...
class HeldInheritedIncidentAuthorityExact10:
    """Read the launcher's exact ten inherited incident-authority files.

    These descriptors are the sole content views used to rederive the frozen
    v10/v9 regression witness.  Path access below is metadata-only identity
    comparison; no predecessor source is reopened by pathname.
    """
    def __init__(self) -> None:
        ...
        need(_INCIDENT_AUTHORITY_WITNESS is None,
             "single inherited exact10 incident-authority hold per process")
        ...
        self.files: list[HeldInheritedFileView] = []
        ...
        for env_name, path, file_pin in INCIDENT_AUTHORITY_INHERITED_EXACT10:
            text = os.environ.get(env_name)
            need(isinstance(text, str) and text.isdecimal(),
                 "exact inherited incident fd environment:" + env_name)
            inherited_fd = int(text)
            need(inherited_fd >= 0,
                 "nonnegative inherited incident fd:" + env_name)
            ...
            try:
                ...
                need(stat.S_ISREG(before.st_mode) and
                     ...
                     "inherited incident fd/path identity/mount/mode:" + env_name)
                ...
                need(sha(raw) == file_pin and
                     ...
                     "inherited incident fd same-view pinned read:" + env_name)
            except BaseException:
                os.close(descriptor)
                raise
            identities.add((before.st_dev, before.st_ino))
            mount_ids.add(mount_id)
            self.files.append(HeldInheritedFileView(
                env_name, path, file_pin, descriptor, before, mount_id, raw))
        need(len(self.files) == len(identities) == 10 and len(mount_ids) == 1,
             "inherited incident exact10 unique identities on one mount")
        ...
        verify_object(rejection, "inherited v11 official rejection",
                      V11_OFFICIAL_REJECTION_OBJECT_PIN)
        need(set(rejection) and len(rejection) == 52 and
        ...
        need(self.v12_shape_incident == V12_V5_REJECTION_SHAPE_INCIDENT,
             "consumer inherited exact10 reproduces v12 shape incident")
    ...
    def _hold_and_validate_v12_predecessor(self) -> None:
        ...
        need(self.v11_rejection_namespace.mount_id in set(mount_by_path.values()),
             "published v12 exact10/v11 singleton same mount")
    ...
    def terminal_replay(self) -> None:
        for item in self.files:
            ...
            need(raw == item.raw and sha(raw) == item.file_sha256 and
                 ...
                 "inherited incident fd terminal same-view replay:" +
                 item.env_name)
    ...
    def close(self) -> None:
        ...
        if failures:
            raise Reject("inherited incident exact10 close:" + "|".join(failures))
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v13-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def terminal_replay_v12_published_exact10() -> None:
    need(isinstance(_INCIDENT_AUTHORITY_HOLD,
                    HeldInheritedIncidentAuthorityExact10),
         "published v12 exact10 remains continuously inherited and held")
    _INCIDENT_AUTHORITY_HOLD.terminal_replay()


def held_v12_official_rejection(
        policy_guard: HeldInputSet) -> HeldPinnedInput:
    matches = [item for item in policy_guard.files
               if item.path == V12_OFFICIAL_REJECTION]
    namespace_matches = [item for item in policy_guard.directories
                         if item.path == V12_OFFICIAL_REJECTION.parent]
    need(len(matches) == 1 and len(namespace_matches) == 1 and
         namespace_matches[0].names == {V12_OFFICIAL_REJECTION.name},
         "official v12 rejection comes from current-policy exact singleton")
    return matches[0]
...
def exact_v12_official_rejection(
        policy_guard: HeldInputSet) -> tuple[dict[str, Any], HeldPinnedInput]:
    receipt_guard = held_v12_official_rejection(policy_guard)
...
def validate_v12_published_then_rejected_predecessor(
        policy_guard: HeldInputSet) -> dict[str, Any]:
    need(isinstance(_INCIDENT_AUTHORITY_HOLD,
                    HeldInheritedIncidentAuthorityExact10),
         "v12 predecessor exact10 remains held from inherited launch authority")
    hold = _INCIDENT_AUTHORITY_HOLD
    _, rejection_guard = exact_v12_official_rejection(policy_guard)
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V12_OFFICIAL_REJECTION,
             V12_TO_V13_TRANSITION, STATIC_AUDIT_V13,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v13 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v13 schema root is cold-launched wrapper over zero-credit inner composite")
    ...
    need(isinstance(_INCIDENT_AUTHORITY_HOLD,
                    HeldInheritedIncidentAuthorityExact10),
         "v12 predecessor remains held during full history identity closure")
    v12_predecessor_identities = \
        _INCIDENT_AUTHORITY_HOLD.v12_exact10_identities()
    v12_predecessor_mount_ids = \
        _INCIDENT_AUTHORITY_HOLD.v12_exact10_mount_ids()
    ...
    # rejection is shared by v11/v10; v11 rejection is shared by the current
    # held v12 predecessor; v12 rejection is current policy's first member.
    need(len(current_policy_identities) == 10 and
         len(v12_predecessor_identities) == 10 and
         len(predecessor_identities) == 98 and
         current_policy_identities.isdisjoint(predecessor_identities) and
         len(current_policy_identities | predecessor_identities) == 108 and
         len({item.mount_id for item in policy_guard.files} |
             ...
             {item.mount_id for item in v11_source_metadata} |
             v12_predecessor_mount_ids) == 1,
         "current v13 exact10 plus v3/v4/v5/v6/v7/v8/v9/v10/v11/v12 "
         "predecessor exact identities close as exact108 on one mount")
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
             ...
             "current_v13_producer_source_content_opened_or_read",
             "current_v13_producer_source_content_imported_compiled_or_executed",
         ...
         registry["published_then_officially_rejected_predecessor_v11"] ==
             expected["published_then_officially_rejected_predecessor_v11"] and
         ...
         registry["append_only_history_unique_file_identity_count"] == 108 and
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v12_to_v13_transition_receipt", "static_audit_v13", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v12_to_v13_transition_receipt", {}).get("path") ==
             str(V12_TO_V13_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v12_to_v13_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v12_to_v13_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v13", {}).get("path") ==
             str(STATIC_AUDIT_V13.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v13", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v13", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
         ...
         registry["current_v13_producer_source_content_opened_or_read"] is False and
         registry["current_v13_producer_source_content_imported_compiled_or_executed"] is False and
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V13__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            ...
            "official v12 rejection shared with predecessor", 0o444,
            V12_OFFICIAL_REJECTION_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v13 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v13 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V12_TO_V13_TRANSITION,
            "post-source v12-to-v13 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V13, "post-source v13 static audit", 0o444),
        ...
        0o555, 2, "official v12 rejection exact singleton namespace")])
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v13 contract", CONTRACT_OBJECT_PIN)
    need(set(contract) == {
    ...
    expected_paths = {
        ...
        "v13_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v13_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v13-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v13-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    need(published_v11 == _expected_published_then_rejected_v11_proof() and
         ...
         contract.get("v11_dual_validator_divergence_incident") ==
             V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT,
         "contract exact v11 divergence, rejection, and per-clause witness binding")
    bundle = contract.get("v13_bundle")
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v12_to_v13_transition_path") ==
             str(V12_TO_V13_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V13.relative_to(ROOT)),
         "contract exact acyclic v13 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    """Fail closed on every final v13 dual-static-audit acceptance field.
    ...
    need(set(audit) == {
             ...
             "effective_checkpoint_object_sha256", "audited_v13_bundle",
    ...
    need(set(dual) == {
         ...
         }, "final v13 static audit dual-checker exact15 closure")
    ...
    need(isinstance(checker_a, dict) and set(checker_a) == {
         ...
         }, "final v13 checker A/B/C and helper-consensus exact object closures")
    ...
    need(helper_consensus == {
         ...
         digest(expected_helper_callsites) ==
             "69979c91172f95d179e5af986d4f8d2d5406ffcfdc14abaef1f1578766c1963d",
         "final v13 exact three-helper AST/key-order/callsite consensus")
    need(checker_a.get("algorithm") ==
         ...
         "final v13 checker A/B/C algorithms and exact GO statuses")
    ...
    need(isinstance(input_a, dict) and isinstance(input_b, dict) and
         ...
         len(input_keys) == 44 and input_a == input_b and
         tuple(input_a) == STATIC_AUDIT_INPUT_EXACT44 and
         tuple(input_b) == STATIC_AUDIT_INPUT_EXACT44 and
         sha(canonical(list(STATIC_AUDIT_INPUT_EXACT44))) ==
             STATIC_AUDIT_INPUT_EXACT44_ORDER_SHA256 and
         _nonzero_sha256(input_a.get("launcher_template")),
         "final v13 checker A/B exact44 ordered identical input-pin closure")
    expected_inputs = {
    ...
    need(tuple(expected_inputs) == STATIC_AUDIT_INPUT_EXACT44 and
         input_a == expected_inputs and
         all(_nonzero_sha256(value) for value in input_a.values()),
         "final v13 checker inputs pin exact current core and append-only history")
    ...
    need(_nonzero_sha256(normalized_a) and
         ...
         "final v13 three-way normalized and B/C common-callsite consensus")
    ...
    need(isinstance(kind_census, dict) and set(kind_census) == {
         ...
         "final v13 checker C exact common-callsite kind census")
    need(type(checker_a.get("wider_local_callsite_census_row_count")) is int and
         ...
         "final v13 checker A positive census and three-file in-memory compile")
    need(type(checker_a.get("arity_failure_count")) is int and
         ...
         "final v13 checker A zero arity/undefined/duplicate/failed counts")
    for key in (
    ...
    need(type(dual.get("independent_pin_normalizer_count")) is int and
         ...
         "final v13 dual exact 3/2 checker counts and type-exact consensuses")
    ...
    need(set(sealed) == {
         ...
         "final v13 exact16 sealed-exec/current-producer/inherited-incident policy")
    ...
    need(set(acceptance) == {
         ...
         "final v13 audit acceptance exact10 type-exact zero-runtime closure")
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v13 contract")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v13 closed schema")
    transition = strict_json(
        by_path[V12_TO_V13_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V13].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        v6_guard, v5_guard, v5_source_metadata)
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        v7_guard, v6_guard, v6_source_metadata)
    ...
    transition_file_sha256 = sha(by_path[V12_TO_V13_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V13].raw)
    ...
    need(isinstance(successor, dict) and isinstance(successor_consumer, dict) and
         ...
         "transition exact bundle/v3/v4/v5/v6/v7/v8/v9/v10/v11/v12 predecessor objects")
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V12_TO_V13_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v13_path", "contract",
             "draft_pin_sentinels_remain_present",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v13_path",
         ...
         transition_v12 == _expected_published_then_rejected_v12_proof(),
         "transition pins current bundle and append-only "
         "v3/v4/v5/v6/v7/v8/v9/v10/v11/v12 predecessors")
    audited = audit.get("audited_v13_bundle")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         ...
         audited.get("v12_to_v13_transition_receipt", {}).get("path") ==
             str(V12_TO_V13_TRANSITION.relative_to(ROOT)) and
         audited.get("v12_to_v13_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v12_to_v13_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        {"file_sha256": V12_OFFICIAL_REJECTION_FILE_PIN,
         "entry_name": str(V12_OFFICIAL_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V12_TO_V13_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V13.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V12_TO_V13_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V13])
    ...
    v8_rejection_identity["object_sha256"] = \
        V8_OFFICIAL_REJECTION_OBJECT_PIN
    v12_rejection_identity = _one_identity(
        held_v12_official_rejection(policy_guard))
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v12_to_v13_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v12_to_v13_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v12_to_v13_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "current_exact8_first_member_is_shared_v12_official_rejection":
            cold_manifest[0] == {
                "file_sha256": V12_OFFICIAL_REJECTION_FILE_PIN,
                "entry_name": str(V12_OFFICIAL_REJECTION.relative_to(ROOT))} and
            transition_v4.get("ordered_provisional_exact8") ==
                v4_supersession["frozen_v4_provisional_exact8"]["ordered_members"],
        ...
        "historical_rejection_exact_keyset_witness_validated":
            audit.get("historical_rejection_exact_keyset_witness") ==
                list(HISTORICAL_REJECTION_EXACT_KEYSET_WITNESS) and
            audit.get("dual_independent_static_checkers", {}).get(
                "checker_A", {}).get("input_sha256", {}).get(
                    "historical_rejection_exact_keyset_witness_sha256") ==
                digest(list(HISTORICAL_REJECTION_EXACT_KEYSET_WITNESS)),
        "append_only_history_unique_file_identity_count": 108,
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V12_TO_V13_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V13].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "historical_rejection_exact_keyset_witness",
        "append_only_history_unique_file_identity_count",
        "v12_to_v13_transition_identity", "static_audit_identity",
        ...
        proof.get("historical_rejection_exact_keyset_witness") ==
            list(HISTORICAL_REJECTION_EXACT_KEYSET_WITNESS) and
        proof.get("append_only_history_unique_file_identity_count") == 108 and
        proof.get("v7_publication_lock_continuity_incident") ==
            _validated_v7_publication_lock_continuity_incident() and
        proof.get("v12_to_v13_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V13__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V13_PRESEAL_ROOT_V2",
    }
    ...
    need(freeze_proof[
             "published_then_officially_rejected_predecessor_v11"] ==
             _expected_published_then_rejected_v11_proof(),
         "preseal binds exact dual-validator-divergence-and-rejected v11 predecessor")
    ...
    body["preseal_root_sha256"] = sha(
        b"CM2_C79G_V13_PRESEAL_ROOT_V2" +
...
def independent_consumer_proof(
    ...
    return close_object({
        ...
        "consumer_exec_bytes_equal_installed_source_bytes":
            ...
            self_guard.exec_file_sha256 == self_guard.file_sha256,
        "consumer_exec_and_installed_source_terminal_replayed": True,
        "current_v13_producer_source_content_opened_read_decoded_parsed_compiled_imported_or_executed": False,
        "frozen_predecessor_incident_source_exact10_held_fd_bytes_read_only_noncredit": True,
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "published_then_officially_rejected_predecessor_v11": copy.deepcopy(
            freeze_proof[
                "published_then_officially_rejected_predecessor_v11"]),
        "v12_to_v13_transition_file_sha256":
            freeze_proof["v12_to_v13_transition_identity"]["file_sha256"],
        "v12_to_v13_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v12_to_v13_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v12_to_v13_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v12_to_v13_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V13_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V13_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v12_to_v13_transition_file_sha256") ==
             freeze_proof.get("v12_to_v13_transition_identity", {}).get("file_sha256") and
         seal.get("v12_to_v13_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
         ...
         consumer_proof.get("consumer_SELF_identity", {}).get("path") ==
             str(SELF.relative_to(ROOT)) and
         consumer_proof.get(
             "current_v13_producer_source_content_opened_read_decoded_parsed_compiled_imported_or_executed") is False and
         consumer_proof.get(
             "frozen_predecessor_incident_source_exact10_held_fd_bytes_read_only_noncredit") is True and
         consumer_proof.get(
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V13_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v13 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v13 rejection")
            verify_object(value, "permanent C79g v13 rejection")
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v13 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v13 authority seal")
            verify_object(seal, "C79g v13 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v7_publication_lock_continuity_incident") ==
                     _validated_v7_publication_lock_continuity_incident() and
                 seal.get("v12_to_v13_transition_file_sha256") ==
                     freeze_proof["v12_to_v13_transition_identity"]["file_sha256"] and
                 seal.get("v12_to_v13_transition_object_sha256") ==
...
def main(argv: list[str] | None = None) -> int:
    ...
    incident_guard: HeldInheritedIncidentAuthorityExact10 | None = None
    ...
    try:
        self_guard = HeldSelf()
        incident_guard = HeldInheritedIncidentAuthorityExact10()
        producer_guard = HeldOpaqueMetadata(
