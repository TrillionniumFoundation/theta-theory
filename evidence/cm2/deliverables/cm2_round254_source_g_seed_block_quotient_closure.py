#!/usr/bin/env python3
"""Close repeated known-block seeds and assign compatible Round208 rows."""
...
OUTPUT = HERE / "cm2_round254_source_g_seed_block_quotient_closure_certificate.json"
SCHEMA = "cm2.round254.source-g-seed-block-quotient-closure.v1"
PINS = {
