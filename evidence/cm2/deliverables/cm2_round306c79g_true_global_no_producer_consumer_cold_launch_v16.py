#!/usr/bin/env python3
"""Externally pinned cold launcher for the C79g v16 exact10 static bundle.
...
CHECKPOINT_OBJECT_PIN = CHECKPOINT
...
# credit into v16.  Runtime consumers must supply these bytes from distinct
...
V14_OFFICIAL_REJECTION_RELATIVE_PATH = (
    ".cm2-runtime/c79g-v14-rejections-" + CHECKPOINT_OBJECT_PIN +
    "/rejection.json")
...
V14_EXACT10_FD_ENV_ORDER = tuple(
    (role, "CM2_C79G_V16_V14_" + role.upper() + "_FD")
    for role, _, _, _ in V14_PUBLISHED_EXACT10_WITNESS)
V14_OFFICIAL_REJECTION_FD_ENV = "CM2_C79G_V16_V14_OFFICIAL_REJECTION_FD"
V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_FD_ENV = (
    "CM2_C79G_V16_V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_FD")
...
V16_BOOTSTRAP_DESCRIPTOR_COUNT = 4
V16_CHILD_AUTHORITY_DESCRIPTOR_COUNT = 12
V16_CHILD_PASS_FD_COUNT = 16
V14_RUNTIME_REGISTRY_SHAPE_DRIFT_INCIDENT = {
    ...
    "v14_credit_may_transfer_to_v16": False,
}
BASE = "cm2_round306c79g_true_global_no_producer_consumer"
LAUNCHER_RELATIVE = Path("deliverables") / (BASE + "_cold_launch_v16.py")
...
ROOT = Path("/__C79G_V16_UNCONFIGURED_ROOT__")
...
V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT = (
    ROOT / "__unconfigured_v14_registry_shape_drift_supersession_receipt__")
V16_REJECTION_NAMESPACE = ROOT / "__unconfigured_v16_rejections__"
V16_LATER_REJECTION = V16_REJECTION_NAMESPACE / "rejection.json"
...
# Cross-source incident helpers deliberately use the producer/consumer names
# so their normalized ASTs are byte-identical across all three executables.
...
V12_V5_REJECTION_SHAPE_INCIDENT = {
    ...
    "v12_official_rejection_file_sha256": V12_REJECTION_FILE_PIN,
    "v12_official_rejection_object_sha256": V12_REJECTION_OBJECT_PIN,
...
V16_LATER_REJECTION_EXACT56_KEYSET_SHA256 = (
    "9c272f16d92497a7c5ced499e9e42c514b81cbfddcdb3f79c4f33837836e057e")
V8_LAUNCHER_FILE_PIN = (
    "169866df2d418c3ccb467ef2b678d322584910500cdeee9dd2b40d8564de3d1e")
V8_LAUNCHER_REGRESSION_DEFECT: dict[str, Any] = {
    "D02_started": False,
    "D02_unlock": False,
    "actual_guard_identity_census": 3,
    "authority_uses_source_locations": False,
    "candidate_surface_count": 0,
    "child_process_started": False,
    "callsite_owner": "HeldV6PredecessorExact10.__init__",
    "diagnostic_source_lines": [2041, 2062, 2235],
    "formal_global_closure_credit": 0,
    "frozen_v8_launcher_file_sha256": V8_LAUNCHER_FILE_PIN,
    "helper": "v6_held_self_identity_defect_regression",
    "old_global_count_expectation": 1,
    "prechild_constructor_subprocess_call_count": 0,
    "official_rejection_file_sha256": V8_REJECTION_FILE_PIN,
    "official_rejection_object_sha256": V8_REJECTION_OBJECT_PIN,
    "regression_authority": (
        "UNIQUE_STRUCTURAL_COMPREHENSION_WITH_ITERABLE_CURRENT_COLD_TEN_GUARDS_"
        "AND_ELT_GUARD_IDENTITY"),
    "schema": (
        "cm2.round306c79g.true-global-no-producer-consumer."
        "v8-launcher-regression-defect.v1"),
    "v8_execution_allowed": False,
    "v8_formal_credit_transferred": False,
}
V8_ROLLOUT_CONTROL_FLOW_INCIDENT: dict[str, Any] = {
    "schema": (
        "cm2.round306c79g.true-global-no-producer-consumer."
...
V9_V6_PROOF_SHAPE_DRIFT_INCIDENT: dict[str, Any] = {
    "schema": (
        "cm2.round306c79g.true-global-no-producer-consumer."
...
V10_REGRESSION_LABEL_PREFIX_INCIDENT: dict[str, Any] = {
    "schema": (
        "cm2.round306c79g.true-global-no-producer-consumer."
        "v10-regression-label-prefix-incident.v1"),
    "incident_id": "V10_PRODUCER_V9_REGRESSION_LABEL_PREFIX_COLON_MISMATCH",
    "evidence_source": (
        "FROZEN_V10_PRODUCER_AST_CONTROL_FLOW_AND_FIRST_BUILD_A_STDERR"),
    "authority_source": (
        "AST_STRUCTURE_AND_EXACT_PREFIX_JOIN__NOT_RAW_WHOLE_TREE_STRING_"
        "EQUALITY"),
    "producer_source_path": (
        "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v10.py"),
    "producer_source_file_sha256": V10_PRODUCER_FILE_PIN,
    ...
    "first_orientation": "a",
    "inner_stderr_line": (
        "REJECT: frozen v9 launcher statically embeds structural16 in exact "
        "equality gate"),
    ...
    "failure_occurs_before_candidate_or_stage_creation": True,
    "required_successor_fix": (
        "MATCH_COLON_PREFIX_BY_AST_STRUCTURE_AND_EXACT_PREFIX_JOIN__NEVER_RAW_"
        "WHOLE_TREE_LITERAL_MEMBERSHIP"),
    "formal_global_closure_credit": 0,
    "D02_unlock": False,
    "D02_started": False,
}

# v11 was fully and correctly cold-published, then its first build/A child
# rejected before any candidate or hidden stage existed.  The frozen launcher
# holds a 44-key V10 incident while the frozen producer embeds a 45-key variant
# (the extra key is ``source_locations_are_diagnostic_not_authority``) but still
# carries a 44-key count claim.  Because the child persisted only one composite
# failure label, no individual false conjunct may be asserted retrospectively.
V11_FIRST_RUNTIME_ATTEMPT: dict[str, Any] = {
    "attempted": True,
    "producer_child_spawned": True,
    "candidate_write_started": False,
    "candidate_or_stage_created": False,
...
V11_FIRST_RUNTIME_ATTEMPT_DIGEST = (
...
V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT: dict[str, Any] = {
    "schema": (
        "cm2.round306c79g.true-global-no-producer-consumer."
    ...
    "v11_producer_source_file_sha256": V11_PRODUCER_FILE_PIN,
    "v11_launcher_source_path": (
        "deliverables/cm2_round306c79g_true_global_no_producer_consumer_"
        "cold_launch_v11.py"),
    "v11_launcher_source_file_sha256": V11_LAUNCHER_FILE_PIN,
    "v11_official_rejection_file_sha256": V11_REJECTION_FILE_PIN,
    "v11_official_rejection_object_sha256": V11_REJECTION_OBJECT_PIN,
    "first_command": "build",
    "first_orientation": "a",
    "producer_child_spawned": True,
    "candidate_write_started": False,
    ...
    "v10_colon_prefix_witness_object_sha256":
        V10_COLON_PREFIX_WITNESS_OBJECT_PIN,
    "v10_colon_prefix_witness_key_count":
        V10_COLON_PREFIX_WITNESS_KEY_COUNT,
    "v10_colon_prefix_witness_successor_clause_truth_vector":
        V10_COLON_PREFIX_WITNESS_SUCCESSOR_TRUTH_VECTOR,
...
V7_LOCK_CONTINUITY_INCIDENT: dict[str, Any] = {
    ...
    "official_rejection_file_sha256": V7_REJECTION_FILE_PIN,
    "official_rejection_object_sha256": V7_REJECTION_OBJECT_PIN,
...
V6_NORMALIZED_AST_SHA256 = (
    "1b4ddb88cb5ac48548ac2bcad3e4d13f93bf41e40d9905c3647e4c56ce09fe48")
V6_TARGET_IDENTITY_COMPREHENSION_AST_SHA256 = (
    "a7fb9f5f32fd3fbf06a7fafce3643c003e2f90a2b5be42872838e11da4f20b6c")
...
def configure_workspace_paths(root: Path) -> None:
    ...
    global V16_REJECTION_NAMESPACE
    global V16_LATER_REJECTION, SCHEMA, CONTRACT, PRODUCER, CONSUMER
    ...
    V6_OFFICIAL_REJECTION = RUNTIME / (
        "c79g-v6-rejections-" + CHECKPOINT + "/rejection.json")
    V7_OFFICIAL_REJECTION = RUNTIME / (
        "c79g-v7-rejections-" + CHECKPOINT + "/rejection.json")
    V8_OFFICIAL_REJECTION = RUNTIME / (
        "c79g-v8-rejections-" + CHECKPOINT + "/rejection.json")
    V9_OFFICIAL_REJECTION = RUNTIME / (
        "c79g-v9-rejections-" + CHECKPOINT + "/rejection.json")
    V10_OFFICIAL_REJECTION = RUNTIME / (
        "c79g-v10-rejections-" + CHECKPOINT + "/rejection.json")
    V11_OFFICIAL_REJECTION = RUNTIME / (
        "c79g-v11-rejections-" + CHECKPOINT + "/rejection.json")
    V12_OFFICIAL_REJECTION = RUNTIME / (
        "c79g-v12-rejections-" + CHECKPOINT + "/rejection.json")
    V13_SUPERSESSION_RECEIPT = OUT / (
        BASE + "_v13_prepublication_pyc_contamination_rejection_"
        "supersession_receipt_v1.json")
    V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT = OUT / (
        BASE + "_v14_runtime_registry_shape_drift_rejection_"
        "supersession_receipt_v1.json")
    V13_FROZEN_PRODUCER = OUT / (BASE + "_v13.py")
    V13_FROZEN_CONSUMER = OUT / (
        BASE + "_independent_verifier_assembler_authority_consumer_v13.py")
    V13_FROZEN_LAUNCHER = OUT / (BASE + "_cold_launch_v13.py")
    V13_FROZEN_PRODUCER_PYC = OUT / "__pycache__" / (
        BASE + "_v13.cpython-312.pyc")
    V13_FROZEN_CONSUMER_PYC = OUT / "__pycache__" / (
        BASE + "_independent_verifier_assembler_authority_consumer_"
        "v13.cpython-312.pyc")
    V13_FROZEN_LAUNCHER_PYC = OUT / "__pycache__" / (
        BASE + "_cold_launch_v13.cpython-312.pyc")
    V16_REJECTION_NAMESPACE = RUNTIME / ("c79g-v16-rejections-" + CHECKPOINT)
    V16_LATER_REJECTION = V16_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / (BASE + "_schema_v16.json")
    CONTRACT = OUT / (BASE + "_contract_v16.json")
    PRODUCER = OUT / (BASE + "_v16.py")
    CONSUMER = OUT / (BASE + "_independent_verifier_assembler_authority_consumer_v16.py")
    TRANSITION = OUT / (BASE + "_v14_to_v16_static_launch_transition_receipt_v1.json")
    AUDIT = OUT / (BASE + "_static_audit_v16.json")
    MANIFEST = OUT / (BASE + "_cold_launch_manifest_v16.sha256")
    OUTER = OUT / (BASE + "_cold_launch_outer_receipt_v16.json")
    BASE7_PINS = {
        # The frozen v14 rejection supersession receipt is the one-way anchor.
        V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT:
            (V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_FILE_PIN,
             V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_OBJECT_PIN),
        # The remaining six entries stay draft sentinels until final injection.
        # The audit binds this launcher through PIN_NORMALIZED AST, not raw bytes.
        SCHEMA: ('ab120abd2d77667388c94e5af00637f843e7af1b48adba95306e1a7ea79e73bd', None),
        CONTRACT: ('292ad598033ff2f89c1d6c502e4e6077df9559688a5885088ad107fa45a7dabf', '9a2ba48cbcb200ff95bf1ca593cd8030ba6bac2b1b8fdc84301d3eb72605bd0e'),
        PRODUCER: ('7b3621bf6579cd9cc9289ed2bda353cbe5f2e32b108ec718bf80a4fd19af125b', None),
        CONSUMER: ('5f988490d014a1427a773b7c5fda03318ec67ad9716a4a75b4008b007e944541', None),
        TRANSITION: ('74c82c804993a6b00196ba5c0b78a3c5067d3242452d61044229f3f04eaf4a7a', '3ead78915247f1a43eaa301d2ebd77d05f790f36530c59deeba677d747bae431'),
        AUDIT: ('69557bc7971a6c9943a5d4cee36895bc47413d9b45d92c56597d5cde83b3ed06', 'b00c87033d9ca880901bac9853709bd60644cc39bc24bc3ec4a05216fba82158'),
    }
    EXACT8 = (V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT,
              SCHEMA, CONTRACT, PRODUCER, CONSUMER, TRANSITION, AUDIT, SELF)
    V3_EXACT10_PINS = (
    ...
    V6_EXACT10_PINS = (
        ...
        (OUT / (BASE + "_independent_verifier_assembler_authority_consumer_v6.py"),
         "af4875d2ab84101b05eff9811f33d8bf7b1a060720a956ae3fb42d8d466f4775", None),
        (OUT / (BASE + "_v5_to_v6_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (BASE + "_static_audit_v6.json"),
    ...
    V6_FORBIDDEN_RUNTIME_PATHS = (
        RUNTIME / ("c79g-v6-candidate-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v6-candidate-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v6-verification-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v6-verification-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v6-committed-completion-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            ("c79g-v6-" + CHECKPOINT + ".seal"),
        RUNTIME / (".c79g-v6-candidate-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v6-candidate-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v6-verification-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v6-verification-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v6-completion-stage-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            (".c79g-v6-authority-stage-" + CHECKPOINT + ".seal"),
    )
    V7_EXACT10_PINS = (
        (V6_OFFICIAL_REJECTION,
         V6_REJECTION_FILE_PIN, V6_REJECTION_OBJECT_PIN),
        (OUT / (BASE + "_schema_v7.json"),
         "edcdbb568044d04fc7c86b4c4e64fdb7b12b3841f1e93092694ebc3177b6fe18", None),
        (OUT / (BASE + "_contract_v7.json"),
        ...
        (OUT / (BASE + "_independent_verifier_assembler_authority_consumer_v7.py"),
         "3ee9f2c666b7297a23faa31d39d5ea66b708d545120b1aeb93f77ac9ef704f8a", None),
        (OUT / (BASE + "_v6_to_v7_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (BASE + "_static_audit_v7.json"),
        ...
        (OUT / (BASE + "_cold_launch_v7.py"),
         "93404ad229728b682018ad236075b6c789e12ee4bf043426049e2aa501b2b9e0", None),
        (OUT / (BASE + "_cold_launch_manifest_v7.sha256"),
         "eeabe5d52504231a6163b0e057e9129b632b8a4c33a18fc3a3ac4576612de80c", None),
        (OUT / (BASE + "_cold_launch_outer_receipt_v7.json"),
         "0a1fc6afe12db5c630b0c73e1fb8280140adb1590c93f176c564e4e24637584e",
         "8214fa50020fed7ea4046d607b1631723f660d18b3f8a2f8653f7444b02a1795"),
    )
    V7_FORBIDDEN_RUNTIME_PATHS = (
        RUNTIME / ("c79g-v7-candidate-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v7-candidate-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v7-verification-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v7-verification-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v7-committed-completion-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            ("c79g-v7-" + CHECKPOINT + ".seal"),
        RUNTIME / (".c79g-v7-candidate-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v7-candidate-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v7-verification-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v7-verification-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v7-completion-stage-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            (".c79g-v7-authority-stage-" + CHECKPOINT + ".seal"),
    )
    V8_EXACT10_PINS = (
        (V7_OFFICIAL_REJECTION,
         V7_REJECTION_FILE_PIN, V7_REJECTION_OBJECT_PIN),
        (OUT / (BASE + "_schema_v8.json"),
         "65904d48296a568d2cd4ec2fc49abe1a7651ca77d4a119a780fc91fb6ddaaeeb",
         None),
        (OUT / (BASE + "_contract_v8.json"),
        ...
        (OUT / (BASE + "_v8.py"),
         ...
         None),
        (OUT / (BASE +
                "_independent_verifier_assembler_authority_consumer_v8.py"),
         "d9c5c56f0ae88b573812c660a64eb94dd345d7efd0257cce975752945e1240f3",
         None),
        (OUT / (BASE +
                "_v7_to_v8_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (BASE + "_static_audit_v8.json"),
        ...
        (OUT / (BASE + "_cold_launch_v8.py"),
         V8_LAUNCHER_FILE_PIN, None),
        (OUT / (BASE + "_cold_launch_manifest_v8.sha256"),
         "ae6e4998d6b347902b3e1ab5256abb6f9ab62d5feabf63a597a28e881068365f",
         None),
        (OUT / (BASE + "_cold_launch_outer_receipt_v8.json"),
    ...
    V8_FORBIDDEN_RUNTIME_PATHS = (
        RUNTIME / ("c79g-v8-candidate-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v8-candidate-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v8-verification-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v8-verification-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v8-committed-completion-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            ("c79g-v8-" + CHECKPOINT + ".seal"),
        RUNTIME / (".c79g-v8-candidate-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v8-candidate-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v8-verification-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v8-verification-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v8-completion-stage-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            (".c79g-v8-authority-stage-" + CHECKPOINT + ".seal"),
    )
    V9_EXACT10_PINS = (
        (V8_OFFICIAL_REJECTION,
         V8_REJECTION_FILE_PIN, V8_REJECTION_OBJECT_PIN),
        (OUT / (BASE + "_schema_v9.json"),
         "2ddd254e43a196bb550fce69552c7f51eae063f4a9b75bc5818099c93335080b",
         None),
        (OUT / (BASE + "_contract_v9.json"),
        ...
        (OUT / (BASE + "_v9.py"),
         ...
         None),
        (OUT / (BASE +
                "_independent_verifier_assembler_authority_consumer_v9.py"),
         "0b38317123f88dc5f065603e51f63171ac0fcd3760de758cd1aa50544f8d3c97",
         None),
        (OUT / (BASE +
                "_v8_to_v9_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (BASE + "_static_audit_v9.json"),
        ...
        (OUT / (BASE + "_cold_launch_v9.py"),
         "f7559ceeb7d491b8489812670392cb63e3cd5f6a2764db469e2dd51d6b5577fa",
         None),
        (OUT / (BASE + "_cold_launch_manifest_v9.sha256"),
         "648f3dce04ca5fdfed8635e0f8c0d21c09404b3799dbfd108e92013fab5392a4",
         None),
        (OUT / (BASE + "_cold_launch_outer_receipt_v9.json"),
    ...
    V9_FORBIDDEN_RUNTIME_PATHS = (
        RUNTIME / ("c79g-v9-candidate-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v9-candidate-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v9-verification-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v9-verification-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v9-committed-completion-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            ("c79g-v9-" + CHECKPOINT + ".seal"),
        RUNTIME / (".c79g-v9-candidate-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v9-candidate-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v9-verification-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v9-verification-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v9-completion-stage-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            (".c79g-v9-authority-stage-" + CHECKPOINT + ".seal"),
    )
    V10_EXACT10_PINS = (
        (V9_OFFICIAL_REJECTION,
         V9_REJECTION_FILE_PIN, V9_REJECTION_OBJECT_PIN),
        (OUT / (BASE + "_schema_v10.json"),
         "a42dc06e276cc9206b29ec22df74ac7f8d76a4afb1de30115d048e1f7ce52801",
         None),
        (OUT / (BASE + "_contract_v10.json"),
        ...
        (OUT / (BASE + "_v10.py"), V10_PRODUCER_FILE_PIN, None),
        (OUT / (BASE +
                "_independent_verifier_assembler_authority_consumer_v10.py"),
         "3a72bba8930f15a66fa1111c76b9c3b6b2b9a2d21db32093d64d0c68a9f6d708",
         None),
        (OUT / (BASE +
                "_v9_to_v10_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (BASE + "_static_audit_v10.json"),
        ...
        (OUT / (BASE + "_cold_launch_v10.py"), V10_LAUNCHER_FILE_PIN, None),
        (OUT / (BASE + "_cold_launch_manifest_v10.sha256"),
         "bead6e9e1c53478c874612f00cae6cab1add14069d41b71b4310eb9b46b958db",
         None),
        (OUT / (BASE + "_cold_launch_outer_receipt_v10.json"),
    ...
    V10_FORBIDDEN_RUNTIME_PATHS = (
        RUNTIME / ("c79g-v10-candidate-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v10-candidate-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v10-verification-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v10-verification-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v10-committed-completion-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            ("c79g-v10-" + CHECKPOINT + ".seal"),
        RUNTIME / (".c79g-v10-candidate-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v10-candidate-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v10-verification-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v10-verification-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v10-completion-stage-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            (".c79g-v10-authority-stage-" + CHECKPOINT + ".seal"),
    )
    V11_EXACT10_PINS = (
        (V10_OFFICIAL_REJECTION,
         V10_REJECTION_FILE_PIN, V10_REJECTION_OBJECT_PIN),
        (OUT / (BASE + "_schema_v11.json"),
         "cf1630e3ab1b590876c663b8752d702eae5fe37b7bdbcc7824efbd03bbdbd8e2",
         None),
        (OUT / (BASE + "_contract_v11.json"),
        ...
        (OUT / (BASE + "_v11.py"), V11_PRODUCER_FILE_PIN, None),
        (OUT / (BASE +
                "_independent_verifier_assembler_authority_consumer_v11.py"),
         "d8ad069e3486b9d657e4840e504885bf13129050f68e6cc04e47b71f149370ec",
         None),
        (OUT / (BASE +
                "_v10_to_v11_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (BASE + "_static_audit_v11.json"),
        ...
        (OUT / (BASE + "_cold_launch_v11.py"), V11_LAUNCHER_FILE_PIN, None),
        (OUT / (BASE + "_cold_launch_manifest_v11.sha256"),
         "e27e9b58dbf57a72550da701589819dad7ebb01f6b3c649a56b701c99ef13135",
         None),
        (OUT / (BASE + "_cold_launch_outer_receipt_v11.json"),
    ...
    V11_FORBIDDEN_RUNTIME_PATHS = (
        RUNTIME / ("c79g-v11-candidate-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v11-candidate-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v11-verification-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v11-verification-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v11-committed-completion-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            ("c79g-v11-" + CHECKPOINT + ".seal"),
        RUNTIME / (".c79g-v11-candidate-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v11-candidate-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v11-verification-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v11-verification-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v11-completion-stage-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            (".c79g-v11-authority-stage-" + CHECKPOINT + ".seal"),
    )
    V12_EXACT10_PINS = (
        (V11_OFFICIAL_REJECTION,
         V11_REJECTION_FILE_PIN, V11_REJECTION_OBJECT_PIN),
        (OUT / (BASE + "_schema_v12.json"),
         "5ed911a55e8f90e750fdcaf6ab4fb6c9683bebaf66a4d6250329dff98acb2e28", None),
        (OUT / (BASE + "_contract_v12.json"),
        ...
        (OUT / (BASE +
                "_independent_verifier_assembler_authority_consumer_v12.py"),
         "b74dee738257d485e9ca3357d7d138b5175b95e58f1c8ea87d1eca7bfc96b2ed", None),
        (OUT / (BASE +
                "_v11_to_v12_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (BASE + "_static_audit_v12.json"),
    ...
    V12_FORBIDDEN_RUNTIME_PATHS = (
        RUNTIME / ("c79g-v12-candidate-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v12-candidate-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v12-verification-a-" + CHECKPOINT),
        RUNTIME / ("c79g-v12-verification-b-" + CHECKPOINT),
        RUNTIME / ("c79g-v12-committed-completion-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            ("c79g-v12-" + CHECKPOINT + ".seal"),
        RUNTIME / (".c79g-v12-candidate-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v12-candidate-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v12-verification-stage-a-" + CHECKPOINT),
        RUNTIME / (".c79g-v12-verification-stage-b-" + CHECKPOINT),
        RUNTIME / (".c79g-v12-completion-stage-" + CHECKPOINT),
        RUNTIME / "cm2-global-authority-heads" /
            (".c79g-v12-authority-stage-" + CHECKPOINT + ".seal"),
    )
INNER_SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v16.inner-composite"
COLD_ROOT_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v16."
    "cold-launched-committed-authority"
)
COLD_ROOT_DOMAIN = b"CM2_C79G_V16_COLD_LAUNCHED_AUTHORITY_ROOT_V1\0"
LIVE_PROTOCOL = "CM2_C79G_V16_COLD_TWO_PHASE_LIVE_ACK_V1"
LIVE_REQUEST_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v16."
    "cold-live-commit-request"
)
LIVE_ACK_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v16.cold-live-ack"
)
LIVE_RELEASE_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v16.cold-live-release"
)
PREWRAPPER_BODY_DOMAIN = "CM2_C79G_V16_COLD_PREWRAPPER_BODY_V1"
TRANSACTION_BINDING_DOMAIN = "CM2_C79G_V16_COLD_TRANSACTION_BINDING_V1"
LIVE_ACK_BINDING_DOMAIN = "CM2_C79G_V16_COLD_LIVE_ACK_BINDING_V1"
SOURCE_FD_ENV = "CM2_C79G_V16_COLD_SOURCE_FD"
EXEC_FD_ENV = "CM2_C79G_V16_COLD_EXEC_FD"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V16_COORDINATION_PARENT_FD"
WORKSPACE_ROOT_ENV = "CM2_C79G_V16_COLD_WORKSPACE_ROOT"
WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V16_COLD_WORKSPACE_ROOT_FD"
LAUNCHER_SHA_ENV = "CM2_C79G_V16_COLD_LAUNCHER_FILE_SHA256"
HELD_V10_PRODUCER_FD_ENV = "CM2_C79G_V16_V10_PRODUCER_FD"
HELD_V9_LAUNCHER_FD_ENV = "CM2_C79G_V16_V9_LAUNCHER_FD"
HELD_V11_PRODUCER_FD_ENV = "CM2_C79G_V16_V11_PRODUCER_FD"
HELD_V11_LAUNCHER_FD_ENV = "CM2_C79G_V16_V11_LAUNCHER_FD"
HELD_V11_REJECTION_FD_ENV = "CM2_C79G_V16_V11_REJECTION_FD"
HELD_V12_PRODUCER_FD_ENV = "CM2_C79G_V16_V12_PRODUCER_FD"
HELD_V12_CONSUMER_FD_ENV = "CM2_C79G_V16_V12_CONSUMER_FD"
HELD_V12_LAUNCHER_FD_ENV = "CM2_C79G_V16_V12_LAUNCHER_FD"
HELD_V5_REJECTION_FD_ENV = "CM2_C79G_V16_V5_REJECTION_FD"
HELD_V12_REJECTION_FD_ENV = "CM2_C79G_V16_V12_REJECTION_FD"
HELD_V13_PRODUCER_FD_ENV = "CM2_C79G_V16_V13_PRODUCER_FD"
HELD_V13_CONSUMER_FD_ENV = "CM2_C79G_V16_V13_CONSUMER_FD"
HELD_V13_LAUNCHER_FD_ENV = "CM2_C79G_V16_V13_LAUNCHER_FD"
HELD_V13_PRODUCER_PYC_FD_ENV = "CM2_C79G_V16_V13_PRODUCER_PYC_FD"
HELD_V13_CONSUMER_PYC_FD_ENV = "CM2_C79G_V16_V13_CONSUMER_PYC_FD"
HELD_V13_LAUNCHER_PYC_FD_ENV = "CM2_C79G_V16_V13_LAUNCHER_PYC_FD"
HELD_V13_SUPERSESSION_RECEIPT_FD_ENV = (
    "CM2_C79G_V16_V13_SUPERSESSION_RECEIPT_FD")


def v13_inherited_exact16_records() -> list[dict[str, Any]]:
    """Rebuild the receipt's ordered exact16 from independent fixed pins."""
    members = (
        ("v10_producer", V10_EXACT10_PINS[3][0], V10_PRODUCER_FILE_PIN),
        ("v9_launcher", V9_EXACT10_PINS[7][0], V9_EXACT10_PINS[7][1]),
        ("v11_producer", V11_EXACT10_PINS[3][0], V11_PRODUCER_FILE_PIN),
        ("v11_launcher", V11_EXACT10_PINS[7][0], V11_LAUNCHER_FILE_PIN),
        ("v11_rejection", V11_OFFICIAL_REJECTION, V11_REJECTION_FILE_PIN),
        ("v12_producer", V12_EXACT10_PINS[3][0], V12_EXACT10_PINS[3][1]),
        ("v12_consumer", V12_EXACT10_PINS[4][0], V12_EXACT10_PINS[4][1]),
        ("v12_launcher", V12_EXACT10_PINS[7][0], V12_EXACT10_PINS[7][1]),
        ("v5_rejection", V5_OFFICIAL_REJECTION, V5_REJECTION_FILE_PIN),
        ("v12_rejection", V12_OFFICIAL_REJECTION, V12_REJECTION_FILE_PIN),
    ...
    return [
        ...
        for ordinal, (role, path, file_pin) in enumerate(members, start=1)
    ]


def validate_v13_supersession_receipt(
        value: Any, exact6: list[HeldFile] | None = None) -> None:
    """Close the one-way receipt, exact16 table, census and live exact6."""
    need(isinstance(value, dict), "v13 supersession receipt object")
    verify_object(value, "v13 supersession receipt",
                  V13_SUPERSESSION_RECEIPT_OBJECT_PIN)
    exact16 = v13_inherited_exact16_records()
    exact16_raw = canonical(exact16)
    successor = value.get("v16_successor_contract", {})
    ...
    need(value.get("schema") ==
         ...
         value.get("status") ==
             ...
             "REJECTION__V16_SUCCESSOR_ONLY" and
         ...
         successor.get("v16_current_exact8_first_member_must_be_this_receipt")
             is True and
         successor.get("v16_must_preserve_v12_exact10_and_official_rejection")
             is True and
         successor.get("v16_predecessor_unique_live_identity_count") == 105 and
         successor.get("v16_prepublication_unique_live_identity_count") == 113 and
         successor.get("v16_terminal_unique_live_identity_count") == 115 and
         successor.get("v16_terminal_group_vector") ==
             [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 7, 1, 3, 3, 1] and
         inherited.get("v16_must_live_hold_and_terminally_replay_exact16_plus_this_receipt")
             is True,
         "v13 supersession receipt exact16/digest/census closure")
    if exact6 is not None:
        expected = exact16[10:]
        need(len(exact6) == 6 and
             [item.path for item in exact6] ==
                 [ROOT / row["path"] for row in expected] and
             [item.file_sha256 for item in exact6] ==
                 [row["file_sha256"] for row in expected],
             "v13 receipt exact6 equals live held source/pyc order and pins")


def expected_v13_supersession_summary(
    ...
    return {
        ...
        "receipt_status": (
            "FROZEN_APPEND_ONLY_V13_PREPUBLICATION_PYC_CONTAMINATION_"
            "REJECTION__V16_SUCCESSOR_ONLY"),
        "transition_kind": (
            "APPEND_ONLY_V13_PREPUBLICATION_PYC_CONTAMINATION_REJECTION_TO_"
            "ZERO_CREDIT_V16_STATIC_SUCCESSOR"),
        "v16_successor_contract": copy.deepcopy(
            receipt["v16_successor_contract"]),
    }


def validate_v13_supersession_summary(
        value: Any, receipt: Mapping[str, Any], label: str) -> None:
    expected = expected_v13_supersession_summary(receipt)
    need(isinstance(value, dict) and list(value) == list(expected) and
         value == expected and len(value) == 7,
         label + ":exact rejected-prepublication v13 receipt summary")
...
def derive_v12_v5_rejection_shape_incident(
    ...
    expected_hashes = {
        "producer": V12_V5_REJECTION_SHAPE_INCIDENT[
            "v12_producer_source_file_sha256"],
        "consumer": V12_V5_REJECTION_SHAPE_INCIDENT[
            "v12_consumer_source_file_sha256"],
        "launcher": V12_V5_REJECTION_SHAPE_INCIDENT[
            "v12_launcher_source_file_sha256"],
    }
    ...
    for role, raw, label in source_rows:
        ...
        exact39_counts[role] = sum(
            ...
            if isinstance(node, ast.Set) and
               len(node.elts) == 39 and
               all(isinstance(item, ast.Constant) and
                   isinstance(item.value, str) for item in node.elts) and
    ...
    for version, additions, file_pin, object_pin, keyset_digest in \
        ...
        rows.append({
            ...
            "path": ".cm2-runtime/c79g-v" + str(version) + "-rejections-" +
                    CHECKPOINT_OBJECT_PIN + "/rejection.json",
...
def expected_v5_published_rejected_segment() -> dict[str, Any]:
    """Construct the one exact v5 regression shape shared by v16 proofs."""
    names = (
...
def expected_v6_published_rejected_segment() -> dict[str, Any]:
    ...
    ordered: list[dict[str, Any]] = []
    for name, (path, file_pin, object_pin) in zip(
            names, V6_EXACT10_PINS, strict=True):
        member: dict[str, Any] = {
            "name": name,
            "path": str(path.relative_to(ROOT)),
            "file_sha256": file_pin,
    ...
    return {
        ...
        "held_self_identity_defect": {
            "source_path": str(V6_EXACT10_PINS[3][0].relative_to(ROOT)),
            "class_name": "HeldSelf",
            "missing_attribute": "identity",
            "failing_function": "hold_static_freeze_trust",
            "failing_expression": (
...
def validate_v6_published_rejected_segment(value: Any, label: str) -> None:
    ...
    need(isinstance(value, dict) and set(value) == set(expected) and
         value == expected,
         label + ":exact v6 exact10, rejection, spawned-before-write and "
         "HeldSelf.identity defect regression")
...
def validate_v7_lock_continuity_incident(value: Any, label: str) -> None:
    ...
    need(isinstance(value, dict) and value == V7_LOCK_CONTINUITY_INCIDENT and
         set(value) == set(V7_LOCK_CONTINUITY_INCIDENT),
         label + ":exact 26-key v7 publication-lock incident")
    verify_object(value, label + ":v7 incident",
                  V7_LOCK_CONTINUITY_INCIDENT_OBJECT_PIN)
...
def expected_v7_published_rejected_segment() -> dict[str, Any]:
    ...
    ordered: list[dict[str, Any]] = []
    for name, (path, file_pin, object_pin) in zip(
            names, V7_EXACT10_PINS, strict=True):
        member: dict[str, Any] = {
            "name": name,
            "path": str(path.relative_to(ROOT)),
            "file_sha256": file_pin,
    ...
    return {
        ...
        "official_later_rejection": {
            ...
            "schema": (
                "cm2.round306c79g.true-global-no-producer-consumer.v7."
                "later-rejection"),
            "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
...
def validate_v7_published_rejected_segment(value: Any, label: str) -> None:
    ...
    need(isinstance(value, dict) and set(value) == set(expected) and
         value == expected,
         label + ":exact v7 exact10/rejection/incident zero-credit proof")
    validate_v7_lock_continuity_incident(
        value.get("publication_lock_continuity_incident"), label)
...
def expected_v8_published_rejected_segment() -> dict[str, Any]:
    ...
    ordered: list[dict[str, Any]] = []
    for name, (path, file_pin, object_pin) in zip(
            names, V8_EXACT10_PINS, strict=True):
        member: dict[str, Any] = {
            "name": name,
            "path": str(path.relative_to(ROOT)),
            "file_sha256": file_pin,
    ...
    return {
        ...
        "official_later_rejection": {
            ...
            "file_sha256": V8_REJECTION_FILE_PIN,
            "object_sha256": V8_REJECTION_OBJECT_PIN,
            "schema": (
                "cm2.round306c79g.true-global-no-producer-consumer.v8."
                "later-rejection"),
            "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
        ...
        "rollout_control_flow_incident":
            copy.deepcopy(V8_ROLLOUT_CONTROL_FLOW_INCIDENT),
        "all_ten_file_pins_match": True,
        "all_declared_object_pins_match": True,
        "all_ten_regular_0444_nlink1": True,
        "exact8_manifest_reconstructs_first_eight_in_order": True,
...
def validate_v8_published_rejected_segment(value: Any, label: str) -> None:
    ...
    need(isinstance(value, dict) and set(value) == set(expected) and
         value == expected,
         label + ":exact v8 exact10/rejection/rollout-incident zero-credit proof")
    incident = value.get("rollout_control_flow_incident")
    first = value.get("first_rollout_attempt")
    need(isinstance(incident, dict) and
         incident == V8_ROLLOUT_CONTROL_FLOW_INCIDENT and
         incident.get("regressor_expected_occurrence_count") ==
             V8_LAUNCHER_REGRESSION_DEFECT["old_global_count_expectation"] and
         incident.get("regressor_observed_occurrence_count") ==
             V8_LAUNCHER_REGRESSION_DEFECT["actual_guard_identity_census"] and
         incident.get("positive_runtime_surface_count") ==
             V8_LAUNCHER_REGRESSION_DEFECT["candidate_surface_count"] and
         isinstance(first, dict) and first.get("producer_child_spawned") is False and
         first.get("candidate_write_started") is False and
         value.get("chronology_is_not_control_flow_proof") is True,
         label + ":exact trusted v8 rollout control-flow incident gate")
...
def expected_v9_published_rejected_segment() -> dict[str, Any]:
    ...
    ordered: list[dict[str, Any]] = []
    for name, (path, file_pin, object_pin) in zip(
            names, V9_EXACT10_PINS, strict=True):
        member: dict[str, Any] = {
            "name": name,
            "path": str(path.relative_to(ROOT)),
            "file_sha256": file_pin,
    ...
    return {
        ...
        "official_later_rejection": {
            ...
            "file_sha256": V9_REJECTION_FILE_PIN,
            "object_sha256": V9_REJECTION_OBJECT_PIN,
            "schema": (
                "cm2.round306c79g.true-global-no-producer-consumer.v9."
                "later-rejection"),
            "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
        ...
        "v6_held_self_identity_defect_shape_drift_incident":
            copy.deepcopy(V9_V6_PROOF_SHAPE_DRIFT_INCIDENT),
...
def validate_v9_published_rejected_segment(value: Any, label: str) -> None:
    ...
    need(isinstance(value, dict) and set(value) == set(expected) and
         value == expected,
         label + ":exact v9 exact10/rejection/shape-drift zero-credit proof")
    incident = value.get("v6_held_self_identity_defect_shape_drift_incident")
    need(isinstance(incident, dict) and
         incident == V9_V6_PROOF_SHAPE_DRIFT_INCIDENT and
         len(incident.get("persisted_held_self_identity_defect", {})) == 9 and
         len(incident.get("launcher_expanded_structural_evidence", {})) == 16 and
         incident.get("whole_predecessor_v6_equality_failed_before_child_spawn")
             is True and
         value.get("positive_and_stage_surfaces_absent", {}).get("all_absent")
             is True,
         label + ":exact trusted v9 proof-shape drift incident gate")
...
def expected_v10_published_rejected_segment() -> dict[str, Any]:
    ...
    ordered: list[dict[str, Any]] = []
    for name, (path, file_pin, object_pin) in zip(
            names, V10_EXACT10_PINS, strict=True):
        member: dict[str, Any] = {
            "name": name,
            "path": str(path.relative_to(ROOT)),
            "file_sha256": file_pin,
...
def validate_v10_published_rejected_segment(value: Any, label: str) -> None:
    ...
    need(isinstance(value, dict) and set(value) == set(expected) and
         value == expected,
         label + ":exact v10 exact10/rejection/label-prefix zero-credit proof")
    incident = value.get("regression_label_prefix_incident")
    first = value.get("first_runtime_attempt")
    need(isinstance(incident, dict) and
         incident == V10_REGRESSION_LABEL_PREFIX_INCIDENT and
         len(incident) == 44 and
         incident.get("regression_guard_conjunct_truth_vector") ==
             [True, True, True, True, False, True] and
         incident.get("unique_false_conjunct_zero_based_index") == 4 and
         incident.get("exact_unprefixed_failure_label_literal_count") == 0 and
         incident.get("exact_colon_prefixed_failure_label_literal_count") == 1 and
         isinstance(first, dict) and first.get("producer_child_spawned") is True and
         first.get("candidate_or_stage_created") is False and
         value.get("positive_and_stage_surfaces_absent", {}).get("all_absent")
             is True,
         label + ":exact trusted v10 regression label-prefix incident gate")
...
def expected_v11_published_rejected_segment() -> dict[str, Any]:
    ...
    ordered: list[dict[str, Any]] = []
    for name, (path, file_pin, object_pin) in zip(
            names, V11_EXACT10_PINS, strict=True):
        member: dict[str, Any] = {
            "name": name,
            "path": str(path.relative_to(ROOT)),
            "file_sha256": file_pin,
    ...
    return {
        ...
        "official_later_rejection": {
            ...
            "file_sha256": V11_REJECTION_FILE_PIN,
            "object_sha256": V11_REJECTION_OBJECT_PIN,
            "schema": (
...
def validate_v11_published_rejected_segment(value: Any, label: str) -> None:
    ...
    need(isinstance(value, dict) and list(value) == list(expected) and
         value == expected and len(value) == 19,
         label + ":exact v11 exact10/rejection/dual-validator zero-credit proof")
    incident = value.get("dual_validator_divergence_incident")
    first = value.get("first_runtime_attempt")
    need(isinstance(incident, dict) and list(incident) ==
             list(V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT) and
         incident == V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT and
         len(incident) == 45 and
         incident.get("producer_embedded_v10_incident_key_count_claim") == 44 and
         incident.get("producer_embedded_v10_incident_actual_key_count") == 45 and
         ...
         isinstance(first, dict) and first == V11_FIRST_RUNTIME_ATTEMPT and
         first.get("producer_child_spawned") is True and
         first.get("candidate_or_stage_created") is False and
         value.get("positive_and_stage_surfaces_absent", {}).get("all_absent")
             is True and
         sha_bytes(canonical(first)) == V11_FIRST_RUNTIME_ATTEMPT_DIGEST and
         sha_bytes(canonical(incident)) ==
             V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT_DIGEST,
         label + ":exact trusted v11 44-to-45 dual-validator divergence gate")
...
def expected_v12_published_rejected_segment() -> dict[str, Any]:
    ...
    ordered: list[dict[str, Any]] = []
    for name, (path, file_pin, object_pin) in zip(
            names, V12_EXACT10_PINS, strict=True):
        member: dict[str, Any] = {
            "name": name,
            "path": str(path.relative_to(ROOT)),
            "file_sha256": file_pin,
    ...
    return {
        ...
        "official_later_rejection": {
            ...
            "file_sha256": V12_REJECTION_FILE_PIN,
            "object_sha256": V12_REJECTION_OBJECT_PIN,
            "schema": (
        ...
        "v5_rejection_shape_incident": copy.deepcopy(
            V12_V5_REJECTION_SHAPE_INCIDENT),
        "positive_and_stage_surfaces_absent": {
            "exact_absent_path_count": len(V12_FORBIDDEN_RUNTIME_PATHS),
            "exact_absent_paths": absent,
            "all_absent": True,
        },
        "all_ten_file_pins_match": True,
...
def validate_v12_published_rejected_segment(value: Any, label: str) -> None:
    ...
    need(isinstance(value, dict) and list(value) == list(expected) and
         value == expected and len(value) == 19 and
         value.get("v5_rejection_shape_incident") ==
             V12_V5_REJECTION_SHAPE_INCIDENT,
...
def exact_helper_callsite_census(
    ...
    need([role for role, _ in ordered_sources] == [
             "producer", "consumer", "launcher"],
         "helper callsite exact ordered source roles")
    result: list[dict[str, Any]] = []
    for role, raw in ordered_sources:
        try:
            tree = ast.parse(
                raw.decode("utf-8"), filename="helper_callsites_" + role,
                mode="exec")
        except (UnicodeDecodeError, SyntaxError) as exc:
        ...
        for name in loaded_names:
            ...
            need(isinstance(call, ast.Call) and call.func is name and
                 len(call.args) == 2 and not call.keywords,
                 role + ":helper is used only by exact direct two-argument calls")
            cursor: ast.AST = call
            owner: ast.FunctionDef | ast.AsyncFunctionDef | None = None
            while cursor in parent:
                cursor = parent[cursor]
                need(not isinstance(cursor, ast.Lambda),
                     role + ":helper call not nested in lambda")
                if isinstance(cursor, (ast.FunctionDef, ast.AsyncFunctionDef)):
                    owner = cursor
                    break
            need(owner is not None,
                 role + ":helper call has direct enclosing function")
...
PIN_NORMALIZED_AST_ALGORITHM = (
    ...
    "CURRENT_V16_SIX_BASE7_FILE_F64_OBJECT_E64_OR_NONE__"
...
FINAL_STATIC_AUDIT_TOP_LEVEL_KEY_ORDER = (
    "schema", "status", "audit_path", "effective_checkpoint_object_sha256",
    "audited_v16_bundle", "predecessor_v3_exact10_regression",
...
FINAL_STATIC_AUDIT_STATUS = (
    "PASS_DUAL_STATIC_PIN_NORMALIZED_AST_GO_V16__"
    "PHYSICAL_COLD_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED")
FINAL_STATIC_AUDIT_CHECKER_STATUSES = {
    "checker_A": (
...
FINAL_STATIC_AUDIT_OUTPUT_SHAPES = {
...
def pin_normalized_launcher_ast_sha256(raw: bytes, label: str) -> str:
    ...
    six current-v16 BASE7 values are replaced by fixed draft sentinels.  The
    ...
    for node in tree.body:
        if (isinstance(node, ast.Assign) and len(node.targets) == 1 and
            ...
            flag_assignments.append(node)
    need(len(flag_assignments) == 1,
         label + ":one module FINAL_BASE7_PINS_INSTALLED assignment")
    ...
    need(len(configure_functions) == 1,
    ...
    need(len(base7_assignments) == 1 and
    ...
    need(key_names == expected_key_names and
         len(base7.values) == len(expected_key_names),
         label + ":exact ordered v14-receipt-plus-current-v16 BASE7 key census")
    ...
    for index, key_name in enumerate(key_names[1:], start=1):
        object_sentinel: str | None = (
            "e" * 64 if key_name in PIN_NORMALIZED_OBJECT_BASE7_KEYS else None)
    ...
    need(ast.dump(
         ...
         label + ":v14 rejection-supersession-receipt BASE7 value preserved")
...
def producer_source_registry_shape_from_ast(raw: bytes) -> int:
    ...
    try:
        tree = ast.parse(raw.decode("utf-8"), filename="producer_v16",
                         mode="exec")
    except (UnicodeDecodeError, SyntaxError) as exc:
        raise Reject("current v16 producer registry AST parse") from exc
    ...
    need(len(registry_returns) == 1 and len(proof_returns) == 1,
         "unique current v16 registry/proof return dicts")
    ...
    need(len(explicit_keys) == len(set(explicit_keys)) == 67 and
         ...
         len(proof_dict.keys) == 7 and all(
             isinstance(key, ast.Constant) and isinstance(key.value, str)
             for key in proof_dict.keys),
         "current v16 registry explicit67 plus exact execution-proof7")
    shape = len(explicit_keys) + len(proof_dict.keys) + 1
    need(shape == 75,
         "current v16 producerSourceRegistry exact explicit67 plus "
         "execution-proof7 plus enclosing-object1 equals 75")
    return shape


def _v6_identity_semantic_checker_a(
        hold: ast.FunctionDef | ast.AsyncFunctionDef) -> dict[str, Any]:
    ...
    for node in ast.walk(hold):
        ...
        if (isinstance(generator.target, ast.Name) and
                ...
                generator.iter.id == "current_cold_ten_guards" and
                not generator.ifs and generator.is_async == 0 and
                isinstance(node.elt, ast.Attribute) and
                node.elt.attr == "identity" and
                isinstance(node.elt.value, ast.Name) and
                node.elt.value.id == "guard"):
            targets.append(node)
    target_digests = [
        sha_bytes(ast.dump(
    ...
    self_guard_constructions = [
        node for node in ast.walk(hold)
        if isinstance(node, ast.Assign) and len(node.targets) == 1 and
           isinstance(node.targets[0], ast.Name) and
           node.targets[0].id == "current_cold_ten_guards" and
           isinstance(node.value, ast.List) and
           any(isinstance(element, ast.Name) and element.id == "self_guard"
               for element in node.value.elts)
    ]
    return {
        "guard_identity_structural_census": len(identity_uses),
        "diagnostic_source_lines": sorted(node.lineno for node in identity_uses),
        "current_cold_ten_guards_self_guard_construction_count":
            len(self_guard_constructions),
        "target_count": len(targets),
        "target_ast_sha256": target_digests,
    }


def _v6_identity_semantic_checker_b(
        hold: ast.FunctionDef | ast.AsyncFunctionDef) -> dict[str, Any]:
    ...
    class Visitor(ast.NodeVisitor):
        ...
        def visit_Assign(self, node: ast.Assign) -> None:
            if (len(node.targets) == 1 and
                    ...
                    node.targets[0].id == "current_cold_ten_guards" and
                    isinstance(node.value, ast.List) and
                    any(isinstance(element, ast.Name) and
                        element.id == "self_guard"
                        for element in node.value.elts)):
                self.self_guard_constructions.append(node)
            self.generic_visit(node)

        def visit_Attribute(self, node: ast.Attribute) -> None:
            if (node.attr == "identity" and isinstance(node.value, ast.Name) and
                    node.value.id == "guard"):
        ...
        def visit_SetComp(self, node: ast.SetComp) -> None:
            ...
            required = (
                "elt=Attribute(value=Name(id='guard', ctx=Load()), "
                "attr='identity', ctx=Load())",
                "target=Name(id='guard', ctx=Store())",
                "iter=Name(id='current_cold_ten_guards', ctx=Load())",
                "ifs=[], is_async=0",
            )
    ...
    target_digests = [
        sha_bytes(ast.dump(
            node, annotate_fields=True,
            include_attributes=False).encode("utf-8"))
        for node in visitor.targets
    ]
    return {
        "guard_identity_structural_census": len(visitor.identity_uses),
        "diagnostic_source_lines": sorted(
            node.lineno for node in visitor.identity_uses),
        "current_cold_ten_guards_self_guard_construction_count":
            len(visitor.self_guard_constructions),
        "target_count": len(visitor.targets),
        "target_ast_sha256": target_digests,
    }
...
def v6_held_self_identity_structural_evidence(raw: bytes) -> dict[str, Any]:
    ...
    # The diagnostic line list is reported but is intentionally excluded from
    # checker agreement and from every authority decision below.
    semantic_a = {key: value for key, value in checker_a.items()
                  if key != "diagnostic_source_lines"}
    semantic_b = {key: value for key, value in checker_b.items()
                  if key != "diagnostic_source_lines"}
    need("identity" not in direct_methods and semantic_a == semantic_b and
         semantic_a == {
             "guard_identity_structural_census": 3,
             "current_cold_ten_guards_self_guard_construction_count": 1,
             "target_count": 1,
             "target_ast_sha256": [
                 V6_TARGET_IDENTITY_COMPREHENSION_AST_SHA256],
         } and structural_digest == V6_NORMALIZED_AST_SHA256,
         "frozen v6 HeldSelf.identity structural defect and dual checker")
    evidence = {
        "source_path": str(V6_EXACT10_PINS[3][0].relative_to(ROOT)),
        "class_name": "HeldSelf",
        "missing_attribute": "identity",
        ...
        "source_locations_are_diagnostic_not_authority": True,
        "guard_identity_structural_census":
            checker_a["guard_identity_structural_census"],
        "target_structural_comprehension_count": checker_a["target_count"],
        "target_structural_comprehension_ast_sha256":
            checker_a["target_ast_sha256"][0],
        "normalized_frozen_source_ast_sha256": structural_digest,
        "independent_semantic_checker_count": 2,
        "independent_semantic_checkers_agree": True,
        "deterministic_failure_kind": "AttributeError",
        "failure_occurs_before_candidate_or_stage_creation": True,
    ...
    need(evidence ==
         V9_V6_PROOF_SHAPE_DRIFT_INCIDENT[
             "launcher_expanded_structural_evidence"],
         "frozen v6 exact independent 16-key structural evidence")
    return evidence
...
def v6_held_self_identity_defect_regression(raw: bytes) -> dict[str, Any]:
    ...
    persisted = expected_v6_published_rejected_segment()[
        "held_self_identity_defect"]
    need(len(structural) == 16 and len(persisted) == 9 and
         structural != persisted and
         persisted == V9_V6_PROOF_SHAPE_DRIFT_INCIDENT[
             "persisted_held_self_identity_defect"],
         "v6 structural16 remains separate from canonical persisted9")
    return persisted
...
def v8_launcher_regression_defect_gate(raw: bytes) -> dict[str, Any]:
    ...
    try:
        tree = ast.parse(raw.decode("utf-8"), filename="cold_launcher_v8",
                         mode="exec")
    except (UnicodeDecodeError, SyntaxError) as exc:
    ...
    helper = next(
        (node for node in tree.body
         if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)) and
            node.name == "v6_held_self_identity_defect_regression"), None)
    need(isinstance(helper, (ast.FunctionDef, ast.AsyncFunctionDef)),
         "frozen v8 launcher regression helper definition")
    ...
    for node in ast.walk(helper):
        if (isinstance(node, ast.Compare) and len(node.ops) == 1 and
                ...
                node.left.args[0].id == "failing"):
            old_count_predicates.append(node)
    callsites = [
        node for node in ast.walk(tree)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Name) and
           node.func.id == "v6_held_self_identity_defect_regression"
    ]
    held_v6 = next(
        (node for node in tree.body if isinstance(node, ast.ClassDef) and
         node.name == "HeldV6PredecessorExact10"), None)
    held_v6_init = next(
        (node for node in held_v6.body
         if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)) and
            node.name == "__init__"), None) if isinstance(held_v6, ast.ClassDef) else None
    init_helper_calls = [
        node for node in ast.walk(held_v6_init)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Name) and
           node.func.id == "v6_held_self_identity_defect_regression"
    ] if isinstance(held_v6_init, (ast.FunctionDef, ast.AsyncFunctionDef)) else []
    init_subprocess_calls = [
        node for node in ast.walk(held_v6_init)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Attribute) and
           isinstance(node.func.value, ast.Name) and
           node.func.value.id == "subprocess"
    ] if isinstance(held_v6_init, (ast.FunctionDef, ast.AsyncFunctionDef)) else []
    need(len(old_count_predicates) == 1 and len(callsites) == 1 and
         len(init_helper_calls) == 1 and not init_subprocess_calls and
         sha_bytes(raw) == V8_LAUNCHER_FILE_PIN,
         "frozen v8 launcher old count predicate in prechild held-v6 constructor")
...
def v9_proof_shape_drift_gate(raw: bytes) -> dict[str, Any]:
    ...
    try:
        tree = ast.parse(raw.decode("utf-8"), filename="cold_launcher_v9",
                         mode="exec")
    except (UnicodeDecodeError, SyntaxError) as exc:
        raise Reject("frozen v9 launcher AST parse") from exc
    need(sha_bytes(raw) == V9_EXACT10_PINS[7][1],
         "frozen v9 launcher exact file pin")
    expected_expanded_keys = set(
        V9_V6_PROOF_SHAPE_DRIFT_INCIDENT[
            "launcher_expanded_structural_evidence"])
    ...
    helper = next(
        (node for node in tree.body
         if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)) and
            node.name == "v6_held_self_identity_defect_regression"), None)
    helper_expected_calls = [
        node for node in ast.walk(helper)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Name) and
           node.func.id == "expected_v6_published_rejected_segment"
    ] if isinstance(helper, (ast.FunctionDef, ast.AsyncFunctionDef)) else []
    validator = next(
        (node for node in tree.body
         if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)) and
    ...
    ] if isinstance(validator, (ast.FunctionDef, ast.AsyncFunctionDef)) else []
    held_v6 = next(
        (node for node in tree.body if isinstance(node, ast.ClassDef) and
         node.name == "HeldV6PredecessorExact10"), None)
    held_v6_init = next(
    ...
    need(len(expanded_dicts) == 1 and len(helper_expected_calls) == 1 and
         isinstance(validator, (ast.FunctionDef, ast.AsyncFunctionDef)) and
         bool(equality_tests) and not subprocess_calls and
         len(expected_v6_published_rejected_segment()[
             "held_self_identity_defect"]) == 9,
         "frozen v9 expanded16 equality gate precedes every child spawn")
...
def validate_v11_dual_validator_divergence(
        producer_v11_raw: bytes, launcher_v11_raw: bytes,
        colon_witness: Mapping[str, Any]) -> None:
    """Prove the frozen 44/45 drift without inventing a false subclause."""
    try:
        producer_tree = ast.parse(
            producer_v11_raw.decode("utf-8"), filename="producer_v11", mode="exec")
        launcher_tree = ast.parse(
            launcher_v11_raw.decode("utf-8"), filename="cold_launcher_v11",
            mode="exec")
    except (UnicodeDecodeError, SyntaxError) as exc:
    ...
    need(isinstance(producer_incident, ast.Dict) and
         ...
         producer_claim.value == 44,
         "frozen v11 producer incident key-count claim AST")
    producer_keys = [
        key.value for key in producer_incident.keys
        if isinstance(key, ast.Constant) and isinstance(key.value, str)]
    launcher_keys = [
        key.value for key in launcher_incident.keys
        if isinstance(key, ast.Constant) and isinstance(key.value, str)]
    need(len(producer_keys) == 45 and len(set(producer_keys)) == 45 and
         len(launcher_keys) == 44 and len(set(launcher_keys)) == 44 and
         set(producer_keys) - set(launcher_keys) ==
             {"source_locations_are_diagnostic_not_authority"} and
         not (set(launcher_keys) - set(producer_keys)),
         "frozen v11 exact producer45 versus launcher44 incident drift")
    ...
    held_v10 = next(
        (node for node in launcher_tree.body
         if isinstance(node, ast.ClassDef) and
            node.name == "HeldV10PredecessorExact10"), None)
    need(isinstance(producer_guard, (ast.FunctionDef, ast.AsyncFunctionDef)) and
         isinstance(launcher_gate, (ast.FunctionDef, ast.AsyncFunctionDef)) and
         isinstance(held_v10, ast.ClassDef),
         "frozen v11 dual validator definitions")
    composite_calls = [
        node for node in ast.walk(producer_guard)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Name) and
           node.func.id == "need" and len(node.args) == 2 and
           isinstance(node.args[1], ast.Constant) and
           node.args[1].value ==
               "frozen v10 sole-false colon-prefix regression and pre-stage control flow"]
    need(len(composite_calls) == 1 and
         isinstance(composite_calls[0].args[0], ast.BoolOp) and
         isinstance(composite_calls[0].args[0].op, ast.And) and
         len(composite_calls[0].args[0].values) == 12,
         "frozen v11 producer one non-diagnostic twelve-conjunct guard")
    prechild_gate_calls = [
        node for node in ast.walk(held_v10)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Name) and
           node.func.id == "v10_regression_label_prefix_gate"]
    need(len(prechild_gate_calls) == 2,
         "frozen v11 launcher bind and terminal prechild gate calls")

    need(sha_bytes(producer_v11_raw) == V11_PRODUCER_FILE_PIN and
         sha_bytes(launcher_v11_raw) == V11_LAUNCHER_FILE_PIN and
         list(V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT) == [
             "schema", "incident_id", "evidence_source",
             "v11_producer_source_path", "v11_producer_source_file_sha256",
             "v11_launcher_source_path", "v11_launcher_source_file_sha256",
             "v11_official_rejection_file_sha256",
             "v11_official_rejection_object_sha256", "first_command",
             "first_orientation", "producer_child_spawned",
             "candidate_write_started", "candidate_or_stage_created",
             "positive_runtime_surface_count", "launcher_gate_function",
             "launcher_gate_passed_before_child_spawn", "producer_guard_function",
             "producer_composite_guard_rejected", "producer_failure_label",
             "producer_embedded_v10_incident_key_count_claim",
             "producer_embedded_v10_incident_actual_key_count",
             "producer_composite_guard_conjunct_count",
             "exact_failing_subpredicate_persisted", "specific_false_clause_authority",
             "child_consumed_inherited_held_predecessor_fds",
             ...
             "v10_colon_prefix_witness_key_count",
             "v10_colon_prefix_witness_successor_clause_truth_vector",
             "v10_colon_prefix_witness_all_clauses_true", "inner_stderr_line",
             "outer_stderr_line", "failure_occurs_before_candidate_or_stage_creation",
             "official_rejection_strictly_after_v11_outer", "required_successor_fix",
             "required_held_fd_fix", "required_validator_fix",
             "formal_global_closure_credit", "D02_unlock", "D02_started",
             "standalone_authority", "exact_false_clause_claim_allowed"] and
         len(V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT) == 45 and
         colon_witness.get("object_sha256") ==
             V10_COLON_PREFIX_WITNESS_OBJECT_PIN and
         colon_witness.get("successor_clause_truth_vector") ==
             V10_COLON_PREFIX_WITNESS_SUCCESSOR_TRUTH_VECTOR and
         colon_witness.get("successor_all_clauses_true") is True and
         V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT[
             "specific_false_clause_authority"] == "UNAVAILABLE" and
         V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT[
             "exact_false_clause_claim_allowed"] is False,
         "v11 dual-validator incident exact evidence and no invented clause")


def _v10_exact_label_prefix_join_count(tree: ast.Module,
                                       suffix: str) -> int:
...
def v10_regression_label_prefix_gate(producer_raw: bytes,
                                     launcher_v9_raw: bytes) -> dict[str, Any]:
    """Reproduce v10's sole false conjunct and prove the colon-prefix repair."""
    try:
        producer_tree = ast.parse(
            producer_raw.decode("utf-8"), filename="producer_v10", mode="exec")
        launcher_tree = ast.parse(
            launcher_v9_raw.decode("utf-8"), filename="cold_launcher_v9",
            mode="exec")
    except (UnicodeDecodeError, SyntaxError) as exc:
        raise Reject("frozen v10 producer/v9 launcher AST parse") from exc
    need(sha_bytes(producer_raw) == V10_PRODUCER_FILE_PIN and
         sha_bytes(launcher_v9_raw) == V9_EXACT10_PINS[7][1],
         "frozen v10 producer and v9 launcher exact pins")
    ...
    build = next(
        (node for node in producer_tree.body
         if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)) and
            node.name == "build"), None)
    need(isinstance(regression, (ast.FunctionDef, ast.AsyncFunctionDef)) and
         isinstance(hold, (ast.FunctionDef, ast.AsyncFunctionDef)) and
         isinstance(build, (ast.FunctionDef, ast.AsyncFunctionDef)),
         "frozen v10 regression, hold and build definitions")
    expected_function = next(
        (node for node in launcher_tree.body
         if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)) and
            node.name == "expected_v6_published_rejected_segment"), None)
    validator = next(
        (node for node in launcher_tree.body
         if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)) and
            node.name == "validate_v6_published_rejected_segment"), None)
    need(isinstance(expected_function,
                    (ast.FunctionDef, ast.AsyncFunctionDef)) and
         isinstance(validator, (ast.FunctionDef, ast.AsyncFunctionDef)),
         "frozen v9 expected/validator functions for v6 predecessor")
    ...
    need(len(guard_calls) == 1,
         "frozen v10 unique six-conjunct regression guard")
    guard = guard_calls[0].args[0]
    need(isinstance(guard, ast.BoolOp),
         "frozen v10 six-conjunct guard AST")
    fifth = guard.values[4]
    need(isinstance(fifth, ast.Compare) and len(fifth.ops) == 1 and
         isinstance(fifth.ops[0], ast.In) and len(fifth.comparators) == 1 and
         isinstance(fifth.comparators[0], ast.Name) and
         fifth.comparators[0].id == "constants" and
         isinstance(fifth.left, ast.Subscript) and
         ...
         isinstance(fifth.left.slice, ast.Constant) and
         fifth.left.slice.value == "failure_label",
         "frozen v10 unique false conjunct exact AST anchor")
    ...
    suffix = V10_REGRESSION_LABEL_PREFIX_INCIDENT[
        "failure_label_without_colon_prefix"]
    ...
    truth_vector = [
        len(expanded_dicts) == 1,
        bool(expanded_dicts) and len(expanded_dicts[0].keys) == 16,
        len(validator_calls) == 1,
        len(equality_gates) == 2,
        unprefixed_count > 0,
        sha_bytes(launcher_v9_raw) == V9_EXACT10_PINS[7][1],
    ...
    hold_regression_calls = [
        node for node in ast.walk(hold)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Name) and
           node.func.id == "v9_prechild_shape_drift_regression"
    ]
    hold_mkdir_calls = [
        node for node in ast.walk(hold)
        if isinstance(node, ast.Call) and
           ((isinstance(node.func, ast.Attribute) and node.func.attr == "mkdir") or
            (isinstance(node.func, ast.Name) and node.func.id == "mkdir"))
    ]
    build_hold_calls = [
        node for node in ast.walk(build)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Name) and
           node.func.id == "hold_static_freeze_trust"
    ]
    producer_stage_calls = [
        node for node in ast.walk(build)
        if isinstance(node, ast.Call) and isinstance(node.func, ast.Name) and
           node.func.id == "new_candidate_stage"
    ]
    def enclosing_statement_index(
            function: ast.FunctionDef | ast.AsyncFunctionDef,
            target: ast.AST) -> int:
        indices = [
        ...
        need(len(indices) == 1,
             "unique enclosing top-level statement for v10 control-flow node")
        return indices[0]

    hold_statement_index = (
        enclosing_statement_index(build, build_hold_calls[0])
        if len(build_hold_calls) == 1 else -1)
    stage_statement_index = (
        enclosing_statement_index(build, producer_stage_calls[0])
        if len(producer_stage_calls) == 1 else -1)
    need(truth_vector == [True, True, True, True, False, True] and
         unprefixed_count == 0 and prefixed_count == 1 and suffix_count == 1 and
         join_count == 1 and len(hold_regression_calls) == 1 and
         not hold_mkdir_calls and len(build_hold_calls) == 1 and
         len(producer_stage_calls) == 1 and
         hold_statement_index < stage_statement_index,
         "frozen v10 five true/one false label-prefix pre-candidate gate")

    # Coherent mutation attacks are performed on AST copies only.  Removing
    # the colon or adding a second colon must destroy the exact prefix-join
    # authority, while the held original has exactly one authorized join.
    no_colon_tree = copy.deepcopy(launcher_tree)
    no_colon_join = next(
        node for node in ast.walk(no_colon_tree)
        if isinstance(node, ast.BinOp) and isinstance(node.op, ast.Add) and
           isinstance(node.left, ast.Name) and node.left.id == "label" and
           isinstance(node.right, ast.Constant) and
           node.right.value == ":" + suffix)
    ...
    double_colon_tree = copy.deepcopy(launcher_tree)
    double_colon_join = next(
        node for node in ast.walk(double_colon_tree)
        if isinstance(node, ast.BinOp) and isinstance(node.op, ast.Add) and
           isinstance(node.left, ast.Name) and node.left.id == "label" and
           isinstance(node.right, ast.Constant) and
           node.right.value == ":" + suffix)
    double_colon_join.right.value = "::" + suffix
    need(_v10_exact_label_prefix_join_count(no_colon_tree, suffix) == 0 and
         _v10_exact_label_prefix_join_count(double_colon_tree, suffix) == 0 and
         _v10_exact_label_prefix_join_count(launcher_tree, suffix) == 1,
         "with/without/double-colon structural prefix mutation attacks")
...
def validate_final_static_audit(
        ...
        predecessor_v5: "HeldV5PredecessorExact10",
        predecessor_v6: "HeldV6PredecessorExact10",
        predecessor_v7: "HeldV7PredecessorExact10",
        predecessor_v8: "HeldV8PredecessorExact10",
        predecessor_v9: "HeldV9PredecessorExact10",
        predecessor_v10: "HeldV10PredecessorExact10",
        predecessor_v11: "HeldV11PredecessorExact10",
    ...
    need(set(audit) == audit_keys and
         audit.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer.static-audit.v16" and
         audit.get("audit_path") == str(AUDIT.relative_to(ROOT)) and
         audit.get("effective_checkpoint_object_sha256") == CHECKPOINT and
         audit.get("status") == FINAL_STATIC_AUDIT_STATUS,
         "final static audit exact top-level closure and PASS_V16 status")
    validate_v6_published_rejected_segment(
        audit.get("published_then_officially_rejected_predecessor_v6"),
        "final static audit v6 direct-predecessor regression")
    validate_v7_published_rejected_segment(
        audit.get("published_then_officially_rejected_predecessor_v7"),
        "final static audit v7 direct-predecessor regression")
    validate_v8_published_rejected_segment(
        audit.get("published_then_officially_rejected_predecessor_v8"),
        "final static audit v8 direct-predecessor regression")
    validate_v9_published_rejected_segment(
        audit.get("published_then_officially_rejected_predecessor_v9"),
        "final static audit v9 direct-predecessor regression")
    validate_v10_published_rejected_segment(
        audit.get("published_then_officially_rejected_predecessor_v10"),
        "final static audit v10 direct-predecessor regression")
    validate_v11_published_rejected_segment(
        audit.get("published_then_officially_rejected_predecessor_v11"),
        "final static audit v11 direct-predecessor regression")
    validate_v12_published_rejected_segment(
        audit.get("published_then_officially_rejected_predecessor_v12"),
        "final static audit v12 direct-predecessor regression")
    validate_v13_supersession_summary(
    ...
    need(predecessor_v11.colon_witness is not None and
         predecessor_v12.shape_incident ==
             V12_V5_REJECTION_SHAPE_INCIDENT and
         audit.get("v10_colon_prefix_witness") ==
             predecessor_v11.colon_witness and
         audit.get("v10_colon_prefix_witness", {}).get("object_sha256") ==
             V10_COLON_PREFIX_WITNESS_OBJECT_PIN and
         audit.get("v11_dual_validator_divergence_incident") ==
             V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT and
         sha_bytes(canonical(
             audit.get("v11_dual_validator_divergence_incident"))) ==
             V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT_DIGEST and
    ...
    helper_digests = [
        normalized_named_function_ast_sha256(
            held_by_path[path].raw, "derive_v10_colon_prefix_witness",
            "held current " + path.name)
        for path in (PRODUCER, CONSUMER, SELF)
    ]
    need(helper_digests == [
             V10_COLON_PREFIX_HELPER_NORMALIZED_AST_SHA256,
             V10_COLON_PREFIX_HELPER_NORMALIZED_AST_SHA256,
         ...
         "producer consumer launcher exact independent helper AST consensus")
    ...
    helper_callsites = (
        ...
        if isinstance(helper_consensus, dict) else None)
    ...
    actual_helper_callsites = exact_helper_callsite_census([
        ("producer", held_by_path[PRODUCER].raw),
        ("consumer", held_by_path[CONSUMER].raw),
        ("launcher", launcher_source_raw),
    ])
    need(isinstance(helper_consensus, dict) and
         set(helper_consensus) == helper_consensus_keys and
         helper_consensus.get("algorithm") ==
    ...
    need(isinstance(input_a, dict) and isinstance(input_b, dict) and
         tuple(input_a) == FINAL_STATIC_AUDIT_INPUT_KEY_ORDER and
         tuple(input_b) == FINAL_STATIC_AUDIT_INPUT_KEY_ORDER and
         len(input_a) == len(input_b) == 43 and
         sha_bytes(canonical(list(input_a))) ==
             FINAL_STATIC_AUDIT_INPUT_KEY_ORDER_SHA256 and
         sha_bytes(canonical(list(input_b))) ==
             FINAL_STATIC_AUDIT_INPUT_KEY_ORDER_SHA256 and
         input_a == input_b and _nonzero_sha256(input_a.get("launcher_template")),
         "final static audit exact ordered equal forty-three-pin A/B input census")
    expected_inputs = {
        ...
        # ``launcher_template`` is deliberately the PIN_NORMALIZED AST
        # digest, not a raw pre-injection launcher file hash.  The held final
        # launcher can therefore reproduce it after the AUDIT pin is
        # installed without creating a launcher<->audit byte-hash cycle.
        "launcher_template": pin_normalized_launcher_ast_sha256(
            launcher_source_raw, "held_v16_launcher_source"),
        ...
        "v5_rejection_file":
            predecessor_v6.by_path[V5_OFFICIAL_REJECTION].file_sha256,
        "v5_rejection_object": V5_REJECTION_OBJECT_PIN,
        "v6_rejection_file":
            predecessor_v7.by_path[V6_OFFICIAL_REJECTION].file_sha256,
        "v6_rejection_object": V6_REJECTION_OBJECT_PIN,
        "v7_rejection_file":
            predecessor_v7.rejection.file_sha256,
        "v7_rejection_object": V7_REJECTION_OBJECT_PIN,
        "v7_lock_continuity_incident_object":
            V7_LOCK_CONTINUITY_INCIDENT_OBJECT_PIN,
        "v8_rejection_file": predecessor_v8.rejection.file_sha256,
        "v8_rejection_object": V8_REJECTION_OBJECT_PIN,
        "v8_launcher_file":
            predecessor_v8.by_path[V8_EXACT10_PINS[7][0]].file_sha256,
        "v8_launcher_regression_defect_sha256":
            sha_bytes(canonical(V8_LAUNCHER_REGRESSION_DEFECT)),
        "trusted_v8_rollout_control_flow_incident_digest":
            sha_bytes(canonical(V8_ROLLOUT_CONTROL_FLOW_INCIDENT)),
        "v9_rejection_file": predecessor_v9.rejection.file_sha256,
        "v9_rejection_object": V9_REJECTION_OBJECT_PIN,
        "v9_launcher_file":
            predecessor_v9.by_path[V9_EXACT10_PINS[7][0]].file_sha256,
        ...
        "v9_expanded_v6_proof_sha256": sha_bytes(canonical(
            V9_V6_PROOF_SHAPE_DRIFT_INCIDENT[
                "launcher_expanded_structural_evidence"])),
        "trusted_v9_proof_shape_drift_incident_digest":
            sha_bytes(canonical(V9_V6_PROOF_SHAPE_DRIFT_INCIDENT)),
        "v10_rejection_file": predecessor_v10.rejection.file_sha256,
        "v10_rejection_object": V10_REJECTION_OBJECT_PIN,
        "v10_producer_file":
            predecessor_v10.by_path[V10_EXACT10_PINS[3][0]].file_sha256,
        "trusted_v10_regression_label_prefix_incident_digest":
            sha_bytes(canonical(V10_REGRESSION_LABEL_PREFIX_INCIDENT)),
        "v11_rejection_file": predecessor_v11.rejection.file_sha256,
        "v11_rejection_object": V11_REJECTION_OBJECT_PIN,
        "v11_producer_file":
            predecessor_v11.by_path[V11_EXACT10_PINS[3][0]].file_sha256,
        "v11_launcher_file":
            predecessor_v11.by_path[V11_EXACT10_PINS[7][0]].file_sha256,
        "trusted_v11_dual_validator_divergence_incident_digest":
            V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT_DIGEST,
        "v12_rejection_file": predecessor_v12.rejection.file_sha256,
        "v12_rejection_object": V12_REJECTION_OBJECT_PIN,
        "v12_producer_file":
            predecessor_v12.by_path[V12_EXACT10_PINS[3][0]].file_sha256,
        "v12_consumer_file":
            predecessor_v12.by_path[V12_EXACT10_PINS[4][0]].file_sha256,
        "v12_launcher_file":
            predecessor_v12.by_path[V12_EXACT10_PINS[7][0]].file_sha256,
        "trusted_v12_v5_rejection_shape_incident_digest":
            V12_V5_REJECTION_SHAPE_INCIDENT_SHA256,
    }
    need(tuple(expected_inputs) == FINAL_STATIC_AUDIT_INPUT_KEY_ORDER and
    ...
    need(_nonzero_sha256(pin_normalized) and
         checker_b.get("pin_normalized_launcher_ast_sha256") ==
             pin_normalized and
         checker_c.get("pin_normalized_launcher_ast_sha256") ==
             pin_normalized and
    ...
    need(isinstance(kind_census, dict) and set(kind_census) == kind_keys and
         ...
         type(dual.get("independent_pin_normalizer_count")) is int and
         ...
         dual.get(
             "pin_normalization_forces_final_base7_installed_false") is True and
         dual.get(
             "pin_normalization_preserves_v12_rejection_and_all_historical_pins")
             is True and
         dual.get(
             "pin_normalization_removes_current_audit_hash_dependency") is True and
         ...
         dual.get("held_launcher_pin_normalized_ast_sha256") ==
             pin_normalized and
         dual.get("held_launcher_pin_normalized_ast_sha256") ==
             pin_normalized_launcher_ast_sha256(
                 launcher_source_raw, "held_v16_launcher_source"),
         "final static audit exact PIN_NORMALIZED AST and callsite consensus")
    ...
    need(isinstance(attack, dict) and set(attack) == attack_keys and
         ...
         attack.get("exact_unique_ordered_attack_count_required") == 137 and
         type(attack.get("exact_unique_ordered_attack_count_observed")) is int and
         attack.get("exact_unique_ordered_attack_count_observed") == 137 and
         ...
         "final static audit exact 137/137 coherent attack census")
    ...
    computed_registry_shape = producer_source_registry_shape_from_ast(
        held_by_path[PRODUCER].raw)
    need(isinstance(closure, dict) and set(closure) == closure_keys and
         ...
         closure.get("schema_definition_count") == 46 ==
             len(schema.get("$defs", {})) and
         type(closure.get("schema_ref_count")) is int and
         closure.get("schema_ref_count") == 242 ==
         ...
         closure.get("closed_object_count") == 52 == len(closed_nodes) and
         ...
         computed_registry_shape ==
             expected_shapes["producerSourceRegistry"] == 75 and
         closure.get(
    ...
    no_producer_keys = {
        ...
        "consumer_current_v16_producer_content_open_read_hash_decode_compile_import_or_execute_allowed",
    ...
    need(isinstance(no_producer, dict) and
         set(no_producer) == no_producer_keys and
         no_producer.get(
         ...
         no_producer.get(
             "consumer_current_v16_producer_content_open_read_hash_decode_compile_import_or_execute_allowed") is False and
         no_producer.get("consumer_producer_source_hold_api") ==
             "O_PATH|O_NOFOLLOW" and
         no_producer.get("exact_required_seal_mask") == 15 and
         no_producer.get(
             "installed_and_exec_bytes_equal_and_terminally_replayed") is True and
         no_producer.get("installed_source_mode") == "0444" and
         no_producer.get("installed_source_nlink") == 1 and
         no_producer.get(
             "launcher_bootstrap_exec_source_root_fds_distinct") is True and
         no_producer.get(
         ...
         no_producer.get("sealed_exec_mode") == "0444" and
         no_producer.get("sealed_exec_nlink") == 0 and
         no_producer.get(
             "consumer_frozen_predecessor_incident_exact5_bytes_read_only_noncredit_allowed") is True and
         no_producer.get(
             "consumer_independently_rederives_witness_from_inherited_held_fds") is True,
         "final static audit exact current-v16 no-producer and inherited incident evidence policy")
    ...
    need(isinstance(acceptance, dict) and set(acceptance) == acceptance_keys and
         ...
         acceptance.get(
             "dual_static_checker_A_pin_normalized_ast_GO") is True and
         acceptance.get(
             "dual_static_checker_B_pin_normalized_ast_GO") is True and
         acceptance.get(
             "pin_normalized_launcher_ast_digest_consensus") is True and
    ...
    need(isinstance(no_run, dict) and set(no_run) == {
             "C79_entrypoint_executed", "C79_v16_runtime_artifact_count",
             "C79_v16_process_count", "pyc_or___pycache___created",
             "cold_manifest_or_outer_created_before_dual_GO",
         } and no_run.get("C79_entrypoint_executed") is False and
         type(no_run.get("C79_v16_runtime_artifact_count")) is int and
         no_run.get("C79_v16_runtime_artifact_count") == 0 and
         type(no_run.get("C79_v16_process_count")) is int and
         no_run.get("C79_v16_process_count") == 0 and
    ...
    def __init__(self, source: HeldFile) -> None:
        ...
        try:
            self.fd = os.memfd_create(
                "c79g-v16-child-exec", MFD_CLOEXEC | MFD_ALLOW_SEALING)
        except OSError as exc:
...
class HeldEmptyRejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent) -> None:
        coordination.verify()
        name = V16_REJECTION_NAMESPACE.name
        ...
        try:
            try:
                ...
                state = os.stat(name, dir_fd=coordination.fd,
                                follow_symlinks=False)
            self.path = V16_REJECTION_NAMESPACE
...
def construct_launcher_native_rejection(
    ...
    return close_object({
        ...
        "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
        "effective_checkpoint_object_sha256": CHECKPOINT,
        "namespace_exact_path": str(V16_REJECTION_NAMESPACE.relative_to(ROOT)),
        "target_exact_path": str(V16_LATER_REJECTION.relative_to(ROOT)),
        "rejection_reason": "ORPHANED_OR_INCOMPLETE_C79G_V16_SURFACE",
        ...
        "v6_official_rejection_file_sha256": V6_REJECTION_FILE_PIN,
        "v6_official_rejection_object_sha256": V6_REJECTION_OBJECT_PIN,
        "v7_official_rejection_file_sha256": V7_REJECTION_FILE_PIN,
        "v7_official_rejection_object_sha256": V7_REJECTION_OBJECT_PIN,
        "v7_publication_lock_continuity_incident_object_sha256":
            V7_LOCK_CONTINUITY_INCIDENT_OBJECT_PIN,
        "v8_official_rejection_file_sha256": V8_REJECTION_FILE_PIN,
        "v8_official_rejection_object_sha256": V8_REJECTION_OBJECT_PIN,
        "v9_official_rejection_file_sha256": V9_REJECTION_FILE_PIN,
        "v9_official_rejection_object_sha256": V9_REJECTION_OBJECT_PIN,
        "v10_official_rejection_file_sha256": V10_REJECTION_FILE_PIN,
        "v10_official_rejection_object_sha256": V10_REJECTION_OBJECT_PIN,
        "v11_official_rejection_file_sha256": V11_REJECTION_FILE_PIN,
        "v11_official_rejection_object_sha256": V11_REJECTION_OBJECT_PIN,
        "v12_official_rejection_file_sha256": V12_REJECTION_FILE_PIN,
        "v12_official_rejection_object_sha256": V12_REJECTION_OBJECT_PIN,
...
def install_or_replay_launcher_native_rejection(
    ...
    try:
        try:
            ...
            namespace_fd = openat2_beneath(
                V16_REJECTION_NAMESPACE, os.O_RDONLY | os.O_DIRECTORY)
    except BaseException:
        if namespace_fd >= 0:
    ...
    try:
        ...
        path_before = root_lstat(V16_REJECTION_NAMESPACE)
        ...
        target = os.stat(V16_LATER_REJECTION.name, dir_fd=namespace_fd,
                         follow_symlinks=False) if V16_LATER_REJECTION.name in universe else None
        if target is not None:
            need(universe == {V16_LATER_REJECTION.name},
                 "idempotent rejection exact singleton")
            rejection_guard = HeldFile(
                V16_LATER_REJECTION, "existing launcher-native v16 rejection")
        else:
            ...
            try:
                ...
                os.fsync(namespace_fd)
            rejection_guard = HeldFile(
                V16_LATER_REJECTION, "new launcher-native v16 rejection")
        need(rejection_guard is not None,
             "launcher-native rejection file held")
        value = strict_json(rejection_guard.raw, "launcher-native v16 rejection")
        need(isinstance(value, dict), "launcher-native rejection mapping")
        verify_object(value, "launcher-native v16 rejection")
        os.fsync(rejection_guard.fd)
        os.fsync(namespace_fd)
        os.fsync(coordination.fd)
        after = os.fstat(namespace_fd)
        path_after = root_lstat(V16_REJECTION_NAMESPACE)
        need(value == expected and rejection_guard.raw == expected_raw and
             set(os.listdir(namespace_fd)) == {V16_LATER_REJECTION.name} and
        ...
        try:
            ...
            need(len(V5_OFFICIAL_REJECTION_EXACT39_KEYS) == 39 and
                 sha_bytes(canonical(sorted(V5_OFFICIAL_REJECTION_EXACT39_KEYS))) ==
                     V5_OFFICIAL_REJECTION_EXACT39_KEYSET_SHA256 and
                 set(rejected) == V5_OFFICIAL_REJECTION_EXACT39_KEYS and
                 sha_bytes(canonical(sorted(rejected))) ==
                     V5_OFFICIAL_REJECTION_EXACT39_KEYSET_SHA256 and
                 rejection.raw == canonical(rejected) + b"\n" and
                 rejected.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer.v5."
                     "later-rejection" and
                 rejected.get("status") ==
...
class HeldV6RejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            ...
            before_path = root_lstat(self.path)
            first = set(os.listdir(self.fd))
            member = os.stat(V6_OFFICIAL_REJECTION.name, dir_fd=self.fd,
                             follow_symlinks=False)
            after = os.fstat(self.fd)
            after_path = root_lstat(self.path)
            second = set(os.listdir(self.fd))
            need(stat.S_ISDIR(self.before.st_mode) and
                 ...
                 fingerprint(before_path) == fingerprint(self.before) ==
                     fingerprint(after) == fingerprint(after_path) and
                 first == second == {V6_OFFICIAL_REJECTION.name} and
                 (member.st_dev, member.st_ino) == rejection.identity and
                 self.mount_id == rejection.mount_id == coordination.mount_id,
                 "official v6 rejection exact singleton namespace held under lock")
        except BaseException:
            os.close(self.fd)
            self.fd = -1
            raise
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(fingerprint(before) == fingerprint(before_path) ==
             ...
             (member.st_dev, member.st_ino) == rejection.identity and
             mount_id(self.fd) == self.mount_id,
             "official v6 rejection namespace terminal singleton replay")
...
class HeldV6PredecessorExact10:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            for path, file_pin, _ in V6_EXACT10_PINS:
                self.files.append(HeldFile(
                    path, "frozen v6 exact10:" + path.name, file_pin))
            self.by_path = {item.path: item for item in self.files}
            need(len(self.by_path) == 10 and
                 len({item.identity for item in self.files}) == 10 and
                 len({item.mount_id for item in self.files}) == 1 and
                 next(iter({item.mount_id for item in self.files})) ==
                     coordination.mount_id == rejection.mount_id,
                 "frozen v6 exact10 unique live files on coordination mount")
            for path, _, object_pin in V6_EXACT10_PINS:
                if object_pin is not None:
                    value = strict_json(self.by_path[path].raw,
                                        "frozen v6 object:" + path.name)
                    need(isinstance(value, dict), "frozen v6 object mapping")
                    verify_object(value, "frozen v6 object:" + path.name,
                                  object_pin)
            expected_exact8 = [
                {"path": str(path.relative_to(ROOT)), "file_sha256": file_pin}
                for path, file_pin, _ in V6_EXACT10_PINS[:8]
            ]
            manifest = self.files[8]
            need(parse_manifest(manifest.raw) == expected_exact8,
                 "frozen v6 exact8 manifest reconstructed exactly")
            ...
            need(self.files[9].raw == canonical(outer) + b"\n" and
                 ...
                 outer.get("exact8_ordered_entries") == expected_exact8 and
                 outer.get("cold_launch_manifest", {}).get("file_sha256") ==
                     V6_EXACT10_PINS[8][1] and
                 outer.get("cold_launcher", {}).get("file_sha256") ==
                     V6_EXACT10_PINS[7][1] and
                 outer.get("formal_global_closure_credit") == 0 and
                 outer.get("D02_unlock") is False and
                 outer.get("runtime_executed_during_static_freeze") is False and
                 all(chronology.values()) and
                 max(self.files[9].before.st_mtime_ns,
                     ...
                     min(rejection.before.st_mtime_ns,
                         rejection.before.st_ctime_ns),
                 "frozen v6 exact10 outer then strictly later rejection closure")
            ...
            verify_object(rejected, "official v6 later rejection",
                          V6_REJECTION_OBJECT_PIN)
            need(rejection.raw == canonical(rejected) + b"\n" and
                 ...
                 rejected.get("closed_schema_file_sha256") ==
                     V6_EXACT10_PINS[1][1] and
                 rejected.get("contract_file_sha256") == V6_EXACT10_PINS[2][1] and
                 rejected.get("contract_object_sha256") == V6_EXACT10_PINS[2][2] and
                 rejected.get("producer_file_sha256") == V6_EXACT10_PINS[3][1] and
                 rejected.get("consumer_file_sha256") == V6_EXACT10_PINS[4][1] and
                 rejected.get("cold_launcher_file_sha256") == V6_EXACT10_PINS[7][1] and
                 rejected.get("cold_manifest_file_sha256") == V6_EXACT10_PINS[8][1] and
                 rejected.get("cold_outer_file_sha256") == V6_EXACT10_PINS[9][1] and
                 rejected.get("cold_outer_object_sha256") == V6_EXACT10_PINS[9][2] and
                 rejected.get("v4_rejection_supersession_file_sha256") ==
                     V4_SUPERSESSION_FILE_PIN and
                 rejected.get("v4_rejection_supersession_object_sha256") ==
                     V4_SUPERSESSION_OBJECT_PIN and
                 rejected.get("v5_official_rejection_file_sha256") ==
                     V5_REJECTION_FILE_PIN and
                 rejected.get("v5_official_rejection_object_sha256") ==
                     V5_REJECTION_OBJECT_PIN and
                 rejected.get("formal_global_closure_credit") == 0 and
                 rejected.get("D02_unlock") is False and
                 rejected.get("D02_started") is False and
                 rejected.get("standalone_authority") is False and
                 rejected.get("overwrite_delete_or_reuse_allowed") is False,
                 "official v6 rejection binds published v6 exact10")
            self.held_self_identity_structural_evidence = (
                v6_held_self_identity_structural_evidence(self.files[3].raw))
            self.held_self_identity_defect = (
                v6_held_self_identity_defect_regression(self.files[3].raw))
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        self.namespace.terminal_replay(rejection)
        need(v6_held_self_identity_defect_regression(self.files[3].raw) ==
                 self.held_self_identity_defect and
             v6_held_self_identity_structural_evidence(self.files[3].raw) ==
                 self.held_self_identity_structural_evidence,
             "terminal frozen v6 structural defect dual-check replay")
        self._assert_positive_runtime_absence()
...
class HeldV7RejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            ...
            path_before = root_lstat(self.path)
            first = set(os.listdir(self.fd))
            member = os.stat(V7_OFFICIAL_REJECTION.name, dir_fd=self.fd,
                             follow_symlinks=False)
            after = os.fstat(self.fd)
            path_after = root_lstat(self.path)
            second = set(os.listdir(self.fd))
            need(stat.S_ISDIR(self.before.st_mode) and
                 stat.S_IMODE(self.before.st_mode) == 0o555 and
                 self.before.st_nlink == 2 and
                 fingerprint(path_before) == fingerprint(self.before) ==
                     fingerprint(after) == fingerprint(path_after) and
                 first == second == {V7_OFFICIAL_REJECTION.name} and
                 (member.st_dev, member.st_ino) == rejection.identity and
                 self.mount_id == rejection.mount_id == coordination.mount_id,
                 "official v7 rejection exact singleton namespace held under lock")
        except BaseException:
            os.close(self.fd)
            self.fd = -1
            raise
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(fingerprint(before) == fingerprint(path_before) ==
             ...
             (member.st_dev, member.st_ino) == rejection.identity and
             mount_id(self.fd) == self.mount_id,
             "official v7 rejection namespace terminal singleton replay")
...
class HeldV7PredecessorExact10:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            for path, file_pin, _ in V7_EXACT10_PINS:
                self.files.append(HeldFile(
                    path, "frozen v7 exact10:" + path.name, file_pin))
            self.by_path = {item.path: item for item in self.files}
            need(len(self.by_path) == 10 and
                 len({item.identity for item in self.files}) == 10 and
                 len({item.mount_id for item in self.files}) == 1 and
                 next(iter({item.mount_id for item in self.files})) ==
                     coordination.mount_id == rejection.mount_id,
                 "frozen v7 exact10 unique live files on coordination mount")
            for path, _, object_pin in V7_EXACT10_PINS:
                if object_pin is not None:
                    value = strict_json(self.by_path[path].raw,
                                        "frozen v7 object:" + path.name)
                    need(isinstance(value, dict), "frozen v7 object mapping")
                    verify_object(value, "frozen v7 object:" + path.name,
                                  object_pin)
            expected_exact8 = [
                {"path": str(path.relative_to(ROOT)), "file_sha256": file_pin}
                for path, file_pin, _ in V7_EXACT10_PINS[:8]
            ]
            need(parse_manifest(self.files[8].raw) == expected_exact8,
                 "frozen v7 exact8 manifest reconstructed exactly")
            ...
            need(self.files[9].raw == canonical(outer) + b"\n" and
                 ...
                 outer.get("status") ==
                     "FROZEN_COLD_LAUNCH_OUTER_LAST__EXACT8_MANIFEST_CLOSED__"
                     "RUNTIME_DEFERRED" and
                 outer.get("effective_checkpoint_object_sha256") == CHECKPOINT and
                 outer.get("exact8_ordered_entries") == expected_exact8 and
                 outer.get("cold_launch_manifest", {}).get("file_sha256") ==
                     V7_EXACT10_PINS[8][1] and
                 outer.get("cold_launcher", {}).get("file_sha256") ==
                     V7_EXACT10_PINS[7][1] and
                 outer.get("formal_global_closure_credit") == 0 and
                 outer.get("D02_unlock") is False and
                 outer.get("runtime_executed_during_static_freeze") is False and
                 all(chronology.values()) and
                 max(self.files[9].before.st_mtime_ns,
                     ...
                     min(rejection.before.st_mtime_ns,
                         rejection.before.st_ctime_ns),
                 "frozen v7 exact10 outer then strictly later rejection closure")
            ...
            verify_object(rejected, "official v7 later rejection",
                          V7_REJECTION_OBJECT_PIN)
            need(rejection.raw == canonical(rejected) + b"\n" and
                 rejected.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer.v7."
                 ...
                 rejected.get("closed_schema_file_sha256") ==
                     V7_EXACT10_PINS[1][1] and
                 rejected.get("contract_file_sha256") == V7_EXACT10_PINS[2][1] and
                 rejected.get("contract_object_sha256") == V7_EXACT10_PINS[2][2] and
                 rejected.get("producer_file_sha256") == V7_EXACT10_PINS[3][1] and
                 rejected.get("consumer_file_sha256") == V7_EXACT10_PINS[4][1] and
                 rejected.get("cold_launcher_file_sha256") == V7_EXACT10_PINS[7][1] and
                 rejected.get("cold_manifest_file_sha256") == V7_EXACT10_PINS[8][1] and
                 rejected.get("cold_outer_file_sha256") == V7_EXACT10_PINS[9][1] and
                 rejected.get("cold_outer_object_sha256") == V7_EXACT10_PINS[9][2] and
                 rejected.get("v6_official_rejection_file_sha256") ==
                     V6_REJECTION_FILE_PIN and
                 rejected.get("v6_official_rejection_object_sha256") ==
                     V6_REJECTION_OBJECT_PIN and
                 rejected.get("formal_global_closure_credit") == 0 and
                 rejected.get("D02_unlock") is False and
                 rejected.get("D02_started") is False and
                 rejected.get("standalone_authority") is False and
                 rejected.get("overwrite_delete_or_reuse_allowed") is False,
                 "official v7 rejection binds published v7 exact10")
            validate_v7_lock_continuity_incident(
                V7_LOCK_CONTINUITY_INCIDENT, "held v7 predecessor")
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        self.namespace.terminal_replay(rejection)
        validate_v7_lock_continuity_incident(
            V7_LOCK_CONTINUITY_INCIDENT, "terminal v7 predecessor")
        self._assert_positive_runtime_absence()
...
class HeldV8RejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            ...
            path_before = root_lstat(self.path)
            first = set(os.listdir(self.fd))
            member = os.stat(V8_OFFICIAL_REJECTION.name, dir_fd=self.fd,
                             follow_symlinks=False)
            after = os.fstat(self.fd)
            path_after = root_lstat(self.path)
            second = set(os.listdir(self.fd))
            need(stat.S_ISDIR(self.before.st_mode) and
                 ...
                 fingerprint(path_before) == fingerprint(self.before) ==
                     fingerprint(after) == fingerprint(path_after) and
                 first == second == {V8_OFFICIAL_REJECTION.name} and
                 (member.st_dev, member.st_ino) == rejection.identity and
                 self.mount_id == rejection.mount_id == coordination.mount_id,
                 "official v8 rejection exact singleton namespace held under lock")
        except BaseException:
            os.close(self.fd)
            self.fd = -1
            raise
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(fingerprint(before) == fingerprint(path_before) ==
             ...
             (member.st_dev, member.st_ino) == rejection.identity and
             mount_id(self.fd) == self.mount_id,
             "official v8 rejection namespace terminal singleton replay")
...
class HeldV8PredecessorExact10:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            for path, file_pin, _ in V8_EXACT10_PINS:
                self.files.append(HeldFile(
                    path, "frozen v8 exact10:" + path.name, file_pin))
            self.by_path = {item.path: item for item in self.files}
            need(len(self.by_path) == 10 and
                 len({item.identity for item in self.files}) == 10 and
                 len({item.mount_id for item in self.files}) == 1 and
                 next(iter({item.mount_id for item in self.files})) ==
                     coordination.mount_id == rejection.mount_id,
                 "frozen v8 exact10 unique live files on coordination mount")
            for path, _, object_pin in V8_EXACT10_PINS:
                if object_pin is not None:
                    value = strict_json(self.by_path[path].raw,
                                        "frozen v8 object:" + path.name)
                    need(isinstance(value, dict), "frozen v8 object mapping")
                    verify_object(value, "frozen v8 object:" + path.name,
                                  object_pin)
            expected_exact8 = [
                {"path": str(path.relative_to(ROOT)), "file_sha256": file_pin}
                for path, file_pin, _ in V8_EXACT10_PINS[:8]
            ]
            need(parse_manifest(self.files[8].raw) == expected_exact8,
                 "frozen v8 exact8 manifest reconstructed exactly")
            ...
            need(self.files[9].raw == canonical(outer) + b"\n" and
                 outer.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer."
                     "cold-launch-outer-receipt.v8" and
                 outer.get("status") ==
                     "FROZEN_COLD_LAUNCH_OUTER_LAST__EXACT8_MANIFEST_CLOSED__"
                     "RUNTIME_DEFERRED" and
                 outer.get("effective_checkpoint_object_sha256") == CHECKPOINT and
                 outer.get("exact8_ordered_entries") == expected_exact8 and
                 outer.get("cold_launch_manifest", {}).get("file_sha256") ==
                     V8_EXACT10_PINS[8][1] and
                 outer.get("cold_launcher", {}).get("file_sha256") ==
                     V8_EXACT10_PINS[7][1] and
                 outer.get("formal_global_closure_credit") == 0 and
                 outer.get("D02_unlock") is False and
                 outer.get("runtime_executed_during_static_freeze") is False and
                 all(chronology.values()) and
                 max(self.files[9].before.st_mtime_ns,
                     ...
                     min(rejection.before.st_mtime_ns,
                         rejection.before.st_ctime_ns),
                 "frozen v8 exact10 outer then strictly later rejection closure")
            ...
            verify_object(rejected, "official v8 later rejection",
                          V8_REJECTION_OBJECT_PIN)
            need(rejection.raw == canonical(rejected) + b"\n" and
                 rejected.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer.v8."
                 ...
                 rejected.get("closed_schema_file_sha256") ==
                     V8_EXACT10_PINS[1][1] and
                 rejected.get("contract_file_sha256") == V8_EXACT10_PINS[2][1] and
                 rejected.get("contract_object_sha256") == V8_EXACT10_PINS[2][2] and
                 rejected.get("producer_file_sha256") == V8_EXACT10_PINS[3][1] and
                 rejected.get("consumer_file_sha256") == V8_EXACT10_PINS[4][1] and
                 rejected.get("cold_launcher_file_sha256") == V8_EXACT10_PINS[7][1] and
                 rejected.get("cold_manifest_file_sha256") == V8_EXACT10_PINS[8][1] and
                 rejected.get("cold_outer_file_sha256") == V8_EXACT10_PINS[9][1] and
                 rejected.get("cold_outer_object_sha256") == V8_EXACT10_PINS[9][2] and
                 rejected.get("v7_official_rejection_file_sha256") ==
                     V7_REJECTION_FILE_PIN and
                 rejected.get("v7_official_rejection_object_sha256") ==
                     V7_REJECTION_OBJECT_PIN and
                 rejected.get("v7_publication_lock_continuity_incident_object_sha256") ==
                 ...
                 rejected.get("standalone_authority") is False and
                 rejected.get("overwrite_delete_or_reuse_allowed") is False,
                 "official v8 rejection binds published v8 exact10")
            need(v8_launcher_regression_defect_gate(
                     self.by_path[V8_EXACT10_PINS[7][0]].raw) ==
                     V8_LAUNCHER_REGRESSION_DEFECT,
                 "held v8 launcher regression defect exact gate")
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(v8_launcher_regression_defect_gate(
                 self.by_path[V8_EXACT10_PINS[7][0]].raw) ==
                 V8_LAUNCHER_REGRESSION_DEFECT,
             "terminal v8 launcher regression defect exact gate")
        self._assert_positive_runtime_absence()
...
class HeldV9RejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            ...
            path_before = root_lstat(self.path)
            first = set(os.listdir(self.fd))
            member = os.stat(V9_OFFICIAL_REJECTION.name, dir_fd=self.fd,
                             follow_symlinks=False)
            after = os.fstat(self.fd)
            path_after = root_lstat(self.path)
            second = set(os.listdir(self.fd))
            need(stat.S_ISDIR(self.before.st_mode) and
                 ...
                 fingerprint(path_before) == fingerprint(self.before) ==
                     fingerprint(after) == fingerprint(path_after) and
                 first == second == {V9_OFFICIAL_REJECTION.name} and
                 (member.st_dev, member.st_ino) == rejection.identity and
                 self.mount_id == rejection.mount_id == coordination.mount_id,
                 "official v9 rejection exact singleton namespace held under lock")
        except BaseException:
            os.close(self.fd)
            self.fd = -1
            raise
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(fingerprint(before) == fingerprint(path_before) ==
             ...
             (member.st_dev, member.st_ino) == rejection.identity and
             mount_id(self.fd) == self.mount_id,
             "official v9 rejection namespace terminal singleton replay")
...
class HeldV9PredecessorExact10:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            for path, file_pin, _ in V9_EXACT10_PINS:
                self.files.append(HeldFile(
                    path, "frozen v9 exact10:" + path.name, file_pin))
            self.by_path = {item.path: item for item in self.files}
            need(len(self.by_path) == 10 and
                 len({item.identity for item in self.files}) == 10 and
                 len({item.mount_id for item in self.files}) == 1 and
                 next(iter({item.mount_id for item in self.files})) ==
                     coordination.mount_id == rejection.mount_id,
                 "frozen v9 exact10 unique live files on coordination mount")
            for path, _, object_pin in V9_EXACT10_PINS:
                if object_pin is not None:
                    value = strict_json(self.by_path[path].raw,
                                        "frozen v9 object:" + path.name)
                    need(isinstance(value, dict), "frozen v9 object mapping")
                    verify_object(value, "frozen v9 object:" + path.name,
                                  object_pin)
            expected_exact8 = [
                {"path": str(path.relative_to(ROOT)), "file_sha256": file_pin}
                for path, file_pin, _ in V9_EXACT10_PINS[:8]
            ]
            need(parse_manifest(self.files[8].raw) == expected_exact8,
                 "frozen v9 exact8 manifest reconstructed exactly")
            ...
            need(self.files[9].raw == canonical(outer) + b"\n" and
                 outer.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer."
                     "cold-launch-outer-receipt.v9" and
                 outer.get("status") ==
                     "FROZEN_COLD_LAUNCH_OUTER_LAST__EXACT8_MANIFEST_CLOSED__"
                     "RUNTIME_DEFERRED" and
                 outer.get("effective_checkpoint_object_sha256") == CHECKPOINT and
                 outer.get("exact8_ordered_entries") == expected_exact8 and
                 outer.get("cold_launch_manifest", {}).get("file_sha256") ==
                     V9_EXACT10_PINS[8][1] and
                 outer.get("cold_launcher", {}).get("file_sha256") ==
                     V9_EXACT10_PINS[7][1] and
                 outer.get("formal_global_closure_credit") == 0 and
                 outer.get("D02_unlock") is False and
                 outer.get("runtime_executed_during_static_freeze") is False and
                 all(chronology.values()) and
                 max(self.files[9].before.st_mtime_ns,
                     ...
                     min(rejection.before.st_mtime_ns,
                         rejection.before.st_ctime_ns),
                 "frozen v9 exact10 outer then strictly later rejection closure")
            ...
            verify_object(rejected, "official v9 later rejection",
                          V9_REJECTION_OBJECT_PIN)
            need(rejection.raw == canonical(rejected) + b"\n" and
                 rejected.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer.v9."
                 ...
                 rejected.get("closed_schema_file_sha256") ==
                     V9_EXACT10_PINS[1][1] and
                 rejected.get("contract_file_sha256") == V9_EXACT10_PINS[2][1] and
                 rejected.get("contract_object_sha256") == V9_EXACT10_PINS[2][2] and
                 rejected.get("producer_file_sha256") == V9_EXACT10_PINS[3][1] and
                 rejected.get("consumer_file_sha256") == V9_EXACT10_PINS[4][1] and
                 rejected.get("cold_launcher_file_sha256") == V9_EXACT10_PINS[7][1] and
                 rejected.get("cold_manifest_file_sha256") == V9_EXACT10_PINS[8][1] and
                 rejected.get("cold_outer_file_sha256") == V9_EXACT10_PINS[9][1] and
                 rejected.get("cold_outer_object_sha256") == V9_EXACT10_PINS[9][2] and
                 rejected.get("v8_official_rejection_file_sha256") ==
                     V8_REJECTION_FILE_PIN and
                 rejected.get("v8_official_rejection_object_sha256") ==
                     V8_REJECTION_OBJECT_PIN and
                 rejected.get("formal_global_closure_credit") == 0 and
                 rejected.get("D02_unlock") is False and
                 rejected.get("D02_started") is False and
                 rejected.get("standalone_authority") is False and
                 rejected.get("overwrite_delete_or_reuse_allowed") is False,
                 "official v9 rejection binds published v9 exact10")
            need(v9_proof_shape_drift_gate(
                     self.by_path[V9_EXACT10_PINS[7][0]].raw) ==
                     V9_V6_PROOF_SHAPE_DRIFT_INCIDENT,
                 "held v9 launcher proof-shape drift exact gate")
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(v9_proof_shape_drift_gate(
                 self.by_path[V9_EXACT10_PINS[7][0]].raw) ==
                 V9_V6_PROOF_SHAPE_DRIFT_INCIDENT,
             "terminal v9 launcher proof-shape drift exact gate")
        self._assert_positive_runtime_absence()
...
class HeldV12RejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            ...
            path_before = root_lstat(self.path)
            first = set(os.listdir(self.fd))
            member = os.stat(V12_OFFICIAL_REJECTION.name, dir_fd=self.fd,
                             follow_symlinks=False)
            after = os.fstat(self.fd)
            path_after = root_lstat(self.path)
            second = set(os.listdir(self.fd))
            need(stat.S_ISDIR(self.before.st_mode) and
                 ...
                 fingerprint(path_before) == fingerprint(self.before) ==
                     fingerprint(after) == fingerprint(path_after) and
                 first == second == {V12_OFFICIAL_REJECTION.name} and
                 (member.st_dev, member.st_ino) == rejection.identity and
                 self.mount_id == rejection.mount_id == coordination.mount_id,
                 "official v12 rejection exact singleton namespace held under lock")
        except BaseException:
            os.close(self.fd)
            self.fd = -1
            raise
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(fingerprint(before) == fingerprint(path_before) ==
             ...
             (member.st_dev, member.st_ino) == rejection.identity and
             mount_id(self.fd) == self.mount_id,
             "official v12 rejection namespace terminal singleton replay")
...
class HeldV12PredecessorExact10:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            for path, file_pin, _ in V12_EXACT10_PINS:
                self.files.append(HeldFile(
                    path, "frozen v12 exact10:" + path.name, file_pin))
            self.by_path = {item.path: item for item in self.files}
            need(len(V12_EXACT10_PINS) == len(self.files) ==
                     len(self.by_path) == 10 and
                 len({item.identity for item in self.files}) == 10 and
                 len({item.mount_id for item in self.files}) == 1 and
                 next(iter({item.mount_id for item in self.files})) ==
                     coordination.mount_id == rejection.mount_id,
                 "frozen v12 exact10 unique live files on coordination mount")
            for path, _, object_pin in V12_EXACT10_PINS:
                if object_pin is not None:
                    value = strict_json(self.by_path[path].raw,
                                        "frozen v12 object:" + path.name)
                    need(isinstance(value, dict), "frozen v12 object mapping")
                    verify_object(value, "frozen v12 object:" + path.name,
                                  object_pin)
            expected_exact8 = [
                {"path": str(path.relative_to(ROOT)), "file_sha256": file_pin}
                for path, file_pin, _ in V12_EXACT10_PINS[:8]
            ]
            need(parse_manifest(self.files[8].raw) == expected_exact8,
                 "frozen v12 exact8 manifest reconstructed exactly")
            ...
            need(self.files[9].raw == canonical(outer) + b"\n" and
                 outer.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer."
                     "cold-launch-outer-receipt.v12" and
                 outer.get("status") ==
                     "FROZEN_COLD_LAUNCH_OUTER_LAST__EXACT8_MANIFEST_CLOSED__"
                     "RUNTIME_DEFERRED" and
                 outer.get("effective_checkpoint_object_sha256") == CHECKPOINT and
                 outer.get("exact8_ordered_entries") == expected_exact8 and
                 outer.get("cold_launch_manifest", {}).get("file_sha256") ==
                     V12_EXACT10_PINS[8][1] and
                 outer.get("cold_launcher", {}).get("file_sha256") ==
                     V12_EXACT10_PINS[7][1] and
                 outer.get("formal_global_closure_credit") == 0 and
                 outer.get("D02_unlock") is False and
                 outer.get("runtime_executed_during_static_freeze") is False and
                 all(chronology.values()) and
                 max(self.files[9].before.st_mtime_ns,
                     ...
                     min(rejection.before.st_mtime_ns,
                         rejection.before.st_ctime_ns),
                 "frozen v12 exact10 outer then strictly later rejection closure")
            ...
            verify_object(rejected, "official v12 later rejection",
                          V12_REJECTION_OBJECT_PIN)
            need(rejection.raw == canonical(rejected) + b"\n" and
                 len(rejected) == len(V12_OFFICIAL_REJECTION_EXACT54_KEYS) == 54 and
                 set(rejected) == V12_OFFICIAL_REJECTION_EXACT54_KEYS and
                 sha_bytes(canonical(sorted(rejected))) ==
                     V12_OFFICIAL_REJECTION_EXACT54_KEYSET_SHA256 and
                 rejected.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer.v12."
                 ...
                 rejected.get("closed_schema_file_sha256") ==
                     V12_EXACT10_PINS[1][1] and
                 rejected.get("contract_file_sha256") == V12_EXACT10_PINS[2][1] and
                 rejected.get("contract_object_sha256") == V12_EXACT10_PINS[2][2] and
                 rejected.get("producer_file_sha256") == V12_EXACT10_PINS[3][1] and
                 rejected.get("consumer_file_sha256") == V12_EXACT10_PINS[4][1] and
                 rejected.get("cold_launcher_file_sha256") == V12_EXACT10_PINS[7][1] and
                 rejected.get("cold_manifest_file_sha256") == V12_EXACT10_PINS[8][1] and
                 rejected.get("cold_outer_file_sha256") == V12_EXACT10_PINS[9][1] and
                 rejected.get("cold_outer_object_sha256") == V12_EXACT10_PINS[9][2] and
                 rejected.get("v11_official_rejection_file_sha256") ==
                     V11_REJECTION_FILE_PIN and
                 rejected.get("v11_official_rejection_object_sha256") ==
                     V11_REJECTION_OBJECT_PIN and
                 rejected.get("formal_global_closure_credit") == 0 and
                 rejected.get("D02_unlock") is False and
                 rejected.get("D02_gate_credit") == 0 and
                 rejected.get("D02_task_credit") == 0 and
                 rejected.get("D02_formal_pending_task_count") == 33_638 and
                 rejected.get("D02_started") is False and
                 rejected.get("standalone_authority") is False and
                 rejected.get("overwrite_delete_or_reuse_allowed") is False,
                 "official v12 rejection exact54 binds published v12 exact10")
    ...
    @staticmethod
    def _assert_positive_runtime_absence() -> None:
        need(len(V12_FORBIDDEN_RUNTIME_PATHS) == 12,
             "v12 exact twelve forbidden runtime paths")
        for path in V12_FORBIDDEN_RUNTIME_PATHS:
            root_absent(path,
                        "officially rejected v12 runtime surface:" + path.name)

    def bind_history(self, predecessor_v11: "HeldV11PredecessorExact10",
                     v5_rejection: HeldFile) -> None:
        need(self.predecessor_v11 is None and self.v5_rejection is None and
             self.shape_incident is None,
             "v12 predecessor and incident held-byte evidence bind once")
        need(predecessor_v11.rejection.identity ==
                 self.by_path[V11_OFFICIAL_REJECTION].identity and
             v5_rejection.path == V5_OFFICIAL_REJECTION,
             "v12 binds shared v11 and v5 rejection held identities")
        incident = derive_v12_v5_rejection_shape_incident(
            self.by_path[V12_EXACT10_PINS[3][0]].raw,
            self.by_path[V12_EXACT10_PINS[4][0]].raw,
            self.by_path[V12_EXACT10_PINS[7][0]].raw,
            v5_rejection.raw, self.rejection.raw)
        need(incident == V12_V5_REJECTION_SHAPE_INCIDENT,
             "v12 exact39-vs-52 incident exact reproduction")
    ...
    def inherited_v12_evidence_fds(self) -> tuple[int, int, int, int, int]:
        need(self.predecessor_v11 is not None and
             self.v5_rejection is not None and
             self.shape_incident is not None,
             "v12 inherited incident evidence fully bound")
        return (
            self.by_path[V12_EXACT10_PINS[3][0]].fd,
            self.by_path[V12_EXACT10_PINS[4][0]].fd,
            self.by_path[V12_EXACT10_PINS[7][0]].fd,
            self.v5_rejection.fd,
            self.rejection.fd,
        )
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        for item in self.files:
            item.terminal_replay()
        need(self.namespace is not None and
             self.predecessor_v11 is not None and
             self.v5_rejection is not None and
             self.shape_incident is not None,
             "v12 exact10, namespace, history, and incident held")
        self.namespace.terminal_replay(rejection)
        need(derive_v12_v5_rejection_shape_incident(
                 self.by_path[V12_EXACT10_PINS[3][0]].raw,
                 self.by_path[V12_EXACT10_PINS[4][0]].raw,
                 self.by_path[V12_EXACT10_PINS[7][0]].raw,
                 self.v5_rejection.raw, rejection.raw) ==
                 self.shape_incident,
             "terminal v12 exact39-vs-52 incident replay")
        self._assert_positive_runtime_absence()
...
class HeldV11RejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            ...
            path_before = root_lstat(self.path)
            first = set(os.listdir(self.fd))
            member = os.stat(V11_OFFICIAL_REJECTION.name, dir_fd=self.fd,
                             follow_symlinks=False)
            after = os.fstat(self.fd)
            path_after = root_lstat(self.path)
            second = set(os.listdir(self.fd))
            need(stat.S_ISDIR(self.before.st_mode) and
                 ...
                 fingerprint(path_before) == fingerprint(self.before) ==
                     fingerprint(after) == fingerprint(path_after) and
                 first == second == {V11_OFFICIAL_REJECTION.name} and
                 (member.st_dev, member.st_ino) == rejection.identity and
                 self.mount_id == rejection.mount_id == coordination.mount_id,
                 "official v11 rejection exact singleton namespace held under lock")
        except BaseException:
            os.close(self.fd)
            self.fd = -1
            raise
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(fingerprint(before) == fingerprint(path_before) ==
             ...
             (member.st_dev, member.st_ino) == rejection.identity and
             mount_id(self.fd) == self.mount_id,
             "official v11 rejection namespace terminal singleton replay")
...
class HeldV11PredecessorExact10:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            for path, file_pin, _ in V11_EXACT10_PINS:
                self.files.append(HeldFile(
                    path, "frozen v11 exact10:" + path.name, file_pin))
            self.by_path = {item.path: item for item in self.files}
            need(len(self.by_path) == 10 and
                 len({item.identity for item in self.files}) == 10 and
                 len({item.mount_id for item in self.files}) == 1 and
                 next(iter({item.mount_id for item in self.files})) ==
                     coordination.mount_id == rejection.mount_id,
                 "frozen v11 exact10 unique live files on coordination mount")
            for path, _, object_pin in V11_EXACT10_PINS:
                if object_pin is not None:
                    value = strict_json(self.by_path[path].raw,
                                        "frozen v11 object:" + path.name)
                    need(isinstance(value, dict), "frozen v11 object mapping")
                    verify_object(value, "frozen v11 object:" + path.name,
                                  object_pin)
            expected_exact8 = [
                {"path": str(path.relative_to(ROOT)), "file_sha256": file_pin}
                for path, file_pin, _ in V11_EXACT10_PINS[:8]
            ]
            need(parse_manifest(self.files[8].raw) == expected_exact8,
                 "frozen v11 exact8 manifest reconstructed exactly")
            ...
            need(self.files[9].raw == canonical(outer) + b"\n" and
                 ...
                 outer.get("exact8_ordered_entries") == expected_exact8 and
                 outer.get("cold_launch_manifest", {}).get("file_sha256") ==
                     V11_EXACT10_PINS[8][1] and
                 outer.get("cold_launcher", {}).get("file_sha256") ==
                     V11_EXACT10_PINS[7][1] and
                 outer.get("formal_global_closure_credit") == 0 and
                 outer.get("D02_unlock") is False and
                 outer.get("runtime_executed_during_static_freeze") is False and
                 all(chronology.values()) and
                 max(self.files[9].before.st_mtime_ns,
                     ...
                     min(rejection.before.st_mtime_ns,
                         rejection.before.st_ctime_ns),
                 "frozen v11 exact10 outer then strictly later rejection closure")
            ...
            verify_object(rejected, "official v11 later rejection",
                          V11_REJECTION_OBJECT_PIN)
            need(rejection.raw == canonical(rejected) + b"\n" and
                 rejected.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer.v11."
                 ...
                 rejected.get("closed_schema_file_sha256") ==
                     V11_EXACT10_PINS[1][1] and
                 rejected.get("contract_file_sha256") == V11_EXACT10_PINS[2][1] and
                 rejected.get("contract_object_sha256") == V11_EXACT10_PINS[2][2] and
                 rejected.get("producer_file_sha256") == V11_EXACT10_PINS[3][1] and
                 rejected.get("consumer_file_sha256") == V11_EXACT10_PINS[4][1] and
                 rejected.get("cold_launcher_file_sha256") == V11_EXACT10_PINS[7][1] and
                 rejected.get("cold_manifest_file_sha256") == V11_EXACT10_PINS[8][1] and
                 rejected.get("cold_outer_file_sha256") == V11_EXACT10_PINS[9][1] and
                 rejected.get("cold_outer_object_sha256") == V11_EXACT10_PINS[9][2] and
                 rejected.get("v10_official_rejection_file_sha256") ==
                     V10_REJECTION_FILE_PIN and
                 rejected.get("v10_official_rejection_object_sha256") ==
                     V10_REJECTION_OBJECT_PIN and
                 rejected.get("formal_global_closure_credit") == 0 and
                 rejected.get("D02_unlock") is False and
                 rejected.get("D02_started") is False and
                 rejected.get("standalone_authority") is False and
                 rejected.get("overwrite_delete_or_reuse_allowed") is False,
                 "official v11 rejection binds published v11 exact10")
    ...
    @staticmethod
    def _assert_positive_runtime_absence() -> None:
        need(len(V11_FORBIDDEN_RUNTIME_PATHS) == 12,
             "v11 exact twelve forbidden runtime paths")
        for path in V11_FORBIDDEN_RUNTIME_PATHS:
            root_absent(path,
                        "officially rejected v11 runtime surface:" + path.name)

    def bind_predecessors(
            self, predecessor_v10: "HeldV10PredecessorExact10",
            predecessor_v9: "HeldV9PredecessorExact10") -> None:
        need(self.predecessor_v10 is None and self.predecessor_v9 is None,
             "v11 predecessor held-byte evidence binds once")
        witness = derive_v10_colon_prefix_witness(
            predecessor_v10.by_path[V10_EXACT10_PINS[3][0]].raw,
            predecessor_v9.by_path[V9_EXACT10_PINS[7][0]].raw)
        need(len(witness) == V10_COLON_PREFIX_WITNESS_KEY_COUNT and
             witness.get("object_sha256") ==
                 V10_COLON_PREFIX_WITNESS_OBJECT_PIN and
             witness.get("successor_all_clauses_true") is True and
             witness.get("formal_global_closure_credit") == 0,
             "held v10/v9 exact per-clause colon-prefix witness")
        validate_v11_dual_validator_divergence(
            self.by_path[V11_EXACT10_PINS[3][0]].raw,
            self.by_path[V11_EXACT10_PINS[7][0]].raw,
            witness)
    ...
    def inherited_evidence_fds(self) -> tuple[int, int, int, int, int]:
        need(self.predecessor_v10 is not None and self.predecessor_v9 is not None,
             "v11 inherited predecessor fd evidence bound")
        return (
            ...
            self.by_path[V11_EXACT10_PINS[7][0]].fd,
            self.rejection.fd,
        )
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        self.namespace.terminal_replay(rejection)
        need(self.predecessor_v10 is not None and
             self.predecessor_v9 is not None and
             self.colon_witness is not None and
             derive_v10_colon_prefix_witness(
                 ...
                 self.colon_witness,
             "terminal v11 exact per-clause witness replay")
        validate_v11_dual_validator_divergence(
            self.by_path[V11_EXACT10_PINS[3][0]].raw,
            self.by_path[V11_EXACT10_PINS[7][0]].raw,
            self.colon_witness)
...
class HeldV10RejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            ...
            path_before = root_lstat(self.path)
            first = set(os.listdir(self.fd))
            member = os.stat(V10_OFFICIAL_REJECTION.name, dir_fd=self.fd,
                             follow_symlinks=False)
            after = os.fstat(self.fd)
            path_after = root_lstat(self.path)
            second = set(os.listdir(self.fd))
            need(stat.S_ISDIR(self.before.st_mode) and
                 ...
                 fingerprint(path_before) == fingerprint(self.before) ==
                     fingerprint(after) == fingerprint(path_after) and
                 first == second == {V10_OFFICIAL_REJECTION.name} and
                 (member.st_dev, member.st_ino) == rejection.identity and
                 self.mount_id == rejection.mount_id == coordination.mount_id,
                 "official v10 rejection exact singleton namespace held under lock")
        except BaseException:
            os.close(self.fd)
            self.fd = -1
            raise
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        need(fingerprint(before) == fingerprint(path_before) ==
             ...
             (member.st_dev, member.st_ino) == rejection.identity and
             mount_id(self.fd) == self.mount_id,
             "official v10 rejection namespace terminal singleton replay")
...
class HeldV10PredecessorExact10:
    ...
    def __init__(self, coordination: HeldCoordinationParent,
        ...
        try:
            for path, file_pin, _ in V10_EXACT10_PINS:
                self.files.append(HeldFile(
                    path, "frozen v10 exact10:" + path.name, file_pin))
            self.by_path = {item.path: item for item in self.files}
            need(len(self.by_path) == 10 and
                 len({item.identity for item in self.files}) == 10 and
                 len({item.mount_id for item in self.files}) == 1 and
                 next(iter({item.mount_id for item in self.files})) ==
                     coordination.mount_id == rejection.mount_id,
                 "frozen v10 exact10 unique live files on coordination mount")
            for path, _, object_pin in V10_EXACT10_PINS:
                if object_pin is not None:
                    value = strict_json(self.by_path[path].raw,
                                        "frozen v10 object:" + path.name)
                    need(isinstance(value, dict), "frozen v10 object mapping")
                    verify_object(value, "frozen v10 object:" + path.name,
                                  object_pin)
            expected_exact8 = [
                {"path": str(path.relative_to(ROOT)), "file_sha256": file_pin}
                for path, file_pin, _ in V10_EXACT10_PINS[:8]
            ]
            need(parse_manifest(self.files[8].raw) == expected_exact8,
                 "frozen v10 exact8 manifest reconstructed exactly")
            ...
            need(self.files[9].raw == canonical(outer) + b"\n" and
                 outer.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer."
                     "cold-launch-outer-receipt.v10" and
                 outer.get("status") ==
                     "FROZEN_COLD_LAUNCH_OUTER_LAST__EXACT8_MANIFEST_CLOSED__"
                     "RUNTIME_DEFERRED" and
                 outer.get("effective_checkpoint_object_sha256") == CHECKPOINT and
                 outer.get("exact8_ordered_entries") == expected_exact8 and
                 outer.get("cold_launch_manifest", {}).get("file_sha256") ==
                     V10_EXACT10_PINS[8][1] and
                 outer.get("cold_launcher", {}).get("file_sha256") ==
                     V10_EXACT10_PINS[7][1] and
                 outer.get("formal_global_closure_credit") == 0 and
                 outer.get("D02_unlock") is False and
                 outer.get("runtime_executed_during_static_freeze") is False and
                 all(chronology.values()) and
                 max(self.files[9].before.st_mtime_ns,
                     ...
                     min(rejection.before.st_mtime_ns,
                         rejection.before.st_ctime_ns),
                 "frozen v10 exact10 outer then strictly later rejection closure")
            ...
            verify_object(rejected, "official v10 later rejection",
                          V10_REJECTION_OBJECT_PIN)
            need(rejection.raw == canonical(rejected) + b"\n" and
                 rejected.get("schema") ==
                     "cm2.round306c79g.true-global-no-producer-consumer.v10."
                 ...
                 rejected.get("closed_schema_file_sha256") ==
                     V10_EXACT10_PINS[1][1] and
                 rejected.get("contract_file_sha256") == V10_EXACT10_PINS[2][1] and
                 rejected.get("contract_object_sha256") == V10_EXACT10_PINS[2][2] and
                 rejected.get("producer_file_sha256") == V10_EXACT10_PINS[3][1] and
                 rejected.get("consumer_file_sha256") == V10_EXACT10_PINS[4][1] and
                 rejected.get("cold_launcher_file_sha256") == V10_EXACT10_PINS[7][1] and
                 rejected.get("cold_manifest_file_sha256") == V10_EXACT10_PINS[8][1] and
                 rejected.get("cold_outer_file_sha256") == V10_EXACT10_PINS[9][1] and
                 rejected.get("cold_outer_object_sha256") == V10_EXACT10_PINS[9][2] and
                 rejected.get("v9_official_rejection_file_sha256") ==
                     V9_REJECTION_FILE_PIN and
                 rejected.get("v9_official_rejection_object_sha256") ==
                     V9_REJECTION_OBJECT_PIN and
                 rejected.get("formal_global_closure_credit") == 0 and
                 rejected.get("D02_unlock") is False and
                 rejected.get("D02_started") is False and
                 rejected.get("standalone_authority") is False and
                 rejected.get("overwrite_delete_or_reuse_allowed") is False,
                 "official v10 rejection binds published v10 exact10")
    ...
    def _assert_positive_runtime_absence() -> None:
        for path in V10_FORBIDDEN_RUNTIME_PATHS:
            root_absent(path,
                        "officially rejected v10 runtime surface:" + path.name)

    def bind_predecessor_v9(
            self, predecessor_v9: HeldV9PredecessorExact10) -> None:
        need(self.predecessor_v9 is None,
             "v10 predecessor-v9 regression evidence binds once")
        need(v10_regression_label_prefix_gate(
                 self.by_path[V10_EXACT10_PINS[3][0]].raw,
                 predecessor_v9.by_path[V9_EXACT10_PINS[7][0]].raw) ==
                 V10_REGRESSION_LABEL_PREFIX_INCIDENT,
             "held v10 producer regression label-prefix exact gate")
        self.predecessor_v9 = predecessor_v9
    ...
    def terminal_replay(self, rejection: HeldFile) -> None:
        ...
        self.namespace.terminal_replay(rejection)
        need(self.predecessor_v9 is not None and
             v10_regression_label_prefix_gate(
                 self.by_path[V10_EXACT10_PINS[3][0]].raw,
                 self.predecessor_v9.by_path[V9_EXACT10_PINS[7][0]].raw) ==
                 V10_REGRESSION_LABEL_PREFIX_INCIDENT,
             "terminal v10 producer regression label-prefix exact gate")
        self._assert_positive_runtime_absence()
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str,
                    ...
                    bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / (BASE + "_cold_launch_v16.py"),
        ...
        for path, (file_pin, object_pin) in BASE7_PINS.items():
            need(re.fullmatch(r"[0-9a-f]{64}", file_pin) is not None and
                 file_pin != "0" * 64 and
                 (path == V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT or
        ...
        for path in (V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT,
                     CONTRACT, TRANSITION, AUDIT):
        ...
        supersession = self.base_objects[
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT]
        successor_contract = supersession.get("v16_successor_contract", {})
        credit = supersession.get("credit", {})
        need(self.by_path[
                 V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT].raw ==
                 canonical(supersession) + b"\n" and
             supersession.get("status") ==
                 "FROZEN_APPEND_ONLY_V14_RUNTIME_REGISTRY_SHAPE_DRIFT_"
                 "REJECTION__ZERO_CREDIT__V16_SUCCESSOR_ONLY" and
             supersession.get("object_sha256") ==
                 V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_OBJECT_PIN and
             credit == {
                 "D02_formal_pending_task_count": 33_638,
                 "D02_gate_credit": 0, "D02_started": False,
                 "D02_task_credit": 0, "D02_unlock": False,
                 "formal_global_closure_credit": 0,
             } and
             successor_contract.get("v16_current_exact8_first_member_must_be_this_receipt")
                 is True and
             successor_contract.get(
                 "v16_must_directly_hold_and_terminally_replay_v14_exact10_plus_official_rejection_plus_this_receipt")
                 is True and
             successor_contract.get(
                 "v16_inherited_published_incident_authority_exact12_count") == 12 and
             successor_contract.get(
                 "v16_launcher_registry_helper_must_require_explicit67_plus_execution_proof7_plus_object_closure1_equals75")
                 is True,
        ...
        v13_supersession = strict_json(
            self.v14_inherited_authority_by_role[
                "v13_supersession_receipt"].raw,
            "v14 exact12 inherited v13 supersession receipt")
        need(isinstance(v13_supersession, dict),
             "v14 exact12 inherited v13 supersession receipt object")
        need(set(self.base_objects[TRANSITION]) == {
                 ...
                 "published_then_officially_rejected_predecessor_v12",
                 "rejected_prepublication_v13_supersession_receipt",
                 "successor_v16_static_bundle", "physical_mode_policy",
             ...
             self.base_objects[TRANSITION].get("schema") ==
                 "cm2.round306c79g.true-global-no-producer-consumer."
                 "v13-to-v16-static-launch-transition.v1" and
             self.base_objects[TRANSITION].get("transition_kind") ==
                 "APPEND_ONLY_V13_PREPUBLICATION_PYC_CONTAMINATION_REJECTION_"
                 "TO_ZERO_CREDIT_V16_STATIC_SUCCESSOR",
             "transition exact top-level v13-to-v16 closed shape")
        need(set(self.base_objects[CONTRACT]) == {
             ...
             self.base_objects[CONTRACT].get("schema") ==
                 "cm2.round306c79g.true-global-no-producer-consumer.v16.contract" and
             self.base_objects[CONTRACT].get("status") ==
                 "STATIC_CONTRACT_BYTES_FINAL__COLD_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED" and
             self.base_objects[TRANSITION].get("status") ==
                 "STATIC_BYTES_CLOSED_V14_TO_V16__PHYSICAL_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED" and
        ...
        for proof_path in (CONTRACT, TRANSITION, AUDIT):
            ...
            validate_v13_supersession_summary(
                self.base_objects[proof_path].get(
                    "rejected_prepublication_v13_supersession_receipt"),
                v13_supersession, proof_path.name)
        contract_witness = self.base_objects[CONTRACT].get(
            "v10_colon_prefix_witness")
        audit_witness = self.base_objects[AUDIT].get(
            "v10_colon_prefix_witness")
        need(isinstance(contract_witness, dict) and
             contract_witness == audit_witness and
             tuple(contract_witness) == V10_COLON_PREFIX_WITNESS_KEY_ORDER and
             contract_witness.get("object_sha256") ==
                 V10_COLON_PREFIX_WITNESS_OBJECT_PIN and
             self.base_objects[CONTRACT].get(
                 "v11_dual_validator_divergence_incident") ==
                 self.base_objects[AUDIT].get(
                     "v11_dual_validator_divergence_incident") ==
                 V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT,
             "contract and audit exact v11 incident and witness consensus")
        ...
        need(set(self.outer_object) == {
             ...
             self.outer_object.get("schema") ==
                 "cm2.round306c79g.true-global-no-producer-consumer."
                 "cold-launch-outer-receipt.v16" and
        ...
        # V12 rejection remains historical authority.  The current exact8
        # begins with the frozen v14 rejection-supersession receipt, while the
        # v13 receipt is inherited as role one of v14 exact12.  The six
        # contaminated v13 source/pyc identities remain launcher-internal
        # historical evidence and are never passed to a child.
        self.v12_rejection = HeldFile(
            V12_OFFICIAL_REJECTION, "official v12 later rejection",
            V12_REJECTION_FILE_PIN)
        v13_source_pins = (
            (V13_FROZEN_PRODUCER, V13_PRODUCER_FILE_PIN),
            (V13_FROZEN_CONSUMER, V13_CONSUMER_FILE_PIN),
            (V13_FROZEN_LAUNCHER, V13_LAUNCHER_FILE_PIN),
        )
        v13_pyc_pins = (
            (V13_FROZEN_PRODUCER_PYC, V13_PRODUCER_PYC_FILE_PIN),
            (V13_FROZEN_CONSUMER_PYC, V13_CONSUMER_PYC_FILE_PIN),
            (V13_FROZEN_LAUNCHER_PYC, V13_LAUNCHER_PYC_FILE_PIN),
        )
        self.v13_incident_sources = [
            HeldFile(path, "frozen v13 incident source:" + path.name, pin)
            for path, pin in v13_source_pins
        ]
        self.v13_incident_pycs = [
            HeldFile(path, "frozen v13 incident pyc:" + path.name, pin)
            for path, pin in v13_pyc_pins
        ]
        validate_v13_supersession_receipt(
            v13_supersession,
            [*self.v13_incident_sources, *self.v13_incident_pycs])
        incident_guards = [
            *self.v13_incident_sources, *self.v13_incident_pycs,
            self.v12_rejection,
            self.v14_inherited_authority_by_role[
        ...
        need(len({item.identity for item in incident_guards}) == 8 and
             len({item.mount_id for item in incident_guards}) == 1 and
             next(iter({item.mount_id for item in incident_guards})) ==
                 coordination.mount_id,
             "v13 exact6, receipt, and v12 rejection are distinct held files")
        self.predecessor_v12 = HeldV12PredecessorExact10(
            coordination, self.v12_rejection)
        self.predecessor_v11 = HeldV11PredecessorExact10(
            coordination,
            self.predecessor_v12.by_path[V11_OFFICIAL_REJECTION])
        self.predecessor_v10 = HeldV10PredecessorExact10(
            coordination,
            self.predecessor_v11.by_path[V10_OFFICIAL_REJECTION])
        self.predecessor_v9 = HeldV9PredecessorExact10(
            coordination,
            self.predecessor_v10.by_path[V9_OFFICIAL_REJECTION])
        self.predecessor_v10.bind_predecessor_v9(self.predecessor_v9)
        self.predecessor_v11.bind_predecessors(
            self.predecessor_v10, self.predecessor_v9)
        self.predecessor_v8 = HeldV8PredecessorExact10(
            coordination, self.predecessor_v9.by_path[V8_OFFICIAL_REJECTION])
        self.predecessor_v7 = HeldV7PredecessorExact10(
            coordination, self.predecessor_v8.by_path[V7_OFFICIAL_REJECTION])
        self.predecessor_v6 = HeldV6PredecessorExact10(
            coordination, self.predecessor_v7.by_path[V6_OFFICIAL_REJECTION])
        need(self.predecessor_v6.held_self_identity_structural_evidence.get(
                 "guard_identity_structural_census") ==
                 V8_LAUNCHER_REGRESSION_DEFECT["actual_guard_identity_census"] and
             self.predecessor_v6.held_self_identity_structural_evidence.get(
                 "target_structural_comprehension_count") == 1 and
             self.predecessor_v6.held_self_identity_defect ==
                 V9_V6_PROOF_SHAPE_DRIFT_INCIDENT[
                     "persisted_held_self_identity_defect"] and
             V8_LAUNCHER_REGRESSION_DEFECT["old_global_count_expectation"] == 1,
             "v8/v9 incidents join pinned v6 structural16 and persisted9")
        self.predecessor_v5 = HeldV5PredecessorExact10(
            coordination, self.predecessor_v6.by_path[V5_OFFICIAL_REJECTION])
        self.predecessor_v12.bind_history(
            self.predecessor_v11,
        ...
        contract_static_census = self.base_objects[CONTRACT].get(
            "v16_bundle", {}).get("cold_launch_outer_closure", {})
        need(self.global_identity_census == {
                 "v16_predecessor_unique_live_identity_count": 116,
                 "v16_prepublication_unique_live_identity_count": 124,
                 "v16_terminal_unique_live_identity_count": 126,
                 "v16_terminal_group_vector":
                     [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
                      7, 1, 3, 3, 1, 1],
                 "all_126_file_identities_share_one_statx_mount": True,
                 "all_126_held_descriptors_are_pairwise_distinct": True,
                 ...
                 "on_one_statx_mount": True,
             } and
             isinstance(contract_static_census, dict) and
             contract_static_census.get(
                 "current_v16_exact10_plus_all_append_only_predecessors_"
                 "unique_file_identity_count") ==
                 self.global_identity_census[
                     "v16_terminal_unique_live_identity_count"] and
             all(contract_static_census.get(key) ==
                     self.global_identity_census[key]
                 for key in (
                     "v16_predecessor_unique_live_identity_count",
                     "v16_prepublication_unique_live_identity_count",
                     "v16_terminal_unique_live_identity_count",
                     "v16_terminal_group_vector",
                     "all_126_file_identities_share_one_statx_mount")) and
             next(iter({guard.mount_id for guard in [
                 *self.files, self.manifest, self.outer,
                 *self.v14_inherited_authority_exact12_owned,
             ]})) == coordination.mount_id,
             "current v16 exact10 plus all predecessors are an exact "
             "126-file terminal census (124 prepublication) on one mount")
        validate_final_static_audit(
            self.base_objects[AUDIT], self.schema, self.schema_keywords,
            self.by_path, self.base_objects,
            self.predecessor_v5, self.predecessor_v6, self.predecessor_v7,
            self.predecessor_v8, self.predecessor_v9, self.predecessor_v10,
            self.predecessor_v11, self.predecessor_v12,
            self.by_path[SELF].raw)
    ...
    def _global_identity_census(self) -> dict[str, Any]:
        ...
        """
        need(self.manifest is not None and self.outer is not None and
             self.predecessor_v3 is not None and
             self.predecessor_v5 is not None and
             self.predecessor_v6 is not None and
             self.predecessor_v7 is not None and
             self.predecessor_v8 is not None and
             self.predecessor_v9 is not None and
             self.predecessor_v10 is not None and
             self.predecessor_v11 is not None and
             self.predecessor_v12 is not None and
             self.rejected_v4 is not None and
             self.v3_rejection is not None and self.v12_rejection is not None and
             tuple(self.v14_inherited_authority_by_role) ==
                 V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER,
             "complete current and predecessor guards for global census")
        current_exact10 = [*self.files, self.manifest, self.outer]
        v14_published_exact10 = [
            self.v14_inherited_authority_by_role[role]
            for role, _, _, _ in V14_PUBLISHED_EXACT10_WITNESS
        ]
        v14_official_rejection = [
            self.v14_inherited_authority_by_role["v14_official_rejection"]]
        v14_supersession = self.v14_inherited_authority_by_role[
            "v14_registry_shape_drift_supersession_receipt"]
        group_guards = [
            current_exact10,
            self.predecessor_v12.files,
            self.predecessor_v11.files,
            self.predecessor_v10.files,
            self.predecessor_v9.files,
            self.predecessor_v8.files,
            self.predecessor_v7.files,
            self.predecessor_v6.files,
            self.predecessor_v5.files,
            self.predecessor_v3.files,
            v14_published_exact10,
            self.rejected_v4.files,
            [self.v3_rejection],
            self.v13_incident_sources,
            self.v13_incident_pycs,
            [self.v12_rejection],
        ...
        identity_groups = [
            {guard.identity for guard in group} for group in group_guards]
        ...
        prepublication_identities = (
            current_exact8_identities | predecessor_identities)
        all_guards = [guard for group in group_guards for guard in group]
        pairwise_disjoint = all(
            identity_groups[left].isdisjoint(identity_groups[right])
            for left in range(len(identity_groups))
            for right in range(left + 1, len(identity_groups)))
        all_mount_ids = {guard.mount_id for guard in all_guards}
        owned_v14_identities = {
            guard.identity
            for guard in self.v14_inherited_authority_exact12_owned}
        current_first_is_receipt = (
            len(self.files) == 8 and EXACT8[0] ==
                V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT and
            self.files[0] is v14_supersession and
            self.by_path[EXACT8[0]] is v14_supersession and
            v14_supersession.identity in current_exact8_identities)
        exact_vector = (
            terminal_group_vector ==
                [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
                 7, 1, 3, 3, 1, 1])
        exact_partition = (
            pairwise_disjoint and len(all_guards) == 126 and
            len(terminal_identities) == 126 and
            len(predecessor_identities) == 116 and
            len(prepublication_identities) == 124 and
            terminal_identities - prepublication_identities == {
                self.manifest.identity, self.outer.identity} and
            current_exact8_identities.isdisjoint(predecessor_identities) and
            len(owned_v14_identities) == 11 and
            owned_v14_identities ==
                ({guard.identity for guard in v14_published_exact10} |
                 {v14_official_rejection[0].identity}) and
        ...
        need(exact_vector and exact_partition and one_mount and
             ...
             "global exact126 terminal/exact124 prepublication identity "
             "partition, v14 exact12 overlap, descriptors, and mount")
        return {
            "v16_predecessor_unique_live_identity_count":
            ...
            "v16_terminal_group_vector": terminal_group_vector,
            "all_126_file_identities_share_one_statx_mount": one_mount,
            "all_126_held_descriptors_are_pairwise_distinct":
                distinct_descriptors,
            "current_exact8_first_member_is_v14_registry_shape_drift_"
            "supersession_receipt": current_first_is_receipt,
            "all_current_and_historical_124_identities_globally_unique_"
            "on_one_statx_mount": (
                exact_partition and one_mount and
                len(prepublication_identities) == 124),
        }

    def _hold_v14_inherited_authority_exact12(
            self, coordination: HeldCoordinationParent) -> None:
        """Hold v14 exact10, rejection, and final receipt in fixed order.

        The final receipt is already the first current-v16 exact8 guard and is
        ...
        """
        need(not self.v14_inherited_authority_exact12 and
             not self.v14_inherited_authority_exact12_owned and
             not self.v14_inherited_authority_by_role,
             "v14 inherited authority exact12 binds once")
        need(tuple(role for role, _ in
                   V14_INHERITED_AUTHORITY_EXACT12_FD_ENV_ORDER) ==
                 V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER and
             len(V14_INHERITED_AUTHORITY_EXACT12_FD_ENV_ORDER) ==
                 V16_CHILD_AUTHORITY_DESCRIPTOR_COUNT == 12,
             "v14 exact12 role/environment order closure")
        for role, relative_path, file_pin, _ in \
                V14_INHERITED_AUTHORITY_EXACT12:
            path = ROOT / relative_path
            if role == "v14_registry_shape_drift_supersession_receipt":
                guard = self.by_path[
                    V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT]
                need(guard.path == path,
                     "v14 exact12 final receipt reuses current exact8 first guard")
            else:
                guard = HeldFile(
                    path, "v14 inherited authority exact12:" + role, file_pin)
                self.v14_inherited_authority_exact12_owned.append(guard)
            need(guard.file_sha256 == file_pin,
                 "v14 inherited authority exact12 file pin:" + role)
        ...
        need(len(guards) == len({guard.fd for guard in guards}) ==
                 len({guard.identity for guard in guards}) == 12 and
             len({guard.mount_id for guard in guards}) == 1 and
             next(iter({guard.mount_id for guard in guards})) ==
                 coordination.mount_id and
             guards[-1] is self.files[0],
             "v14 inherited authority exact12 unique same-mount held guards")
        held_raw_by_role = {
            role: self.v14_inherited_authority_by_role[role].raw
            for role in V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER
        }
        self.v14_inherited_authority_initial_replay = \
            terminal_replay_v14_inherited_authority_exact12(held_raw_by_role)

    def inherited_v14_authority_exact12_fds(self) -> tuple[int, ...]:
        need(tuple(self.v14_inherited_authority_by_role) ==
                 V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER and
             len(self.v14_inherited_authority_exact12) == 12,
             "v14 inherited authority exact12 remains held")
        result = tuple(
            self.v14_inherited_authority_by_role[role].fd
            for role in V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER)
        need(len(result) == len(set(result)) ==
                 V16_CHILD_AUTHORITY_DESCRIPTOR_COUNT == 12,
             "v14 inherited authority exact12 descriptors pairwise distinct")
        return result
    ...
    def terminal_replay(self) -> None:
        need(self.predecessor_v3 is not None and
             ...
             self.rejected_v4 is not None and
             self.v3_rejection is not None and self.v12_rejection is not None and
             len(self.v13_incident_sources) == 3 and
             len(self.v13_incident_pycs) == 3 and self.manifest is not None and
             self.outer is not None and
             len(self.v14_inherited_authority_exact12) == 12 and
             self.v14_inherited_authority_initial_replay is not None,
        ...
        for guard in self.v14_inherited_authority_exact12:
            guard.terminal_replay()
        replayed_v14_authority = \
            terminal_replay_v14_inherited_authority_exact12({
                role: self.v14_inherited_authority_by_role[role].raw
                for role in V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER
            })
        need(replayed_v14_authority ==
                 self.v14_inherited_authority_initial_replay,
             "v14 inherited authority exact12 terminal replay unchanged")
...
def child_environment(bundle: HeldBundle, child_exec: HeldSealedChildExec,
    ...
    need(tuple(role for role, _ in
             ...
             V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER and
         len(authority_fds) ==
             len(V14_INHERITED_AUTHORITY_EXACT12_FD_ENV_ORDER) == 12,
         "v14 exact12 child environment role/fd order")
    authority_environment = {
        env_name: str(descriptor)
        for ((_, env_name), descriptor) in zip(
            V14_INHERITED_AUTHORITY_EXACT12_FD_ENV_ORDER,
            authority_fds, strict=True)
    }
    result = {
        "LC_ALL": "C",
        "TZ": "UTC",
    ...
    need(len(authority_environment) == 12 and
         set(authority_environment) == {
             env_name for _, env_name in
             V14_INHERITED_AUTHORITY_EXACT12_FD_ENV_ORDER} and
         all(env_name.startswith("CM2_C79G_V16_V14_") and
             env_name.endswith("_FD")
             for env_name in authority_environment),
         "children receive only the twelve ordered v14 authority environments")
    return result


def child_pass_fds(bundle: HeldBundle, child_exec: HeldSealedChildExec,
                   source: HeldFile,
                   coordination: HeldCoordinationParent) -> tuple[int, ...]:
    result = (
        child_exec.fd, source.fd, coordination.fd, bundle.bootstrap.root_fd,
        *bundle.inherited_v14_authority_exact12_fds(),
    )
    need(len(result) == len(set(result)) ==
             V16_CHILD_PASS_FD_COUNT ==
             V16_BOOTSTRAP_DESCRIPTOR_COUNT +
             V16_CHILD_AUTHORITY_DESCRIPTOR_COUNT == 16,
         "child exact sixteen inherited descriptors are pairwise distinct")
    return result
    ...
    try:
        ...
        completed = subprocess.run(
            ...
            pass_fds=child_pass_fds(
                bundle, child_exec, source, coordination),
            check=False)
        if completed.stderr:
...
def cold_root(bundle: HeldBundle, coordination: HeldCoordinationParent,
    ...
    need(bundle.predecessor_v5 is not None and
         bundle.predecessor_v6 is not None and
         bundle.predecessor_v7 is not None and
         bundle.predecessor_v8 is not None and
         bundle.predecessor_v9 is not None and
         bundle.predecessor_v10 is not None and
         bundle.predecessor_v11 is not None,
         "v11 direct predecessor and v10/v9/v8/v7/v6/v5 history remain held")
    ...
    need(bundle.global_identity_census is not None and
         live_global_identity_census == bundle.global_identity_census,
         "cold-root live global exact126/exact124 identity census unchanged")
    proof = {
        ...
        "v7_official_rejection_identity": {
            **predecessor_v8.by_path[V7_OFFICIAL_REJECTION].identity_object(),
            "object_sha256": V7_REJECTION_OBJECT_PIN,
        },
        "v7_official_rejection_file_sha256": V7_REJECTION_FILE_PIN,
        "v7_official_rejection_object_sha256": V7_REJECTION_OBJECT_PIN,
        "v6_official_rejection_identity": {
            **predecessor_v7.by_path[V6_OFFICIAL_REJECTION].identity_object(),
            "object_sha256": V6_REJECTION_OBJECT_PIN,
        },
        "v6_official_rejection_file_sha256": V6_REJECTION_FILE_PIN,
        "v6_official_rejection_object_sha256": V6_REJECTION_OBJECT_PIN,
        "v5_official_rejection_identity": {
            **predecessor_v6.by_path[V5_OFFICIAL_REJECTION].identity_object(),
            "object_sha256": V5_REJECTION_OBJECT_PIN,
        },
        "v5_official_rejection_file_sha256": V5_REJECTION_FILE_PIN,
        "v5_official_rejection_object_sha256": V5_REJECTION_OBJECT_PIN,
        ...
        "all_current_and_historical_124_identities_globally_unique_on_one_statx_mount":
            live_global_identity_census[
                "all_current_and_historical_124_identities_globally_unique_"
                "on_one_statx_mount"],
        "current_v16_and_all_predecessor_unique_file_identity_count":
            live_global_identity_census[
                "v16_prepublication_unique_live_identity_count"],
        "current_v16_and_all_predecessor_same_statx_mount":
            live_global_identity_census[
                "all_126_file_identities_share_one_statx_mount"],
        **bundle.chronology,
        ...
        "published_then_officially_rejected_predecessor_v9":
            expected_v9_published_rejected_segment(),
        "published_then_officially_rejected_predecessor_v10":
            expected_v10_published_rejected_segment(),
        "published_then_officially_rejected_predecessor_v11":
            expected_v11_published_rejected_segment(),
        "published_then_officially_rejected_predecessor_v12":
            expected_v12_published_rejected_segment(),
        "v12_official_rejection_file_sha256": V12_REJECTION_FILE_PIN,
        "v12_official_rejection_object_sha256": V12_REJECTION_OBJECT_PIN,
        "v12_v5_rejection_shape_incident": copy.deepcopy(
            V12_V5_REJECTION_SHAPE_INCIDENT),
        "published_then_officially_rejected_predecessor_v7":
            expected_v7_published_rejected_segment(),
        "official_v7_later_rejection": {
            "path": str(V7_OFFICIAL_REJECTION.relative_to(ROOT)),
            "namespace_path": str(V7_OFFICIAL_REJECTION.parent.relative_to(ROOT)),
            "file_sha256": V7_REJECTION_FILE_PIN,
            "object_sha256": V7_REJECTION_OBJECT_PIN,
        ...
        "official_v6_later_rejection": {
            "path": str(V6_OFFICIAL_REJECTION.relative_to(ROOT)),
            "namespace_path": str(V6_OFFICIAL_REJECTION.parent.relative_to(ROOT)),
            "file_sha256": V6_REJECTION_FILE_PIN,
            "object_sha256": V6_REJECTION_OBJECT_PIN,
        },
        "v6_predecessor_HeldSelf_identity_defect":
            predecessor_v6.held_self_identity_defect,
        ...
        "launcher_same_lock_live_v6_exact10_and_official_rejection_held": True,
        "terminal_v6_exact10_and_official_rejection_replay_completed_before_final_dynamic_request": True,
        "launcher_same_lock_live_v7_exact10_and_official_rejection_held": True,
        "terminal_v7_exact10_and_official_rejection_replay_completed_before_final_dynamic_request": True,
        "launcher_same_lock_live_v8_exact10_and_official_rejection_held": True,
        "terminal_v8_exact10_and_official_rejection_replay_completed_before_final_dynamic_request": True,
        "launcher_same_lock_live_v10_exact10_and_official_rejection_held": True,
        "terminal_v10_exact10_and_official_rejection_replay_completed_before_final_dynamic_request": True,
        "v10_regression_label_prefix_incident_validated_by_AST_structure_and_exact_prefix_join":
            v10_regression_label_prefix_gate(
                predecessor_v10.by_path[V10_EXACT10_PINS[3][0]].raw,
                predecessor_v9.by_path[V9_EXACT10_PINS[7][0]].raw) ==
            V10_REGRESSION_LABEL_PREFIX_INCIDENT,
        "v8_rollout_control_flow_incident_validated_without_timestamp_inference": True,
        "v7_interrupted_publication_cannot_be_rehabilitated_by_later_replay": True,
        ...
        "reject_command_exempts_only_fresh_empty_v16_rejection_namespace": True,
...
def _validate_live_ack(
    ...
    expected_keys = {
        ...
        "static_v16_exact10_with_v11_exact10_and_official_rejection_v10_exact10_and_official_rejection_v9_exact10_and_official_rejection_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request",
    ...
    need(set(ack) == expected_keys and ack.get("schema") == LIVE_ACK_SCHEMA and
         ...
         ack.get("static_v16_exact10_with_v11_exact10_and_official_rejection_v10_exact10_and_official_rejection_v9_exact10_and_official_rejection_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
...
def terminal_replay_v14_exact10_and_official_rejection(
    ...
    return {
        ...
        "D02_task_credit": 0,
        "D02_formal_pending_task_count": 33_638,
        "v14_credit_transferred_to_v16": False,
    }


def v14_inherited_authority_draft_state(
        supersession_receipt_exists: bool) -> dict[str, Any]:
    """Prove the legal v16 draft state without opening the frozen receipt."""
    need(V16_DRAFT_RUNTIME_DISABLED is True and
         FINAL_BASE7_PINS_INSTALLED is False and
         ...
         "v16 draft requires frozen pinned v14 receipt and uninstalled v16 base7 pins")
    return {
        "status": "V16_DRAFT_RUNTIME_DISABLED__V14_SUPERSESSION_RECEIPT_FROZEN_PINNED",
        "receipt_path":
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_RELATIVE_PATH,
...
def terminal_replay_v14_inherited_authority_exact12(
    ...
    need(tuple(held_raw_by_role) == V14_INHERITED_AUTHORITY_EXACT12_ROLE_ORDER and
         len(held_raw_by_role) == V16_CHILD_AUTHORITY_DESCRIPTOR_COUNT == 12,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if V16_DRAFT_RUNTIME_DISABLED and not FINAL_BASE7_PINS_INSTALLED:
        raise Reject(
            "C79g v16 successor is a sentinel draft; runtime is disabled")
    need(FINAL_BASE7_PINS_INSTALLED is True,
         "C79g v16 launcher requires final base7 pins")
    ...
    try:
        ...
        if args.command == "reject":
            ...
            return 0
        # Every positive-capable command holds the exact-empty v16 rejection
