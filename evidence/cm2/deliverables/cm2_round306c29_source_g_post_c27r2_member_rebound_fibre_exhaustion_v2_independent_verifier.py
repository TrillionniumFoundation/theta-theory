...
def terminal(
    ...
    require(receipt["terminal_receipt_sha256"] == receipt_object_pin
            and type(receipt.get("status")) is str
    ...
    require(projection.get("schema") == expected_schema
            ...
            and projection.get("terminal_root_manifest_sha256") == root_pin
            and projection.get("terminal_receipt_file_sha256") == receipt_file_pin
            and projection.get("terminal_receipt_object_sha256") == receipt_object_pin
    ...
    require(pass_bytes.startswith(b"PASS_") and pass_bytes.endswith(b"\n")
    ...
    if kind == "C27R2":
        ...
        require(census.get("post_C27R2_components") == COMPONENTS
                ...
                "C28:B2/maximality")
    return {
        "root": root_pin, "receipt_file": receipt_file_pin,
        "receipt_object": receipt_object_pin,
