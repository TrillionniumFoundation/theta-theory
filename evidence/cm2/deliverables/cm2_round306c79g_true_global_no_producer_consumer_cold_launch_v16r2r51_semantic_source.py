...
HISTORICAL_BASE = 'cm2_round306c79g_true_global_no_producer_consumer'
BASE = 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r51_semantic_source'
LAUNCHER_RELATIVE = Path('deliverables') / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r51_semantic_source.py'
...
ACTIVE_PREDECESSOR_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r51_active_predecessor_supersession_receipt_v1.json'
ACTIVE_SUCCESSOR_NAMESPACE = 'v16r2r51_semantic_source'
ACTIVE_SUCCESSOR_NAMESPACE_TAG = 'v16r2r51-semantic-regeneration'
ACTIVE_PREDECESSOR_SUPERSESSION_FILE_PIN = '3d56690089b7691fed7fbcfe18a639ea603afad2c7dcd3befa1b92e91d459d8e'
ACTIVE_PREDECESSOR_SUPERSESSION_OBJECT_PIN = '356e2d17f9a8b8701c6aefc29f11792b1601475594972de2fc6d1a38316b087d'
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r51_active_predecessor_supersession_receipt_v1.json'
RUNTIME = ROOT / '.cm2-runtime'
SELF = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r51_semantic_source.py'
...
SCHEMA = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r51.json'
CONTRACT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r51.json'
PRODUCER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r51_semantic_source.py'
CONSUMER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r51_semantic_source.py'
TRANSITION = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r50_to_v16r2r51_static_launch_transition_receipt_v1.json'
AUDIT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r51.json'
MANIFEST = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r51.sha256'
OUTER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r51.json'
MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r51.sha256'
OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r51.json'
V16R2_DRAFT_RUNTIME_DISABLED = True
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / 'rejection.json'
    SCHEMA = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r51.json'
    CONTRACT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r51.json'
    PRODUCER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r51_semantic_source.py'
    CONSUMER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r51_semantic_source.py'
    TRANSITION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r50_to_v16r2r51_static_launch_transition_receipt_v1.json'
    AUDIT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r51.json'
    MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r51.sha256'
    OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r51.json'
    BASE7_PINS = {V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT: ('aa4323027e2313f8a2eda0d6ffc039a537afe342d496d1f75cd73fcd47446c01', '93689e62ae36f405f045a769f4dc6f6e6fd83a16605d08299d5c3397ad657e2e'), SCHEMA: ('a1fdf6fb9156086ce60aaca72f6fb32db6afc17411ccc07f24da78cf1d15f78c', None), CONTRACT: ('2aac1e71194edf7e2eb85b2c0cb07a52b17f4dbb72385c0481d625dcc75ab8a7', '72c3addc70cf938a9f122eb3770784c203fcf393ef4330173eef35a12ad76643'), PRODUCER: ('03f2aed1f28dd446b1ff84356cc6eae2a65003462b46b7183ab3994f41765bd7', None), CONSUMER: ('934c982dcb00b28d87b608b26bd11d3b6ed2381faef0ab4320dabbef25dff1c0', None), TRANSITION: ('ae7e207e44738f754fe755efba14a0a0995ca895de3f9ae9e7918ce852552de1', '4cae80c590d7296a8385ab5cfe001b563e832bcc96bd80a9b63648e55887a48a'), AUDIT: ('e467e73b6a8b023bf8f557e29ea07eb9ce697eb269949677e8fb46a7aee99f00', '79b1f0f1b485e644bc6f41bc37f67ec801511df9c049c631ea85aaacd4015100')}
...
def producer_source_registry_shape_from_ast(raw: bytes) -> int:
    ...
    try:
        tree = ast.parse(raw.decode('utf-8'), filename='producer_v15', mode='exec')
    except (UnicodeDecodeError, SyntaxError) as exc:
    ...
    need(isinstance(registry_function, (ast.FunctionDef, ast.AsyncFunctionDef)) and isinstance(execution_proof, (ast.FunctionDef, ast.AsyncFunctionDef)), 'current v15 input_registry and HeldSelf.execution_proof')
    ...
    need(len(registry_returns) == 1 and len(proof_returns) == 1, 'unique current v15 registry/proof return dicts')
...
def validate_final_static_audit(audit: Mapping[str, Any], schema: Mapping[str, Any], schema_keywords: frozenset[str], held_by_path: Mapping[Path, 'HeldFile'], base_objects: Mapping[Path, Mapping[str, Any]], predecessor_v5: 'HeldV5PredecessorExact10', predecessor_v6: 'HeldV6PredecessorExact10', predecessor_v7: 'HeldV7PredecessorExact10', predecessor_v8: 'HeldV8PredecessorExact10', predecessor_v9: 'HeldV9PredecessorExact10', predecessor_v10: 'HeldV10PredecessorExact10', predecessor_v11: 'HeldV11PredecessorExact10', predecessor_v12: 'HeldV12PredecessorExact10', launcher_source_raw: bytes) -> None:
    ...
    validate_v13_supersession_summary(audit.get('rejected_prepublication_v13_supersession_receipt'), base_objects[V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT], 'final static audit v13 prepublication rejection')
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str, coordination: HeldCoordinationParent, bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r51_semantic_source.py', 'exact cold launcher path')
        ...
        validate_final_static_audit(self.base_objects[AUDIT], self.schema, self.schema_keywords, self.by_path, self.base_objects, self.predecessor_v5, self.predecessor_v6, self.predecessor_v7, self.predecessor_v8, self.predecessor_v9, self.predecessor_v10, self.predecessor_v11, self.predecessor_v12, self.by_path[SELF].raw)
    ...
    def _global_identity_census(self) -> dict[str, Any]:
        ...
        need(exact_vector and exact_partition and one_mount and distinct_descriptors and current_first_is_receipt, 'global exact126 terminal/exact124 prepublication identity partition, v14 exact12 overlap, descriptors, and mount')
