#!/usr/bin/env python3
"""Hardened append-only r2 runner for the post-actual-v2 C27R2 gate v3.
...
SOURCES = {
    ...
    "independent_verifier": ROOT / "deliverables/cm2_round306c27r2_post_actual_v2_rebuild_gate_v3_independent_verifier_r2.py",
    "coherent_attack_harness": ROOT / "deliverables/cm2_round306c27r2_post_actual_v2_rebuild_gate_v3_coherent_attack_harness_r2.py",
    "python": PYTHON,
}
SOURCE_PINS = {
...
OUTPUT_PREFIX = "c27r2-post-actual-v2-rebuild-gate-v3-r2-zero-credit-"
...
def main() -> int:
    ...
    try:
        ...
        body = {
            "schema": "cm2.round306c27r2.post-actual-v2-rebuild-gate-execution-r2.v3",
            "status": (
                "PASS_HARDENED_R2_GATE_PRODUCER_INDEPENDENT_VERIFIER_AND_16_COHERENT_ATTACKS__"
                "FRESH_C27R2_REBUILD_MAY_BEGIN__ZERO_CREDIT"
                if not negative else
                "PASS_HARDENED_R2_NEGATIVE_MISSING_TERMINAL_SELF_TEST_REJECTED_AND_INDEPENDENTLY_"
        ...
        lock = (
            b"PASS_HARDENED_R2_NEGATIVE_MISSING_TERMINAL_GATE_V3_SELF_TEST__ZERO_CREDIT\n"
            if negative else
            b"PASS_HARDENED_R2_POST_ACTUAL_V2_C27R2_REBUILD_GATE_V3__FRESH_REBUILD_MAY_BEGIN__ZERO_CREDIT\n"
        )
