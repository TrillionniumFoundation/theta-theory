...
VALIDATOR_DEFAULT = ROOT / "deliverables/cm2_round306c27r2_source_g_actual_v2_fresh_quotient_rebuild_v2_release_repair_boundary_independent_validator_v6.py"
...
RESULT_SCHEMA = PREFIX + "release-integrity-fixture.v6"
RESULT_STATUS = (
    "PASS_C27R2_RELEASE_BOUNDARY_V6_CONTROL_70_OF_70_REAL_SINGLE_OPEN_"
    "VALIDATOR_WRAPPERS_AND_8_OF_8_PUBLICATION_LOCK_PREFLIGHTS_REJECTED_"
    "WITH_TEN_PROPERTY_SERVICE_IDENTITY__ZERO_CREDIT"
)
PASS_BYTES = (
    b"PASS_C27R2_RELEASE_BOUNDARY_V6_70_VALIDATOR_PLUS_8_LOCK_CHECKS__"
    b"ZERO_CREDIT\n"
)
...
def execute(args: argparse.Namespace) -> dict[str, Any]:
    ...
    need(work.parent == AUDIT and work.name.startswith(
         "c27r2-release-repair-integrity-v6-")
    ...
    need(baseline_value.get("status")
             == "PASS_C27R2_RELEASE_REPAIR_BOUNDARY_V6_FORMAL_EMPTY_OVERRIDE_EXACT_SPEC_ATTESTATION_INPUT_SET_FIXED_USER_BUS_SERVICE_QUERY_TEN_PROPERTY_EXECSTART_FRAGMENT_CURRENT_PROCESS_INVENTORY_AND_AUTHORITY_CLOSURE__ZERO_CREDIT"
...
def self_test() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="c27r2-fixture-runner-v6-") as raw:
        root = Path(raw)
        lock_body = {
