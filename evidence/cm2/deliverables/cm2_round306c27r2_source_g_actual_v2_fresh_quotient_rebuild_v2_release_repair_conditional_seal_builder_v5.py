#!/usr/bin/env python3
"""Build a strictly conditional C27R2 v5 seal; never mint authority.
...
def self_test() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(dir=ROOT / ".cm2-runtime",
            prefix="c27r2-seal-v5-selftest-") as raw:
    ...
    return {"status": "PASS_C27R2_RELEASE_REPAIR_CONDITIONAL_SEAL_V5_SELF_TEST"}
