#!/usr/bin/env python3
"""Externally pinned cold launcher for the C79g v14 exact10 static bundle.
...
LAUNCHER_RELATIVE = Path("deliverables") / (BASE + "_cold_launch_v14.py")
...
ROOT = Path("/__C79G_V14_UNCONFIGURED_ROOT__")
...
V14_REJECTION_NAMESPACE = ROOT / "__unconfigured_v14_rejections__"
V14_LATER_REJECTION = V14_REJECTION_NAMESPACE / "rejection.json"
...
V14_DRAFT_RUNTIME_DISABLED = True
...
def configure_workspace_paths(root: Path) -> None:
    ...
    global V14_REJECTION_NAMESPACE
    global V14_LATER_REJECTION, SCHEMA, CONTRACT, PRODUCER, CONSUMER
    ...
    V14_REJECTION_NAMESPACE = RUNTIME / ("c79g-v14-rejections-" + CHECKPOINT)
    V14_LATER_REJECTION = V14_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / (BASE + "_schema_v14.json")
    CONTRACT = OUT / (BASE + "_contract_v14.json")
    PRODUCER = OUT / (BASE + "_v14.py")
    CONSUMER = OUT / (BASE + "_independent_verifier_assembler_authority_consumer_v14.py")
    TRANSITION = OUT / (BASE + "_v13_to_v14_static_launch_transition_receipt_v1.json")
    ...
    BASE7_PINS = {
        # The frozen v13 supersession receipt is the one-way current anchor.
        V13_SUPERSESSION_RECEIPT:
            (V13_SUPERSESSION_RECEIPT_FILE_PIN,
             V13_SUPERSESSION_RECEIPT_OBJECT_PIN),
        # The remaining six entries are the final acyclic v14 static pins.
        # The audit binds this launcher through PIN_NORMALIZED AST, not raw bytes.
        SCHEMA: ('3d07ccda67cb71d0e5c64d37c0d8e1fcf425de4fbfefddf03bf43934ffdaaa4d', None),
        CONTRACT: ('479a0b3f6b4f0ad7e25d22c9f32eec046758a9a7d40509a6bda200e8e41e0ece', '11fd8966ed631f3bcc0eb6b1881f0536c814b7a7c093eca8289680e38a7d7b8b'),
        PRODUCER: ('9fa2f2e20cdf15ed37d7f3ff904197fa7bc46a4eec243cab0ae8fb477e2e1ff0', None),
        CONSUMER: ('83c58e792b922ad57a7c031b4aca60fe4d5868679e6f7a70b513e3cc4b7dc24c', None),
        TRANSITION: ('e8c810f85b511cbc3637321f872f96c996a854454ab7ae1fbb3f5bdf19d7fd95', '78912a8f23f7a2e229795aae0e609ca58232dbe36c52ad50bddad727f259413f'),
        AUDIT: ('dbf5e6bf0f13524ee847d01482f9ad34f715368deb2df40207bd2eb436f293e9', '16a8bc6e274a9e4e5a8fe4b2a39b80136cbbb117bfdf2e0ed89ee90fdc71944a'),
    }
    EXACT8 = (V13_SUPERSESSION_RECEIPT, SCHEMA, CONTRACT, PRODUCER,
...
INNER_SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v14.inner-composite"
COLD_ROOT_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v14."
    "cold-launched-committed-authority"
)
COLD_ROOT_DOMAIN = b"CM2_C79G_V14_COLD_LAUNCHED_AUTHORITY_ROOT_V1\0"
LIVE_PROTOCOL = "CM2_C79G_V14_COLD_TWO_PHASE_LIVE_ACK_V1"
LIVE_REQUEST_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v14."
    "cold-live-commit-request"
)
LIVE_ACK_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v14.cold-live-ack"
)
LIVE_RELEASE_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v14.cold-live-release"
)
PREWRAPPER_BODY_DOMAIN = "CM2_C79G_V14_COLD_PREWRAPPER_BODY_V1"
TRANSACTION_BINDING_DOMAIN = "CM2_C79G_V14_COLD_TRANSACTION_BINDING_V1"
LIVE_ACK_BINDING_DOMAIN = "CM2_C79G_V14_COLD_LIVE_ACK_BINDING_V1"
SOURCE_FD_ENV = "CM2_C79G_V14_COLD_SOURCE_FD"
EXEC_FD_ENV = "CM2_C79G_V14_COLD_EXEC_FD"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V14_COORDINATION_PARENT_FD"
WORKSPACE_ROOT_ENV = "CM2_C79G_V14_COLD_WORKSPACE_ROOT"
WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V14_COLD_WORKSPACE_ROOT_FD"
LAUNCHER_SHA_ENV = "CM2_C79G_V14_COLD_LAUNCHER_FILE_SHA256"
HELD_V10_PRODUCER_FD_ENV = "CM2_C79G_V14_V10_PRODUCER_FD"
HELD_V9_LAUNCHER_FD_ENV = "CM2_C79G_V14_V9_LAUNCHER_FD"
HELD_V11_PRODUCER_FD_ENV = "CM2_C79G_V14_V11_PRODUCER_FD"
HELD_V11_LAUNCHER_FD_ENV = "CM2_C79G_V14_V11_LAUNCHER_FD"
HELD_V11_REJECTION_FD_ENV = "CM2_C79G_V14_V11_REJECTION_FD"
HELD_V12_PRODUCER_FD_ENV = "CM2_C79G_V14_V12_PRODUCER_FD"
HELD_V12_CONSUMER_FD_ENV = "CM2_C79G_V14_V12_CONSUMER_FD"
HELD_V12_LAUNCHER_FD_ENV = "CM2_C79G_V14_V12_LAUNCHER_FD"
HELD_V5_REJECTION_FD_ENV = "CM2_C79G_V14_V5_REJECTION_FD"
HELD_V12_REJECTION_FD_ENV = "CM2_C79G_V14_V12_REJECTION_FD"
HELD_V13_PRODUCER_FD_ENV = "CM2_C79G_V14_V13_PRODUCER_FD"
HELD_V13_CONSUMER_FD_ENV = "CM2_C79G_V14_V13_CONSUMER_FD"
HELD_V13_LAUNCHER_FD_ENV = "CM2_C79G_V14_V13_LAUNCHER_FD"
HELD_V13_PRODUCER_PYC_FD_ENV = "CM2_C79G_V14_V13_PRODUCER_PYC_FD"
HELD_V13_CONSUMER_PYC_FD_ENV = "CM2_C79G_V14_V13_CONSUMER_PYC_FD"
HELD_V13_LAUNCHER_PYC_FD_ENV = "CM2_C79G_V14_V13_LAUNCHER_PYC_FD"
HELD_V13_SUPERSESSION_RECEIPT_FD_ENV = (
    "CM2_C79G_V14_V13_SUPERSESSION_RECEIPT_FD")
...
def expected_v5_published_rejected_segment() -> dict[str, Any]:
    """Construct the one exact v5 regression shape shared by v14 proofs."""
    names = (
...
FINAL_STATIC_AUDIT_TOP_LEVEL_KEY_ORDER = (
    ...
    "audited_v14_bundle", "predecessor_v3_exact10_regression",
...
def pin_normalized_launcher_ast_sha256(raw: bytes, label: str) -> str:
    ...
    six current-v14 BASE7 values are replaced by fixed draft sentinels.  The
    frozen v13 supersession-receipt BASE7 member and every historical pin
    remain untouched.
    """
    try:
        tree = ast.parse(raw.decode("utf-8"), filename=label, mode="exec")
    ...
    need(key_names == expected_key_names and
         ...
         label + ":exact ordered v13-receipt-plus-current-v14 BASE7 key census")
    ...
    need(ast.dump(
         ...
         label + ":v13 supersession-receipt BASE7 value preserved")
...
def producer_source_registry_shape_from_ast(raw: bytes) -> int:
    """Derive explicit62 + execution-proof7 + object closure1 structurally."""
    try:
        tree = ast.parse(raw.decode("utf-8"), filename="producer_v14",
                         mode="exec")
    except (UnicodeDecodeError, SyntaxError) as exc:
        raise Reject("current v14 producer registry AST parse") from exc
    ...
    need(isinstance(registry_function,
         ...
         "current v14 input_registry and HeldSelf.execution_proof")
    registry_returns = [
    ...
    need(len(registry_returns) == 1 and len(proof_returns) == 1,
         "unique current v14 registry/proof return dicts")
    ...
    need(len(explicit_keys) == len(set(explicit_keys)) == 62 and
    ...
    return len(explicit_keys) + len(proof_dict.keys) + 1
...
def validate_final_static_audit(
    ...
    need(set(audit) == audit_keys and
         audit.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer.static-audit.v14" and
         ...
         "final static audit exact top-level closure and PASS_V14 status")
    ...
    validate_v13_supersession_summary(
        ...
        base_objects[V13_SUPERSESSION_RECEIPT],
    ...
    expected_inputs = {
        ...
        "launcher_template": pin_normalized_launcher_ast_sha256(
            launcher_source_raw, "held_v14_launcher_source"),
    ...
    no_producer_keys = {
        ...
        "consumer_current_v14_producer_content_open_read_hash_decode_compile_import_or_execute_allowed",
    ...
    need(isinstance(no_producer, dict) and
         ...
         no_producer.get(
             "consumer_current_v14_producer_content_open_read_hash_decode_compile_import_or_execute_allowed") is False and
         ...
         "final static audit exact current-v14 no-producer and inherited incident evidence policy")
    ...
    need(isinstance(no_run, dict) and set(no_run) == {
             "C79_entrypoint_executed", "C79_v14_runtime_artifact_count",
             "C79_v14_process_count", "pyc_or___pycache___created",
             "cold_manifest_or_outer_created_before_dual_GO",
         } and no_run.get("C79_entrypoint_executed") is False and
         type(no_run.get("C79_v14_runtime_artifact_count")) is int and
         no_run.get("C79_v14_runtime_artifact_count") == 0 and
         type(no_run.get("C79_v14_process_count")) is int and
         no_run.get("C79_v14_process_count") == 0 and
    ...
    def __init__(self, source: HeldFile) -> None:
        ...
        try:
            self.fd = os.memfd_create(
                "c79g-v14-child-exec", MFD_CLOEXEC | MFD_ALLOW_SEALING)
        except OSError as exc:
...
class HeldEmptyRejectionNamespace:
    ...
    def __init__(self, coordination: HeldCoordinationParent) -> None:
        coordination.verify()
        name = V14_REJECTION_NAMESPACE.name
        ...
        try:
            try:
                ...
                state = os.stat(name, dir_fd=coordination.fd,
                                follow_symlinks=False)
            self.path = V14_REJECTION_NAMESPACE
...
def construct_launcher_native_rejection(
    ...
    return close_object({
        ...
        "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
        "effective_checkpoint_object_sha256": CHECKPOINT,
        "namespace_exact_path": str(V14_REJECTION_NAMESPACE.relative_to(ROOT)),
        "target_exact_path": str(V14_LATER_REJECTION.relative_to(ROOT)),
        "rejection_reason": "ORPHANED_OR_INCOMPLETE_C79G_V14_SURFACE",
...
def install_or_replay_launcher_native_rejection(
    ...
    try:
        try:
            ...
            namespace_fd = openat2_beneath(
                V14_REJECTION_NAMESPACE, os.O_RDONLY | os.O_DIRECTORY)
    except BaseException:
        if namespace_fd >= 0:
    ...
    try:
        ...
        path_before = root_lstat(V14_REJECTION_NAMESPACE)
        ...
        target = os.stat(V14_LATER_REJECTION.name, dir_fd=namespace_fd,
                         follow_symlinks=False) if V14_LATER_REJECTION.name in universe else None
        if target is not None:
            need(universe == {V14_LATER_REJECTION.name},
                 "idempotent rejection exact singleton")
            rejection_guard = HeldFile(
                V14_LATER_REJECTION, "existing launcher-native v14 rejection")
        else:
            ...
            try:
                ...
                os.fsync(namespace_fd)
            rejection_guard = HeldFile(
                V14_LATER_REJECTION, "new launcher-native v14 rejection")
        need(rejection_guard is not None,
             "launcher-native rejection file held")
        value = strict_json(rejection_guard.raw, "launcher-native v14 rejection")
        need(isinstance(value, dict), "launcher-native rejection mapping")
        verify_object(value, "launcher-native v14 rejection")
        os.fsync(rejection_guard.fd)
        os.fsync(namespace_fd)
        os.fsync(coordination.fd)
        after = os.fstat(namespace_fd)
        path_after = root_lstat(V14_REJECTION_NAMESPACE)
        need(value == expected and rejection_guard.raw == expected_raw and
             set(os.listdir(namespace_fd)) == {V14_LATER_REJECTION.name} and
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str,
                    ...
                    bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / (BASE + "_cold_launch_v14.py"),
        ...
        for path, (file_pin, object_pin) in BASE7_PINS.items():
            need(re.fullmatch(r"[0-9a-f]{64}", file_pin) is not None and
                 file_pin != "0" * 64 and
                 (path == V13_SUPERSESSION_RECEIPT or
        ...
        for path in (V13_SUPERSESSION_RECEIPT, CONTRACT, TRANSITION, AUDIT):
        ...
        supersession = self.base_objects[V13_SUPERSESSION_RECEIPT]
        ...
        need(self.by_path[V13_SUPERSESSION_RECEIPT].raw ==
             ...
             successor_contract.get("v14_current_exact8_first_member_must_be_this_receipt")
                 is True and
             successor_contract.get("v14_must_preserve_v12_exact10_and_official_rejection")
                 is True and
             successor_contract.get("v14_predecessor_unique_live_identity_count") == 105 and
             successor_contract.get("v14_prepublication_unique_live_identity_count") == 113 and
             successor_contract.get("v14_terminal_unique_live_identity_count") == 115 and
             successor_contract.get("v14_terminal_group_vector") ==
                 [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 7, 1, 3, 3, 1] and
             inherited_exact16.get("ordered_member_count") == 16 and
             inherited_exact16.get("v14_must_live_hold_and_terminally_replay_exact16_plus_this_receipt")
                 is True,
             "v13 supersession receipt exact16/current-first/census contract")
        need(set(self.base_objects[TRANSITION]) == {
                 ...
                 "published_then_officially_rejected_predecessor_v12",
                 "rejected_prepublication_v13_supersession_receipt",
                 "successor_v14_static_bundle", "physical_mode_policy",
             ...
             "transition exact top-level v13-to-v14 closed shape")
        ...
        need(set(self.outer_object) == {
             ...
             self.outer_object.get("schema") ==
                 "cm2.round306c79g.true-global-no-producer-consumer."
                 "cold-launch-outer-receipt.v14" and
        ...
        # V12 rejection is predecessor authority, while the current exact8
        # begins with the append-only v13 supersession receipt.  The six
        # contaminated v13 source/pyc identities remain live incident evidence.
        ...
        incident_guards = [
            *self.v13_incident_sources, *self.v13_incident_pycs,
            self.v12_rejection, self.by_path[V13_SUPERSESSION_RECEIPT],
        ]
        ...
        predecessor_v6_identities = {
            item.identity for item in self.predecessor_v6.files
        }
        predecessor_v7_identities = {
            item.identity for item in self.predecessor_v7.files
        }
        predecessor_v8_identities = {
            item.identity for item in self.predecessor_v8.files
        }
        predecessor_v9_identities = {
            item.identity for item in self.predecessor_v9.files
        }
        predecessor_v10_identities = {
            item.identity for item in self.predecessor_v10.files
        }
        predecessor_v11_identities = {
            item.identity for item in self.predecessor_v11.files
        }
        predecessor_v12_identities = {
            item.identity for item in self.predecessor_v12.files
        }
        ...
        v13_source_identities = {
            item.identity for item in self.v13_incident_sources}
        v13_pyc_identities = {
            item.identity for item in self.v13_incident_pycs}
        need(self.v12_rejection is not None,
             "v12 official rejection remains separately held")
        identity_groups = [
            current_identities, predecessor_v12_identities,
            predecessor_v11_identities,
            predecessor_v10_identities,
            predecessor_v9_identities, predecessor_v8_identities,
            predecessor_v7_identities, predecessor_v6_identities,
            predecessor_v5_identities, predecessor_v3_identities,
            rejected_v4_identities, {self.v3_rejection.identity},
            v13_source_identities, v13_pyc_identities,
            {self.v12_rejection.identity},
        ]
        all_history_identities: set[tuple[int, int]] = set()
        for identity_group in identity_groups:
            all_history_identities.update(identity_group)
        need(len(all_history_identities) == 115 and
             ...
             self.predecessor_v12.by_path[V11_OFFICIAL_REJECTION].identity in
                 predecessor_v12_identities and
             self.predecessor_v11.by_path[V10_OFFICIAL_REJECTION].identity in
                 predecessor_v11_identities and
             self.predecessor_v10.by_path[V9_OFFICIAL_REJECTION].identity in
                 predecessor_v10_identities and
             self.predecessor_v8.by_path[V7_OFFICIAL_REJECTION].identity in
                 predecessor_v8_identities and
             self.predecessor_v9.by_path[V8_OFFICIAL_REJECTION].identity in
                 predecessor_v9_identities and
             self.predecessor_v7.by_path[V6_OFFICIAL_REJECTION].identity in
                 predecessor_v7_identities and
             self.predecessor_v6.by_path[V5_OFFICIAL_REJECTION].identity in
                 predecessor_v6_identities and
             ...
             len({item.mount_id for item in self.predecessor_v3.files} |
                 ...
                 {item.mount_id for item in self.predecessor_v6.files} |
                 {item.mount_id for item in self.predecessor_v7.files} |
                 {item.mount_id for item in self.predecessor_v8.files} |
                 {item.mount_id for item in self.predecessor_v9.files} |
                 {item.mount_id for item in self.predecessor_v10.files} |
                 {item.mount_id for item in self.predecessor_v11.files} |
                 {item.mount_id for item in self.predecessor_v12.files} |
                 {item.mount_id for item in self.rejected_v4.files} |
                 {item.mount_id for item in self.v13_incident_sources} |
                 {item.mount_id for item in self.v13_incident_pycs} |
                 {item.mount_id for item in [*self.files, self.manifest,
                                             self.outer, self.v3_rejection,
                                             self.v12_rejection]}) == 1,
             "current v14 exact10, v12/v11/v10/v9/v8/v7/v6/v5/v3 exact10, "
             "v3/v12 rejections, v4 draft7, and v13 exact6 are 115 unique "
             "live files on one mount")
    ...
    def inherited_incident_evidence_fds(
            self) -> tuple[int, ...]:
        need(self.predecessor_v11 is not None and
             self.predecessor_v12 is not None and
             self.v12_rejection is not None and
             len(self.v13_incident_sources) == 3 and
             len(self.v13_incident_pycs) == 3,
             "v11/v12/v13 inherited incident evidence layers held")
        result = (
            *self.predecessor_v11.inherited_evidence_fds(),
            *self.predecessor_v12.inherited_v12_evidence_fds(),
            *(item.fd for item in self.v13_incident_sources),
            *(item.fd for item in self.v13_incident_pycs),
            self.by_path[V13_SUPERSESSION_RECEIPT].fd,
        )
        need(len(result) == len(set(result)) == 17,
             "exact seventeen inherited incident evidence fds pairwise distinct")
        return result
...
def child_environment(bundle: HeldBundle, child_exec: HeldSealedChildExec,
    ...
    need(bundle.predecessor_v11 is not None and
         bundle.predecessor_v12 is not None,
         "v11/v12 inherited held-fd evidence available before child spawn")
    (v10_producer_fd, v9_launcher_fd, v11_producer_fd,
     ...
     v12_rejection_fd, v13_producer_fd, v13_consumer_fd,
     v13_launcher_fd, v13_producer_pyc_fd, v13_consumer_pyc_fd,
     v13_launcher_pyc_fd,
     v13_receipt_fd) = bundle.inherited_incident_evidence_fds()
    return {
        "LC_ALL": "C",
        "TZ": "UTC",
        ...
        HELD_V10_PRODUCER_FD_ENV: str(v10_producer_fd),
        HELD_V9_LAUNCHER_FD_ENV: str(v9_launcher_fd),
        HELD_V11_PRODUCER_FD_ENV: str(v11_producer_fd),
        HELD_V11_LAUNCHER_FD_ENV: str(v11_launcher_fd),
        HELD_V11_REJECTION_FD_ENV: str(v11_rejection_fd),
        HELD_V12_PRODUCER_FD_ENV: str(v12_producer_fd),
        HELD_V12_CONSUMER_FD_ENV: str(v12_consumer_fd),
        HELD_V12_LAUNCHER_FD_ENV: str(v12_launcher_fd),
        HELD_V5_REJECTION_FD_ENV: str(v5_rejection_fd),
        HELD_V12_REJECTION_FD_ENV: str(v12_rejection_fd),
        HELD_V13_PRODUCER_FD_ENV: str(v13_producer_fd),
        HELD_V13_CONSUMER_FD_ENV: str(v13_consumer_fd),
        HELD_V13_LAUNCHER_FD_ENV: str(v13_launcher_fd),
        HELD_V13_PRODUCER_PYC_FD_ENV: str(v13_producer_pyc_fd),
        HELD_V13_CONSUMER_PYC_FD_ENV: str(v13_consumer_pyc_fd),
        HELD_V13_LAUNCHER_PYC_FD_ENV: str(v13_launcher_pyc_fd),
        HELD_V13_SUPERSESSION_RECEIPT_FD_ENV: str(v13_receipt_fd),
    }
...
def child_pass_fds(bundle: HeldBundle, child_exec: HeldSealedChildExec,
    ...
    need(bundle.predecessor_v11 is not None and
         bundle.predecessor_v12 is not None,
         "v11/v12 inherited held-fd evidence available for pass_fds")
    result = (
        child_exec.fd, source.fd, coordination.fd, bundle.bootstrap.root_fd,
        *bundle.inherited_incident_evidence_fds(),
    )
    need(len(result) == 21 and len(set(result)) == 21,
         "child exact twenty-one inherited descriptors are pairwise distinct")
    return result
...
def cold_root(bundle: HeldBundle, coordination: HeldCoordinationParent,
    ...
    proof = {
        ...
        "current_exact8_first_member_is_v13_supersession_receipt":
            EXACT8[0] == V13_SUPERSESSION_RECEIPT,
        ...
        "all_current_and_historical_113_identities_globally_unique_on_one_statx_mount": True,
        "current_v14_and_all_predecessor_unique_file_identity_count": 113,
        "current_v14_and_all_predecessor_same_statx_mount": True,
        **bundle.chronology,
        ...
        "reject_command_exempts_only_fresh_empty_v14_rejection_namespace": True,
...
def _validate_live_ack(
    ...
    expected_keys = {
        ...
        "static_v14_exact10_with_v11_exact10_and_official_rejection_v10_exact10_and_official_rejection_v9_exact10_and_official_rejection_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request",
    ...
    need(set(ack) == expected_keys and ack.get("schema") == LIVE_ACK_SCHEMA and
         ...
         ack.get("static_v14_exact10_with_v11_exact10_and_official_rejection_v10_exact10_and_official_rejection_v9_exact10_and_official_rejection_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
...
def main(argv: list[str] | None = None) -> int:
    ...
    if V14_DRAFT_RUNTIME_DISABLED and not FINAL_BASE7_PINS_INSTALLED:
        raise Reject(
            "C79g v14 successor is a sentinel draft; runtime is disabled")
    need(FINAL_BASE7_PINS_INSTALLED is True,
         "C79g v14 launcher requires final base7 pins")
    ...
    try:
        ...
        if args.command == "reject":
            ...
            return 0
        # Every positive-capable command holds the exact-empty v14 rejection
