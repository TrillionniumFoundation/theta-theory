#!/usr/bin/env python3
"""Independent C79g v16 verifier, assembler, and authority consumer.

The verifier never content-opens, reads, hashes, imports, compiles, decodes,
or executes the current C79g v16 producer source.  Frozen predecessor source
...
SOURCE_BASENAME = (
    ...
    "independent_verifier_assembler_authority_consumer_v16.py")
COLD_EXEC_FD_ENV = "CM2_C79G_V16_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V16_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V16_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V16_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V16_COLD_LAUNCHER_FILE_SHA256"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V16_COORDINATION_PARENT_FD"
V10_PRODUCER_FD_ENV = "CM2_C79G_V16_V10_PRODUCER_FD"
V9_LAUNCHER_FD_ENV = "CM2_C79G_V16_V9_LAUNCHER_FD"
V11_PRODUCER_FD_ENV = "CM2_C79G_V16_V11_PRODUCER_FD"
V11_LAUNCHER_FD_ENV = "CM2_C79G_V16_V11_LAUNCHER_FD"
V11_REJECTION_FD_ENV = "CM2_C79G_V16_V11_REJECTION_FD"
V12_PRODUCER_FD_ENV = "CM2_C79G_V16_V12_PRODUCER_FD"
V12_CONSUMER_FD_ENV = "CM2_C79G_V16_V12_CONSUMER_FD"
V12_LAUNCHER_FD_ENV = "CM2_C79G_V16_V12_LAUNCHER_FD"
V5_REJECTION_FD_ENV = "CM2_C79G_V16_V5_REJECTION_FD"
V12_REJECTION_FD_ENV = "CM2_C79G_V16_V12_REJECTION_FD"
V13_PRODUCER_FD_ENV = "CM2_C79G_V16_V13_PRODUCER_FD"
V13_CONSUMER_FD_ENV = "CM2_C79G_V16_V13_CONSUMER_FD"
V13_LAUNCHER_FD_ENV = "CM2_C79G_V16_V13_LAUNCHER_FD"
V13_PRODUCER_PYC_FD_ENV = "CM2_C79G_V16_V13_PRODUCER_PYC_FD"
V13_CONSUMER_PYC_FD_ENV = "CM2_C79G_V16_V13_CONSUMER_PYC_FD"
V13_LAUNCHER_PYC_FD_ENV = "CM2_C79G_V16_V13_LAUNCHER_PYC_FD"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v16"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v16"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v16.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16.json"
...
V14_TO_V16_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v14_to_v16_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V16 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16.json")
# Final current-v16 static-freeze pins.  The historical draft sentinels remain
...
CONTRACT_FILE_PIN = "292ad598033ff2f89c1d6c502e4e6077df9559688a5885088ad107fa45a7dabf"
CONTRACT_OBJECT_PIN = "9a2ba48cbcb200ff95bf1ca593cd8030ba6bac2b1b8fdc84301d3eb72605bd0e"
CLOSED_SCHEMA_FILE_PIN = "ab120abd2d77667388c94e5af00637f843e7af1b48adba95306e1a7ea79e73bd"
...
V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_STATUS = (
    ...
    "ZERO_CREDIT__V16_SUCCESSOR_ONLY")
V14_TO_V16_TRANSITION_KIND = (
    "APPEND_ONLY_PUBLISHED_V14_RUNTIME_FAIL_CLOSED_REJECTION_TO_"
    "ZERO_CREDIT_V16_CLEAN_ROOM_SUCCESSOR")
...
V16_CURRENT_EXACT8 = (
    ...
    V14_TO_V16_TRANSITION, STATIC_AUDIT_V16, COLD_LAUNCHER,
)
...
PRODUCER_SOURCE_PIN = "7b3621bf6579cd9cc9289ed2bda353cbe5f2e32b108ec718bf80a4fd19af125b"
V16_DRAFT_CURRENT_CORE_PINS = (
...
VERIFICATION_FILE = BASE + "_independent_verification_v16.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v16.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v16.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v16.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v16.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v16-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v16-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v16-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v16-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v16-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v16-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v16-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v16-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v16-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v16-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v16-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v16-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v16-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V16_SURFACE"
...
# v16 base7 and is therefore shared with the current static-policy holder.  The
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16.py",
             "SELF exact frozen v16 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V16_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V16_PINS_INSTALLED is True,
         "v16 final current pins are not installed; every command is disabled")
    need(all(value not in V16_DRAFT_CURRENT_CORE_PINS for value in (
             CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
             PRODUCER_SOURCE_PIN)),
         "v16 draft current-core sentinels must be replaced before execution")
    ...
    need(all(value.isascii() and value.isdecimal() and len(value) <= 10 and
         ...
         len(all_fd_texts) == len({int(value) for value in all_fd_texts}) ==
             V16_CHILD_PASS_FD_COUNT == 16 and
    ...
    need(all(_nonzero_sha256(value) for value in
              ...
              *V13_INCIDENT_EXACT6_PINS.values(),
              PRODUCER_SOURCE_PIN)),
         "all v16 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v16-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v16-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v16-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v16-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v16-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v16-" +
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            need(len(self.authority_exact12) == len(exact12_identities) ==
                     V16_CHILD_AUTHORITY_DESCRIPTOR_COUNT == 12 and
        ...
        expected_normalized_rows = [
            {
                ...
                "role": HISTORICAL_TRANSITIVE_EXACT16_ROLES[
                    ordinal - 1],
                "fd_environment": env_name.replace("_V16_", "_V13_", 1),
                "path": str(path.relative_to(ROOT)),
                "file_sha256": file_pin,
            }
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v16-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def expected_published_then_rejected_v14_summary() -> dict[str, Any]:
    ...
    need(isinstance(receipt, dict) and
         ...
         receipt.get("status") ==
             V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_STATUS and
         receipt.get("transition_kind") == V14_TO_V16_TRANSITION_KIND and
         isinstance(receipt.get("v16_successor_contract"), dict),
    ...
    return {
        ...
        "receipt_status":
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_STATUS,
        "transition_kind": V14_TO_V16_TRANSITION_KIND,
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT,
             CONTRACT, CLOSED_SCHEMA,
             V14_TO_V16_TRANSITION, STATIC_AUDIT_V16,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v16 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v16 schema root is cold-launched wrapper over zero-credit inner composite")
    ...
    need(len(current_terminal_identities) == 10 and
         ...
         [len(group) for group in identity_groups] ==
             list(V16_TERMINAL_GROUP_VECTOR) and
         ...
         len(predecessor_identities) ==
             V16_PREDECESSOR_UNIQUE_LIVE_IDENTITY_COUNT and
         len(prepublication_identities) ==
             V16_PREPUBLICATION_UNIQUE_LIVE_IDENTITY_COUNT and
         ...
         "current v16 exact10 plus predecessor exact116 close as exact126 "
    ...
    return {
        ...
        "v16_prepublication_unique_live_identity_count":
            len(prepublication_identities),
        "v16_terminal_unique_live_identity_count": len(terminal_identities),
        "v16_terminal_group_vector": [len(group) for group in identity_groups],
    }
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
             ...
             "current_v16_producer_source_content_opened_or_read",
             "current_v16_producer_source_content_imported_compiled_or_executed",
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v14_to_v16_transition_receipt", "static_audit_v16", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v14_to_v16_transition_receipt", {}).get("path") ==
             str(V14_TO_V16_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v14_to_v16_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v14_to_v16_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v16", {}).get("path") ==
             str(STATIC_AUDIT_V16.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v16", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v16", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
         ...
         registry["current_v16_producer_source_content_opened_or_read"] is False and
         registry["current_v16_producer_source_content_imported_compiled_or_executed"] is False and
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V16__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            ...
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v16 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v16 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V14_TO_V16_TRANSITION,
            "post-source v14-to-v16 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V16, "post-source v16 static audit", 0o444),
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v16 contract", CONTRACT_OBJECT_PIN)
    need(set(contract) == {
    ...
    expected_paths = {
        ...
        "v16_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v16_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v16-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v16-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    bundle = contract.get("v16_bundle")
    expected_base7_paths = [
        str(V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT.relative_to(
            ROOT)),
        str(CLOSED_SCHEMA.relative_to(ROOT)),
        str(CONTRACT.relative_to(ROOT)),
        str(PRODUCER_SOURCE.relative_to(ROOT)),
        str(SELF.relative_to(ROOT)),
        str(V14_TO_V16_TRANSITION.relative_to(ROOT)),
        str(STATIC_AUDIT_V16.relative_to(ROOT)),
    ]
    ...
    need(isinstance(bundle, dict) and
         ...
         "contract exact acyclic v16 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    """Fail closed on every final v16 dual-static-audit acceptance field.
    ...
    need(set(audit) == {
             ...
             "effective_checkpoint_object_sha256", "audited_v16_bundle",
         ...
         "final v16 static audit exact top-level PASS_V16 closure")
    ...
    need(set(dual) == {
         ...
         }, "final v16 static audit dual-checker exact16 closure")
    ...
    need(isinstance(checker_a, dict) and set(checker_a) == {
         ...
         }, "final v16 checker A/B/C and helper-consensus exact object closures")
    ...
    need(helper_consensus == {
         ...
         digest(expected_helper_callsites) ==
             "1ca6de98366645a520cbc604990d71197f039207cacfa3291e9d87ff09a3cf57",
         "final v16 exact three-helper AST/key-order/callsite consensus")
    ...
    need(set(producer_registry_census) == {
         ...
         "final v16 producer actual source-registry exact75 census")
    ...
    need(set(close_semantics) == {
         ...
         "final v16 producer close_object exact semantics")
    need(set(launcher_registry_census) == {
         ...
         "final v16 launcher actual runtime-registry helper census")
    need(set(registry_consensus) == {
         ...
         "final v16 independent actual runtime-registry exact75 evidence")
    need(checker_a.get("algorithm") ==
         ...
         "final v16 checker A/B/C algorithms and exact GO statuses")
    ...
    need(isinstance(input_a, dict) and isinstance(input_b, dict) and
         ...
         "final v16 checker A/B exact43 ordered identical input-pin closure")
    expected_inputs = {
    ...
    need(tuple(expected_inputs) == STATIC_AUDIT_INPUT_EXACT43 and
         ...
         "final v16 checker inputs pin exact current core and append-only history")
    ...
    need(_nonzero_sha256(normalized_a) and
         ...
         "final v16 three-way normalized and B/C common-callsite consensus")
    ...
    need(isinstance(kind_census, dict) and set(kind_census) == {
         ...
         "final v16 checker C exact common-callsite kind census")
    need(type(checker_a.get("wider_local_callsite_census_row_count")) is int and
         ...
         "final v16 checker A positive census and three-file in-memory compile")
    need(type(checker_a.get("arity_failure_count")) is int and
         ...
         "final v16 checker A zero arity/undefined/duplicate/failed counts")
    for key in (
    ...
    need(type(dual.get("independent_pin_normalizer_count")) is int and
         ...
         "final v16 dual exact 3/2 checker counts and type-exact consensuses")
    ...
    need(set(sealed) == {
         ...
         "final v16 exact16 sealed-exec/current-producer/inherited-incident policy")
    ...
    need(set(acceptance) == {
         ...
         "final v16 audit acceptance exact10 type-exact zero-runtime closure")
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v16 contract")
    v14_supersession = strict_json(
        by_path[V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT].raw,
        "live v14 supersession receipt current anchor")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v16 closed schema")
    transition = strict_json(
        by_path[V14_TO_V16_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V16].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        v6_guard, v5_guard, v5_source_metadata)
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        v7_guard, v6_guard, v6_source_metadata)
    ...
    verify_object(
        v14_supersession, "live v14 supersession receipt current anchor",
        V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT_OBJECT_PIN)
    ...
    need(set(transition) == {
         ...
         transition.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer."
             "v14-to-v16-static-launch-transition.v1" and
         transition.get("transition_kind") ==
             V14_TO_V16_TRANSITION_KIND,
         "transition exact top-level v14-to-v16 closed shape")
    transition_file_sha256 = sha(by_path[V14_TO_V16_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V16].raw)
    ...
    exact8_stats = [
        ...
        self_guard.before,
        by_path[V14_TO_V16_TRANSITION].before,
        by_path[STATIC_AUDIT_V16].before,
        by_path[COLD_LAUNCHER].before,
    ]
    chronology = cold_publication_chronology(
        exact8_stats, by_path[COLD_LAUNCH_MANIFEST].before,
        by_path[COLD_LAUNCH_OUTER].before)
    successor = transition.get("successor_v16_static_bundle")
    ...
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V14_TO_V16_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v16_path", "contract",
             "draft_pin_sentinels_remain_present",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v16_path",
         ...
         cold_launch_boundary.get("base7_order") == [
             "v14_registry_shape_drift_supersession_receipt",
             "closed_schema_v16", "contract_v16", "producer_v16",
             "consumer_v16", "transition_v14_to_v16",
             "static_audit_v16"] and
    ...
    audited = audit.get("audited_v16_bundle")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         ...
         audited.get("v14_to_v16_transition_receipt", {}).get("path") ==
             str(V14_TO_V16_TRANSITION.relative_to(ROOT)) and
         audited.get("v14_to_v16_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v14_to_v16_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V14_TO_V16_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V16.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V14_TO_V16_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V16])
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v14_to_v16_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v14_to_v16_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v14_to_v16_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V14_TO_V16_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V16].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "historical_rejection_exact_keyset_witness",
        "append_only_history_unique_file_identity_count",
        "v14_to_v16_transition_identity", "static_audit_identity",
        ...
        proof.get("v7_publication_lock_continuity_incident") ==
            _validated_v7_publication_lock_continuity_incident() and
        proof.get("v14_to_v16_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V16__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V16_PRESEAL_ROOT_V2",
    }
    ...
    body["preseal_root_sha256"] = sha(
        b"CM2_C79G_V16_PRESEAL_ROOT_V2" +
...
def independent_consumer_proof(
    ...
    return close_object({
        ...
        "consumer_exec_bytes_equal_installed_source_bytes":
            ...
            self_guard.exec_file_sha256 == self_guard.file_sha256,
        "consumer_exec_and_installed_source_terminal_replayed": True,
        "current_v16_producer_source_content_opened_read_decoded_parsed_compiled_imported_or_executed": False,
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "published_then_officially_rejected_predecessor_v12": copy.deepcopy(
            _expected_published_then_rejected_v12_proof()),
        "v14_to_v16_transition_file_sha256":
            freeze_proof["v14_to_v16_transition_identity"]["file_sha256"],
        "v14_to_v16_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v14_to_v16_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v14_to_v16_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v14_to_v16_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V16_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V16_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v14_to_v16_transition_file_sha256") ==
             freeze_proof.get("v14_to_v16_transition_identity", {}).get("file_sha256") and
         seal.get("v14_to_v16_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
         ...
         consumer_proof.get("consumer_SELF_identity", {}).get("path") ==
             str(SELF.relative_to(ROOT)) and
         consumer_proof.get(
             "current_v16_producer_source_content_opened_read_decoded_parsed_compiled_imported_or_executed") is False and
         consumer_proof.get(
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V16_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v16 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v16 rejection")
            verify_object(value, "permanent C79g v16 rejection")
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v16 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v16 authority seal")
            verify_object(seal, "C79g v16 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v7_publication_lock_continuity_incident") ==
                     _validated_v7_publication_lock_continuity_incident() and
                 seal.get("v14_to_v16_transition_file_sha256") ==
                     freeze_proof["v14_to_v16_transition_identity"]["file_sha256"] and
                 seal.get("v14_to_v16_transition_object_sha256") ==
...
def v14_inherited_authority_draft_state(
    ...
    need(V16_DRAFT_RUNTIME_DISABLED is True and
         FINAL_CURRENT_V16_PINS_INSTALLED is False and
         ...
         "v16 draft requires frozen pinned v14 receipt and uninstalled v16 core pins")
    return {
...
def main(argv: list[str] | None = None) -> int:
    ...
    if V16_DRAFT_RUNTIME_DISABLED and not FINAL_CURRENT_V16_PINS_INSTALLED:
        raise Reject(
