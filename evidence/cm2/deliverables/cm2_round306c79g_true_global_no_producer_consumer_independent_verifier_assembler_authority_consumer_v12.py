#!/usr/bin/env python3
"""Independent C79g v12 verifier, assembler, and authority consumer.

The verifier never content-opens, reads, hashes, imports, compiles, decodes,
or executes the current C79g v12 producer source.  Frozen predecessor source
bytes are readable only through the launcher's inherited exact-five held fds,
...
COLD_EXEC_FD_ENV = "CM2_C79G_V12_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V12_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V12_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V12_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V12_COLD_LAUNCHER_FILE_SHA256"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V12_COORDINATION_PARENT_FD"
V10_PRODUCER_FD_ENV = "CM2_C79G_V12_V10_PRODUCER_FD"
V9_LAUNCHER_FD_ENV = "CM2_C79G_V12_V9_LAUNCHER_FD"
V11_PRODUCER_FD_ENV = "CM2_C79G_V12_V11_PRODUCER_FD"
V11_LAUNCHER_FD_ENV = "CM2_C79G_V12_V11_LAUNCHER_FD"
V11_REJECTION_FD_ENV = "CM2_C79G_V12_V11_REJECTION_FD"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v12"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v12"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v12.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v12.json"
...
V11_TO_V12_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v11_to_v12_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V12 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v12.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v12.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v12.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v12.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v12.json")
# Final current-v12 static-freeze pins.  The historical draft sentinels remain
# explicit below so the absolute command gate proves none survived injection.
FINAL_CURRENT_V12_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "72246725b15891f92cbc6e3fa1c07ab4a76cdaa19f1b366a736f47f51989b343"
CONTRACT_OBJECT_PIN = "f5c1710817dc8e3aa7fe2bbf4b88e6e39baaa1b17bbeb0f8bf37c8c4575ae5d7"
CLOSED_SCHEMA_FILE_PIN = "5ed911a55e8f90e750fdcaf6ab4fb6c9683bebaf66a4d6250329dff98acb2e28"
...
PRODUCER_SOURCE_PIN = "4cafc594f8a60063b7e7caaa82ddcc2b7983d0fbf0929034cd3cb5f360f3ed1d"
V12_DRAFT_CURRENT_CORE_PINS = (
...
VERIFICATION_FILE = BASE + "_independent_verification_v12.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v12.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v12.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v12.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v12.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v12-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v12-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v12-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v12-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v12-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v12-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v12-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v12-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v12-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v12-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v12-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v12-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v12-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V12_SURFACE"
...
# v12 base7 and is therefore shared with the current static-policy holder.  The
...
# official rejection bytes are also read from the inherited exact-five fds,
...
INCIDENT_AUTHORITY_INHERITED_EXACT5 = (
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v12.py",
             "SELF exact frozen v12 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V12_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V12_PINS_INSTALLED is True,
         "v12 final current pins are not installed; every command is disabled")
    need(all(value not in V12_DRAFT_CURRENT_CORE_PINS for value in (
             CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
             PRODUCER_SOURCE_PIN)),
         "v12 draft current-core sentinels must be replaced before execution")
    ...
    need(all(_nonzero_sha256(value) for value in
         ...
         "all v12 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v12-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v12-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v12-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v12-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v12-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v12-" +
...
class HeldInheritedIncidentAuthorityExact5:
    """Read the launcher's exact five inherited incident-authority files.
    ...
    def __init__(self) -> None:
        ...
        need(_INCIDENT_AUTHORITY_WITNESS is None,
             "single inherited exact5 incident-authority hold per process")
        self.files: list[dict[str, Any]] = []
        identities: set[tuple[int, int]] = set()
        mount_ids: set[int] = set()
        for env_name, path, file_pin in INCIDENT_AUTHORITY_INHERITED_EXACT5:
            ...
            self.files.append({
                "env_name": env_name, "path": path, "file_sha256": file_pin,
                "fd": descriptor, "before": before, "mount_id": mount_id,
                "raw": raw,
            })
        need(len(self.files) == len(identities) == 5 and len(mount_ids) == 1,
             "inherited incident exact5 unique identities on one mount")
        by_env = {item["env_name"]: item for item in self.files}
    ...
    def close(self) -> None:
        ...
        if failures:
            raise Reject("inherited incident exact5 close:" + "|".join(failures))
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v12-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def held_v11_official_rejection(policy_guard: HeldInputSet) -> HeldPinnedInput:
    matches = [item for item in policy_guard.files
               if item.path == V11_OFFICIAL_REJECTION]
    need(len(matches) == 1,
         "official v11 rejection is one shared current-policy held file")
    namespace_matches = [item for item in policy_guard.directories
                         if item.path == V11_OFFICIAL_REJECTION.parent]
    need(len(namespace_matches) == 1 and
         namespace_matches[0].names == {V11_OFFICIAL_REJECTION.name},
         "official v11 rejection namespace is one exact singleton held dirfd")
    return matches[0]
...
def exact_v11_official_rejection(
        policy_guard: HeldInputSet) -> tuple[dict[str, Any], HeldPinnedInput]:
    receipt_guard = held_v11_official_rejection(policy_guard)
...
def validate_v11_published_then_rejected_predecessor(
        policy_guard: HeldInputSet, v11_guard: HeldInputSet,
        v11_source_metadata: list[HeldOpaqueMetadata]) -> dict[str, Any]:
    _, rejection_guard = exact_v11_official_rejection(policy_guard)
    source_names = {
        "build_only_producer_v11", "independent_consumer_v11",
        "cold_launcher_v11"}
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V11_OFFICIAL_REJECTION,
             V11_TO_V12_TRANSITION, STATIC_AUDIT_V12,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v12 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v12 schema root is cold-launched wrapper over zero-credit inner composite")
    ...
    v11_predecessor = validate_v11_published_then_rejected_predecessor(
        policy_guard, v11_guard, v11_source_metadata)
    ...
    # policy and the v11 proof.
    need(len(current_policy_identities) == 10 and
         len(predecessor_identities) == 88 and
         current_policy_identities.isdisjoint(predecessor_identities) and
         len(current_policy_identities | predecessor_identities) == 98 and
         len({item.mount_id for item in policy_guard.files} |
             ...
             {item.mount_id for item in v11_source_metadata}) == 1,
         "current v12 exact10 plus v3/v4/v5/v6/v7/v8/v9/v10/v11 predecessor "
         "exact identities close as exact98 on one mount")
    ...
    return {
        ...
        "v11_official_rejection": exact_v11_official_rejection(policy_guard)[0],
    }
...
def reconstruct_expected(evidence: dict[str, Any]) -> dict[str, Any]:
    ...
    need(_INCIDENT_AUTHORITY_WITNESS == V10_COLON_PREFIX_WITNESS,
         "consumer inherited exact5 witness remains independently derived")
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
             ...
             "current_v12_producer_source_content_opened_or_read",
             "current_v12_producer_source_content_imported_compiled_or_executed",
             "frozen_predecessor_incident_source_exact5_held_fd_bytes_read_only",
         ...
         registry["append_only_history_unique_file_identity_count"] == 98 and
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v11_to_v12_transition_receipt", "static_audit_v12", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v11_to_v12_transition_receipt", {}).get("path") ==
             str(V11_TO_V12_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v11_to_v12_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v11_to_v12_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v12", {}).get("path") ==
             str(STATIC_AUDIT_V12.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v12", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v12", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
         ...
         all(registry["post_source_static_freeze_trust"].get(name) is True for name in (
             ...
             "cold_exact10_identities_unique_same_mount",
             "normative_runtime_entry_is_externally_pinned_cold_launcher")) and
         registry["five_incident_authority_inputs_inherited_as_held_fds"] is True and
         registry["five_incident_held_fds_path_identity_mount_and_hash_revalidated"] is True and
         registry["current_v12_producer_source_content_opened_or_read"] is False and
         registry["current_v12_producer_source_content_imported_compiled_or_executed"] is False and
         registry["frozen_predecessor_incident_source_exact5_held_fd_bytes_read_only"] is True and
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V12__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            ...
            "official v11 rejection shared with predecessor", 0o444,
            V11_OFFICIAL_REJECTION_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v12 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v12 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V11_TO_V12_TRANSITION,
            "post-source v11-to-v12 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V12, "post-source v12 static audit", 0o444),
        ...
        0o555, 2, "official v11 rejection exact singleton namespace")])
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v12 contract", CONTRACT_OBJECT_PIN)
    need(set(contract) == {
    ...
    expected_paths = {
        ...
        "v12_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v12_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v12-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v12-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    bundle = contract.get("v12_bundle")
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v11_to_v12_transition_path") ==
             str(V11_TO_V12_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V12.relative_to(ROOT)),
         "contract exact acyclic v12 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    """Fail closed on every final v12 dual-static-audit acceptance field.
    ...
    need(set(audit) == {
             ...
             "effective_checkpoint_object_sha256", "audited_v12_bundle",
    ...
    need(set(dual) == {
         ...
         }, "final v12 static audit dual-checker exact15 closure")
    ...
    need(isinstance(checker_a, dict) and set(checker_a) == {
         ...
         }, "final v12 checker A/B/C and helper-consensus exact object closures")
    ...
    need(helper_consensus == {
         ...
         digest(expected_helper_callsites) ==
             "69979c91172f95d179e5af986d4f8d2d5406ffcfdc14abaef1f1578766c1963d",
         "final v12 exact three-helper AST/key-order/callsite consensus")
    need(checker_a.get("algorithm") ==
         ...
         "final v12 checker A/B/C algorithms and exact GO statuses")
    ...
    need(isinstance(input_a, dict) and isinstance(input_b, dict) and
         ...
         len(input_keys) == 37 and input_a == input_b and
         tuple(input_a) == STATIC_AUDIT_INPUT_EXACT37 and
         tuple(input_b) == STATIC_AUDIT_INPUT_EXACT37 and
         sha(canonical(list(STATIC_AUDIT_INPUT_EXACT37))) ==
             STATIC_AUDIT_INPUT_EXACT37_ORDER_SHA256 and
         _nonzero_sha256(input_a.get("launcher_template")),
         "final v12 checker A/B exact37 ordered identical input-pin closure")
    expected_inputs = {
    ...
    need(tuple(expected_inputs) == STATIC_AUDIT_INPUT_EXACT37 and
         input_a == expected_inputs and
         all(_nonzero_sha256(value) for value in input_a.values()),
         "final v12 checker inputs pin exact current core and append-only history")
    ...
    need(_nonzero_sha256(normalized_a) and
         ...
         "final v12 three-way normalized and B/C common-callsite consensus")
    ...
    need(isinstance(kind_census, dict) and set(kind_census) == {
         ...
         "final v12 checker C exact common-callsite kind census")
    need(type(checker_a.get("wider_local_callsite_census_row_count")) is int and
         ...
         "final v12 checker A positive census and three-file in-memory compile")
    need(type(checker_a.get("arity_failure_count")) is int and
         ...
         "final v12 checker A zero arity/undefined/duplicate/failed counts")
    for key in (
    ...
    need(type(dual.get("independent_pin_normalizer_count")) is int and
         ...
         dual.get("pin_normalized_ast_algorithm") ==
             ...
             "PRESERVE_V11_REJECTION_AND_ALL_HISTORICAL_PINS_V1" and
         ...
         dual.get(
             "pin_normalization_preserves_v11_rejection_and_all_historical_pins") is True and
         ...
         "final v12 dual exact 3/2 checker counts and type-exact consensuses")
    ...
    need(set(sealed) == {
         ...
         "final v12 exact16 sealed-exec/current-producer/inherited-incident policy")
    ...
    need(set(acceptance) == {
         ...
         "final v12 audit acceptance exact10 type-exact zero-runtime closure")
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v12 contract")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v12 closed schema")
    transition = strict_json(
        by_path[V11_TO_V12_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V12].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        v6_guard, v5_guard, v5_source_metadata)
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        v7_guard, v6_guard, v6_source_metadata)
    ...
    transition_file_sha256 = sha(by_path[V11_TO_V12_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V12].raw)
    ...
    need(isinstance(successor, dict) and isinstance(successor_consumer, dict) and
         ...
         "transition exact bundle/v3/v4/v5/v6/v7/v8/v9/v10/v11 predecessor objects")
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V11_TO_V12_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v12_path", "contract",
             "draft_pin_sentinels_remain_present",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v12_path",
         ...
         transition_v11 == _expected_published_then_rejected_v11_proof(),
         "transition pins current bundle and append-only "
         "v3/v4/v5/v6/v7/v8/v9/v10/v11 predecessors")
    audited = audit.get("audited_v12_bundle")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         ...
         audited.get("v11_to_v12_transition_receipt", {}).get("path") ==
             str(V11_TO_V12_TRANSITION.relative_to(ROOT)) and
         audited.get("v11_to_v12_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v11_to_v12_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        {"file_sha256": V11_OFFICIAL_REJECTION_FILE_PIN,
         "entry_name": str(V11_OFFICIAL_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V11_TO_V12_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V12.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V11_TO_V12_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V12])
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v11_to_v12_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v11_to_v12_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v11_to_v12_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "current_exact8_first_member_is_shared_v11_official_rejection":
            cold_manifest[0] == {
                "file_sha256": V11_OFFICIAL_REJECTION_FILE_PIN,
                "entry_name": str(V11_OFFICIAL_REJECTION.relative_to(ROOT))} and
            transition_v4.get("ordered_provisional_exact8") ==
                v4_supersession["frozen_v4_provisional_exact8"]["ordered_members"],
        ...
        "published_then_officially_rejected_predecessor_v11_validated":
            ...
            transition_v11.get("official_later_rejection", {}).get(
                "object_sha256") == V11_OFFICIAL_REJECTION_OBJECT_PIN,
        "append_only_history_unique_file_identity_count": 98,
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V11_TO_V12_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V12].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "published_then_officially_rejected_predecessor_v11",
        "append_only_history_unique_file_identity_count",
        "v11_to_v12_transition_identity", "static_audit_identity",
        ...
        proof.get("append_only_history_unique_file_identity_count") == 98 and
        proof.get("v7_publication_lock_continuity_incident") ==
            _validated_v7_publication_lock_continuity_incident() and
        proof.get("v11_to_v12_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V12__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V12_PRESEAL_ROOT_V2",
    }
    ...
    body["preseal_root_sha256"] = sha(
        b"CM2_C79G_V12_PRESEAL_ROOT_V2" +
...
def independent_consumer_proof(
    ...
    self_guard.terminal_replay()
    need(_INCIDENT_AUTHORITY_WITNESS == V10_COLON_PREFIX_WITNESS,
         "independent consumer retains exact inherited-fd witness")
    return close_object({
        ...
        "consumer_exec_bytes_equal_installed_source_bytes":
            ...
            self_guard.exec_file_sha256 == self_guard.file_sha256,
        "consumer_exec_and_installed_source_terminal_replayed": True,
        "current_v12_producer_source_content_opened_read_decoded_parsed_compiled_imported_or_executed": False,
        "frozen_predecessor_incident_source_exact5_held_fd_bytes_read_only_noncredit": True,
        "v10_colon_prefix_witness_independently_rederived_from_inherited_exact5_held_fds": True,
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "v11_to_v12_transition_file_sha256":
            freeze_proof["v11_to_v12_transition_identity"]["file_sha256"],
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v11_to_v12_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v11_to_v12_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v11_to_v12_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V12_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V12_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v11_to_v12_transition_file_sha256") ==
             freeze_proof.get("v11_to_v12_transition_identity", {}).get("file_sha256") and
         seal.get("v11_to_v12_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
         ...
         consumer_proof.get("consumer_SELF_identity", {}).get("path") ==
             str(SELF.relative_to(ROOT)) and
         consumer_proof.get(
             "current_v12_producer_source_content_opened_read_decoded_parsed_compiled_imported_or_executed") is False and
         consumer_proof.get(
             "frozen_predecessor_incident_source_exact5_held_fd_bytes_read_only_noncredit") is True and
         consumer_proof.get(
             "v10_colon_prefix_witness_independently_rederived_from_inherited_exact5_held_fds") is True and
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V12_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v12 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v12 rejection")
            verify_object(value, "permanent C79g v12 rejection")
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v12 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v12 authority seal")
            verify_object(seal, "C79g v12 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v7_publication_lock_continuity_incident") ==
                     _validated_v7_publication_lock_continuity_incident() and
                 seal.get("v11_to_v12_transition_file_sha256") ==
                     freeze_proof["v11_to_v12_transition_identity"]["file_sha256"] and
                 seal.get("v11_to_v12_transition_object_sha256") ==
...
def main(argv: list[str] | None = None) -> int:
    ...
    incident_guard: HeldInheritedIncidentAuthorityExact5 | None = None
    ...
    try:
        self_guard = HeldSelf()
        incident_guard = HeldInheritedIncidentAuthorityExact5()
        producer_guard = HeldOpaqueMetadata(
