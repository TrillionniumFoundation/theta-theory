...
HISTORICAL_BASE = 'cm2_round306c79g_true_global_no_producer_consumer'
BASE = 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r52_semantic_source'
LAUNCHER_RELATIVE = Path('deliverables') / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r52_semantic_source.py'
...
ACTIVE_PREDECESSOR_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r52_active_predecessor_supersession_receipt_v1.json'
ACTIVE_SUCCESSOR_NAMESPACE = 'v16r2r52_semantic_source'
ACTIVE_SUCCESSOR_NAMESPACE_TAG = 'v16r2r52-semantic-regeneration'
ACTIVE_PREDECESSOR_SUPERSESSION_FILE_PIN = '81fb3995bcf98b4a96dc1f71969700dfe743a6e9c42eb59e6c6fc4a6d5616559'
ACTIVE_PREDECESSOR_SUPERSESSION_OBJECT_PIN = 'e88744a79dd91f4e68bc133e23e3b2261d468bc21ce7c15890e1faaaf31c84dd'
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r52_active_predecessor_supersession_receipt_v1.json'
RUNTIME = ROOT / '.cm2-runtime'
SELF = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r52_semantic_source.py'
...
SCHEMA = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r52.json'
CONTRACT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r52.json'
PRODUCER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r52_semantic_source.py'
CONSUMER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r52_semantic_source.py'
TRANSITION = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r51_to_v16r2r52_static_launch_transition_receipt_v1.json'
AUDIT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r52.json'
MANIFEST = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r52.sha256'
OUTER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r52.json'
MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r52.sha256'
OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r52.json'
V16R2_DRAFT_RUNTIME_DISABLED = True
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / 'rejection.json'
    SCHEMA = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r52.json'
    CONTRACT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r52.json'
    PRODUCER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r52_semantic_source.py'
    CONSUMER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r52_semantic_source.py'
    TRANSITION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r51_to_v16r2r52_static_launch_transition_receipt_v1.json'
    AUDIT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r52.json'
    MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r52.sha256'
    OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r52.json'
    BASE7_PINS = {V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT: ('aa4323027e2313f8a2eda0d6ffc039a537afe342d496d1f75cd73fcd47446c01', '93689e62ae36f405f045a769f4dc6f6e6fd83a16605d08299d5c3397ad657e2e'), SCHEMA: ('609b9268686271eb5cbe7d3859f57846db52a636da98ebe463afb2c7018ed140', None), CONTRACT: ('c75fe2846af759ddc58929f3633d1d2c6f1e07f1c3abf6882da054b70f91b505', '3fe2680b73a7af74091997f8dfd7982046e2ec372753b2eded9e14ae88429d6a'), PRODUCER: ('c7b3108b4692ba695c1a1a4c9b1e2224ad6c42684399242359e88e6b82251989', None), CONSUMER: ('bbd08696ea7f9eee66456b703b05e1529bdf71f1f04fb800a66c087021020da1', None), TRANSITION: ('26959762048d9ada0be8558841d622e7a8c363c6eed1a6cbbb94d9a8ac69b741', '7515311e3ad8f8a0072fd453141dce31a54ee544d3bacd2742322051ae95fe2e'), AUDIT: ('52ff60ce514230ed87de6a61233cf8eeceae38bad372a518aff3cea4567dd000', '9e3dbcd141c62d7c1bc9271beacc2630de55467a00cfaa6e4e594b5712d1c50c')}
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str, coordination: HeldCoordinationParent, bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r52_semantic_source.py', 'exact cold launcher path')
