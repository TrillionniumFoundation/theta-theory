#!/usr/bin/env python3
"""Hardened r2 coherent attacks for the zero-credit C27R2 rebuild gate v3.
...
def mutations(receipt: dict[str, Any]) -> list[tuple[str, Callable[[dict[str, Any]], None], bool]]:
    ...
    if receipt["decision"] == "PASS":
        attacks.append((
            "deep_terminal_evidence_census_forgery",
            lambda x: x["actual_v2_terminal_evidence"]["exact_census"].__setitem__(
                "candidate_total", 7_486_075),
            True,
        ))
    else:
        attacks.append((
