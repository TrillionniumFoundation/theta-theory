...
VERIFIER = ROOT / (
    "deliverables/"
    "cm2_round306c27r2_source_g_actual_v2_fresh_quotient_rebuild_v2_"
    "independent_verifier_v3.py"
)
ATTACKS = ROOT / (
    "deliverables/"
    "cm2_round306c27r2_source_g_actual_v2_fresh_quotient_rebuild_v2_"
    "coherent_attack_harness_v3.py"
)
RUNNER = ROOT / (
    "deliverables/"
    "cm2_round306c27r2_source_g_actual_v2_fresh_quotient_rebuild_v2_"
    "transaction_runner_v3.py"
)
C15 = ROOT / (
    "deliverables/"
...
TRANSACTION_SCHEMA = (
    "cm2.round306c27r2.source-g-actual-v2-fresh-quotient-rebuild.v2."
    "gated-dual-seed-transaction-receipt.v3"
)
FAILURE_SCHEMA = (
    "cm2.round306c27r2.source-g-actual-v2-fresh-quotient-rebuild.v2."
    "gated-dual-seed-failure-receipt.v3"
)
OUTPUT_FILES = {
