...
OUTPUT_SCHEMA = PREFIX + "release-boundary-validator.v7"
FORMAL_STATUS = (
    "PASS_C27R2_RELEASE_REPAIR_BOUNDARY_V7_FORMAL_EMPTY_OVERRIDE_EXACT_"
...
PRIVATE_STATUS = (
    "PASS_C27R2_RELEASE_REPAIR_BOUNDARY_V7_PRIVATE_SINGLE_OVERRIDE_EXACT_"
    "SPEC_ATTESTATION_INPUT_SET_FIXED_USER_BUS_SERVICE_QUERY_TEN_PROPERTY_"
    "EXECSTART_FRAGMENT_COLD_EXACT14_CURRENT_PROCESS_INVENTORY_AND_"
    "AUTHORITY_CLOSURE__"
    "ZERO_CREDIT"
...
def self_test() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="c27r2-boundary-v7-") as raw:
        root = Path(raw)
        normal = root / "normal"
