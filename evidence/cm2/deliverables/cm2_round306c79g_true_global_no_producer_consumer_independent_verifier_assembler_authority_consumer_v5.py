#!/usr/bin/env python3
"""Independent C79g v5 verifier, assembler, and authority consumer.
...
COLD_EXEC_FD_ENV = "CM2_C79G_V5_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V5_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V5_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V5_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V5_COLD_LAUNCHER_FILE_SHA256"
COORDINATION_PARENT_FD_ENV = "CM2_C79G_V5_COORDINATION_PARENT_FD"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v5"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v5"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v5.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v5.json"
...
V4_TO_V5_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v4_to_v5_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V5 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v5.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v5.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v5.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v5.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v5.json")
...
CONTRACT_FILE_PIN = "162cd554ea972b434c019924a9ab8b87621ab65aae7d4896b6dac72d6288b997"
CONTRACT_OBJECT_PIN = "27d457a583f4d9892e0a866917ea4add25ff677669ee814861e0608036189377"
CLOSED_SCHEMA_FILE_PIN = "1048740103257351abb1266ed91bb80028436cb1497918a0f0f177ec3268ff4f"
...
PRODUCER_SOURCE_PIN = "bc6d48903f61257cd75b20b83c6cd369ca3748d19427cf18129c0fb9bb59e76e"
TERMINALS = {
...
VERIFICATION_FILE = BASE + "_independent_verification_v5.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v5.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v5.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v5.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v5.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v5-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v5-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v5-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v5-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v5-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v5-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v5-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v5-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v5-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v5-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v5-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v5-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v5-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V5_SURFACE"
COLD_ROOT_SCHEMA = SCHEMA + ".cold-launched-committed-authority"
LIVE_PROTOCOL = "CM2_C79G_V5_COLD_TWO_PHASE_LIVE_ACK_V1"
...
PREWRAPPER_BODY_DOMAIN = "CM2_C79G_V5_COLD_PREWRAPPER_BODY_V1"
TRANSACTION_BINDING_DOMAIN = "CM2_C79G_V5_COLD_TRANSACTION_BINDING_V1"
LIVE_ACK_BINDING_DOMAIN = "CM2_C79G_V5_COLD_LIVE_ACK_BINDING_V1"
V3_FROZEN_FILES = {
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v5.py",
             "SELF exact frozen v5 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              ...
              V4_REJECTION_SUPERSESSION_OBJECT_PIN, PRODUCER_SOURCE_PIN)),
         "all v5 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v5-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v5-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v5-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v5-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v5-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v5-" +
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v5-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def read_evidence(
        ...
        v4_source_metadata: list[HeldOpaqueMetadata]) -> dict[str, Any]:
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V4_REJECTION_SUPERSESSION,
             V4_TO_V5_TRANSITION, STATIC_AUDIT_V5,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v5 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v5 schema root is cold-launched wrapper over zero-credit inner composite")
    v4_supersession = exact_v4_rejection_supersession(
        policy_by_path[V4_REJECTION_SUPERSESSION])
    ...
    need(len(predecessor_identities) == 11 and
         ...
         len({item.mount_id for item in policy_guard.files} |
             ...
             {item.mount_id for item in v3_source_metadata}) == 1,
         "current policy exact8 is identity-disjoint from held v3 exact10 plus rejection")
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v4_to_v5_transition_receipt", "static_audit_v5", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v4_to_v5_transition_receipt", {}).get("path") ==
             str(V4_TO_V5_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v4_to_v5_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v4_to_v5_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v5", {}).get("path") ==
             str(STATIC_AUDIT_V5.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v5", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v5", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V5__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            V4_REJECTION_SUPERSESSION, "frozen v4 rejection/supersession", 0o444,
            V4_REJECTION_SUPERSESSION_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v5 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v5 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V4_TO_V5_TRANSITION, "post-source v4-to-v5 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V5, "post-source v5 static audit", 0o444),
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v5 contract", CONTRACT_OBJECT_PIN)
    ...
    expected_paths = {
        ...
        "v5_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v5_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v5-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v5-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    need(isinstance(rejected_v4, dict) and isinstance(v4_supersession, dict) and
         ...
         rejected_v4.get("v4_files_modified_by_v5") is False and
    ...
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v4_to_v5_transition_path") ==
             str(V4_TO_V5_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V5.relative_to(ROOT)),
         "contract exact acyclic v5 bundle and post-source trust-anchor paths")
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v5 contract")
    transition = strict_json(
        by_path[V4_TO_V5_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V5].raw, "post-source static audit")
    v4_supersession = exact_v4_rejection_supersession(
        by_path[V4_REJECTION_SUPERSESSION])
    ...
    transition_file_sha256 = sha(by_path[V4_TO_V5_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V5].raw)
    ...
    exact8_stats = [
        by_path[V4_REJECTION_SUPERSESSION].before,
        by_path[CLOSED_SCHEMA].before,
        by_path[CONTRACT].before,
        producer_guard.before,
        self_guard.before,
        by_path[V4_TO_V5_TRANSITION].before,
        by_path[STATIC_AUDIT_V5].before,
    ...
    successor = transition.get("successor_v5_static_bundle")
    ...
    need(isinstance(successor, dict) and isinstance(successor_consumer, dict) and
         ...
         "transition exact bundle/v3 predecessor/v4 rejection objects")
    need(transition.get("status") ==
             "STATIC_BYTES_CLOSED_V4_TO_V5__PHYSICAL_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED" and
         transition.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         transition.get("receipt_path") == str(V4_TO_V5_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v5_path", "contract",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v5_path",
         ...
         "transition pins current bundle, rejected v4, and append-only v3 predecessor")
    audited = audit.get("audited_v5_bundle")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         audit.get("audit_path") == str(STATIC_AUDIT_V5.relative_to(ROOT)) and
         ...
         audited.get("v4_to_v5_transition_receipt", {}).get("path") ==
             str(V4_TO_V5_TRANSITION.relative_to(ROOT)) and
         audited.get("v4_to_v5_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v4_to_v5_transition_receipt", {}).get("object_sha256") ==
         ...
         audit.get("status") ==
             "PASS_DUAL_STATIC_BYTES_GO_V5__PHYSICAL_COLD_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED" and
    ...
    exact8_expected = [
        {"file_sha256": V4_REJECTION_SUPERSESSION_FILE_PIN,
         "entry_name": str(V4_REJECTION_SUPERSESSION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V4_TO_V5_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V5.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V4_TO_V5_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V5])
    audit_identity["object_sha256"] = audit_object_sha256
    v4_supersession_identity = _one_identity(
        by_path[V4_REJECTION_SUPERSESSION])
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v4_to_v5_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v4_to_v5_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v4_to_v5_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "rejected_unpublished_predecessor_v4_validated":
            by_path[V4_REJECTION_SUPERSESSION].raw ==
        ...
        "ordered_provisional_exact8_validated":
            cold_manifest[0] == {
                "file_sha256": V4_REJECTION_SUPERSESSION_FILE_PIN,
                "entry_name": str(V4_REJECTION_SUPERSESSION.relative_to(ROOT))} and
            transition_v4.get("ordered_provisional_exact8") ==
        ...
        "predecessor_v4_rejection_supersession_regression_validated":
            ...
            audit_v4.get(
                "v5_closed_object_required_property_mismatch_count") == 0 and
            audit_v4.get("same_defects_absent_from_v5") is True,
        ...
        "v4_rejection_supersession_receipt_held_and_terminally_replayed":
            by_path[V4_REJECTION_SUPERSESSION].fd >= 0,
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V4_TO_V5_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V5].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "v4_rejection_supersession_file_sha256",
        "v4_rejection_supersession_object_sha256",
        "v4_to_v5_transition_identity", "static_audit_identity",
        ...
        proof.get("v4_rejection_supersession_object_sha256") ==
            V4_REJECTION_SUPERSESSION_OBJECT_PIN and
        proof.get("v4_to_v5_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V5__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V5_PRESEAL_ROOT_V2",
    }
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "v4_to_v5_transition_file_sha256":
            freeze_proof["v4_to_v5_transition_identity"]["file_sha256"],
        "v4_to_v5_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v4_to_v5_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v4_to_v5_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v4_to_v5_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V5_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V5_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v4_to_v5_transition_file_sha256") ==
             freeze_proof.get("v4_to_v5_transition_identity", {}).get("file_sha256") and
         seal.get("v4_to_v5_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V5_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v5 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v5 rejection")
            verify_object(value, "permanent C79g v5 rejection")
...
def cold_authorize_live_protocol(
    ...
    request_keys = {
        ...
        "static_v5_exact10_with_v4_supersession_v3_exact10_and_official_rejection_namespace_terminal_replay_completed_by_launcher_before_request",
    ...
    need(request.get("transaction_binding_domain") ==
         ...
         request.get(
             "static_v5_exact10_with_v4_supersession_v3_exact10_and_official_rejection_namespace_terminal_replay_completed_by_launcher_before_request") is True and
         request.get(
    ...
    ack = close_object({
        ...
        "final_dynamic_replay_census": {
            ...
            "v4_rejection_supersession_in_static_policy_held_file_count": 1,
        ...
        "transaction_binding_is_replay_identical_not_fresh_or_random": True,
        "static_v5_exact10_with_v4_supersession_v3_exact10_and_official_rejection_namespace_terminal_replay_completed_by_launcher_before_request": True,
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v5 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v5 authority seal")
            verify_object(seal, "C79g v5 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v4_rejection_supersession_object_sha256") ==
                     V4_REJECTION_SUPERSESSION_OBJECT_PIN and
                 seal.get("v4_to_v5_transition_file_sha256") ==
                     freeze_proof["v4_to_v5_transition_identity"]["file_sha256"] and
                 seal.get("v4_to_v5_transition_object_sha256") ==
