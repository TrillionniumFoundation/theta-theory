#!/usr/bin/env python3
"""Fail-closed append-only C30c postreceipt bridge v5.
...
START_GATE = DELIVERABLES / "cm2_round306c30c_postreceipt_v3_p1_bridge_start_gate_v2.py"
...
def publish_gate_materials(
    ...
    try:
        ...
        for critical in (
            ...
            "bridge_composite_finalizer", "process_wrapper",
        ):
...
def self_test(executed_watcher: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    return closed({
        ...
        "status": "PASS_12_PRODUCTION_3_POST_READY_FAULT_AND_15_GATE_NEGATIVES_ZERO_CREDIT",
