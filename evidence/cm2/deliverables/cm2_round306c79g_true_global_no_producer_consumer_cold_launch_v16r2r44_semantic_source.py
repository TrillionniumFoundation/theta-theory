...
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v16r2r44_semantic_source"
LAUNCHER_RELATIVE = Path("deliverables") / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r44_semantic_source.py"
...
ACTIVE_PREDECESSOR_SUPERSESSION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r44_active_predecessor_supersession_receipt_v1.json"
ACTIVE_SUCCESSOR_NAMESPACE = "v16r2r44_semantic_source"
ACTIVE_SUCCESSOR_NAMESPACE_TAG = "v16r2r44-semantic-regeneration"
ACTIVE_PREDECESSOR_SUPERSESSION_FILE_PIN = "19514a07b5cc65167e7805b73779bd0726ddc6ec023f7456fec120ca3427f316"
ACTIVE_PREDECESSOR_SUPERSESSION_OBJECT_PIN = "5a16d62b835f118d309767dd10cdb2f8faa6f9631897edac451b1348d822178d"
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r44_active_predecessor_supersession_receipt_v1.json"
RUNTIME = ROOT / ".cm2-runtime"
SELF = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r44_semantic_source.py"
...
SCHEMA = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r44.json"
CONTRACT = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r44.json"
PRODUCER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r44_semantic_source.py"
CONSUMER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r44_semantic_source.py"
TRANSITION = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r43_to_v16r2r44_static_launch_transition_receipt_v1.json"
AUDIT = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r44.json"
MANIFEST = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r44.sha256"
OUTER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r44.json"
MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r44.sha256"
OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r44.json"
...
BASE7_PINS = {}
EXACT8: tuple[Path, ...] = (    ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r44_active_predecessor_supersession_receipt_v1.json",
    SCHEMA,
    CONTRACT,
    PRODUCER,
    CONSUMER,
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r44.json"
    CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r44.json"
    PRODUCER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r44_semantic_source.py"
    CONSUMER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r44_semantic_source.py"
    TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r43_to_v16r2r44_static_launch_transition_receipt_v1.json"
    AUDIT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r44.json"
    MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r44.sha256"
    OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r44.json"
    BASE7_PINS.clear()
    BASE7_PINS.update({
        ACTIVE_PREDECESSOR_SUPERSESSION: ("19514a07b5cc65167e7805b73779bd0726ddc6ec023f7456fec120ca3427f316", '5a16d62b835f118d309767dd10cdb2f8faa6f9631897edac451b1348d822178d'),
        SCHEMA: ("74939d8ac33545a775bdd4bdb537628fdc7ebf4b393d5e611b5c07d3eec17084", None),
        CONTRACT: ("7e230ad85d50c764a74b5510b79ec8f5499c0b679639984ca26877b2a76fb7e8", 'd77b63c88f559ffe64b9ab6a8442b429ef77df622fabc05864c3349775b46991'),
        PRODUCER: ("ea654178328fa2fd2f506ae7b77e56b66fe36aa7ea45eeb190ce9ff42ecab76e", None),
        CONSUMER: ("126292852e2011dbfa470745c228561e75dcfd906760803785ccfc891199a2bc", None),
        TRANSITION: ("659d6d28718af8f5d6c04d68dd1d786da82a381b1aa382697e90d77ef0eef5ed", 'ea3c6a15f89b6d38da1cb21ae266396c6f4d4a82172bc1178dccaf778ec569f9'),
        AUDIT: ("f171f880b10962de68a99fd70106ded04ce29cb0ce81e36855bc891ad09c998a", '9e38850efc62e0604d1f098564077f6d363fb31386cc5e4f1b63fcc1d494cb55'),
    })
    EXACT8 = (    ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r44_active_predecessor_supersession_receipt_v1.json",
        SCHEMA,
        CONTRACT,
        PRODUCER,
        CONSUMER,
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str,
                    ...
                    bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r44_semantic_source.py",
