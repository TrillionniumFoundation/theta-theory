...
PROGRAM_PINS = {
    ...
    "outer": "5f65ebaa362f2127a6a6726a23006d5f60fc21862188229b91f6b9b6587c3de8",
...
def self_test() -> dict[str, Any]:
    ...
    return {"status": "PASS_C28_RELEASE_CHAIN_WATCHER_V3_SELF_TEST",
