...
SELF = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r42_semantic_source.py"
...
COLD_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r42.sha256"
COLD_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r42.json"
...
COLD_EXACT8 = (    OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r42_active_predecessor_supersession_receipt_v1.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r42.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r42.json",
    SELF,
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r42_semantic_source.py",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r41_to_v16r2r42_static_launch_transition_receipt_v1.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r42.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r42_semantic_source.py",
)
...
class HeldSelf:
    ...
    def __init__(self, exec_inherited: int, source_inherited: int,
        ...
        try:
            ...
            need(SELF == OUT /
                 "cm2_round306c79g_true_global_no_producer_consumer_v16r2r42_semantic_source.py",
...
def ensure_launch_configuration() -> HeldSelf:
    ...
    need(all(value and len(value) <= 10 and
         ...
         SELF == ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r42_semantic_source.py",
...
def validate_static_authorities(static_trust: dict[str, Any]) -> dict[str, Any]:
    ...
    need(set(contract) == {
         ...
         contract.get("v16r2_bundle", {}).get(
             ...
             "deliverables/cm2_round306c79g_true_global_no_producer_consumer_"
             "independent_verifier_assembler_authority_consumer_v16r2r42_semantic_source.py" and
