...
Version 4 additionally opens and validates every one of the seven formal-core
...
before a release preflight may succeed.
"""
...
def validate_core(args: argparse.Namespace) -> tuple[dict[str, Any], dict[str, Any], dict[str, Path]]:
    ...
    validate_core_run_attestations(control, core, pinset, targets)
...
def self_test() -> dict[str, Any]:
    ...
    return {"status": "PASS_C29_V2_COLD_REPLAY_V4_COMPLETE_CORE_RUN_ATTESTATION_PROVENANCE_SELF_TEST",
