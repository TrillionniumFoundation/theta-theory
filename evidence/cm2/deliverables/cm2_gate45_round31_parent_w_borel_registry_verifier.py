#!/usr/bin/env python3
"""Fail-closed verifier for the round-31 parent-W Borel registry."""
...
import cm2_gate45_round31_parent_w_borel_registry_cert as cert
...
def verify(path: Path) -> list[str]:
    ...
    try:
        ...
        if verdict.get("actual_parent_W_registry") != "CERTIFIED_PARAMETERIZED":
            errors.append("parent W")
        if verdict.get("Gate5") != "NOT_CERTIFIED" or verdict.get("CM2") != "NO-GO_FOR_CLAIM":
