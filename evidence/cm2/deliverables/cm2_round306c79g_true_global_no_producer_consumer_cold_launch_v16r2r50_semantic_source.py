...
HISTORICAL_BASE = "cm2_round306c79g_true_global_no_producer_consumer"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v16r2r50_semantic_source"
LAUNCHER_RELATIVE = Path("deliverables") / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r50_semantic_source.py"
...
ACTIVE_PREDECESSOR_SUPERSESSION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r50_active_predecessor_supersession_receipt_v1.json"
ACTIVE_SUCCESSOR_NAMESPACE = "v16r2r50_semantic_source"
ACTIVE_SUCCESSOR_NAMESPACE_TAG = "v16r2r50-semantic-regeneration"
ACTIVE_PREDECESSOR_SUPERSESSION_FILE_PIN = "f7f94d8de8918de7e28d1bf45b890646f5feca8adb36bf0ed2b90c717cab0fc2"
ACTIVE_PREDECESSOR_SUPERSESSION_OBJECT_PIN = "89cd68d3221999496144eb30347e20b3da64f392d7d4a3ce9bc3cfbd1cfe92e8"
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r50_active_predecessor_supersession_receipt_v1.json"
RUNTIME = ROOT / ".cm2-runtime"
SELF = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r50_semantic_source.py"
...
SCHEMA = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r50.json"
CONTRACT = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r50.json"
PRODUCER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r50_semantic_source.py"
CONSUMER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r50_semantic_source.py"
TRANSITION = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r46_to_v16r2r50_static_launch_transition_receipt_v1.json"
AUDIT = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r50.json"
MANIFEST = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r50.sha256"
OUTER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r50.json"
MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r50.sha256"
OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r50.json"
...
BASE7_PINS = {}
EXACT8: tuple[Path, ...] = (    V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT,
    SCHEMA,
    CONTRACT,
    PRODUCER,
    CONSUMER,
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r50.json"
    CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r50.json"
    PRODUCER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r50_semantic_source.py"
    CONSUMER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r50_semantic_source.py"
    TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r46_to_v16r2r50_static_launch_transition_receipt_v1.json"
    AUDIT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r50.json"
    MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r50.sha256"
    OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r50.json"
    BASE7_PINS = {
        ...
        SCHEMA: ('bd7bbb886eb04cf933c604b30c8c203274a10c47109c0c358b65d954e3f75a7f', None),
        CONTRACT: ('2868d16f5df85a820bd8a10847546893ca4af4e13e3369efd992f236396bfacb', '115d0a22d0b420e927652b6eb65dfca0fba893d356807801256b3cd82cf2beb1'),
        PRODUCER: ('1a042ee3f9a277546fc4148fe441fae1f983fa91313c5aa701f509a1bed591a1', None),
        CONSUMER: ('fdd89c7ac3a92454d70227019f4ec2eec0e59fce9da566b0ee0a4e94004e2f47', None),
        TRANSITION: ('1a5648527889cb72ca09f242e054239e5668c7afd1c8c2e27da539b95caa2c90', '06f521f15a9008304aaace75262644e2e69dd1595480ab53040a4487a5a3aa47'),
        AUDIT: ('8836aa5d9eb356b706967531a01da53ba344ed9e52b060cb6fac02881bbbb0db', 'bf1f72505de706890bd58904bd21c026e9bf33373856c2ffca3d7bfb9d917ff8'),
    }
...
def validate_v13_supersession_receipt(
    ...
    need(value.get("schema") ==
         ...
         inherited.get("v14_must_live_hold_and_terminally_replay_exact16_plus_this_receipt")
             is True,
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str,
                    ...
                    bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r50_semantic_source.py",
        ...
        need(self.by_path[
             ...
             supersession.get("status") ==
                 ...
                 "REJECTION__ZERO_CREDIT__V" + "15_SUCCESSOR_ONLY" and
             ...
             successor_contract.get("v" + "15_current_exact8_first_member_must_be_this_receipt")
                 is True and
             successor_contract.get(
                 "v" + "15_must_directly_hold_and_terminally_replay_v14_exact10_plus_official_rejection_plus_this_receipt")
                 is True and
             successor_contract.get(
                 "v" + "15_inherited_published_incident_authority_exact12_count") == 12 and
             successor_contract.get(
                 "v" + "15_launcher_registry_helper_must_require_explicit67_plus_execution_proof7_plus_object_closure1_equals75")
                 is True,
        ...
        need(set(self.base_objects[CONTRACT]) == {
             ...
             self.base_objects[CONTRACT].get("schema") ==
                 "cm2.round306c79g.true-global-no-producer-consumer.v16r2r50.contract" and
    ...
    def _global_identity_census(self) -> dict[str, Any]:
        ...
        current_first_is_receipt = (
            ...
            EXACT8[0] == V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT and
