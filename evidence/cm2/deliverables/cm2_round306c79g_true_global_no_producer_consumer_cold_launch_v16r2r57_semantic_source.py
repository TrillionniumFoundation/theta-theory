...
HISTORICAL_BASE = 'cm2_round306c79g_true_global_no_producer_consumer'
BASE = 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r57_semantic_source'
LAUNCHER_RELATIVE = Path('deliverables') / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r57_semantic_source.py'
...
ACTIVE_PREDECESSOR_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r57_active_predecessor_supersession_receipt_v1.json'
ACTIVE_SUCCESSOR_NAMESPACE = 'v16r2r57_semantic_source'
ACTIVE_SUCCESSOR_NAMESPACE_TAG = 'v16r2r57-semantic-regeneration'
ACTIVE_PREDECESSOR_SUPERSESSION_FILE_PIN = '20e35762b74af1a9a52440323d11f51ad88e73dcffa8df558b6966dfe2f8b128'
ACTIVE_PREDECESSOR_SUPERSESSION_OBJECT_PIN = 'fcee1f563ae439872f6c0db6904e7f6eaac291892af56d4117ec333c0e3ce482'
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r57_active_predecessor_supersession_receipt_v1.json'
RUNTIME = ROOT / '.cm2-runtime'
SELF = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r57_semantic_source.py'
...
SCHEMA = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r57.json'
CONTRACT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r57.json'
PRODUCER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r57_semantic_source.py'
CONSUMER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r57_semantic_source.py'
TRANSITION = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r56_to_v16r2r57_static_launch_transition_receipt_v1.json'
AUDIT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r57.json'
MANIFEST = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r57.sha256'
OUTER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r57.json'
MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r57.sha256'
OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r57.json'
V16R2_DRAFT_RUNTIME_DISABLED = True
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / 'rejection.json'
    SCHEMA = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r57.json'
    CONTRACT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r57.json'
    PRODUCER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r57_semantic_source.py'
    CONSUMER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r57_semantic_source.py'
    TRANSITION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r56_to_v16r2r57_static_launch_transition_receipt_v1.json'
    AUDIT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r57.json'
    MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r57.sha256'
    OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r57.json'
    BASE7_PINS = {V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT: ('aa4323027e2313f8a2eda0d6ffc039a537afe342d496d1f75cd73fcd47446c01', '93689e62ae36f405f045a769f4dc6f6e6fd83a16605d08299d5c3397ad657e2e'), SCHEMA: ('d58181505c940388e21b536a4e025de34562143363d27c36068230c225d725e3', None), CONTRACT: ('d0aae106d0ceb729badf7689702975ca7c4797a318fd80701ef1cfe72df0f6fb', 'a257959b5b18cf9810c37b6815318fb6f23f1372ad411d0f6c24f172f8ce0b68'), PRODUCER: ('dc3cfb7cf3ac9c7db1b5da0cf0cfd920008afbcfea87b53a367d191c0a5b2286', None), CONSUMER: ('758ac372464e23df4e1530ff799de07df8119868d0c3bc09babad394d5e646ed', None), TRANSITION: ('3f3ccdf7d79624bdf6a9acbf68783e78e4a5fc89ac83e021e7936327a6e94737', '3a73e596af7fb4bd7139b7083e8e5a2542184be5effd9f2595b80d21903cedd2'), AUDIT: ('9bb131ed87feedf1dd4c4bf612cabf56c5a02ee49041cb19384403bdf9674988', 'ec9ea92338cf0048b642fc9b880e845302d31f6cf6f7e9192aeea737eaf294b7')}
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str, coordination: HeldCoordinationParent, bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r57_semantic_source.py', 'exact cold launcher path')
