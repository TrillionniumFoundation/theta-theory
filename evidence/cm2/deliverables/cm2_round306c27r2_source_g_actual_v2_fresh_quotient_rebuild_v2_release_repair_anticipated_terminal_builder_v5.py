#!/usr/bin/env python3
"""No-import anticipated terminal builder for C27R2 repair v5.
...
REPLAY_SCHEMA = BASE + "anticipated-terminal-replay.v5"
EXPECTED = {
...
def execute(args: argparse.Namespace) -> dict[str, Any]:
    ...
    need(type(service) is dict and set(service) == {"unit", "launch_mode",
         ...
         and service.get("expected_active_state") == "active"
         and service.get("expected_sub_state") == "exited"
...
def self_test() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(dir=ROOT / ".cm2-runtime",
            prefix="c27r2-anticipated-v5-selftest-") as raw:
    ...
    return {"status": "PASS_C27R2_RELEASE_REPAIR_ANTICIPATED_V5_SELF_TEST"}
