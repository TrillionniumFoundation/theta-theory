...
SOURCE_BASENAME = "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63as_repair_semantic_source.py"
...
V16_TO_V16R2_TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r62_to_v16r2r63as_repair_static_launch_transition_receipt_v1.json"
STATIC_AUDIT_V16R2 = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r63as_repair.json"
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r63as_repair_semantic_source.py"
COLD_LAUNCHER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r63as_repair_semantic_source.py"
COLD_LAUNCH_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r63as_runtime_repair.sha256"
COLD_LAUNCH_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63as_runtime_repair.json"
...
V16R2_DRAFT_RUNTIME_DISABLED = True
FINAL_CURRENT_V16R2_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "482491171631730d7cd2bd773baca4ead8bc98929acf2ff4848fd5383e5fdb83"
CONTRACT_OBJECT_PIN = "4974463dbe1b67e497ba917ed49dc048b5e4b63be32c7706b7a3476a6d5fd0b2"
...
PRODUCER_SOURCE_PIN = "31b7e0e07680a677f3c5f3b4efeeff3841df5f24978744ef57afb2852470ca39"
...
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63as_runtime_repair.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v16r2r63as-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v16r2r63as-candidate-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v16r2r63as-verification-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v16r2r63as-verification-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v16r2r63as-committed-completion-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v16r2r63as-" + UPSTREAM_CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v16r2r63as-rejections-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v16r2r63as-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v16r2-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v16r2r63as-verification-stage-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v16r2r63as-verification-stage-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v16r2r63as-candidate-stage-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v16r2r63as-candidate-stage-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63as_repair_semantic_source.py",
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v16r2r63as-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v16r2r63as-candidate-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v16r2r63as-verification-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v16r2r63as-verification-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v16r2r63as-committed-completion-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v16r2r63as-" +
...
# _R63AS_STATIC_FREEZE_SCHEMA_PROJECTION_APPLIED_
def _r63as_schema_later_rejection_projection(self_guard, freeze_proof):
...
_r63as_raw_static_freeze_proof = static_freeze_proof


def static_freeze_proof(*args, **kwargs):
    proof = _r63as_raw_static_freeze_proof(*args, **kwargs)
    self_guard = args[1] if len(args) > 1 else kwargs.get("self_guard")
    if self_guard is None:
        raise RuntimeError("r63as static-freeze self guard missing")
    if not isinstance(proof, dict):
        raise RuntimeError("r63as static-freeze proof is not an object")
    ...
    proof["v8_official_rejection"] = _r63as_schema_later_rejection_projection(
        self_guard, proof)
    return proof
...
def _committed_context(
    ...
    _r63as_recorded_stage = install_proof["staging_path"]
    need(_r63as_recorded_stage == DECLARED_COMPLETION_STAGE,
