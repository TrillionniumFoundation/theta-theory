#!/usr/bin/env python3
"""No-import streaming outer verifier for the C27R2 release repair v2.
...
OUTER_SCHEMA = BASE + "outer-verification.v2"
...
def execute(args: argparse.Namespace) -> dict[str, Any]:
    ...
    dynamic_strings = (args.boundary_closure_key, args.expect_boundary_schema,
        ...
        args.expect_case_status, args.decision_closure_key,
    ...
    need(evidence_record["sha256"] == args.expect_evidence_file_sha256
         and evidence["evidence_bundle_sha256"] == args.expect_evidence_object_sha256
...
def self_test() -> dict[str, Any]:
    ...
    need(EXPECTED["frozen_C15_components"]
         ...
         "math fixture")
    return {"status": "PASS_C27R2_RELEASE_REPAIR_OUTER_V2_SELF_TEST"}
...
def parser() -> argparse.ArgumentParser:
    ...
    names = ("manifest-dir", "evidence-dir", "candidate-dir", "verification",
        ...
        "trust-decision", "output-file", "boundary-closure-key",
        "case-closure-key", "decision-closure-key", "expect-boundary-schema",
