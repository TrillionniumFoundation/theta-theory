#!/usr/bin/env python3
"""Independent C79g v9 verifier, assembler, and authority consumer.
...
COLD_EXEC_FD_ENV = "CM2_C79G_V9_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V9_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V9_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V9_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V9_COLD_LAUNCHER_FILE_SHA256"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v9"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v9"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v9.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v9.json"
...
V8_TO_V9_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v8_to_v9_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V9 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v9.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v9.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v9.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v9.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v9.json")
# Final current-v9 static-freeze pins.  The historical draft sentinels remain
# explicit below so the absolute command gate proves none survived injection.
FINAL_CURRENT_V9_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "c37676119597f235f94104a55095c07e292fdd5c373c1811eeeed10c1b3d333f"
CONTRACT_OBJECT_PIN = "9a5fc94e11a30099ea0e23a574394399842efb8b350c98e9c16c5e8a8ce3963a"
CLOSED_SCHEMA_FILE_PIN = "2ddd254e43a196bb550fce69552c7f51eae063f4a9b75bc5818099c93335080b"
...
PRODUCER_SOURCE_PIN = "e3dfcf7d2bda8daaeaf1412685909a1a96e1ff88f8d3c6ab1645288ee97c5a70"
V9_DRAFT_CURRENT_CORE_PINS = (
...
VERIFICATION_FILE = BASE + "_independent_verification_v9.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v9.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v9.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v9.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v9.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v9-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v9-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v9-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v9-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v9-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v9-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v9-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v9-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v9-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v9-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v9-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v9-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v9-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V9_SURFACE"
...
# v9 base7 and is therefore shared with the current static-policy holder.  The
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v9.py",
             "SELF exact frozen v9 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V9_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V9_PINS_INSTALLED is True,
         "v9 final current pins are not installed; every command is disabled")
    need(all(value not in V9_DRAFT_CURRENT_CORE_PINS for value in (
             CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
             PRODUCER_SOURCE_PIN)),
         "v9 draft current-core sentinels must be replaced before execution")
    ...
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              ...
              V8_OFFICIAL_REJECTION_OBJECT_PIN, PRODUCER_SOURCE_PIN)),
         "all v9 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v9-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v9-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v9-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v9-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v9-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v9-" +
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v9-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V8_OFFICIAL_REJECTION,
             V8_TO_V9_TRANSITION, STATIC_AUDIT_V9,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v9 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v9 schema root is cold-launched wrapper over zero-credit inner composite")
    ...
    v8_predecessor = validate_v8_published_then_rejected_predecessor(
        policy_guard, v8_guard, v8_source_metadata)
    ...
    # rejection is shared by current policy/v8.
    need(len(current_policy_identities) == 10 and
         len(predecessor_identities) == 58 and
         current_policy_identities.isdisjoint(predecessor_identities) and
         len(current_policy_identities | predecessor_identities) == 68 and
         len({item.mount_id for item in policy_guard.files} |
             ...
             {item.mount_id for item in v8_source_metadata}) == 1,
         "current v9 exact10 plus v3/v4/v5/v6/v7/v8 predecessor exact "
         "identities close as exact68 on one mount")
    ...
    return {
        ...
        "v8_official_rejection": exact_v8_official_rejection(policy_guard)[0],
    }
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
         ...
         registry["append_only_history_unique_file_identity_count"] == 68 and
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v8_to_v9_transition_receipt", "static_audit_v9", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v8_to_v9_transition_receipt", {}).get("path") ==
             str(V8_TO_V9_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v8_to_v9_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v8_to_v9_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v9", {}).get("path") ==
             str(STATIC_AUDIT_V9.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v9", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v9", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V9__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            V8_OFFICIAL_REJECTION, "official v8 rejection shared with predecessor", 0o444,
            V8_OFFICIAL_REJECTION_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v9 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v9 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V8_TO_V9_TRANSITION, "post-source v8-to-v9 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V9, "post-source v9 static audit", 0o444),
        ...
        0o555, 2, "official v8 rejection exact singleton namespace")])
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v9 contract", CONTRACT_OBJECT_PIN)
    ...
    expected_paths = {
        ...
        "v9_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v9_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v9-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v9-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v8_to_v9_transition_path") ==
             str(V8_TO_V9_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V9.relative_to(ROOT)),
         "contract exact acyclic v9 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    """Hard gate for all final A/B/C static-audit evidence."""
    need(set(audit) == {
             "schema", "status", "audit_path",
             "effective_checkpoint_object_sha256", "audited_v9_bundle",
             ...
             "final_audit_acceptance", "object_sha256"} and
         audit.get("status") ==
             "PASS_DUAL_STATIC_BYTES_GO_V9__PHYSICAL_COLD_FREEZE_PENDING__"
             "RUNTIME_NOT_AUTHORIZED",
         "final static audit exact full v9 GO/pre-freeze envelope")
    ...
    need(set(dual) == {
         ...
         "final static audit exact dual checker envelope")
    checker_a = dual.get("checker_A")
    checker_b = dual.get("checker_B")
    checker_c = dual.get("checker_C_common_census_reproduction")
    need(isinstance(checker_a, dict) and isinstance(checker_b, dict) and
         isinstance(checker_c, dict),
         "final static audit A/B/C objects")
    need(set(checker_a) == {
         ...
         "final static audit exact A/B/C checker shapes")
    need(checker_a.get("algorithm") ==
         ...
         "final static audit exact A/B/C algorithms and GO statuses")
    input_a = checker_a.get("input_sha256")
    input_b = checker_b.get("input_sha256")
    need(isinstance(input_a, dict) and isinstance(input_b, dict),
         "final static audit A/B input hash objects")
    ...
    need(_nonzero_sha256(launcher_template) and
         input_a == input_b == expected_inputs and
         all(_nonzero_sha256(item) for item in expected_inputs.values()),
         "final static audit A/B identical exact current input pins")
    ...
    wider_count = checker_a.get("wider_local_callsite_census_row_count")
    need(_nonzero_sha256(normalized_a) and
         ...
         common_count_b == common_count_c and
         _nonzero_sha256(common_digest_b) and
         common_digest_b == common_digest_c and
         type(wider_count) is int and wider_count >= common_count_b and
         _nonzero_sha256(checker_a.get("wider_local_callsite_census_sha256")),
         "final static audit normalized and common/wider callsite digests")
    ...
    need(isinstance(kind_census, dict) and set(kind_census) == {
             ...
             "localclass_class_method", "localclass_instance_method"} and
         all(type(item) is int and item >= 0 for item in kind_census.values()) and
         sum(kind_census.values()) == common_count_c,
         "final static audit C exact common callsite kind census")
    for checker, label in ((checker_a, "A"), (checker_b, "B"),
                           (checker_c, "C")):
        need(type(checker.get("arity_failure_count")) is int and
             checker.get("arity_failure_count") == 0 and
             type(checker.get("failed_static_check_count")) is int and
             checker.get("failed_static_check_count") == 0,
             "final static audit checker " + label + " zero arity/failed")
    for checker, label in ((checker_a, "A"), (checker_b, "B")):
        need(type(checker.get("undefined_global_count")) is int and
             checker.get("undefined_global_count") == 0,
             "final static audit checker " + label + " zero undefined globals")
    need(type(checker_a.get("python_literal_dict_count")) is int and
         ...
         type(checker_b.get("starred_positional_total")) is int and
         checker_b.get("starred_positional_total") == 0 and
         type(checker_b.get("double_star_keyword_total")) is int and
         checker_b.get("double_star_keyword_total") == 0 and
         type(checker_b.get("JSON_duplicate_key_count")) is int and
         checker_b.get("JSON_duplicate_key_count") == 0 and
         type(checker_b.get("python_literal_dict_duplicate_key_count")) is int and
         checker_b.get("python_literal_dict_duplicate_key_count") == 0 and
         type(checker_b.get("object_closure_failure_count")) is int and
         checker_b.get("object_closure_failure_count") == 0 and
         type(checker_b.get("pin_failure_count")) is int and
         checker_b.get("pin_failure_count") == 0 and
         type(checker_c.get("starred_positional_total")) is int and
         checker_c.get("starred_positional_total") == 0 and
         type(checker_c.get("double_star_keyword_total")) is int and
         checker_c.get("double_star_keyword_total") == 0,
         "final static audit exact auxiliary zero-failure censuses")
    need(type(dual.get("independent_normalizer_count")) is int and
         ...
         dual.get("independent_common_callsite_implementation_count") == 2,
         "final static audit exact 3/2 independent checker counts")
    for key in ("all_normalizers_equal",
                "all_common_callsite_censuses_equal",
                "final_launcher_must_reproduce_normalized_digest_after_pin_injection"):
        _need_exact_audit_bool(dual, key, True, "final dual static audit")
    ...
    need(set(acceptance) == {
             ...
             "requires_cold_exact8_freeze_manifest_then_outer_last_and_terminal_replay"} and
         type(acceptance.get("final_failed_static_check_count_required")) is int and
         acceptance.get("final_failed_static_check_count_required") == 0,
         "final audit acceptance exact ten-key/zero-failure shape")
    for key in ("current_draft_pass", "final_static_freeze_pass_required",
                "dual_static_checker_A_GO", "dual_static_checker_B_GO",
                "normalized_launcher_digest_consensus",
                "common_callsite_census_digest_consensus",
                "final_launcher_normalized_digest_replay_required_after_pin_injection",
                "requires_cold_exact8_freeze_manifest_then_outer_last_and_terminal_replay"):
        _need_exact_audit_bool(acceptance, key, True,
                               "final audit acceptance")
    _need_exact_audit_bool(acceptance, "this_audit_authorizes_C79_runtime",
                           False, "final audit acceptance")
    ...
    need(type(closure.get("schema_definition_count")) is int and
         closure.get("schema_definition_count") == definition_count == 41 and
         type(closure.get("schema_ref_count")) is int and
         closure.get("schema_ref_count") == reference_count == 221 and
         ...
         closure.get("closed_object_count") == closed_count == 47 and
         ...
         "final schema closure actual 41/221/47/0 counts")
    actual_keywords = [
    ...
    expected_shapes = {
        ...
        "laterRejection": 48, "producerSourceRegistry": 50,
        "liveRequest": 15, "liveACK": 32, "liveACKCensus": 33}
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v9 contract")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v9 closed schema")
    transition = strict_json(
        by_path[V8_TO_V9_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V9].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        v6_guard, v5_guard, v5_source_metadata)
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        v7_guard, v6_guard, v6_source_metadata)
    ...
    transition_file_sha256 = sha(by_path[V8_TO_V9_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V9].raw)
    ...
    need(isinstance(successor, dict) and isinstance(successor_consumer, dict) and
         ...
         "transition exact bundle/v3/v4/v5/v6 predecessor objects")
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V8_TO_V9_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v9_path", "contract",
             "draft_pin_sentinels_are_non_authoritative",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v9_path",
         ...
         transition_v8 == _expected_published_then_rejected_v8_proof(),
         "transition pins current bundle and append-only v3/v4/v5/v6/v7/v8 predecessors")
    audited = audit.get("audited_v9_bundle")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         audit.get("audit_path") == str(STATIC_AUDIT_V9.relative_to(ROOT)) and
         ...
         audited.get("v8_to_v9_transition_receipt", {}).get("path") ==
             str(V8_TO_V9_TRANSITION.relative_to(ROOT)) and
         audited.get("v8_to_v9_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v8_to_v9_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        {"file_sha256": V8_OFFICIAL_REJECTION_FILE_PIN,
         "entry_name": str(V8_OFFICIAL_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V8_TO_V9_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V9.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V8_TO_V9_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V9])
    ...
    v8_rejection_identity = _one_identity(
        held_v8_official_rejection(policy_guard))
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v8_to_v9_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v8_to_v9_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v8_to_v9_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "current_exact8_first_member_is_shared_v8_official_rejection":
            cold_manifest[0] == {
                "file_sha256": V8_OFFICIAL_REJECTION_FILE_PIN,
                "entry_name": str(V8_OFFICIAL_REJECTION.relative_to(ROOT))} and
            transition_v4.get("ordered_provisional_exact8") ==
                v4_supersession["frozen_v4_provisional_exact8"]["ordered_members"],
        ...
        "v8_official_rejection_object_sha256":
            V8_OFFICIAL_REJECTION_OBJECT_PIN,
        "v8_official_rejection_shared_current_policy_held_fd":
            held_v8_official_rejection(policy_guard).fd ==
                by_path[V8_OFFICIAL_REJECTION].fd,
        ...
        "append_only_history_unique_file_identity_count": 68,
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V8_TO_V9_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V9].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "v8_forbidden_positive_and_stage_surface_count",
        "append_only_history_unique_file_identity_count",
        "v8_to_v9_transition_identity", "static_audit_identity",
        ...
        proof.get("append_only_history_unique_file_identity_count") == 68 and
        proof.get("v7_publication_lock_continuity_incident") ==
            _validated_v7_publication_lock_continuity_incident() and
        proof.get("v8_to_v9_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V9__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V9_PRESEAL_ROOT_V2",
    }
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "published_then_officially_rejected_predecessor_v8": copy.deepcopy(
            freeze_proof[
                "published_then_officially_rejected_predecessor_v8"]),
        "v8_to_v9_transition_file_sha256":
            freeze_proof["v8_to_v9_transition_identity"]["file_sha256"],
        "v8_to_v9_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v8_to_v9_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v8_to_v9_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v8_to_v9_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V9_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V9_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v8_to_v9_transition_file_sha256") ==
             freeze_proof.get("v8_to_v9_transition_identity", {}).get("file_sha256") and
         seal.get("v8_to_v9_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V9_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v9 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v9 rejection")
            verify_object(value, "permanent C79g v9 rejection")
...
def cold_authorize_live_protocol(
    ...
    need(request.get("transaction_binding_domain") ==
         ...
         request.get(
             "static_v9_exact10_with_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
         request.get(
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v9 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v9 authority seal")
            verify_object(seal, "C79g v9 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v7_publication_lock_continuity_incident") ==
                     _validated_v7_publication_lock_continuity_incident() and
                 seal.get("v8_to_v9_transition_file_sha256") ==
                     freeze_proof["v8_to_v9_transition_identity"]["file_sha256"] and
                 seal.get("v8_to_v9_transition_object_sha256") ==
