...
HISTORICAL_BASE = 'cm2_round306c79g_true_global_no_producer_consumer'
BASE = 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r61_semantic_source'
LAUNCHER_RELATIVE = Path('deliverables') / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r61_semantic_source.py'
...
ACTIVE_PREDECESSOR_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r61_active_predecessor_supersession_receipt_v1.json'
ACTIVE_SUCCESSOR_NAMESPACE = 'v16r2r61_semantic_source'
ACTIVE_SUCCESSOR_NAMESPACE_TAG = 'v16r2r61-semantic-regeneration'
ACTIVE_PREDECESSOR_SUPERSESSION_FILE_PIN = 'a6e7ebe51eed1a877f0440d2bf90827e17ca955912d449a4eaca6fc17f383838'
ACTIVE_PREDECESSOR_SUPERSESSION_OBJECT_PIN = 'fc63955e5c40352413245ca0e8a2a4a098a4b3f596f534838a9442190dd98be2'
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r61_active_predecessor_supersession_receipt_v1.json'
RUNTIME = ROOT / '.cm2-runtime'
SELF = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r61_semantic_source.py'
...
SCHEMA = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r61.json'
CONTRACT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r61.json'
PRODUCER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r61_semantic_source.py'
CONSUMER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r61_semantic_source.py'
TRANSITION = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r60_to_v16r2r61_static_launch_transition_receipt_v1.json'
AUDIT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r61.json'
MANIFEST = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r61.sha256'
OUTER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r61.json'
MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r61.sha256'
OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r61.json'
V16R2_DRAFT_RUNTIME_DISABLED = True
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / 'rejection.json'
    SCHEMA = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r61.json'
    CONTRACT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r61.json'
    PRODUCER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r61_semantic_source.py'
    CONSUMER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r61_semantic_source.py'
    TRANSITION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r60_to_v16r2r61_static_launch_transition_receipt_v1.json'
    AUDIT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r61.json'
    MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r61.sha256'
    OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r61.json'
    BASE7_PINS = {V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT: ('aa4323027e2313f8a2eda0d6ffc039a537afe342d496d1f75cd73fcd47446c01', '93689e62ae36f405f045a769f4dc6f6e6fd83a16605d08299d5c3397ad657e2e'), SCHEMA: ('fdccae1a4d2c59d712b6ca4c7924a0eac06b285c40da9b76449f9e2c6ea4498a', None), CONTRACT: ('25c8b839f2919e7d41cc4735da5d3161f1bbe74320712396839be103d6979cb4', '7b7ee6a90c1d0248178c6d774186a6bdcbdf506e4f83faff8598f61c9ccd6eb2'), PRODUCER: ('2cc329b416ddd903c0b9e3e8552f18a4f35039086445e5da76973e18798791d4', None), CONSUMER: ('723fe15b9c28d776c9f3a9aaa77449a10e4f09323aaf23ec731ef062266161f0', None), TRANSITION: ('9fd292d9fb88917a63afbec02c5e95436655f6a9d5ec268cfb7f4bf7c80e8851', '1d0d830e04bf768273c6bc6890cc65f638e926464e5dd0313be2f863cb3866cd'), AUDIT: ('f8f2a40fdd55a8a71fd83666c2b165b23e8ecb85382a662898e34d60c0b675b2', 'f2c07d5213d73f9b3e8e5caddf8454817be83d8ac8d463015b495aee030c1c8b')}
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str, coordination: HeldCoordinationParent, bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r61_semantic_source.py', 'exact cold launcher path')
