...
SELF = DELIVERABLES / (
    "cm2_round306c30c_postreceipt_v3_p1_bridge_v5_one_shot_launcher_v1.py")
...
def load_frozen_watcher(held: HeldFile) -> types.ModuleType:
    held.verify()
    module = types.ModuleType("_cm2_bridge_watch_v5_launcher_held")
...
def self_test(
    ...
    try:
        module = load_frozen_watcher(holds["watcher_v5"])
