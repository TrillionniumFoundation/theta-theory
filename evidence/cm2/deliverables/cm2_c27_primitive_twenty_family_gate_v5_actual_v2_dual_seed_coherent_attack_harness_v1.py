#!/usr/bin/env python3
"""Coherent resigned attacks on the compact actual-v2 dual-seed verdict."""
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    mutations: list[tuple[str, str, tuple[str, ...], Any]] = [
        ...
        ("ledger_removed", "first", ("ledger_descriptors",), {key: value for key, value in first["ledger_descriptors"].items() if key != "full_component_edge_union"}),
