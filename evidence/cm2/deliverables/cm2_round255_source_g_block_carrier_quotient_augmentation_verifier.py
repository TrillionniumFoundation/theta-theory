#!/usr/bin/env python3
"""Independently verify block-carrier quotient augmentation."""
...
OUTPUT = HERE / "cm2_round255_source_g_block_carrier_quotient_augmentation_verification.json"
SCHEMA = "cm2.round255.source-g-block-carrier-quotient-augmentation.verification.v1"
CANDIDATE = HERE / "cm2_round255_source_g_block_carrier_quotient_augmentation_certificate.json"
CANDIDATE_SHA256 = (
...
def main() -> int:
    ...
    need(
        ...
        == "cm2.round255.source-g-block-carrier-quotient-augmentation.v1"
    ...
    result = {
        "status": "PASS_INDEPENDENT_ROUND255",
        "producer_imported_or_executed": False,
        "candidate_result_sha256": candidate["result_sha256"],
        "verified_block_carrier_component_count":
            census["new_known_block_only_carrier_component_count"],
        "verified_new_Round208_assignment_count":
            census["new_Round208_block_carrier_assignment_count"],
        "verified_cumulative_assignment_count":
            census["cumulative_occurrence_quotient_assignment_count"],
        "verified_remaining_occurrence_count":
            census["total_occurrences_without_quotient_assignment"],
        "verified_all_known_blocks_represented":
            census["known_blocks_represented_in_unified_quotient"],
