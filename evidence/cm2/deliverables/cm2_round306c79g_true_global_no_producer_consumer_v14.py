#!/usr/bin/env python3
"""C79g v14 append-only zero-credit candidate builder.

This append-only v14 binds the independently verified C78s 13-member final
...
is permanently non-authoritative.  The separately committed v14 seal plus the
...
COLD_EXEC_FD_ENV = "CM2_C79G_V14_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V14_COLD_SOURCE_FD"
COLD_COORDINATION_PARENT_FD_ENV = "CM2_C79G_V14_COORDINATION_PARENT_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V14_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V14_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V14_COLD_LAUNCHER_FILE_SHA256"
V10_PRODUCER_FD_ENV = "CM2_C79G_V14_V10_PRODUCER_FD"
V9_LAUNCHER_FD_ENV = "CM2_C79G_V14_V9_LAUNCHER_FD"
V11_PRODUCER_FD_ENV = "CM2_C79G_V14_V11_PRODUCER_FD"
V11_LAUNCHER_FD_ENV = "CM2_C79G_V14_V11_LAUNCHER_FD"
V11_REJECTION_FD_ENV = "CM2_C79G_V14_V11_REJECTION_FD"
V12_PRODUCER_FD_ENV = "CM2_C79G_V14_V12_PRODUCER_FD"
V12_CONSUMER_FD_ENV = "CM2_C79G_V14_V12_CONSUMER_FD"
V12_LAUNCHER_FD_ENV = "CM2_C79G_V14_V12_LAUNCHER_FD"
V5_REJECTION_FD_ENV = "CM2_C79G_V14_V5_REJECTION_FD"
V12_REJECTION_FD_ENV = "CM2_C79G_V14_V12_REJECTION_FD"
V13_PRODUCER_FD_ENV = "CM2_C79G_V14_V13_PRODUCER_FD"
V13_CONSUMER_FD_ENV = "CM2_C79G_V14_V13_CONSUMER_FD"
V13_LAUNCHER_FD_ENV = "CM2_C79G_V14_V13_LAUNCHER_FD"
V13_PRODUCER_PYC_FD_ENV = "CM2_C79G_V14_V13_PRODUCER_PYC_FD"
V13_CONSUMER_PYC_FD_ENV = "CM2_C79G_V14_V13_CONSUMER_PYC_FD"
V13_LAUNCHER_PYC_FD_ENV = "CM2_C79G_V14_V13_LAUNCHER_PYC_FD"
...
SELF = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v14.py"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v14"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v14"

CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v14.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v14.json"
...
V13_TO_V14_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v13_to_v14_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V14 = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v14.json"
COLD_LAUNCHER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v14.py"
COLD_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v14.sha256"
COLD_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v14.json"
...
FINAL_V14_CORE_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "479a0b3f6b4f0ad7e25d22c9f32eec046758a9a7d40509a6bda200e8e41e0ece"
CONTRACT_OBJECT_PIN = "11fd8966ed631f3bcc0eb6b1881f0536c814b7a7c093eca8289680e38a7d7b8b"
CLOSED_SCHEMA_FILE_PIN = "3d07ccda67cb71d0e5c64d37c0d8e1fcf425de4fbfefddf03bf43934ffdaaa4d"
...
CANDIDATE_A = RUNTIME / ("c79g-v14-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v14-candidate-b-" + CHECKPOINT_OBJECT_PIN)
COLD_EXACT8 = (
    V13_SUPERSESSION_RECEIPT,
    CLOSED_SCHEMA,
    CONTRACT,
    SELF,
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v14.py",
    V13_TO_V14_TRANSITION,
    STATIC_AUDIT_V14,
    COLD_LAUNCHER,
)

# Frozen predecessor authority for the v14 successor draft.  This is a
...
V7_POSITIVE_RUNTIME_SURFACES = tuple(ROOT / value for value in (
    ".cm2-runtime/c79g-v7-candidate-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v7-candidate-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v7-verification-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v7-verification-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v7-committed-completion-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/cm2-global-authority-heads/c79g-v7-" +
        CHECKPOINT_OBJECT_PIN + ".seal",
))
V7_DETERMINISTIC_STAGE_SURFACES = tuple(ROOT / value for value in (
    ".cm2-runtime/.c79g-v7-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v7-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v7-verification-stage-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v7-verification-stage-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v7-completion-stage-" + CHECKPOINT_OBJECT_PIN,
...
V11_POSITIVE_RUNTIME_SURFACES = tuple(ROOT / value for value in (
    ".cm2-runtime/c79g-v11-candidate-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v11-candidate-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v11-verification-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v11-verification-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v11-committed-completion-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/cm2-global-authority-heads/c79g-v11-" +
        CHECKPOINT_OBJECT_PIN + ".seal",
))
V11_DETERMINISTIC_STAGE_SURFACES = tuple(ROOT / value for value in (
    ".cm2-runtime/.c79g-v11-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v11-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v11-verification-stage-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v11-verification-stage-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v11-completion-stage-" + CHECKPOINT_OBJECT_PIN,
...
V12_POSITIVE_RUNTIME_SURFACES = tuple(ROOT / value for value in (
    ".cm2-runtime/c79g-v12-candidate-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v12-candidate-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v12-verification-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v12-verification-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/c79g-v12-committed-completion-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/cm2-global-authority-heads/c79g-v12-" +
        CHECKPOINT_OBJECT_PIN + ".seal",
))
V12_DETERMINISTIC_STAGE_SURFACES = tuple(ROOT / value for value in (
    ".cm2-runtime/.c79g-v12-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v12-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v12-verification-stage-a-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v12-verification-stage-b-" + CHECKPOINT_OBJECT_PIN,
    ".cm2-runtime/.c79g-v12-completion-stage-" + CHECKPOINT_OBJECT_PIN,
...
def _linux_libc() -> ctypes.CDLL:
    need(sys.platform.startswith("linux"), "Linux-only v14 publication protocol")
...
class HeldSelf:
    ...
    def __init__(self, exec_inherited: int, source_inherited: int,
                 ...
                 incident_inherited: Mapping[Path, int]) -> None:
        self.exec_fd = -1
        self.source_fd = -1
        ...
        self.v12_shape_incident: dict[str, Any] | None = None
        ...
        expected_incident_pins = {
            V10_PUBLISHED_EXACT10_PINS[3][0]: V10_PUBLISHED_EXACT10_PINS[3][1],
            V9_PUBLISHED_EXACT10_PINS[7][0]: V9_PUBLISHED_EXACT10_PINS[7][1],
            V11_PUBLISHED_EXACT10_PINS[3][0]: V11_PUBLISHED_EXACT10_PINS[3][1],
            V11_PUBLISHED_EXACT10_PINS[7][0]: V11_PUBLISHED_EXACT10_PINS[7][1],
            ...
            V12_OFFICIAL_REJECTION: V12_OFFICIAL_REJECTION_FILE_PIN,
            **V13_INCIDENT_EXACT6_PINS,
            V13_SUPERSESSION_RECEIPT: V13_SUPERSESSION_RECEIPT_FILE_PIN,
        }
        expected_incident_order = tuple(
            path for _, path, _ in V13_SUPERSESSION_EXACT16) + (
                V13_SUPERSESSION_RECEIPT,)
        need(tuple(expected_incident_pins) == expected_incident_order and
             tuple(incident_inherited) == expected_incident_order and
             set(incident_inherited) == set(expected_incident_pins),
             "exact ordered sixteen incident members plus receipt held fd")
        for path, inherited_fd in incident_inherited.items():
            try:
                self.incident_fds[path] = os.dup(inherited_fd)
            except OSError as exc:
                raise Reject("cold-launch inherited incident fd unavailable:" +
                             str(path)) from exc

        # This is the first physical gate.  It intentionally touches only the
        # Four bootstrap descriptors plus seventeen incident descriptors are held;
        # no workspace pathname has been read yet.
        ...
        need(stat.S_ISREG(self.exec_before.st_mode) and
             ...
             all(stat.S_ISREG(value.st_mode) and
                 stat.S_IMODE(value.st_mode) == 0o444 and value.st_nlink == 1
             ...
             len({(value.st_dev, value.st_ino)
                  for value in self.incident_before.values()}) == 17,
             "sealed exec/source/coordination/root plus seventeen incident fds first gate")
        ...
        need(self.exec_raw == self.source_raw and
             ...
             statx_mount_id(self.source_fd) == self.source_mount_id and
             ...
             "sealed exec/source plus seventeen pinned incident fds stable first gate")
        ...
        need(self.v12_shape_incident == V12_V5_REJECTION_SHAPE_INCIDENT,
             "producer inherited exact10 reproduces v12 shape incident")
        self.v13_supersession_receipt = self._validate_v13_supersession_receipt()
        ...
        need(SELF == OUT / "cm2_round306c79g_true_global_no_producer_consumer_v14.py",
        ...
        for path in expected_incident_pins:
            ...
            need(stat.S_ISREG(path_before.st_mode) and
                 ...
                 "inherited incident fd equals installed path:" + str(path))
    ...
    def _validate_v13_supersession_receipt(self) -> dict[str, Any]:
        """Mechanically close the inherited exact16 plus receipt authority."""
        raw = self.incident_raw[V13_SUPERSESSION_RECEIPT]
        supersession = strict_json(
            raw, "v13 supersession receipt inherited current-anchor fd")
        need(isinstance(supersession, dict), "v13 supersession receipt object")
        verify_object(
            supersession, "v13 supersession receipt",
            V13_SUPERSESSION_RECEIPT_OBJECT_PIN)
        ...
        inherited_exact16 = successor_contract.get(
            ...
            if isinstance(successor_contract, dict) else {}
        expected_exact16 = [
            {
                "ordinal": ordinal,
                "role": role,
            ...
            for ordinal, (role, path, file_pin) in enumerate(
                V13_SUPERSESSION_EXACT16, start=1)
        ]
        observed_exact16 = inherited_exact16.get("ordered_members", []) \
            if isinstance(inherited_exact16, dict) else []
        source_contract = supersession.get(
            "frozen_v13_inherited_incident_authority_exact10_source_contract", {})
        normalized_exact10 = source_contract.get("normalized_ordered_members", []) \
        ...
        normalized_projection = [
            ...
            for row in normalized_exact10 if isinstance(row, dict)
        ] if isinstance(normalized_exact10, list) else []
        live6 = supersession.get("live_successor_required_incident_exact6", {})
        live6_rows = live6.get("ordered_members", []) \
            if isinstance(live6, dict) else []
        live6_projection = [
            (row.get("path"), row.get("file_sha256"), row.get("frozen_mode"),
             row.get("nlink"), row.get("role"))
            for row in live6_rows if isinstance(row, dict)
        ] if isinstance(live6_rows, list) else []
        expected_live6_projection = [
            (str(path.relative_to(ROOT)), file_pin, "0444", 1,
             "LIVE_SUCCESSOR_REQUIRED_INCIDENT_SOURCE" if index < 3 else
             "LIVE_SUCCESSOR_REQUIRED_INCIDENT_PYC")
            for index, (_, path, file_pin) in enumerate(
                V13_SUPERSESSION_EXACT16[10:])
        ]
        census = successor_contract.get("v14_census_derivation", {}) \
            if isinstance(successor_contract, dict) else {}
        expected_census = {
            "predecessor_total": V14_PREDECESSOR_UNIQUE_LIVE_IDENTITY_COUNT,
            "prepublication_total":
                V14_PREPUBLICATION_UNIQUE_LIVE_IDENTITY_COUNT,
            "prior_history": 98,
            "supplemental_tooling_exact2_not_separately_live_counted_by_v14":
                True,
            "terminal_total": V14_TERMINAL_UNIQUE_LIVE_IDENTITY_COUNT,
        ...
        supplemental = supersession.get("supplemental_tooling_exact2", {})
        v12_anchor = supersession.get("frozen_v12_authority_anchor", {})
        expected_v12_anchor_exact10 = [
            {
                "path": record["path"],
                "file_sha256": record["file_sha256"],
                **({"object_sha256": record["object_sha256"]}
                   if "object_sha256" in record else {}),
            }
            for record in _v12_published_exact10_records()
        ]
        need(raw == canonical(supersession) + b"\n" and
             sha_bytes(raw) == V13_SUPERSESSION_RECEIPT_FILE_PIN and
             ...
             set(successor_contract) == {
                 "inherited_incident_authority_exact16",
                 "one_way_binding_avoids_hash_cycle", "successor_version",
                 "this_receipt_does_not_pin_any_v14_successor_byte",
                 "v14_census_derivation",
                 "v14_current_exact8_first_member_must_be_this_receipt",
                 "v14_must_pin_this_receipt_file_and_object_sha256",
             ...
             successor_contract.get("one_way_binding_avoids_hash_cycle") is True and
             successor_contract.get(
                 "this_receipt_does_not_pin_any_v14_successor_byte") is True and
             successor_contract.get(
             ...
             successor_contract.get(
                 "v14_predecessor_unique_live_identity_count") ==
                 V14_PREDECESSOR_UNIQUE_LIVE_IDENTITY_COUNT and
             successor_contract.get(
                 "v14_prepublication_unique_live_identity_count") ==
                 V14_PREPUBLICATION_UNIQUE_LIVE_IDENTITY_COUNT and
             successor_contract.get("v14_terminal_unique_live_identity_count") ==
                 V14_TERMINAL_UNIQUE_LIVE_IDENTITY_COUNT and
             successor_contract.get("v14_terminal_group_vector") ==
                 list(V14_TERMINAL_GROUP_VECTOR) and
             census == expected_census,
             "v13 receipt exact successor/census 105-113-115-vector contract")
        need(isinstance(inherited_exact16, dict) and
             set(inherited_exact16) == {
                 "inherited_normalized_exact10_count",
                 "ordered_exact16_canonical_byte_length",
                 "ordered_exact16_canonical_sha256",
                 "ordered_live_v13_source_then_pyc_exact6_count",
                 "ordered_member_count", "ordered_member_exact_keys",
                 "ordered_members",
                 "this_receipt_pins_no_v14_successor_byte_or_v14_fd_number",
                 "v13_fd_environment_names_are_historical_records_not_v14_pins",
             ...
             inherited_exact16.get(
                 "ordered_live_v13_source_then_pyc_exact6_count") == 6 and
             inherited_exact16.get(
                 "this_receipt_pins_no_v14_successor_byte_or_v14_fd_number") is True and
             inherited_exact16.get(
                 "v13_fd_environment_names_are_historical_records_not_v14_pins") is True and
             inherited_exact16.get(
                 "v14_must_live_hold_and_terminally_replay_exact16_plus_this_receipt") is True and
             observed_exact16 == expected_exact16 and
             all(isinstance(row, dict) and set(row) ==
                 {"ordinal", "role", "path", "file_sha256"}
                 for row in observed_exact16) and
             len(canonical(observed_exact16)) ==
                 V13_SUPERSESSION_EXACT16_CANONICAL_BYTE_LENGTH and
             sha_bytes(canonical(observed_exact16)) ==
                 V13_SUPERSESSION_EXACT16_CANONICAL_SHA256 and
             inherited_exact16.get("ordered_exact16_canonical_byte_length") ==
                 V13_SUPERSESSION_EXACT16_CANONICAL_BYTE_LENGTH and
             inherited_exact16.get("ordered_exact16_canonical_sha256") ==
                 V13_SUPERSESSION_EXACT16_CANONICAL_SHA256,
             "v13 receipt exact16 ordered rows/keys/bytes/digest closure")
        need(isinstance(source_contract, dict) and
             source_contract.get("normalized_ordered_member_count") == 10 and
             source_contract.get("normalized_record_exact_keys") ==
                 ["ordinal", "role", "fd_environment", "path", "file_sha256"] and
             normalized_projection == expected_exact16[:10] and
             all(isinstance(row, dict) and set(row) == {
                 "ordinal", "role", "fd_environment", "path", "file_sha256"}
                 for row in normalized_exact10) and
             len(canonical(normalized_exact10)) ==
                 V13_SUPERSESSION_NORMALIZED_EXACT10_CANONICAL_BYTE_LENGTH and
             sha_bytes(canonical(normalized_exact10)) ==
                 V13_SUPERSESSION_NORMALIZED_EXACT10_CANONICAL_SHA256 and
             source_contract.get("normalized_exact10_canonical_byte_length") ==
                 V13_SUPERSESSION_NORMALIZED_EXACT10_CANONICAL_BYTE_LENGTH and
             source_contract.get("normalized_exact10_canonical_sha256") ==
                 V13_SUPERSESSION_NORMALIZED_EXACT10_CANONICAL_SHA256,
             "v13 receipt inherited normalized exact10 reconstruction")
        need(isinstance(live6, dict) and
             live6.get("ordered_member_count") == 6 and
             live6_projection == expected_live6_projection and
             live6.get(
                 "v14_must_live_hold_and_terminally_replay_all_six_plus_this_receipt")
                 is True and
             isinstance(supplemental, dict) and
             supplemental.get("ordered_member_count") == 2 and
             supplemental.get(
                 "v14_may_bind_these_only_through_this_receipt_file_and_object_hashes")
                 is True and
             supplemental.get("v14_need_not_live_hold_these_two_tool_files") is True and
             isinstance(v12_anchor, dict) and
             v12_anchor.get("ordered_published_exact10") ==
                 expected_v12_anchor_exact10 and
             v12_anchor.get("official_v12_rejection") == {
             ...
             v12_anchor.get(
                 "v12_rejection_is_canonical_singleton_zero_credit") is True,
             "v13 receipt live exact6/supplemental exact2/v12 anchor closure")
        return supersession
    ...
    def execution_proof(self) -> dict[str, Any]:
        return {
            ...
            "seventeen_incident_authority_inputs_inherited_as_held_fds": True,
            "seventeen_incident_held_fds_path_identity_mount_and_hash_revalidated": True,
        }
    ...
    def terminal_replay(self) -> None:
        ...
        need(exec_replay == source_replay == self.exec_raw == self.source_raw and
             ...
             all(self._read_fd(self.incident_fds[path]) ==
                 ...
                 for path in self.incident_fds) and
             self.v12_shape_incident is not None and
             derive_v12_v5_rejection_shape_incident(
                 ...
                 self.incident_raw[V5_OFFICIAL_REJECTION],
                 self.incident_raw[V12_OFFICIAL_REJECTION]) ==
                 self.v12_shape_incident,
             "sealed exec/source plus seventeen incident held-fd terminal replay")
        need(self.v13_supersession_receipt is not None and
             self._validate_v13_supersession_receipt() ==
                 self.v13_supersession_receipt,
             "terminal exact16 plus receipt mechanical successor replay")
...
def new_candidate_stage(outdir: Path, parent: HeldParent) -> tuple[Path, HeldMutableStage]:
    ...
    name = ".c79g-v14-candidate-stage-" + orientation + "-" + CHECKPOINT_OBJECT_PIN
...
def strict_bool_predecessor_and_successor_census(
        ...
        v14_sources: Mapping[str, bytes]) -> dict[str, Any]:
    """Prove frozen v5 defects and zero-unsafe complete v6/v7/v14 boxes."""
    ...
    v14 = {role: _strict_bool_need_census(v14_sources[role], role)
          for role in v14_roles}
    ...
    v14_unproved = sum(
        v14[role]["recursive_exact_bool_unproved_count"] for role in v14_roles)
    v14_arity = sum(
        v14[role]["arity_star_or_keyword_failure_count"] for role in v14_roles)
    v14_returns = sum(
        v14[role]["annotated_bool_return_failure_count"] for role in v14_roles)
    need(v6_unproved == 0 and v6_arity == 0 and v6_returns == 0 and
         v7_unproved == 0 and v7_arity == 0 and v7_returns == 0 and
         v14_unproved == 0 and v14_arity == 0 and v14_returns == 0,
         "v6/v7/v14 recursive exact-bool full boxes have zero unsafe or unproved sites")
    return {
        ...
        "same_seven_absent_from_v14": True,
        ...
        "v14_recursive_exact_bool_unproved_count": v14_unproved,
        ...
        "v14_direct_need_call_count": sum(
            v14[role]["direct_need_call_count"] for role in v14_roles),
...
def v6_held_self_identity_defect_regression(raw: bytes) -> dict[str, Any]:
    ...
    V14 first proves the complete three-site census, then independently locates
...
def _expected_rejected_prepublication_v13_receipt(
    ...
    """Project the frozen receipt into the exact seven-key v14 JSON surface."""
    return {
...
def _validate_v7_regression_section(
    ...
    need(strict_bool_census["v7_recursive_exact_bool_unproved_count"] == 0 and
         strict_bool_census["v14_recursive_exact_bool_unproved_count"] == 0 and
         strict_bool_census["all_twelve_sources_AST_parsed_and_compiled_in_memory"]
             is True and
         strict_bool_census["compiled_code_executed"] is False,
         label + ":v7/v14 full-callsite strict-bool closure")
    need(section.get("all_ten_file_pins_match") is True and
         section.get("all_declared_object_pins_match") is True and
         section.get("all_ten_regular_0444_nlink1") is True and
         section.get("exact8_manifest_reconstructs_first_eight_in_order") is True and
...
def _validate_final_static_audit(
    ...
    """Fail closed on every final v14 dual-static-audit acceptance field.
    ...
    need(set(audit) == {
             ...
             "effective_checkpoint_object_sha256", "audited_v14_bundle",
    ...
    need(isinstance(supersession_receipt, dict) and
         ...
         "final v14 static audit rejected-prepublication v13 receipt")
    need(audit.get("v12_v5_rejection_shape_incident") ==
         ...
         "final v14 static audit v12 incident and exact9 historical witness")
    ...
    need(isinstance(dual, dict) and set(dual) == {
         ...
         }, "final v14 static audit dual-checker exact8 closure")
    ...
    need(isinstance(checker_a, dict) and set(checker_a) == {
         ...
         }, "final v14 checker A/B/C and helper-consensus exact object closures")
    ...
    need(helper_consensus.get("algorithm") ==
         ...
         "final v14 three-source helper AST, exact40 witness, and callsites")
    need(checker_a.get("algorithm") ==
         ...
         "final v14 checker A/B/C algorithms and exact GO statuses")
    ...
    need(isinstance(input_a, dict) and isinstance(input_b, dict) and
         ...
         "final v14 checker A/B exact43 ordered identical input-pin closure")
    expected_inputs = {
    ...
    need(input_a == expected_inputs and
         ...
         "final v14 checker inputs pin exact current core and append-only history")
    ...
    need(_nonzero_lower_sha256(normalized_a) is True and
         ...
         "final v14 three-way normalized and B/C common-callsite consensus")
    ...
    need(isinstance(kind_census, dict) and set(kind_census) == {
         ...
         "final v14 checker C exact common-callsite kind census")
    need(type(checker_a.get("wider_local_callsite_census_row_count")) is int and
         ...
         "final v14 checker A positive census and three-file in-memory compile")
    need(type(checker_a.get("arity_failure_count")) is int and
         ...
         "final v14 checker A zero arity/undefined/duplicate/failed counts")
    for key in (
    ...
    need(type(dual.get("independent_pin_normalizer_count")) is int and
         ...
         dual.get("pin_normalized_ast_algorithm") ==
             ...
             "PRESERVE_V12_REJECTION_AND_ALL_HISTORICAL_PINS_V1" and
         ...
         dual.get(
             "pin_normalization_preserves_v12_rejection_and_all_historical_pins") is True and
         ...
         "final v14 dual exact 3/2 checker counts and type-exact consensuses")
    ...
    need(isinstance(attacks, dict) and set(attacks) == {
         ...
         "final v14 coherent attack exact7, 137/137 including ordered v11 "
    ...
    need(isinstance(sealed, dict) and set(sealed) == {
         ...
         sealed.get(
             "consumer_frozen_predecessor_incident_exact10_bytes_read_only_noncredit_allowed") is True and
         sealed.get(
         ...
         "final v14 sealed-exec and scoped no-producer exact16 closure")
    ...
    need(isinstance(closure, dict) and set(closure) == {
         ...
         }, "final v14 schema/constructor exact21 closure")
    need(type(closure.get("schema_definition_count")) is int and
         ...
         "final v14 schema 46 defs/242 refs/0 unresolved/52 closed/0 mismatch")
    need(closure.get("strict_JSON_duplicate_keys_rejected") is True and
         ...
         "final v14 schema and live-protocol type-exact bool closure")
    actual_keywords = [
    ...
    need(closure.get("actual_schema_keyword_universe") == actual_keywords and
         ...
         "final v14 exact canonical schema keyword universes and digests")
    ...
    need(isinstance(shapes, dict) and set(shapes) == set(expected_shapes) and
         ...
         "final v14 exact nine output-shape key counts")
    ...
    need(isinstance(acceptance, dict) and set(acceptance) == {
         ...
         "final v14 audit acceptance exact10 type-exact zero-runtime closure")
...
def hold_static_freeze_trust(self_guard: HeldSelf) -> dict[str, Any]:
    """Hold current v14 exact10 and every distinct append-only predecessor.
    ...
    manifest_guard = HeldPinnedInput(
        COLD_MANIFEST, "C79g v14 cold-launch manifest", 0o444)
    outer_guard = HeldPinnedInput(
        COLD_OUTER, "C79g v14 cold-launch outer-last receipt", 0o444)
    manifest_entries = parse_manifest_ordered(
        manifest_guard.raw, "C79g v14 cold-launch exact8 manifest")
    ...
    need(len(manifest_by_path) == 8 and
         ...
         manifest_by_path[V13_SUPERSESSION_RECEIPT] ==
             V13_SUPERSESSION_RECEIPT_FILE_PIN and
         COLD_EXACT8[0] == V13_SUPERSESSION_RECEIPT,
         "cold-launch manifest current SELF, receipt-first, and policy pins")

    by_path: dict[Path, HeldPinnedInput] = {}
    for path in COLD_EXACT8:
        if path != SELF:
            by_path[path] = HeldPinnedInput(
                path, "C79g v14 cold exact8:" + path.name, 0o444,
    ...
    v12_rejection_guard = HeldPinnedInput(
        ...
        V12_OFFICIAL_REJECTION_FILE_PIN,
        self_guard.incident_fds[V12_OFFICIAL_REJECTION])
    v13_incident_guards = [
        HeldPinnedInput(
            path, "frozen v13 live incident:" + path.name, 0o444, file_pin,
            self_guard.incident_fds[path])
    ...
    need(len(current_cold_ten_guards) == 10 and
         ...
         "current v14 cold exact10 unique held identities on one statx mount")
    exact8_stats = [
    ...
    need(all(chronology.values()),
         "physical v14 exact8/manifest/outer freeze chronology")
    ...
    need(len(prior_history_guards) == 98 and
         ...
         len({guard.identity for guard in prepublication_guards}) ==
             V14_PREPUBLICATION_UNIQUE_LIVE_IDENTITY_COUNT and
         len(all_file_guards) == V14_TERMINAL_UNIQUE_LIVE_IDENTITY_COUNT and
         len({guard.identity for guard in all_file_guards}) ==
             V14_TERMINAL_UNIQUE_LIVE_IDENTITY_COUNT and
         group_vector == list(V14_TERMINAL_GROUP_VECTOR) and
    ...
    v14_consumer_path = COLD_EXACT8[4]
    strict_bool_census = strict_bool_predecessor_and_successor_census(
        ...
        {
            "producer_v14": self_guard.raw,
            "consumer_v14": by_path[v14_consumer_path].raw,
            "launcher_v14": by_path[COLD_LAUNCHER].raw,
        })

    transition_guard = by_path[V13_TO_V14_TRANSITION]
    audit_guard = by_path[STATIC_AUDIT_V14]
    transition = strict_json(transition_guard.raw, "C79g v14 transition trust")
    audit = strict_json(audit_guard.raw, "C79g v14 static audit trust")
    outer = strict_json(outer_guard.raw, "C79g v14 cold-launch outer trust")
    ...
    verify_object(transition, "C79g v14 transition trust")
    verify_object(audit, "C79g v14 static audit trust")
    verify_object(outer, "C79g v14 cold-launch outer trust")
    need(set(transition) == {
    ...
    contract_cross = strict_json(
        by_path[CONTRACT].raw, "C79g v14 contract cross-check")
    audit_schema = audit.get("schema_and_constructor_closure", {})
    transition_pin = audited.get("v13_to_v14_transition_receipt", {})
    ...
    _validate_v7_regression_section(
        published_v7, strict_bool_census, "v14 transition v7 predecessor")
    _validate_v7_regression_section(
        audit_v7, strict_bool_census, "v14 audit v7 predecessor")
    _validate_v8_regression_section(
        published_v8, v8_rollout_control_flow_incident,
        "v14 transition v8 predecessor")
    _validate_v8_regression_section(
        audit_v8, v8_rollout_control_flow_incident,
        "v14 audit v8 predecessor")
    _validate_v9_regression_section(
        published_v9, "v14 transition v9 predecessor")
    _validate_v9_regression_section(
        audit_v9, "v14 audit v9 predecessor")
    _validate_v10_regression_section(
        published_v10, v10_regression_label_prefix_incident,
        "v14 transition v10 predecessor")
    _validate_v10_regression_section(
        audit_v10, v10_regression_label_prefix_incident,
        "v14 audit v10 predecessor")
    _validate_v11_regression_section(
        published_v11, v10_colon_prefix_witness,
        "v14 transition v11 predecessor")
    _validate_v11_regression_section(
        audit_v11, v10_colon_prefix_witness,
        "v14 audit v11 predecessor")
    _validate_v12_regression_section(
        published_v12, "v14 transition v12 predecessor")
    _validate_v12_regression_section(
        audit_v12, "v14 audit v12 predecessor")
    ...
    need(transition.get("status") ==
         ...
         audit_v4.get(
             "v14_closed_object_required_property_mismatch_count") == 0 and
         audit_v4.get("same_defects_absent_from_v14") is True and
         ...
         "transition/audit pin current v14 and preserve exact v3/v4/v7 history")
    ...
    need(set(outer) == {
         ...
         "cold-launch v14 outer-last exact8 and zero-credit closure")
    ...
    return {
        ...
        "v14_terminal_unique_live_identity_count":
            V14_TERMINAL_UNIQUE_LIVE_IDENTITY_COUNT,
        "v14_terminal_group_vector": list(V14_TERMINAL_GROUP_VECTOR),
...
def ensure_launch_configuration() -> HeldSelf:
    ...
    need(FINAL_V14_CORE_PINS_INSTALLED is True,
         "v14 final core pins are not installed; runtime permanently disabled")
    need(all(value not in V14_DRAFT_CORE_PIN_SENTINELS for value in (
             CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN)),
         "v14 draft contract/schema sentinels must all be replaced before runtime")
    ...
    v10_producer_fd_text = os.environ.get(V10_PRODUCER_FD_ENV, "")
    v9_launcher_fd_text = os.environ.get(V9_LAUNCHER_FD_ENV, "")
    v11_producer_fd_text = os.environ.get(V11_PRODUCER_FD_ENV, "")
    v11_launcher_fd_text = os.environ.get(V11_LAUNCHER_FD_ENV, "")
    v11_rejection_fd_text = os.environ.get(V11_REJECTION_FD_ENV, "")
    v12_producer_fd_text = os.environ.get(V12_PRODUCER_FD_ENV, "")
    v12_consumer_fd_text = os.environ.get(V12_CONSUMER_FD_ENV, "")
    v12_launcher_fd_text = os.environ.get(V12_LAUNCHER_FD_ENV, "")
    v5_rejection_fd_text = os.environ.get(V5_REJECTION_FD_ENV, "")
    v12_rejection_fd_text = os.environ.get(V12_REJECTION_FD_ENV, "")
    v13_producer_fd_text = os.environ.get(V13_PRODUCER_FD_ENV, "")
    v13_consumer_fd_text = os.environ.get(V13_CONSUMER_FD_ENV, "")
    v13_launcher_fd_text = os.environ.get(V13_LAUNCHER_FD_ENV, "")
    v13_producer_pyc_fd_text = os.environ.get(V13_PRODUCER_PYC_FD_ENV, "")
    v13_consumer_pyc_fd_text = os.environ.get(V13_CONSUMER_PYC_FD_ENV, "")
    v13_launcher_pyc_fd_text = os.environ.get(V13_LAUNCHER_PYC_FD_ENV, "")
    v13_receipt_fd_text = os.environ.get(
        V13_SUPERSESSION_RECEIPT_FD_ENV, "")
    ...
    fd_texts = (exec_fd_text, source_fd_text,
                ...
                v13_producer_fd_text, v13_consumer_fd_text,
                v13_launcher_fd_text, v13_producer_pyc_fd_text,
                v13_consumer_pyc_fd_text, v13_launcher_pyc_fd_text,
                v13_receipt_fd_text)
    need(all(value and len(value) <= 10 and
             all(ch in "0123456789" for ch in value) and
             int(value) >= 3 for value in fd_texts) and
         len({int(value) for value in fd_texts}) == 21 and
         EXECUTED_SOURCE == Path("/proc/self/fd") / exec_fd_text and
         _cold_root_text == str(ROOT) and ROOT.is_absolute() and
         SELF == ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v14.py",
         "producer accepts exactly twenty-one distinct decimal cold-launch fds and "
    ...
    need(all(isinstance(value, str) and len(value) == 64 and
         ...
         "C79g v14 exact non-placeholder contract/schema/rejection pins")
    need(set(C78S_FINAL["pins"]) == set(C78S_NAMES) and
         ...
         "C79g v14 exact filled launch configuration")
    ...
    self_guard = HeldSelf(
        ...
        int(coordination_fd_text), int(root_fd_text), {
            V10_PUBLISHED_EXACT10_PINS[3][0]: int(v10_producer_fd_text),
            V9_PUBLISHED_EXACT10_PINS[7][0]: int(v9_launcher_fd_text),
            V11_PUBLISHED_EXACT10_PINS[3][0]: int(v11_producer_fd_text),
            V11_PUBLISHED_EXACT10_PINS[7][0]: int(v11_launcher_fd_text),
            V11_OFFICIAL_REJECTION: int(v11_rejection_fd_text),
            V12_FROZEN_PRODUCER: int(v12_producer_fd_text),
            V12_FROZEN_CONSUMER: int(v12_consumer_fd_text),
            V12_FROZEN_LAUNCHER: int(v12_launcher_fd_text),
            V5_OFFICIAL_REJECTION: int(v5_rejection_fd_text),
            V12_OFFICIAL_REJECTION: int(v12_rejection_fd_text),
            V13_FROZEN_PRODUCER: int(v13_producer_fd_text),
            V13_FROZEN_CONSUMER: int(v13_consumer_fd_text),
            V13_FROZEN_LAUNCHER: int(v13_launcher_fd_text),
            V13_FROZEN_PRODUCER_PYC: int(v13_producer_pyc_fd_text),
            V13_FROZEN_CONSUMER_PYC: int(v13_consumer_pyc_fd_text),
            V13_FROZEN_LAUNCHER_PYC: int(v13_launcher_pyc_fd_text),
            V13_SUPERSESSION_RECEIPT: int(v13_receipt_fd_text),
        })
...
def validate_static_authorities(static_trust: dict[str, Any]) -> dict[str, Any]:
    ...
    need(set(contract) == {
         ...
         contract.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         contract.get("status") ==
             "STATIC_CONTRACT_BYTES_FINAL__COLD_FREEZE_PENDING__RUNTIME_NOT_AUTHORIZED" and
         contract.get("v14_bundle", {}).get(
             "independent_verifier_assembler_authority_consumer", {}).get("path") ==
             "deliverables/cm2_round306c79g_true_global_no_producer_consumer_"
             "independent_verifier_assembler_authority_consumer_v14.py" and
         contract.get("v14_bundle", {}).get("closed_schema_validator_policy") == {
         ...
         "v14 frozen contract checkpoint/composite-only boundary")
    ...
    need(closed.get("$ref") == "#/$defs/coldLaunchedCommittedAuthority" and
         ...
         "append-only v14 cold root, zero-credit inner, and persisted zero boundary")
...
def input_registry(state: dict[str, Any], self_guard: HeldSelf,
    ...
    return close_object({
        ...
        **self_guard.execution_proof(),
        ...
        "v14_predecessor_unique_live_identity_count":
            static_trust["v14_predecessor_unique_live_identity_count"],
        "v14_prepublication_unique_live_identity_count":
            static_trust["v14_prepublication_unique_live_identity_count"],
        "v14_terminal_unique_live_identity_count":
            static_trust["v14_terminal_unique_live_identity_count"],
        "v14_terminal_group_vector":
            static_trust["v14_terminal_group_vector"],
        "post_source_static_freeze_trust": {
            "v13_to_v14_transition_receipt": {
                "path": str(V13_TO_V14_TRANSITION.relative_to(ROOT)),
                "file_sha256": static_trust["transition_file_sha256"],
                "object_sha256": static_trust["transition_object_sha256"],
            },
            "static_audit_v14": {
                "path": str(STATIC_AUDIT_V14.relative_to(ROOT)),
        ...
        "current_v14_producer_source_content_opened_or_read": False,
        "current_v14_producer_source_content_imported_compiled_or_executed": False,
...
def build(outdir: Path, self_guard: HeldSelf,
    ...
    lock = (
        "C79g v14 isolated candidate only; standalone non-authoritative. Formal-global credit "
    ...
    outer = close_object({
        ...
        "candidate_install": {
            "staging_path_template":
                ".cm2-runtime/.c79g-v14-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
            "fixed_target_set": [
...
def main(argv: list[str] | None = None) -> int:
    ...
    if V14_DRAFT_RUNTIME_DISABLED and not FINAL_V14_CORE_PINS_INSTALLED:
        raise Reject(
