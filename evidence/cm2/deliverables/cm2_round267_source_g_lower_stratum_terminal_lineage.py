#!/usr/bin/env python3
"""Close the bookkeeping lineage of every Round174 lower-dimensional stratum.
...
def main() -> int:
    ...
    parser.add_argument("--seed", type=int, default=267_071)
    ...
    print(
        "lower_strata=62696 absent=6120 canonical_support=56576 "
        "physical_existence=1148 nominal_only=55428"
    )
    print(
        "post_Round267_components=63224 frontiers=126468/116/133284 "
        "quotient_unchanged=true strict_nonpromotion=true"
    )
    return 0
