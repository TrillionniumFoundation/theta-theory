#!/usr/bin/env python3
"""Independent C79g v10 verifier, assembler, and authority consumer.
...
COLD_EXEC_FD_ENV = "CM2_C79G_V10_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V10_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V10_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V10_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V10_COLD_LAUNCHER_FILE_SHA256"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v10"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v10"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v10.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v10.json"
...
V9_TO_V10_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v9_to_v10_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V10 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v10.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v10.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v10.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v10.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v10.json")
# Final current-v10 static-freeze pins.  The historical draft sentinels remain
# explicit below so the absolute command gate proves none survived injection.
FINAL_CURRENT_V10_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "e9f9387c191ff7d34a75f73331d4926c989e0bcc641e21c6a3ace58fc5a7d479"
CONTRACT_OBJECT_PIN = "c99acd60e953a939e3e9fd95e7559ce4249dc6efda0c3653e8ac1ae42b771bf4"
CLOSED_SCHEMA_FILE_PIN = "a42dc06e276cc9206b29ec22df74ac7f8d76a4afb1de30115d048e1f7ce52801"
...
PRODUCER_SOURCE_PIN = "99bb321da8a63855e52c8d6757d00886c0deeb2182f5044cac35f645e2ebd00a"
V10_DRAFT_CURRENT_CORE_PINS = (
...
VERIFICATION_FILE = BASE + "_independent_verification_v10.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v10.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v10.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v10.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v10.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v10-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v10-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v10-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v10-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v10-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v10-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v10-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v10-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v10-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v10-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v10-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v10-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v10-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V10_SURFACE"
...
# v10 base7 and is therefore shared with the current static-policy holder.  The
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v10.py",
             "SELF exact frozen v10 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V10_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V10_PINS_INSTALLED is True,
         "v10 final current pins are not installed; every command is disabled")
    need(all(value not in V10_DRAFT_CURRENT_CORE_PINS for value in (
             CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
             PRODUCER_SOURCE_PIN)),
         "v10 draft current-core sentinels must be replaced before execution")
    ...
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              ...
              V9_OFFICIAL_REJECTION_OBJECT_PIN, PRODUCER_SOURCE_PIN)),
         "all v10 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v10-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v10-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v10-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v10-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v10-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v10-" +
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v10-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V9_OFFICIAL_REJECTION,
             V9_TO_V10_TRANSITION, STATIC_AUDIT_V10,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v10 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v10 schema root is cold-launched wrapper over zero-credit inner composite")
    ...
    v9_predecessor = validate_v9_published_then_rejected_predecessor(
        policy_guard, v9_guard, v9_source_metadata)
    ...
    # rejection is shared by v9/v8; v9 rejection is shared by current policy/v9.
    need(len(current_policy_identities) == 10 and
         len(predecessor_identities) == 68 and
         current_policy_identities.isdisjoint(predecessor_identities) and
         len(current_policy_identities | predecessor_identities) == 78 and
         len({item.mount_id for item in policy_guard.files} |
             ...
             {item.mount_id for item in v9_source_metadata}) == 1,
         "current v10 exact10 plus v3/v4/v5/v6/v7/v8/v9 predecessor exact "
         "identities close as exact78 on one mount")
    ...
    return {
        ...
        "v9_official_rejection": exact_v9_official_rejection(policy_guard)[0],
    }
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
         ...
         registry["append_only_history_unique_file_identity_count"] == 78 and
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v9_to_v10_transition_receipt", "static_audit_v10", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v9_to_v10_transition_receipt", {}).get("path") ==
             str(V9_TO_V10_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v9_to_v10_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v9_to_v10_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v10", {}).get("path") ==
             str(STATIC_AUDIT_V10.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v10", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v10", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V10__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            V9_OFFICIAL_REJECTION, "official v9 rejection shared with predecessor", 0o444,
            V9_OFFICIAL_REJECTION_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v10 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v10 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V9_TO_V10_TRANSITION, "post-source v9-to-v10 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V10, "post-source v10 static audit", 0o444),
        ...
        0o555, 2, "official v9 rejection exact singleton namespace")])
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v10 contract", CONTRACT_OBJECT_PIN)
    ...
    expected_paths = {
        ...
        "v10_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v10_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v10-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v10-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    bundle = contract.get("v10_bundle")
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v9_to_v10_transition_path") ==
             str(V9_TO_V10_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V10.relative_to(ROOT)),
         "contract exact acyclic v10 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    """Fail closed on every final v10 dual-static-audit acceptance field.
    ...
    need(set(audit) == {
             ...
             "effective_checkpoint_object_sha256", "audited_v10_bundle",
    ...
    need(set(dual) == {
         ...
         }, "final v10 static audit dual-checker exact8 closure")
    ...
    need(isinstance(checker_a, dict) and set(checker_a) == {
         ...
         isinstance(checker_c, dict) and set(checker_c) == {
             ...
             "starred_positional_total", "double_star_keyword_total",
             "failed_static_check_count",
         }, "final v10 checker A/B/C exact object closures")
    need(checker_a.get("algorithm") ==
         ...
         "final v10 checker A/B/C algorithms and exact GO statuses")
    ...
    need(isinstance(input_a, dict) and isinstance(input_b, dict) and
         ...
         "final v10 checker A/B exact28 identical input-pin closure")
    expected_inputs = {
    ...
    need(input_a == expected_inputs and
         ...
         "final v10 checker inputs pin exact current core and append-only history")
    ...
    need(_nonzero_sha256(normalized_a) and
         ...
         "final v10 three-way normalized and B/C common-callsite consensus")
    ...
    need(isinstance(kind_census, dict) and set(kind_census) == {
         ...
         "final v10 checker C exact common-callsite kind census")
    need(type(checker_a.get("wider_local_callsite_census_row_count")) is int and
         ...
         "final v10 checker A positive census and three-file in-memory compile")
    need(type(checker_a.get("arity_failure_count")) is int and
         ...
         "final v10 checker A zero arity/undefined/duplicate/failed counts")
    for key in (
    ...
    need(type(dual.get("independent_pin_normalizer_count")) is int and
         ...
         dual.get("pin_normalized_ast_algorithm") ==
             ...
             "PRESERVE_V9_AND_ALL_HISTORICAL_PINS_V1" and
         ...
         dual.get("pin_normalization_preserves_v9_and_all_historical_pins") is True and
         ...
         "final v10 dual exact 3/2 checker counts and type-exact consensuses")
    ...
    need(set(acceptance) == {
         ...
         "final v10 audit acceptance exact10 type-exact zero-runtime closure")
    ...
    need(type(closure.get("schema_definition_count")) is int and
         closure.get("schema_definition_count") == definition_count == 42 and
         type(closure.get("schema_ref_count")) is int and
         closure.get("schema_ref_count") == reference_count == 228 and
         ...
         closure.get("closed_object_count") == closed_count == 48 and
         ...
         "final schema closure actual 42/228/48/0 counts")
    actual_keywords = [
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v10 contract")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v10 closed schema")
    transition = strict_json(
        by_path[V9_TO_V10_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V10].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        v6_guard, v5_guard, v5_source_metadata)
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        v7_guard, v6_guard, v6_source_metadata)
    ...
    transition_file_sha256 = sha(by_path[V9_TO_V10_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V10].raw)
    ...
    need(isinstance(successor, dict) and isinstance(successor_consumer, dict) and
         ...
         "transition exact bundle/v3/v4/v5/v6/v7/v8/v9 predecessor objects")
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V9_TO_V10_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v10_path", "contract",
             "draft_pin_sentinels_are_non_authoritative",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v10_path",
         ...
         transition_v9 == _expected_published_then_rejected_v9_proof(),
         "transition pins current bundle and append-only v3/v4/v5/v6/v7/v8/v9 predecessors")
    audited = audit.get("audited_v10_bundle")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         ...
         audited.get("v9_to_v10_transition_receipt", {}).get("path") ==
             str(V9_TO_V10_TRANSITION.relative_to(ROOT)) and
         audited.get("v9_to_v10_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v9_to_v10_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        {"file_sha256": V9_OFFICIAL_REJECTION_FILE_PIN,
         "entry_name": str(V9_OFFICIAL_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V9_TO_V10_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V10.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V9_TO_V10_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V10])
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v9_to_v10_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v9_to_v10_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v9_to_v10_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "current_exact8_first_member_is_shared_v9_official_rejection":
            cold_manifest[0] == {
                "file_sha256": V9_OFFICIAL_REJECTION_FILE_PIN,
                "entry_name": str(V9_OFFICIAL_REJECTION.relative_to(ROOT))} and
            transition_v4.get("ordered_provisional_exact8") ==
                v4_supersession["frozen_v4_provisional_exact8"]["ordered_members"],
        ...
        "published_then_officially_rejected_predecessor_v9_validated":
            ...
            transition_v9.get("official_later_rejection", {}).get(
                "object_sha256") == V9_OFFICIAL_REJECTION_OBJECT_PIN,
        "append_only_history_unique_file_identity_count": 78,
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V9_TO_V10_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V10].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "published_then_officially_rejected_predecessor_v9",
        "append_only_history_unique_file_identity_count",
        "v9_to_v10_transition_identity", "static_audit_identity",
        ...
        proof.get("append_only_history_unique_file_identity_count") == 78 and
        proof.get("v7_publication_lock_continuity_incident") ==
            _validated_v7_publication_lock_continuity_incident() and
        proof.get("v9_to_v10_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V10__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V10_PRESEAL_ROOT_V2",
    }
    ...
    body["preseal_root_sha256"] = sha(
        b"CM2_C79G_V10_PRESEAL_ROOT_V2" +
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "published_then_officially_rejected_predecessor_v9": copy.deepcopy(
            freeze_proof[
                "published_then_officially_rejected_predecessor_v9"]),
        "v9_to_v10_transition_file_sha256":
            freeze_proof["v9_to_v10_transition_identity"]["file_sha256"],
        "v9_to_v10_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v9_to_v10_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v9_to_v10_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v9_to_v10_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V10_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V10_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v9_to_v10_transition_file_sha256") ==
             freeze_proof.get("v9_to_v10_transition_identity", {}).get("file_sha256") and
         seal.get("v9_to_v10_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V10_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v10 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v10 rejection")
            verify_object(value, "permanent C79g v10 rejection")
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v10 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v10 authority seal")
            verify_object(seal, "C79g v10 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v7_publication_lock_continuity_incident") ==
                     _validated_v7_publication_lock_continuity_incident() and
                 seal.get("v9_to_v10_transition_file_sha256") ==
                     freeze_proof["v9_to_v10_transition_identity"]["file_sha256"] and
                 seal.get("v9_to_v10_transition_object_sha256") ==
