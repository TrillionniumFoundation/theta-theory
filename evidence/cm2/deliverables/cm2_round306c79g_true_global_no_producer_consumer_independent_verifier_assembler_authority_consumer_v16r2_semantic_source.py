...
SOURCE_BASENAME = "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2_semantic_source.py"
COLD_EXEC_FD_ENV = "CM2_c79g-v16r2_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_c79g-v16r2_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_c79g-v16r2_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_c79g-v16r2_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_c79g-v16r2_COLD_LAUNCHER_FILE_SHA256"
COORDINATION_PARENT_FD_ENV = "CM2_c79g-v16r2_COORDINATION_PARENT_FD"
V10_PRODUCER_FD_ENV = "CM2_c79g-v16r2_V10_PRODUCER_FD"
V9_LAUNCHER_FD_ENV = "CM2_c79g-v16r2_V9_LAUNCHER_FD"
V11_PRODUCER_FD_ENV = "CM2_c79g-v16r2_V11_PRODUCER_FD"
V11_LAUNCHER_FD_ENV = "CM2_c79g-v16r2_V11_LAUNCHER_FD"
V11_REJECTION_FD_ENV = "CM2_c79g-v16r2_V11_REJECTION_FD"
V12_PRODUCER_FD_ENV = "CM2_c79g-v16r2_V12_PRODUCER_FD"
V12_CONSUMER_FD_ENV = "CM2_c79g-v16r2_V12_CONSUMER_FD"
V12_LAUNCHER_FD_ENV = "CM2_c79g-v16r2_V12_LAUNCHER_FD"
V5_REJECTION_FD_ENV = "CM2_c79g-v16r2_V5_REJECTION_FD"
V12_REJECTION_FD_ENV = "CM2_c79g-v16r2_V12_REJECTION_FD"
V13_PRODUCER_FD_ENV = "CM2_c79g-v16r2_V13_PRODUCER_FD"
V13_CONSUMER_FD_ENV = "CM2_c79g-v16r2_V13_CONSUMER_FD"
V13_LAUNCHER_FD_ENV = "CM2_c79g-v16r2_V13_LAUNCHER_FD"
V13_PRODUCER_PYC_FD_ENV = "CM2_c79g-v16r2_V13_PRODUCER_PYC_FD"
V13_CONSUMER_PYC_FD_ENV = "CM2_c79g-v16r2_V13_CONSUMER_PYC_FD"
V13_LAUNCHER_PYC_FD_ENV = "CM2_c79g-v16r2_V13_LAUNCHER_PYC_FD"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v16r2"
...
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2.json"
...
v16-to-v16r2_TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16_to_v16r2_static_launch_transition_receipt_v1.json"
STATIC_AUDIT_V16R2 = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2.json"
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2_semantic_source.py"
COLD_LAUNCHER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2_semantic_source.py"
COLD_LAUNCH_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2.sha256"
COLD_LAUNCH_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2.json"
...
V16R2_DRAFT_RUNTIME_DISABLED = True
FINAL_CURRENT_V16R2_PINS_INSTALLED = False
CONTRACT_FILE_PIN = "dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd"
CONTRACT_OBJECT_PIN = "eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
CLOSED_SCHEMA_FILE_PIN = "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
...
V16R2_CURRENT_EXACT8 = (    OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16_semantic_rejection_supersession_receipt_v1.json",
    CLOSED_SCHEMA,
    CONTRACT,
    PRODUCER_SOURCE,
    SELF,
    v16-to-v16r2_TRANSITION,
    STATIC_AUDIT_V16R2,
    COLD_LAUNCHER,
)
...
PRODUCER_SOURCE_PIN = "cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc"
...
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v16r2-semantic-source-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v16r2-semantic-source-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v16r2-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v16r2-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v16r2-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v16r2-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v16r2-semantic-source-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v16r2-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v16r2-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v16r2-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v16r2-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v16r2-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v16r2-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_c79g-v16r2_SURFACE"
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2.py",
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v16r2-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v16r2-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v16r2-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v16r2-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v16r2-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v16r2-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def expected_published_then_rejected_v14_summary() -> dict[str, Any]:
    ...
    need(isinstance(receipt, dict) and
         ...
         receipt.get("transition_kind") == v16-to-v16r2_TRANSITION_KIND and
         isinstance(receipt.get("v16r2_successor_contract"), dict),
    ...
    return {
        ...
        "receipt_status":
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_STATUS,
        "transition_kind": v16-to-v16r2_TRANSITION_KIND,
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             ...
             v16-to-v16r2_TRANSITION, STATIC_AUDIT_V16R2,
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v16-to-v16r2_transition_receipt", "static_audit_v16r2", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v16-to-v16r2_transition_receipt", {}).get("path") ==
             str(v16-to-v16r2_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v16-to-v16r2_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v16-to-v16r2_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_c79g-v16r2__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    ...
    expected_paths = {
        ...
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v16r2-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v16r2-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    expected_base7_paths = [
        ...
        str(v16-to-v16r2_TRANSITION.relative_to(ROOT)),
...
def static_freeze_proof(
    ...
    transition = strict_json(
        by_path[v16-to-v16r2_TRANSITION].raw, "post-source transition receipt")
    ...
    transition_file_sha256 = sha(by_path[v16-to-v16r2_TRANSITION].raw)
    ...
    exact8_stats = [
        ...
        self_guard.before,
        by_path[v16-to-v16r2_TRANSITION].before,
    ...
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(v16-to-v16r2_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
         ...
         cold_launch_boundary.get("base7_order") == [
             ...
             "consumer_v16r2", "transition_v16-to-v16r2",
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         ...
         audited.get("v16-to-v16r2_transition_receipt", {}).get("path") ==
             str(v16-to-v16r2_TRANSITION.relative_to(ROOT)) and
         audited.get("v16-to-v16r2_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v16-to-v16r2_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(v16-to-v16r2_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V16R2.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[v16-to-v16r2_TRANSITION])
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v16-to-v16r2_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v16-to-v16r2_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v16-to-v16r2_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[v16-to-v16r2_TRANSITION].fd >= 0 and
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "historical_rejection_exact_keyset_witness",
        "append_only_history_unique_file_identity_count",
        "v16-to-v16r2_transition_identity", "static_audit_identity",
        ...
        proof.get("v7_publication_lock_continuity_incident") ==
            _validated_v7_publication_lock_continuity_incident() and
        proof.get("v16-to-v16r2_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_c79g-v16r2__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_c79g-v16r2_PRESEAL_ROOT_V2",
    }
    ...
    body["preseal_root_sha256"] = sha(
        b"CM2_c79g-v16r2_PRESEAL_ROOT_V2" +
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "published_then_officially_rejected_predecessor_v12": copy.deepcopy(
            _expected_published_then_rejected_v12_proof()),
        "v16-to-v16r2_transition_file_sha256":
            freeze_proof["v16-to-v16r2_transition_identity"]["file_sha256"],
        "v16-to-v16r2_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v16-to-v16r2_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v16-to-v16r2_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v16-to-v16r2_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_c79g-v16r2_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_c79g-v16r2_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v16-to-v16r2_transition_file_sha256") ==
             freeze_proof.get("v16-to-v16r2_transition_identity", {}).get("file_sha256") and
         seal.get("v16-to-v16r2_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_c79g-v16r2_AUTHORITY_ROOT_V1",
    }
        ...
        if seal_state is not None:
            ...
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v7_publication_lock_continuity_incident") ==
                     _validated_v7_publication_lock_continuity_incident() and
                 seal.get("v16-to-v16r2_transition_file_sha256") ==
                     freeze_proof["v16-to-v16r2_transition_identity"]["file_sha256"] and
                 seal.get("v16-to-v16r2_transition_object_sha256") ==
