...
V14_PUBLISHED_EXACT10_WITNESS = (
    ...
    ("v16_to_v16r2_transition", "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16_to_v16r2_static_launch_transition_receipt_v1.json", "e8c810f85b511cbc3637321f872f96c996a854454ab7ae1fbb3f5bdf19d7fd95", "78912a8f23f7a2e229795aae0e609ca58232dbe36c52ad50bddad727f259413f"),
...
V14_OFFICIAL_REJECTION_RELATIVE_PATH = (
    ".cm2-runtime/c79g-v14-rejections-" + CHECKPOINT +
    "/rejection.json")
...
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v16r2r29_semantic_source"
LAUNCHER_RELATIVE = Path("deliverables") / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r29_semantic_source.py"
...
ACTIVE_PREDECESSOR_SUPERSESSION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r29_active_predecessor_supersession_receipt_v1.json"
ACTIVE_SUCCESSOR_NAMESPACE = "v16r2r29_semantic_source"
ACTIVE_SUCCESSOR_NAMESPACE_TAG = "v16r2r29-semantic-regeneration"
ACTIVE_PREDECESSOR_SUPERSESSION_FILE_PIN = "f463d02982c5a6f3834eff4e111f3a512b74e15926334b1e0a732662245cc003"
ACTIVE_PREDECESSOR_SUPERSESSION_OBJECT_PIN = "df75b95942abb9320c9fccbf4353e141e78b205aced3ba0fe39590b8be60a7d8"
...
ACTIVE_REJECTED_RETRY_SUPERSESSION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r29_active_predecessor_supersession_receipt_v1.json"
RUNTIME = ROOT / ".cm2-runtime"
SELF = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r29_semantic_source.py"
...
SCHEMA = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r29.json"
CONTRACT = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r29.json"
PRODUCER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r29_semantic_source.py"
CONSUMER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r29_semantic_source.py"
TRANSITION = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r28_to_v16r2r29_static_launch_transition_receipt_v1.json"
AUDIT = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r29.json"
MANIFEST = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r29.sha256"
OUTER = ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r29.json"
MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r29.sha256"
OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r29.json"
...
BASE7_PINS = {}
EXACT8: tuple[Path, ...] = (    ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r29_active_predecessor_supersession_receipt_v1.json",
    SCHEMA,
    CONTRACT,
    PRODUCER,
    CONSUMER,
...
V16R2_LATER_REJECTION_EXACT56_KEYSET_SHA256 = (
    "9c272f16d92497a7c5ced499e9e42c514b81cbfddcdb3f79c4f33837836e057e")
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V4_REJECTION_SUPERSESSION = OUT / (
        HISTORICAL_BASE + "_v4_rejection_supersession_receipt_v1.json")
    ...
    V13_SUPERSESSION_RECEIPT = OUT / (
        HISTORICAL_BASE + "_v13_prepublication_pyc_contamination_rejection_"
        "supersession_receipt_v1.json")
    V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT = OUT / (
        HISTORICAL_BASE + "_v14_runtime_registry_shape_drift_rejection_"
        "supersession_receipt_v1.json")
    V13_FROZEN_PRODUCER = OUT / (HISTORICAL_BASE + "_v13.py")
    V13_FROZEN_CONSUMER = OUT / (
        HISTORICAL_BASE + "_independent_verifier_assembler_authority_consumer_v13.py")
    V13_FROZEN_LAUNCHER = OUT / (HISTORICAL_BASE + "_cold_launch_v13.py")
    V13_FROZEN_PRODUCER_PYC = OUT / "__pycache__" / (
        HISTORICAL_BASE + "_v13.cpython-312.pyc")
    V13_FROZEN_CONSUMER_PYC = OUT / "__pycache__" / (
        HISTORICAL_BASE + "_independent_verifier_assembler_authority_consumer_"
        "v13.cpython-312.pyc")
    V13_FROZEN_LAUNCHER_PYC = OUT / "__pycache__" / (
        HISTORICAL_BASE + "_cold_launch_v13.cpython-312.pyc")
    V16R2_REJECTION_NAMESPACE = RUNTIME / ("c79g-v16r2-semantic-source-rejections-" + CHECKPOINT)
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / "rejection.json"
    SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r29.json"
    CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r29.json"
    PRODUCER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r29_semantic_source.py"
    CONSUMER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r29_semantic_source.py"
    TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r28_to_v16r2r29_static_launch_transition_receipt_v1.json"
    AUDIT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r29.json"
    MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r29.sha256"
    OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r29.json"
    BASE7_PINS.clear()
    BASE7_PINS.update({
        ACTIVE_PREDECESSOR_SUPERSESSION: ("f463d02982c5a6f3834eff4e111f3a512b74e15926334b1e0a732662245cc003", 'df75b95942abb9320c9fccbf4353e141e78b205aced3ba0fe39590b8be60a7d8'),
        SCHEMA: ("949dcd8c05f63a2ff3a1fe35b5e974e6cad265dec0029695dd27705ab5db69d6", None),
        CONTRACT: ("f54b5a165914acae1b7e3704804ecae3ee5fa355b3e16d653c5b006f17de8a6e", '639c32c185f7414fb95a2252d53333a91b3ed0cd442f79297a55c400731e1a32'),
        PRODUCER: ("3f0aae7438b9ae37f07c2ac4c83ac9e0de94d4c00f2b57971e752bbdbf602245", None),
        CONSUMER: ("22467b6eed79d2347daa6a67befea14c5e6d5d49800d05d384a54c7dd00ba08b", None),
        TRANSITION: ("60d88b4f8c28620fe7adaa7dc9b22d46bf7d669f289a83f6bbd020f809a7f016", '5cba6e23117c1716dc9220473e9b87b6e83ec46fcd816fcd0c5796866c825707'),
        AUDIT: ("4ec2b597f5565acadbfd50c06ee39d6c2e0f44baa6a5d6d726b893a9773ba16b", 'c08fd8cac33405fb06fccbd11950532caf54e69b5b9cc2496f13a19ec4b2711a'),
    })
    EXACT8 = (    ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r29_active_predecessor_supersession_receipt_v1.json",
        SCHEMA,
        CONTRACT,
        PRODUCER,
        CONSUMER,
    ...
    V3_EXACT10_PINS = (
        (OUT / (HISTORICAL_BASE + "_v2_rejection_supersession_receipt_v1.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v3.json"),
         "275a86286480f915af69e18d81d7032140e3db6982d32679206a6a5b88fee036", None),
        (OUT / (HISTORICAL_BASE + "_contract_v3.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_v3.py"),
         "587933a52505488fd87b1c4f99d5659df6f3c3e9557c0a77edd642e6e4dde0ab", None),
        (OUT / (HISTORICAL_BASE + "_independent_verifier_assembler_authority_consumer_v3.py"),
         "d66143d32f4c4257041f03e24e4a4da8f15542853b2a8f47fa39f5b72871bfdd", None),
        (OUT / (HISTORICAL_BASE + "_v2_to_v3_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v3.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v3.py"),
         "63e1b04ce152770ce4bcfda826d418414fd3196ba540752d0bd61a97eec0075b", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v3.sha256"),
         "53c97fc8f01f0dc0de3f7c5729d5940587467a1877ef9a7c96e9ea2403c0b028", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v3.json"),
    ...
    V4_FROZEN_DRAFT7_PINS = (
        (OUT / (HISTORICAL_BASE + "_schema_v4.json"),
         "b2cb58e88b66daed7d0449d11a4441095179b7e537a48a35ee9c630f76beca6a", None),
        (OUT / (HISTORICAL_BASE + "_contract_v4.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_v4.py"),
         "968e401852f45d5104f48526b50d4f59a86bb1fed8e7af23782c5f6d447d1cf1", None),
        (OUT / (HISTORICAL_BASE + "_independent_verifier_assembler_authority_consumer_v4.py"),
         "23753584725365cdc0174d518c26b7d8dbdeb12eea2345a5e3b281274548420c", None),
        (OUT / (HISTORICAL_BASE + "_v3_to_v4_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v4.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v4.py"),
    ...
    V5_EXACT10_PINS = (
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v5.json"),
         "1048740103257351abb1266ed91bb80028436cb1497918a0f0f177ec3268ff4f", None),
        (OUT / (HISTORICAL_BASE + "_contract_v5.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_v5.py"),
         "bc6d48903f61257cd75b20b83c6cd369ca3748d19427cf18129c0fb9bb59e76e", None),
        (OUT / (HISTORICAL_BASE + "_independent_verifier_assembler_authority_consumer_v5.py"),
         "03aed000a94fc7b7d7e68d3c55611bcc55e7ce293f65ddfb3be7709e44fc854d", None),
        (OUT / (HISTORICAL_BASE + "_v4_to_v5_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v5.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v5.py"),
         "889775cfbe1d3cba597c85c28765545805710c99f06ad05673e57b7b7627bc54", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v5.sha256"),
         "55336d5a95e1765cc0f229bbc98ddfb1f6c14218f5b5e619f84d19da39961474", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v5.json"),
    ...
    V6_EXACT10_PINS = (
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v6.json"),
         "250e27777e3ffdaf159a19c00ae683a4ef079f6e785f0b37d003a724099419bc", None),
        (OUT / (HISTORICAL_BASE + "_contract_v6.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_v6.py"),
         "f48982effd6a1068c50260d0d419b281a3fa8c614e4ca76c3b8ee2a48e8afb56", None),
        (OUT / (HISTORICAL_BASE + "_independent_verifier_assembler_authority_consumer_v6.py"),
         "af4875d2ab84101b05eff9811f33d8bf7b1a060720a956ae3fb42d8d466f4775", None),
        (OUT / (HISTORICAL_BASE + "_v5_to_v6_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v6.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v6.py"),
         "796cbb3c0a4a2a5f3801f9a9132421112fc19e81272938092edd3014ef031fcb", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v6.sha256"),
         "281232171e4c2713f81122e731bd4d50e95afef6bdbd2a5040f5e93c3b7171ea", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v6.json"),
    ...
    V7_EXACT10_PINS = (
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v7.json"),
         "edcdbb568044d04fc7c86b4c4e64fdb7b12b3841f1e93092694ebc3177b6fe18", None),
        (OUT / (HISTORICAL_BASE + "_contract_v7.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_v7.py"),
         "67670681481cf372f775ad39a9f8d8b2459a77ef708e2f4da14ca114ac0f0d95", None),
        (OUT / (HISTORICAL_BASE + "_independent_verifier_assembler_authority_consumer_v7.py"),
         "3ee9f2c666b7297a23faa31d39d5ea66b708d545120b1aeb93f77ac9ef704f8a", None),
        (OUT / (HISTORICAL_BASE + "_v6_to_v7_static_launch_transition_receipt_v1.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v7.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v7.py"),
         "93404ad229728b682018ad236075b6c789e12ee4bf043426049e2aa501b2b9e0", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v7.sha256"),
         "eeabe5d52504231a6163b0e057e9129b632b8a4c33a18fc3a3ac4576612de80c", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v7.json"),
         "0a1fc6afe12db5c630b0c73e1fb8280140adb1590c93f176c564e4e24637584e",
         "8214fa50020fed7ea4046d607b1631723f660d18b3f8a2f8653f7444b02a1795"),
    )
    ...
    V8_EXACT10_PINS = (
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v8.json"),
         "65904d48296a568d2cd4ec2fc49abe1a7651ca77d4a119a780fc91fb6ddaaeeb",
         None),
        (OUT / (HISTORICAL_BASE + "_contract_v8.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v8.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v8.py"),
         V8_LAUNCHER_FILE_PIN, None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v8.sha256"),
         "ae6e4998d6b347902b3e1ab5256abb6f9ab62d5feabf63a597a28e881068365f",
         None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v8.json"),
    ...
    V9_EXACT10_PINS = (
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v9.json"),
         "2ddd254e43a196bb550fce69552c7f51eae063f4a9b75bc5818099c93335080b",
         None),
        (OUT / (HISTORICAL_BASE + "_contract_v9.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v9.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v9.py"),
         "f7559ceeb7d491b8489812670392cb63e3cd5f6a2764db469e2dd51d6b5577fa",
         None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v9.sha256"),
         "648f3dce04ca5fdfed8635e0f8c0d21c09404b3799dbfd108e92013fab5392a4",
         None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v9.json"),
    ...
    V10_EXACT10_PINS = (
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v10.json"),
         "a42dc06e276cc9206b29ec22df74ac7f8d76a4afb1de30115d048e1f7ce52801",
         None),
        (OUT / (HISTORICAL_BASE + "_contract_v10.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_v10.py"), V10_PRODUCER_FILE_PIN, None),
        (OUT / (HISTORICAL_BASE +
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v10.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v10.py"), V10_LAUNCHER_FILE_PIN, None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v10.sha256"),
         "bead6e9e1c53478c874612f00cae6cab1add14069d41b71b4310eb9b46b958db",
         None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v10.json"),
    ...
    V11_EXACT10_PINS = (
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v11.json"),
         "cf1630e3ab1b590876c663b8752d702eae5fe37b7bdbcc7824efbd03bbdbd8e2",
         None),
        (OUT / (HISTORICAL_BASE + "_contract_v11.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_v11.py"), V11_PRODUCER_FILE_PIN, None),
        (OUT / (HISTORICAL_BASE +
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v11.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v11.py"), V11_LAUNCHER_FILE_PIN, None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v11.sha256"),
         "e27e9b58dbf57a72550da701589819dad7ebb01f6b3c649a56b701c99ef13135",
         None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v11.json"),
    ...
    V12_EXACT10_PINS = (
        ...
        (OUT / (HISTORICAL_BASE + "_schema_v12.json"),
         "5ed911a55e8f90e750fdcaf6ab4fb6c9683bebaf66a4d6250329dff98acb2e28", None),
        (OUT / (HISTORICAL_BASE + "_contract_v12.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_static_audit_v12.json"),
        ...
        (OUT / (HISTORICAL_BASE + "_cold_launch_v12.py"),
         "b7aaff67be866f8fd7a01f71e97ea1491574f69e62b7760b6ced9183997444ba", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_manifest_v12.sha256"),
         "297e9f58dc7657c6fa959dd45081efffe4e7e8dadcd16ab89457863e2661ece6", None),
        (OUT / (HISTORICAL_BASE + "_cold_launch_outer_receipt_v12.json"),
...
COLD_ROOT_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v16r2."
    "cold-launched-committed-authority"
)
COLD_ROOT_DOMAIN = b"CM2_C79G_V16R2_COLD_LAUNCHED_AUTHORITY_ROOT_V1\0"
...
LIVE_ACK_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v16r2.cold-live-ack"
)
LIVE_RELEASE_SCHEMA = (
    "cm2.round306c79g.true-global-no-producer-consumer.v16r2.cold-live-release"
)
...
def validate_v13_supersession_receipt(
    ...
    successor = value.get("v16r2_successor_contract", {})
    ...
    need(value.get("schema") ==
         ...
         value.get("status") ==
             ...
             "REJECTION__V16R2_SUCCESSOR_ONLY" and
         ...
         successor.get("v16r2_current_exact8_first_member_must_be_this_receipt")
             is True and
         successor.get("v16r2_must_preserve_v12_exact10_and_official_rejection")
             is True and
         successor.get("v16r2_predecessor_unique_live_identity_count") == 105 and
         successor.get("v16r2_prepublication_unique_live_identity_count") == 113 and
         successor.get("v16r2_terminal_unique_live_identity_count") == 115 and
         successor.get("v16r2_terminal_group_vector") ==
             [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 7, 1, 3, 3, 1] and
         inherited.get("v16r2_must_live_hold_and_terminally_replay_exact16_plus_this_receipt")
             is True,
...
def expected_v13_supersession_summary(
    ...
    return {
        ...
        "v16r2_successor_contract": copy.deepcopy(
            receipt["v16r2_successor_contract"]),
    }
...
FINAL_STATIC_AUDIT_TOP_LEVEL_KEY_ORDER = (
    ...
    "audited_v16r2_bundle", "predecessor_v3_exact10_regression",
...
def pin_normalized_launcher_ast_sha256(raw: bytes, label: str) -> str:
    ...
    need(key_names == expected_key_names and
         ...
         label + ":exact ordered v14-receipt-plus-current-v16r2 BASE7 key census")
...
def producer_source_registry_shape_from_ast(raw: bytes) -> int:
    ...
    try:
        tree = ast.parse(raw.decode("utf-8"), filename="producer_v16r2",
                         mode="exec")
    except (UnicodeDecodeError, SyntaxError) as exc:
    ...
    need(isinstance(registry_function,
         ...
         "current v16r2 input_registry and HeldSelf.execution_proof")
    registry_returns = [
    ...
    need(len(registry_returns) == 1 and len(proof_returns) == 1,
         "unique current v16r2 registry/proof return dicts")
    ...
    need(shape == 75,
         "current v16r2 producerSourceRegistry exact explicit67 plus "
...
def validate_final_static_audit(
    ...
    need(set(audit) == audit_keys and
         ...
         "final static audit exact top-level closure and PASS_V16R2 status")
    ...
    expected_inputs = {
        ...
        "launcher_template": pin_normalized_launcher_ast_sha256(
            launcher_source_raw, "held_v16r2_launcher_source"),
    ...
    need(isinstance(no_producer, dict) and
         ...
         "final static audit exact current-v16r2 no-producer and inherited incident evidence policy")
    ...
    need(isinstance(no_run, dict) and set(no_run) == {
             "C79_entrypoint_executed", "C79_v16r2_runtime_artifact_count",
             "C79_v16r2_process_count", "pyc_or___pycache___created",
             "cold_manifest_or_outer_created_before_dual_GO",
         } and no_run.get("C79_entrypoint_executed") is False and
         type(no_run.get("C79_v16r2_runtime_artifact_count")) is int and
         no_run.get("C79_v16r2_runtime_artifact_count") == 0 and
         type(no_run.get("C79_v16r2_process_count")) is int and
         no_run.get("C79_v16r2_process_count") == 0 and
    ...
    def __init__(self, source: HeldFile) -> None:
        ...
        try:
            self.fd = os.memfd_create(
                "c79g-v16r2-child-exec", MFD_CLOEXEC | MFD_ALLOW_SEALING)
        except OSError as exc:
...
def construct_launcher_native_rejection(
    ...
    return close_object({
        ...
        "status": "PERMANENT_FAIL_CLOSED_REJECTION__ZERO_CREDIT",
        "effective_checkpoint_object_sha256": CHECKPOINT,
        "namespace_exact_path": str(V16R2_REJECTION_NAMESPACE.relative_to(ROOT)),
        "target_exact_path": str(V16R2_LATER_REJECTION.relative_to(ROOT)),
        "rejection_reason": "ORPHANED_OR_INCOMPLETE_C79G_V16R2_SURFACE",
...
def install_or_replay_launcher_native_rejection(
    ...
    try:
        try:
            ...
            namespace_fd = openat2_beneath(
                V16R2_REJECTION_NAMESPACE, os.O_RDONLY | os.O_DIRECTORY)
    except BaseException:
        if namespace_fd >= 0:
    ...
    try:
        ...
        target = os.stat(V16R2_LATER_REJECTION.name, dir_fd=namespace_fd,
                         follow_symlinks=False) if V16R2_LATER_REJECTION.name in universe else None
        if target is not None:
            need(universe == {V16R2_LATER_REJECTION.name},
                 "idempotent rejection exact singleton")
            rejection_guard = HeldFile(
                V16R2_LATER_REJECTION, "existing launcher-native v16r2 rejection")
        else:
            ...
            try:
                ...
                os.fsync(namespace_fd)
            rejection_guard = HeldFile(
                V16R2_LATER_REJECTION, "new launcher-native v16r2 rejection")
        ...
        need(value == expected and rejection_guard.raw == expected_raw and
             set(os.listdir(namespace_fd)) == {V16R2_LATER_REJECTION.name} and
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str,
                    ...
                    bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r29_semantic_source.py",
        ...
        supersession = self.base_objects[
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT]
        successor_contract = supersession.get("v16r2_successor_contract", {})
        ...
        need(self.by_path[
             ...
             supersession.get("status") ==
                 ...
                 "REJECTION__ZERO_CREDIT__V16R2_SUCCESSOR_ONLY" and
             ...
             successor_contract.get("v16r2_current_exact8_first_member_must_be_this_receipt")
                 is True and
             successor_contract.get(
                 ...
                 is True and
             successor_contract.get(
                 "v16r2_inherited_published_incident_authority_exact12_count") == 12 and
             successor_contract.get(
        ...
        contract_static_census = self.base_objects[CONTRACT].get(
            "v16r2_bundle", {}).get("cold_launch_outer_closure", {})
        need(self.global_identity_census == {
             ...
             contract_static_census.get(
                 "current_v16r2_exact10_plus_all_append_only_predecessors_"
             ...
             "current v16r2 exact10 plus all predecessors are an exact "
    ...
    def _global_identity_census(self) -> dict[str, Any]:
        ...
        return {
            ...
            "v16r2_terminal_group_vector": terminal_group_vector,
...
def child_environment(bundle: HeldBundle, child_exec: HeldSealedChildExec,
    ...
    need(len(authority_environment) == 12 and
         ...
         all(env_name.startswith("CM2_C79G_V16R2_V14_") and
...
def child_pass_fds(bundle: HeldBundle, child_exec: HeldSealedChildExec,
    ...
    need(len(result) == len(set(result)) ==
             V16R2_CHILD_PASS_FD_COUNT ==
             V16R2_BOOTSTRAP_DESCRIPTOR_COUNT +
             V16R2_CHILD_AUTHORITY_DESCRIPTOR_COUNT == 16,
    ...
    proof = {
        ...
        "all_current_and_historical_124_identities_globally_unique_on_one_statx_mount":
            live_global_identity_census[
                "all_current_and_historical_124_identities_globally_unique_"
                "on_one_statx_mount"],
        "current_v16r2_and_all_predecessor_unique_file_identity_count":
            live_global_identity_census[
                "v16r2_prepublication_unique_live_identity_count"],
        "current_v16r2_and_all_predecessor_same_statx_mount":
            live_global_identity_census[
        ...
        **bundle.chronology,
        ...
        "reject_command_exempts_only_fresh_empty_v16r2_rejection_namespace": True,
...
def _validate_live_ack(
    ...
    need(set(ack) == expected_keys and ack.get("schema") == LIVE_ACK_SCHEMA and
         ...
         ack.get("static_v16r2_exact10_with_v11_exact10_and_official_rejection_v10_exact10_and_official_rejection_v9_exact10_and_official_rejection_v8_exact10_and_official_rejection_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
...
def v14_inherited_authority_draft_state(
    ...
    need(V16R2_DRAFT_RUNTIME_DISABLED is True and
         ...
         "v16r2 draft requires frozen pinned v14 receipt and uninstalled v16r2 base7 pins")
    return {
...
def main(argv: list[str] | None = None) -> int:
    ...
    need(FINAL_BASE7_PINS_INSTALLED is True,
         "C79g v16r2 launcher requires final base7 pins")
    ...
    try:
        ...
        if args.command == "reject":
            ...
            return 0
        # Every positive-capable command holds the exact-empty v16r2 rejection
