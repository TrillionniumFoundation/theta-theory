#!/usr/bin/env python3
"""Independent C79g v8 verifier, assembler, and authority consumer.
...
COLD_EXEC_FD_ENV = "CM2_C79G_V8_COLD_EXEC_FD"
COLD_SOURCE_FD_ENV = "CM2_C79G_V8_COLD_SOURCE_FD"
COLD_WORKSPACE_ROOT_ENV = "CM2_C79G_V8_COLD_WORKSPACE_ROOT"
COLD_WORKSPACE_ROOT_FD_ENV = "CM2_C79G_V8_COLD_WORKSPACE_ROOT_FD"
COLD_LAUNCHER_SHA_ENV = "CM2_C79G_V8_COLD_LAUNCHER_FILE_SHA256"
...
SCHEMA = "cm2.round306c79g.true-global-no-producer-consumer.v8"
BASE = "cm2_round306c79g_true_global_no_producer_consumer_v8"
CONTRACT = OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v8.json"
CLOSED_SCHEMA = OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v8.json"
...
V7_TO_V8_TRANSITION = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_"
    "v7_to_v8_static_launch_transition_receipt_v1.json")
STATIC_AUDIT_V8 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v8.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v8.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v8.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v8.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v8.json")
# Static-freeze pins.  These nonzero 64-hex values are deliberately distinct
# draft sentinels.  No command may run until a successor transition installs
# the final current-v8 pins and flips the explicit finalization bit.
FINAL_CURRENT_V8_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "6ddb6dd015ee9bb88c716cfb939bf2b954789effffa17b141833091a72187ca4"
CONTRACT_OBJECT_PIN = "0bb6634778bf50a9f090d5df7b23358cae30769ce9b2fb87119800f38a1b75c0"
CLOSED_SCHEMA_FILE_PIN = "65904d48296a568d2cd4ec2fc49abe1a7651ca77d4a119a780fc91fb6ddaaeeb"
...
PRODUCER_SOURCE_PIN = "93a591fc870c0fa35ed37e6e2d0f9066161988d3d340031b7ffdb7239eb2c512"
TERMINALS = {
...
VERIFICATION_FILE = BASE + "_independent_verification_v8.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v8.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v8.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v8.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v8.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v8-candidate-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v8-candidate-b-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v8-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v8-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v8-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v8-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v8-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v8-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v8-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v8-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v8-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v8-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v8-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V8_SURFACE"
...
# v8 base7 and is therefore shared with the current static-policy holder.  The
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v8.py",
             "SELF exact frozen v8 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V8_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V8_PINS_INSTALLED is True,
         "v8 final current pins are not installed; every command is disabled")
    ...
    need(all(_nonzero_sha256(value) for value in
             (CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
              ...
              V7_OFFICIAL_REJECTION_OBJECT_PIN, PRODUCER_SOURCE_PIN)),
         "all v8 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v8-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v8-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v8-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v8-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v8-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v8-" +
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            ".cm2-runtime/.c79g-v8-candidate-stage-{a|b}-" + CHECKPOINT_OBJECT_PIN,
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             CONTRACT, CLOSED_SCHEMA, V7_OFFICIAL_REJECTION,
             V7_TO_V8_TRANSITION, STATIC_AUDIT_V8,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v8 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v8 schema root is cold-launched wrapper over zero-credit inner composite")
    ...
    v7_predecessor = validate_v7_published_then_rejected_predecessor(
        policy_guard, v7_guard, v7_source_metadata)
    ...
    # shared by v7/v6 proofs; v7 rejection is shared by current policy/v7.
    need(len(current_policy_identities) == 10 and
         len(predecessor_identities) == 48 and
         current_policy_identities.isdisjoint(predecessor_identities) and
         len(current_policy_identities | predecessor_identities) == 58 and
         len({item.mount_id for item in policy_guard.files} |
             ...
             {item.mount_id for item in v7_source_metadata}) == 1,
         "current v8 exact10 plus v3/v4/v5/v6/v7 predecessor exact "
         "identities close as exact58 on one mount")
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
         ...
         registry["append_only_history_unique_file_identity_count"] == 58 and
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v7_to_v8_transition_receipt", "static_audit_v8", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v7_to_v8_transition_receipt", {}).get("path") ==
             str(V7_TO_V8_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v7_to_v8_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v7_to_v8_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v8", {}).get("path") ==
             str(STATIC_AUDIT_V8.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v8", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v8", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V8__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            V7_OFFICIAL_REJECTION, "official v7 rejection shared with predecessor", 0o444,
            V7_OFFICIAL_REJECTION_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v8 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v8 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V7_TO_V8_TRANSITION, "post-source v7-to-v8 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V8, "post-source v8 static audit", 0o444),
        ...
        0o555, 2, "official v7 rejection exact singleton namespace")])
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v8 contract", CONTRACT_OBJECT_PIN)
    ...
    expected_paths = {
        ...
        "v8_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v8_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v8-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v8-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v7_to_v8_transition_path") ==
             str(V7_TO_V8_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V8.relative_to(ROOT)),
         "contract exact acyclic v8 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    need(audit.get("status") ==
         ...
         "final static audit exact full v8 GO/pre-freeze status")
    ...
    need(type(closure.get("schema_definition_count")) is int and
         closure.get("schema_definition_count") == definition_count == 40 and
         type(closure.get("schema_ref_count")) is int and
         closure.get("schema_ref_count") == reference_count == 212 and
         ...
         closure.get("closed_object_count") == closed_count == 46 and
         ...
         "final schema closure actual 40/212/46/0 counts")
    actual_keywords = [
    ...
    expected_shapes = {
        ...
        "laterRejection": 46, "producerSourceRegistry": 45,
        "liveRequest": 15, "liveACK": 32, "liveACKCensus": 30}
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v8 contract")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v8 closed schema")
    transition = strict_json(
        by_path[V7_TO_V8_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V8].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        v6_guard, v5_guard, v5_source_metadata)
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        v7_guard, v6_guard, v6_source_metadata)
    ...
    transition_file_sha256 = sha(by_path[V7_TO_V8_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V8].raw)
    ...
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V7_TO_V8_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v8_path", "contract",
             "draft_pin_sentinels_are_non_authoritative",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v8_path",
         ...
         transition_v7 == _expected_published_then_rejected_v7_proof(),
         "transition pins current bundle and append-only v3/v4/v5/v6/v7 predecessors")
    audited = audit.get("audited_v8_bundle")
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         audit.get("audit_path") == str(STATIC_AUDIT_V8.relative_to(ROOT)) and
         ...
         audited.get("v7_to_v8_transition_receipt", {}).get("path") ==
             str(V7_TO_V8_TRANSITION.relative_to(ROOT)) and
         audited.get("v7_to_v8_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v7_to_v8_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        {"file_sha256": V7_OFFICIAL_REJECTION_FILE_PIN,
         "entry_name": str(V7_OFFICIAL_REJECTION.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V7_TO_V8_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V8.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V7_TO_V8_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V8])
    ...
    v7_rejection_identity = _one_identity(
        held_v7_official_rejection(policy_guard))
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v7_to_v8_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v7_to_v8_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v7_to_v8_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "current_exact8_first_member_is_shared_v7_official_rejection":
            cold_manifest[0] == {
                "file_sha256": V7_OFFICIAL_REJECTION_FILE_PIN,
                "entry_name": str(V7_OFFICIAL_REJECTION.relative_to(ROOT))} and
            transition_v4.get("ordered_provisional_exact8") ==
                v4_supersession["frozen_v4_provisional_exact8"]["ordered_members"],
        ...
        "v7_official_rejection_object_sha256":
            V7_OFFICIAL_REJECTION_OBJECT_PIN,
        "v7_official_rejection_shared_current_policy_held_fd":
            held_v7_official_rejection(policy_guard).fd ==
                by_path[V7_OFFICIAL_REJECTION].fd,
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V7_TO_V8_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V8].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "v7_official_rejection_file_sha256",
        "v7_official_rejection_object_sha256",
        "v7_to_v8_transition_identity", "static_audit_identity",
        ...
        proof.get("v7_publication_lock_continuity_incident") ==
            _validated_v7_publication_lock_continuity_incident() and
        proof.get("v7_to_v8_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V8__EXACT_121_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V8_PRESEAL_ROOT_V2",
    }
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "v7_official_rejection_object_sha256":
            V7_OFFICIAL_REJECTION_OBJECT_PIN,
        "v7_to_v8_transition_file_sha256":
            freeze_proof["v7_to_v8_transition_identity"]["file_sha256"],
        "v7_to_v8_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v7_to_v8_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v7_to_v8_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v7_to_v8_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V8_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V8_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v7_to_v8_transition_file_sha256") ==
             freeze_proof.get("v7_to_v8_transition_identity", {}).get("file_sha256") and
         seal.get("v7_to_v8_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V8_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v8 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v8 rejection")
            verify_object(value, "permanent C79g v8 rejection")
...
def cold_authorize_live_protocol(
    ...
    need(request.get("transaction_binding_domain") ==
         ...
         request.get(
             "static_v8_exact10_with_v7_exact10_and_official_rejection_v6_exact10_and_official_rejection_v5_exact10_and_official_rejection_v4_supersession_v3_exact10_and_official_rejection_terminal_replay_completed_by_launcher_before_request") is True and
         request.get(
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v8 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v8 authority seal")
            verify_object(seal, "C79g v8 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v7_publication_lock_continuity_incident") ==
                     _validated_v7_publication_lock_continuity_incident() and
                 seal.get("v7_to_v8_transition_file_sha256") ==
                     freeze_proof["v7_to_v8_transition_identity"]["file_sha256"] and
                 seal.get("v7_to_v8_transition_object_sha256") ==
