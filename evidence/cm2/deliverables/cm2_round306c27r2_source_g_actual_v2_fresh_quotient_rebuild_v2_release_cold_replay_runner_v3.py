...
This append-only v3 helper consumes the frozen C27R2 v6 core and the exact
...
FAILURE_SCHEMA = (
    "cm2.round306c27r2.source-g-authority-v2.release-cold-replay-failure.v3"
)
...
def failure(control: Path, stage: str, error: BaseException) -> None:
    body = {
        ...
        "status": "FAILED_CLOSED_C27R2_RELEASE_REPAIR_FRESH_COLD_V3__ZERO_CREDIT",
    ...
    if not (control / "FAILED.lock").exists():
        write_once(control / "FAILED.lock",
                   b"FAILED_CLOSED_C27R2_RELEASE_REPAIR_FRESH_COLD_V3\n")
...
def execute(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.preflight_only:
        ...
        return {"status": "PASS_C27R2_RELEASE_REPAIR_FRESH_COLD_V3_PREFLIGHT_"
...
def self_test() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(dir=ROOT / ".cm2-runtime",
            prefix="c27r2-fresh-cold-v3-selftest-") as raw:
    ...
    return {
        "status": "PASS_C27R2_RELEASE_REPAIR_FRESH_COLD_V3_EXACT_"
