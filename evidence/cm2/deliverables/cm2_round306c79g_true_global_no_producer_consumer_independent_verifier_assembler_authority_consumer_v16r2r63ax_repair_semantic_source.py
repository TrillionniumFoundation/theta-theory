...
SOURCE_BASENAME = "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63ax_repair_semantic_source.py"
...
V16_TO_V16R2_TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r62_to_v16r2r63ax_repair_static_launch_transition_receipt_v1.json"
STATIC_AUDIT_V16R2 = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r63ax_repair.json"
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r63ax_repair_semantic_source.py"
COLD_LAUNCHER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r63ax_repair_semantic_source.py"
COLD_LAUNCH_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r63ax_runtime_repair.sha256"
COLD_LAUNCH_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63ax_runtime_repair.json"
...
V16R2_DRAFT_RUNTIME_DISABLED = True
FINAL_CURRENT_V16R2_PINS_INSTALLED = True
CONTRACT_FILE_PIN = "06dc65a6bdf177b0e0b53b7ba71e04b5d47bda3756cf0024487341a6fb999307"
CONTRACT_OBJECT_PIN = "ca6507050af6cc78b6918f45fa8d53cd463bd0d385d2aa84c82381470db7af20"
...
PRODUCER_SOURCE_PIN = "b7243a50bab0a5b9beb706692b280b74fe5c82066887e225376ea1fe1555c252"
...
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63ax_runtime_repair.json"
COMPLETION_MEMBERS = (COMPLETION_VERIFICATION, COMPLETION_RECEIPT, GLOBAL_MANIFEST, FINAL_OUTER)

RUNTIME = ROOT / ".cm2-runtime"
CANDIDATE_A = RUNTIME / ("c79g-v16r2r63ax-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_B = RUNTIME / ("c79g-v16r2r63ax-candidate-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_A = RUNTIME / ("c79g-v16r2r63ax-verification-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v16r2r63ax-verification-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v16r2r63ax-committed-completion-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v16r2r63ax-" + UPSTREAM_CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v16r2r63ax-rejections-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v16r2r63ax-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v16r2-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v16r2r63ax-verification-stage-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v16r2r63ax-verification-stage-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v16r2r63ax-candidate-stage-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v16r2r63ax-candidate-stage-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN)
...
AUTHORITY_SEAL_DECLARED_PATH = ".cm2-runtime/cm2-global-authority-heads/c79g-v16r2-" + UPSTREAM_CHECKPOINT_OBJECT_PIN + ".seal"
DECLARED_CANDIDATE_A = ".cm2-runtime/c79g-v16r2-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63ax_repair_semantic_source.py",
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v16r2r63ax-candidate-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v16r2r63ax-candidate-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v16r2r63ax-verification-a-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v16r2r63ax-verification-b-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v16r2r63ax-committed-completion-" + UPSTREAM_CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v16r2r63ax-" +
...
def candidate_install_protocol() -> dict[str, Any]:
    return {
        "staging_path_template":
            DECLARED_CANDIDATE_STAGE_TEMPLATE,
        "fixed_target_set": [DECLARED_CANDIDATE_A,
                             DECLARED_CANDIDATE_B],
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    ...
    expected_paths = {
        "candidate_A": DECLARED_CANDIDATE_A,
        "candidate_B": DECLARED_CANDIDATE_B,
        "verification_A": DECLARED_VERIFICATION_A,
        "verification_B": DECLARED_VERIFICATION_B,
        "committed_completion": DECLARED_COMMITTED_COMPLETION,
        "authority_seal": AUTHORITY_SEAL_DECLARED_PATH,
        "v16r2_rejection_namespace": DECLARED_REJECTION_NAMESPACE,
        "v16r2_later_rejection": DECLARED_LATER_REJECTION,
        "candidate_staging_path_template":
            DECLARED_CANDIDATE_STAGE_TEMPLATE,
        "verification_staging_path_template":
            DECLARED_VERIFICATION_STAGE_TEMPLATE,
        "completion_staging_path": DECLARED_COMPLETION_STAGE,
...
def _validate_final_static_audit(
    ...
    need(set(producer_registry_census) == {
         ...
         producer_registry_census.get("explicit_key_count") == 66 and
         producer_registry_census.get("explicit_unique_key_count") == 66 and
         ...
         producer_registry_census.get("computed_closed_registry_key_count") == 74 and
         producer_registry_census.get("matches") is True,
         "final v16r2 producer actual source-registry exact74 census")
    ...
    need(set(launcher_registry_census) == {
         ...
         launcher_registry_census.get("explicit_key_guard_literals") == [66] and
         ...
         launcher_registry_census.get(
             "held_producer_independent_computed_shape") == 74 and
         launcher_registry_census.get(
    ...
    need(set(registry_consensus) == {
         ...
         registry_consensus.get("producer_independent_closed_key_count") == 74 and
         ...
         all(isinstance(values, list) and values and set(values) == {74}
             for values in registry_consensus[
                 "source_declared_producerSourceRegistry_values"].values()) and
         registry_consensus.get("audit_declared_producerSourceRegistry") == 74 and
         registry_consensus.get("expected_closed_key_count") == 74 and
         ...
         runtime_registry_evidence.get("actual_closed_registry_shape") == 74,
         "final v16r2 independent actual runtime-registry exact74 evidence")
    ...
    expected_shapes = {
        ...
        "laterRejection": 56, "producerSourceRegistry": 74,
...
# _R63AX_STATIC_FREEZE_SCHEMA_PROJECTION_APPLIED_
def _r63ax_schema_later_rejection_projection(self_guard, freeze_proof):
...
_r63ax_raw_static_freeze_proof = static_freeze_proof


def static_freeze_proof(*args, **kwargs):
    proof = _r63ax_raw_static_freeze_proof(*args, **kwargs)
    self_guard = args[1] if len(args) > 1 else kwargs.get("self_guard")
    if self_guard is None:
        raise RuntimeError("r63ax static-freeze self guard missing")
    if not isinstance(proof, dict):
        raise RuntimeError("r63ax static-freeze proof is not an object")
    ...
    proof["v8_official_rejection"] = _r63ax_schema_later_rejection_projection(
        self_guard, proof)
    return proof


def _r63ax_project_v4_proof_for_schema(freeze_proof):
    proof = v4_rejection_supersession_proof(freeze_proof)
    if not isinstance(proof, dict):
        raise RuntimeError("r63ax v4 proof is not an object")
    raw = proof.get("ordered_provisional_exact8")
    if not isinstance(raw, list) or len(raw) != 8:
        raise RuntimeError("r63ax v4 exact8 historical shape drift")
    projected = []
    for member in raw:
        if not isinstance(member, dict):
            raise RuntimeError("r63ax v4 exact8 member is not an object")
        if "mode" not in member or "nlink" not in member:
            raise RuntimeError("r63ax v4 historical mode/nlink witness missing")
...
def completion_install_proof(stage: Path) -> dict[str, Any]:
    return {
        "staging_path": DECLARED_COMPLETION_STAGE,
        "staging_created_exclusively": True,
        "staging_initial_mode": "0700",
        "committed_path": DECLARED_COMMITTED_COMPLETION,
        ...
        "exact_member_order": list(DECLARED_COMPLETION_MEMBERS),
...
def _candidate_surface_proof(
    ...
    return {
        "candidate_A_path": DECLARED_CANDIDATE_A,
        "candidate_B_path": DECLARED_CANDIDATE_B,
...
def _verification_surface_proof(
    ...
    return {
        "verification_A_path": DECLARED_VERIFICATION_A,
        "verification_B_path": DECLARED_VERIFICATION_B,
...
def _standalone_outer_proof(completion_objects: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return close_object({
        "schema": DECLARED_STANDALONE_OUTER_SCHEMA,
...
def independent_consumer_proof(
    ...
    return close_object({
        "schema": DECLARED_INDEPENDENT_CONSUMER_SCHEMA,
        ...
        "authority_seal_target_path": AUTHORITY_SEAL_DECLARED_PATH,
        "authority_decision": "NO_GO_PRESEAL",
...
def postseal_live_replay_object(
    ...
    return {
        ...
        "authority_seal_exact_path": AUTHORITY_SEAL_DECLARED_PATH,
...
def no_later_rejection_object() -> dict[str, Any]:
    return {
        "namespace_exact_path": DECLARED_REJECTION_NAMESPACE,
        "deterministic_target_exact_path": DECLARED_LATER_REJECTION,
...
def authority_root(
    ...
    body: dict[str, Any] = {
        ...
        "v4_rejection_supersession":
            _r63ax_project_v4_proof_for_schema(freeze_proof),
        "published_then_officially_rejected_predecessor_v5": copy.deepcopy(
            freeze_proof[
                "published_then_officially_rejected_predecessor_v5"]),
        "published_then_officially_rejected_predecessor_v6": copy.deepcopy(
...
def _committed_context(
    ...
    _r63ax_recorded_stage = install_proof["staging_path"]
    need(_r63ax_recorded_stage == DECLARED_COMPLETION_STAGE,
    ...
    try:
        ...
        if seal_state is not None:
            ...
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("effective_checkpoint_object_sha256") ==
                     UPSTREAM_CHECKPOINT_OBJECT_PIN and
                 seal.get("target_path") == AUTHORITY_SEAL_DECLARED_PATH and
