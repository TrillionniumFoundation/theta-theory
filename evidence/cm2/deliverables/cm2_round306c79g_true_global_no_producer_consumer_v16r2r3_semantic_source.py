...
COLD_COORDINATION_PARENT_FD_ENV = "CM2_c79g-v16r2_COORDINATION_PARENT_FD"
...
SELF = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r3_semantic_source.py"
...
COLD_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2.sha256"
COLD_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2.json"
...
COLD_EXACT8 = (    OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16_semantic_rejection_supersession_receipt_v1.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2.json",
    SELF,
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r3_semantic_source.py",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16_to_v16r2_static_launch_transition_receipt_v1.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r3_semantic_source.py",
)
...
def hold_static_freeze_trust(self_guard: HeldSelf) -> dict[str, Any]:
    ...
    need(set(transition) == {
         ...
         transition.get("schema") ==
             "cm2.round306c79g.true-global-no-producer-consumer."
             "v12-to-v16r2-static-launch-transition.v1" and
    ...
    transition_pin = audited.get("v16-to-v16r2_transition_receipt", {})
    ...
    return close_object({
        ...
        **self_guard.execution_proof(),
        ...
        "post_source_static_freeze_trust": {
            "v16-to-v16r2_transition_receipt": {
