...
SOURCE_BASENAME = "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r3_semantic_source.py"
...
v16_to_v16r2_TRANSITION = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16_to_v16r2_static_launch_transition_receipt_v1.json"
STATIC_AUDIT_V16R2 = OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2.json"
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r3_semantic_source.py"
COLD_LAUNCHER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r3_semantic_source.py"
...
def expected_published_then_rejected_v14_summary() -> dict[str, Any]:
    ...
    need(isinstance(receipt, dict) and
         ...
         receipt.get("transition_kind") == v16_to_v16r2_TRANSITION_KIND and
    ...
    return {
        ...
        "receipt_status":
            V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_STATUS,
        "transition_kind": v16_to_v16r2_TRANSITION_KIND,
...
def static_freeze_proof(
    ...
    exact8_expected = [
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(v16_to_v16r2_TRANSITION.relative_to(ROOT))},
