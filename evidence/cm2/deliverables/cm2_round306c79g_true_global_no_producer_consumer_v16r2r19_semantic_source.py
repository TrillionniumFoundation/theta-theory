...
FINAL_V16_CORE_PINS_INSTALLED = True
...
SELF = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r19_semantic_source.py"
...
COLD_MANIFEST = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r19.sha256"
COLD_OUTER = OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r19.json"
...
V16R2_DRAFT_CORE_PIN_SENTINELS = ("fa70fe1ea1a977ba33830c4555130c1fa777ba76a2f95f4cdf4c9526a16f1b63", "29ad10c4b677bd0ce25d857521d129f046452d4dde0c1b1454177cf18006c2ae", "eb895fe8bd95b44c5116b4c92a35db9aa8c9dd8bc9b53167e8c041428d743690")
...
COLD_EXACT8 = (    OUT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r18_active_predecessor_supersession_receipt_v1.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r19.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r19.json",
    SELF,
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r19_semantic_source.py",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_v16r2r18_to_v16r2r19_static_launch_transition_receipt_v1.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r19.json",
    OUT / "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r19_semantic_source.py",
)
...
class HeldSelf:
    ...
    def __init__(self, exec_inherited: int, source_inherited: int,
        ...
        try:
            ...
            need(SELF == OUT /
                 "cm2_round306c79g_true_global_no_producer_consumer_v16r2.py",
...
def new_candidate_stage(outdir: Path, parent: HeldParent) -> tuple[Path, HeldMutableStage]:
    ...
    name = ".c79g-v16r2-candidate-stage-" + orientation + "-" + CHECKPOINT_OBJECT_PIN
...
def ensure_launch_configuration() -> HeldSelf:
    ...
    need(all(value and len(value) <= 10 and
         ...
         SELF == ROOT / "deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2.py",
...
def validate_static_authorities(static_trust: dict[str, Any]) -> dict[str, Any]:
    ...
    need(set(contract) == {
         ...
         contract.get("v16r2_bundle", {}).get(
             ...
             "deliverables/cm2_round306c79g_true_global_no_producer_consumer_"
             "independent_verifier_assembler_authority_consumer_v16r2.py" and
