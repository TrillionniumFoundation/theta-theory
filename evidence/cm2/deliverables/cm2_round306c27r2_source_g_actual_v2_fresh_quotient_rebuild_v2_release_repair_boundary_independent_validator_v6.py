...
OVERRIDE_SCHEMA = PREFIX + "release-repair-boundary-override-map.v6"
OUTPUT_SCHEMA = PREFIX + "release-boundary-validator.v6"
FORMAL_STATUS = (
    "PASS_C27R2_RELEASE_REPAIR_BOUNDARY_V6_FORMAL_EMPTY_OVERRIDE_EXACT_"
    "SPEC_ATTESTATION_INPUT_SET_FIXED_USER_BUS_SERVICE_QUERY_TEN_PROPERTY_"
    "EXECSTART_FRAGMENT_CURRENT_PROCESS_INVENTORY_AND_AUTHORITY_CLOSURE__"
    "ZERO_CREDIT"
)
PRIVATE_STATUS = (
    "PASS_C27R2_RELEASE_REPAIR_BOUNDARY_V6_PRIVATE_SINGLE_OVERRIDE_EXACT_"
    "SPEC_ATTESTATION_INPUT_SET_FIXED_USER_BUS_SERVICE_QUERY_TEN_PROPERTY_"
    "EXECSTART_FRAGMENT_CURRENT_PROCESS_INVENTORY_AND_AUTHORITY_CLOSURE__"
    "ZERO_CREDIT"
)
...
def self_test() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="c27r2-boundary-v6-") as raw:
        root = Path(raw)
        normal = root / "normal"
