...
LAUNCHER_RELATIVE = Path('deliverables') / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r63bc_repair_semantic_source.py'
...
SELF = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r63bc_repair_semantic_source.py'
...
CONTRACT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r63bc_repair.json'
PRODUCER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r63bc_repair_semantic_source.py'
CONSUMER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63bc_repair_semantic_source.py'
TRANSITION = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_v16r2r62_to_v16r2r63bc_repair_static_launch_transition_receipt_v1.json'
AUDIT = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r63bc_repair.json'
MANIFEST = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r63bc_runtime_repair.sha256'
OUTER = ROOT / 'deliverables/cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63bc_runtime_repair.json'
MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r63bc_runtime_repair.sha256'
OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63bc_runtime_repair.json'
V16R2_DRAFT_RUNTIME_DISABLED = True
...
def configure_workspace_paths(root: Path) -> None:
    ...
    V16R2_REJECTION_NAMESPACE = RUNTIME / ('c79g-v16r2r63bc-rejections-' + CHECKPOINT)
    V16R2_LATER_REJECTION = V16R2_REJECTION_NAMESPACE / 'rejection.json'
    SCHEMA = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_schema_v16r2r62.json'
    CONTRACT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_contract_v16r2r63bc_repair.json'
    PRODUCER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r63bc_repair_semantic_source.py'
    CONSUMER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v16r2r63bc_repair_semantic_source.py'
    TRANSITION = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_v16r2r62_to_v16r2r63bc_repair_static_launch_transition_receipt_v1.json'
    AUDIT = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_static_audit_v16r2r63bc_repair.json'
    MANIFEST = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v16r2r63bc_runtime_repair.sha256'
    OUTER = OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v16r2r63bc_runtime_repair.json'
    BASE7_PINS = {V14_RUNTIME_REGISTRY_SHAPE_DRIFT_SUPERSESSION_RECEIPT: ('aa4323027e2313f8a2eda0d6ffc039a537afe342d496d1f75cd73fcd47446c01', '93689e62ae36f405f045a769f4dc6f6e6fd83a16605d08299d5c3397ad657e2e'), SCHEMA: ('1a9c03d332a1c12a34f330b30acb77b13a8f315732fc0bc75be29d3b8c3e1577', None), CONTRACT: ('e965de702ac5b0440e8f16f319b63a18313458340e3f68ffacadb377b693a0f5', 'a5ed4affd87023fc65ee39bfbdebafee26e6f43d3b88b427c5649b6d0686559f'), PRODUCER: ('86755ee5077e8e4cb65002b91493b60ec424448d741c648c0589c10cc64673a0', None), CONSUMER: ('14a44f1e3b2693bd58738a6cc51f312957a0009c3c7769d55c894a323f022a9d', None), TRANSITION: ('51c8285c4ca02405a3e68f229a4c845a8c44aeb4744a202dea0251641cb55ea6', '1cda6a121df55aed06a0558dabccb6871bb7db68719744188c705738a94a939e'), AUDIT: ('ad59b6d91314b9781d3b7ea8b05f0d80cd6dfadea9c0f1afba59c705bfff4b0a', 'd36c89899891b7b30dd8cfa897c536f4bf071215c50c866de99f3aedbb8593ca')}
...
FINAL_STATIC_AUDIT_OUTPUT_SHAPES = {'selfIdentity': 33, 'independentConsumerProof': 60, 'staticFreezeProof': 84, 'coldLaunchProof': 112, 'laterRejection': 56, 'producerSourceRegistry': 74, 'liveRequest': 15, 'liveACK': 32, 'liveACKCensus': 42}
...
def producer_source_registry_shape_from_ast(raw: bytes) -> int:
    """Derive explicit66 + execution-proof7 + object closure1 structurally."""
    try:
...
def validate_final_static_audit(audit: Mapping[str, Any], schema: Mapping[str, Any], schema_keywords: frozenset[str], held_by_path: Mapping[Path, 'HeldFile'], base_objects: Mapping[Path, Mapping[str, Any]], predecessor_v5: 'HeldV5PredecessorExact10', predecessor_v6: 'HeldV6PredecessorExact10', predecessor_v7: 'HeldV7PredecessorExact10', predecessor_v8: 'HeldV8PredecessorExact10', predecessor_v9: 'HeldV9PredecessorExact10', predecessor_v10: 'HeldV10PredecessorExact10', predecessor_v11: 'HeldV11PredecessorExact10', predecessor_v12: 'HeldV12PredecessorExact10', v13_supersession: Mapping[str, Any], launcher_source_raw: bytes) -> None:
    ...
    need(isinstance(runtime_registry_evidence, dict) and set(runtime_registry_evidence) == runtime_registry_keys and (runtime_registry_evidence.get('explicit62_in_memory_tamper_rejected') is True) and (runtime_registry_evidence.get('actual_closed_registry_shape') == 74) and isinstance(producer_registry, dict) and (producer_registry.get('explicit_key_count') == 66) and (producer_registry.get('execution_proof_key_count') == 7) and (producer_registry.get('computed_closed_registry_key_count') == 74) and (producer_registry.get('matches') is True) and isinstance(launcher_registry, dict) and (launcher_registry.get('explicit_key_guard_literals') == [66]) and (launcher_registry.get('exact_execution_proof_7_guard_count') == 1) and (launcher_registry.get('exact_shape_75_guard_count') == 1) and (launcher_registry.get('held_producer_independent_computed_shape') == 74) and (launcher_registry.get('matches') is True) and isinstance(registry_consensus, dict) and (registry_consensus.get('producer_independent_closed_key_count') == 74) and (registry_consensus.get('audit_declared_producerSourceRegistry') == 74) and (registry_consensus.get('expected_closed_key_count') == 74) and (registry_consensus.get('launcher_actual_runtime_helper_matches') is True) and (registry_consensus.get('matches') is True), 'final static audit exact V14 runtime-registry evidence')
...
class HeldBundle:
    ...
    def _initialize(self, expected_launcher_sha256: str, coordination: HeldCoordinationParent, bootstrap: HeldBootstrapEntry) -> None:
        coordination.verify()
        need(SELF == OUT / 'cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v16r2r63bc_repair_semantic_source.py', 'exact cold launcher path')
