#!/usr/bin/env python3
"""Independent C79g v14 verifier, assembler, and authority consumer.

The verifier never content-opens, reads, hashes, imports, compiles, decodes,
or executes the current C79g v14 producer source.  Frozen predecessor source
bytes are readable only through the launcher's inherited exact-seventeen held
fds (historical exact10, frozen-v13 incident exact6, and supersession receipt),
...
SOURCE_BASENAME = (
    ...
    "independent_verifier_assembler_authority_consumer_v14.py")
...
STATIC_AUDIT_V14 = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_static_audit_v14.json")
PRODUCER_SOURCE = OUT / "cm2_round306c79g_true_global_no_producer_consumer_v14.py"
COLD_LAUNCHER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_v14.py")
COLD_LAUNCH_MANIFEST = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_manifest_v14.sha256")
COLD_LAUNCH_OUTER = OUT / (
    "cm2_round306c79g_true_global_no_producer_consumer_cold_launch_outer_receipt_v14.json")
# Final current-v14 static-freeze pins.  The historical draft sentinels remain
# explicit below so the absolute command gate proves none survived injection.
V14_DRAFT_RUNTIME_DISABLED = True
FINAL_CURRENT_V14_PINS_INSTALLED = True
...
PRODUCER_SOURCE_PIN = "9fa2f2e20cdf15ed37d7f3ff904197fa7bc46a4eec243cab0ae8fb477e2e1ff0"
...
VERIFICATION_FILE = BASE + "_independent_verification_v14.json"
COMPLETION_VERIFICATION = "cm2_round306c79g_true_global_no_producer_consumer_completion_verification_copy_v14.json"
COMPLETION_RECEIPT = "cm2_round306c79g_true_global_no_producer_consumer_pre_outer_completion_receipt_v14.json"
GLOBAL_MANIFEST = "cm2_round306c79g_true_global_no_producer_consumer_one_global_manifest_v14.sha256"
FINAL_OUTER = "cm2_round306c79g_true_global_no_producer_consumer_final_outer_receipt_v14.json"
...
VERIFICATION_A = RUNTIME / ("c79g-v14-verification-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_B = RUNTIME / ("c79g-v14-verification-b-" + CHECKPOINT_OBJECT_PIN)
COMMITTED_COMPLETION = RUNTIME / ("c79g-v14-committed-completion-" + CHECKPOINT_OBJECT_PIN)
AUTHORITY_HEADS = RUNTIME / "cm2-global-authority-heads"
AUTHORITY_SEAL = AUTHORITY_HEADS / ("c79g-v14-" + CHECKPOINT_OBJECT_PIN + ".seal")
REJECTION_NAMESPACE = RUNTIME / ("c79g-v14-rejections-" + CHECKPOINT_OBJECT_PIN)
LATER_REJECTION = REJECTION_NAMESPACE / "rejection.json"
COMPLETION_STAGE_PREFIX = ".c79g-v14-completion-stage-"
AUTHORITY_STAGE_PREFIX = ".c79g-v14-authority-stage-"
VERIFICATION_STAGE_A = RUNTIME / (
    ".c79g-v14-verification-stage-a-" + CHECKPOINT_OBJECT_PIN)
VERIFICATION_STAGE_B = RUNTIME / (
    ".c79g-v14-verification-stage-b-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_A = RUNTIME / (
    ".c79g-v14-candidate-stage-a-" + CHECKPOINT_OBJECT_PIN)
CANDIDATE_STAGE_B = RUNTIME / (
    ".c79g-v14-candidate-stage-b-" + CHECKPOINT_OBJECT_PIN)
...
LATER_REJECTION_REASON = "ORPHANED_OR_INCOMPLETE_C79G_V14_SURFACE"
...
# v14 base7 and is therefore shared with the current static-policy holder.  The
...
# official rejection bytes are also read from the inherited exact-seventeen fds,
...
INCIDENT_AUTHORITY_INHERITED_EXACT17 = (
...
INCIDENT_AUTHORITY_INHERITED_EXACT16_ROLES = (
...
class HeldSelf:
    ...
    def __init__(self) -> None:
        need(SELF == OUT /
             "cm2_round306c79g_true_global_no_producer_consumer_independent_verifier_assembler_authority_consumer_v14.py",
             "SELF exact frozen v14 verifier/assembler/authority-consumer path")
...
def ensure_configuration() -> HeldWorkspaceRoot:
    ...
    need(type(FINAL_CURRENT_V14_PINS_INSTALLED) is bool and
         FINAL_CURRENT_V14_PINS_INSTALLED is True,
         "v14 final current pins are not installed; every command is disabled")
    need(all(value not in V14_DRAFT_CURRENT_CORE_PINS for value in (
             CONTRACT_FILE_PIN, CONTRACT_OBJECT_PIN, CLOSED_SCHEMA_FILE_PIN,
             PRODUCER_SOURCE_PIN)),
         "v14 draft current-core sentinels must be replaced before execution")
    ...
    incident_fd_texts = tuple(
        ...
        for env_name, _, _ in INCIDENT_AUTHORITY_INHERITED_EXACT17)
    all_fd_texts = (
    ...
    need(all(value.isascii() and value.isdecimal() and len(value) <= 10 and
         ...
         len(all_fd_texts) == len({int(value) for value in all_fd_texts}) == 21 and
         ...
         "four bootstrap plus seventeen incident pairwise-distinct fds and mandatory "
    ...
    need(all(_nonzero_sha256(value) for value in
              ...
              *V13_INCIDENT_EXACT6_PINS.values(),
              PRODUCER_SOURCE_PIN)),
         "all v14 static-freeze placeholders must be filled nonzero lowercase 64hex")
    ...
    need(CANDIDATE_A == ROOT / (".cm2-runtime/c79g-v14-candidate-a-" + CHECKPOINT_OBJECT_PIN) and
         CANDIDATE_B == ROOT / (".cm2-runtime/c79g-v14-candidate-b-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_A == ROOT / (".cm2-runtime/c79g-v14-verification-a-" + CHECKPOINT_OBJECT_PIN) and
         VERIFICATION_B == ROOT / (".cm2-runtime/c79g-v14-verification-b-" + CHECKPOINT_OBJECT_PIN) and
         COMMITTED_COMPLETION == ROOT /
             (".cm2-runtime/c79g-v14-committed-completion-" + CHECKPOINT_OBJECT_PIN) and
         AUTHORITY_SEAL == ROOT / (".cm2-runtime/cm2-global-authority-heads/c79g-v14-" +
...
class HeldInheritedIncidentAuthorityExact17:
    """Read the launcher's exact seventeen inherited authority files.

    The ordered set is the historical exact10, the frozen v13 source/pyc
    exact6, and the append-only v13 supersession receipt.  These descriptors
    are the sole content views used for incident authority.  Path access below
    is metadata-only identity comparison; no incident source is reopened by
    pathname.
    """
    def __init__(self) -> None:
        ...
        need(_INCIDENT_AUTHORITY_WITNESS is None,
             "single inherited exact17 incident-authority hold per process")
        ...
        for env_name, path, file_pin in INCIDENT_AUTHORITY_INHERITED_EXACT17:
        ...
        need(len(self.files) == len(identities) == 17 and len(mount_ids) == 1,
             "inherited incident exact17 unique identities on one mount")
        self.by_env = {item.env_name: item for item in self.files}
        need(set(self.by_env) == {
                 env_name for env_name, _, _ in
                 INCIDENT_AUTHORITY_INHERITED_EXACT17},
             "inherited incident exact17 environment role closure")
        by_env = self.by_env
        ...
        exact16 = [
            {
                "ordinal": ordinal,
                "role": INCIDENT_AUTHORITY_INHERITED_EXACT16_ROLES[
                    ordinal - 1],
                "path": str(path.relative_to(ROOT)),
                "file_sha256": file_pin,
            }
            for ordinal, (_, path, file_pin) in enumerate(
                INCIDENT_AUTHORITY_INHERITED_EXACT17[:16], 1)
        ]
        ...
        expected_normalized_rows = [
            {
                ...
                "role": INCIDENT_AUTHORITY_INHERITED_EXACT16_ROLES[
                    ordinal - 1],
                "fd_environment": env_name.replace("_V14_", "_V13_", 1),
                "path": str(path.relative_to(ROOT)),
                "file_sha256": file_pin,
            }
            for ordinal, (env_name, path, file_pin) in enumerate(
                INCIDENT_AUTHORITY_INHERITED_EXACT17[:10], 1)
        ]
        ...
        expected_live_exact6 = INCIDENT_AUTHORITY_INHERITED_EXACT17[10:16]
    ...
    def terminal_replay(self) -> None:
        ...
        need(isinstance(supersession_replayed, dict) and
             ...
             "consumer inherited exact17 supersession terminal replay")
        verify_object(
    ...
    def close(self) -> None:
        ...
        if failures:
            raise Reject("inherited incident exact17 close:" + "|".join(failures))
...
def held_v13_supersession_receipt() -> HeldInheritedFileView:
    need(isinstance(_INCIDENT_AUTHORITY_HOLD,
                    HeldInheritedIncidentAuthorityExact17),
...
def read_evidence(
    ...
    need(set(policy_by_path) == {
             V13_SUPERSESSION_RECEIPT, CONTRACT, CLOSED_SCHEMA,
             V13_TO_V14_TRANSITION, STATIC_AUDIT_V14,
    ...
    need(contract["effective_checkpoint_object_sha256"] == CHECKPOINT_OBJECT_PIN and
         ...
         "v14 contract checkpoint/rejection/zero-outer/composite-root boundary")
    ...
    need(isinstance(closed, dict) and set(closed) <= allowed_root_keys and
         ...
         "v14 schema root is cold-launched wrapper over zero-credit inner composite")
    ...
    identity_groups = [
        current_terminal_identities, v12_predecessor_identities,
    ...
    need(len(current_terminal_identities) == 10 and
         ...
         incident_hold.v13_supersession_identity() ==
             policy_by_path[V13_SUPERSESSION_RECEIPT].identity and
         len({item.mount_id for item in policy_guard.files} |
             ...
             {incident_hold.by_env[V12_REJECTION_FD_ENV].mount_id,
              incident_hold.by_env[V13_SUPERSESSION_RECEIPT_FD_ENV].mount_id}) == 1,
         "current v14 exact10, historical exact10/draft7, v12 rejection, and "
         "v13 incident exact6 close as exact115 on one mount")
    ...
    return {
        ...
        "v14_prepublication_unique_live_identity_count":
            len(prepublication_identities),
        "v14_terminal_unique_live_identity_count": len(terminal_identities),
        "v14_terminal_group_vector": [len(group) for group in identity_groups],
    }
...
def compare(candidate_state: dict[str, Any], expected: dict[str, Any]) -> None:
    ...
    need(set(registry) == {
             ...
             "current_v14_producer_source_content_opened_or_read",
             "current_v14_producer_source_content_imported_compiled_or_executed",
         ...
         set(registry["post_source_static_freeze_trust"]) == {
             "v13_to_v14_transition_receipt", "static_audit_v14", "cold_launcher",
         ...
         registry["post_source_static_freeze_trust"].get(
             "v13_to_v14_transition_receipt", {}).get("path") ==
             str(V13_TO_V14_TRANSITION.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v13_to_v14_transition_receipt", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "v13_to_v14_transition_receipt", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
             "static_audit_v14", {}).get("path") ==
             str(STATIC_AUDIT_V14.relative_to(ROOT)) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v14", {}).get("file_sha256")) and
         _nonzero_sha256(registry["post_source_static_freeze_trust"].get(
             "static_audit_v14", {}).get("object_sha256")) and
         registry["post_source_static_freeze_trust"].get(
         ...
         registry["current_v14_producer_source_content_opened_or_read"] is False and
         registry["current_v14_producer_source_content_imported_compiled_or_executed"] is False and
...
def construct_expected_verification(
    ...
    return close_object({
        ...
        "status": "PASS_INDEPENDENT_C79G_V14__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT",
...
def _static_policy_guards() -> HeldInputSet:
    return HeldInputSet([
        HeldPinnedInput(
            ...
            "v13 supersession receipt current exact8 first member", 0o444,
            V13_SUPERSESSION_RECEIPT_FILE_PIN),
        HeldPinnedInput(CLOSED_SCHEMA, "v14 closed schema", 0o444,
                        CLOSED_SCHEMA_FILE_PIN),
        HeldPinnedInput(CONTRACT, "v14 contract", 0o444, CONTRACT_FILE_PIN),
        HeldPinnedInput(
            V13_TO_V14_TRANSITION,
            "post-source v13-to-v14 transition receipt", 0o444),
        HeldPinnedInput(STATIC_AUDIT_V14, "post-source v14 static audit", 0o444),
...
def _validate_contract_bindings(contract: Mapping[str, Any]) -> None:
    verify_object(contract, "live v14 contract", CONTRACT_OBJECT_PIN)
    need(set(contract) == {
    ...
    expected_paths = {
        ...
        "v14_rejection_namespace": str(REJECTION_NAMESPACE.relative_to(ROOT)),
        "v14_later_rejection": str(LATER_REJECTION.relative_to(ROOT)),
        "candidate_staging_path_template":
            ".cm2-runtime/.c79g-v14-candidate-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
        "verification_staging_path_template":
            ".cm2-runtime/.c79g-v14-verification-stage-{a|b}-" +
            CHECKPOINT_OBJECT_PIN,
    ...
    need(published_v11 == _expected_published_then_rejected_v11_proof() and
         ...
         contract.get("v11_dual_validator_divergence_incident") ==
             V11_DUAL_VALIDATOR_DIVERGENCE_INCIDENT,
         "contract exact v11/v12 rejection, v13 supersession, and witness binding")
    ...
    need(isinstance(bundle, dict) and
         ...
         bundle.get("post_source_static_trust_receipts", {}).get(
             "v13_to_v14_transition_path") ==
             str(V13_TO_V14_TRANSITION.relative_to(ROOT)) and
         bundle.get("post_source_static_trust_receipts", {}).get(
             "static_audit_path") == str(STATIC_AUDIT_V14.relative_to(ROOT)),
         "contract exact acyclic v14 bundle and post-source trust-anchor paths")
...
def _validate_final_static_audit(
    ...
    need(set(dual) == {
         ...
         }, "final v14 static audit dual-checker exact15 closure")
    ...
    need(helper_consensus == {
         ...
         digest(expected_helper_callsites) ==
             "1ca6de98366645a520cbc604990d71197f039207cacfa3291e9d87ff09a3cf57",
         "final v14 exact three-helper AST/key-order/callsite consensus")
    ...
    need(set(sealed) == {
         ...
         "final v14 exact16 sealed-exec/current-producer/inherited-incident policy")
...
def static_freeze_proof(
    ...
    contract = strict_json(by_path[CONTRACT].raw, "live v14 contract")
    v13_supersession = strict_json(
        by_path[V13_SUPERSESSION_RECEIPT].raw,
        "live v13 supersession receipt current anchor")
    closed_schema = strict_json(
        by_path[CLOSED_SCHEMA].raw, "live v14 closed schema")
    transition = strict_json(
        by_path[V13_TO_V14_TRANSITION].raw, "post-source transition receipt")
    audit = strict_json(by_path[STATIC_AUDIT_V14].raw, "post-source static audit")
    v5_predecessor = validate_v5_published_then_rejected_predecessor(
        v6_guard, v5_guard, v5_source_metadata)
    v6_predecessor = validate_v6_published_then_rejected_predecessor(
        v7_guard, v6_guard, v6_source_metadata)
    ...
    need(isinstance(contract, dict) and isinstance(v13_supersession, dict) and
    ...
    verify_object(
        v13_supersession, "live v13 supersession receipt current anchor",
        V13_SUPERSESSION_RECEIPT_OBJECT_PIN)
    ...
    transition_file_sha256 = sha(by_path[V13_TO_V14_TRANSITION].raw)
    audit_file_sha256 = sha(by_path[STATIC_AUDIT_V14].raw)
    ...
    exact8_stats = [
        by_path[V13_SUPERSESSION_RECEIPT].before,
        by_path[CLOSED_SCHEMA].before,
        by_path[CONTRACT].before,
        producer_guard.before,
        self_guard.before,
        by_path[V13_TO_V14_TRANSITION].before,
        by_path[STATIC_AUDIT_V14].before,
    ...
    need(isinstance(successor, dict) and isinstance(successor_consumer, dict) and
         ...
         "transition exact bundle/v3-v12 history and v13 supersession objects")
    need(transition.get("status") ==
         ...
         transition.get("receipt_path") == str(V13_TO_V14_TRANSITION.relative_to(ROOT)) and
         set(successor) == {
             "all_four_core_file_pins_final", "build_only_producer",
             "closed_schema", "cold_launcher_v14_path", "contract",
             "draft_pin_sentinels_remain_present",
             "final_consumer_pin_installed",
             "independent_verifier_assembler_authority_consumer",
             "static_audit_v14_path",
    ...
    need(audit.get("effective_checkpoint_object_sha256") == CHECKPOINT_OBJECT_PIN and
         ...
         audited.get("v13_to_v14_transition_receipt", {}).get("path") ==
             str(V13_TO_V14_TRANSITION.relative_to(ROOT)) and
         audited.get("v13_to_v14_transition_receipt", {}).get("file_sha256") ==
             transition_file_sha256 and
         audited.get("v13_to_v14_transition_receipt", {}).get("object_sha256") ==
    ...
    exact8_expected = [
        {"file_sha256": V13_SUPERSESSION_RECEIPT_FILE_PIN,
         "entry_name": str(V13_SUPERSESSION_RECEIPT.relative_to(ROOT))},
        ...
        {"file_sha256": transition_file_sha256,
         "entry_name": str(V13_TO_V14_TRANSITION.relative_to(ROOT))},
        {"file_sha256": audit_file_sha256,
         "entry_name": str(STATIC_AUDIT_V14.relative_to(ROOT))},
    ...
    transition_identity = _one_identity(by_path[V13_TO_V14_TRANSITION])
    transition_identity["object_sha256"] = transition_object_sha256
    audit_identity = _one_identity(by_path[STATIC_AUDIT_V14])
    ...
    return {
        ...
        "v4_rejection_supersession_object_sha256":
            V4_REJECTION_SUPERSESSION_OBJECT_PIN,
        "v13_to_v14_transition_identity": transition_identity,
        ...
        "static_audit_pins_current_consumer_SELF_transition_contract_schema_rejection_and_producer":
            audited["independent_verifier_assembler_authority_consumer"]
                ["file_sha256"] == self_guard.file_sha256 and
            audited["v13_to_v14_transition_receipt"]["file_sha256"] ==
                transition_file_sha256 and
            audited["v13_to_v14_transition_receipt"]["object_sha256"] ==
                transition_object_sha256 and
        ...
        "current_exact8_first_member_is_v13_supersession_receipt":
            cold_manifest[0] == {
                "file_sha256": V13_SUPERSESSION_RECEIPT_FILE_PIN,
                "entry_name": str(V13_SUPERSESSION_RECEIPT.relative_to(ROOT))} and
            by_path[V13_SUPERSESSION_RECEIPT].identity ==
                _INCIDENT_AUTHORITY_HOLD.by_env[
                    V13_SUPERSESSION_RECEIPT_FD_ENV].identity and
            v13_supersession ==
                _INCIDENT_AUTHORITY_HOLD.v13_supersession_receipt and
            transition_v4.get("ordered_provisional_exact8") ==
                v4_supersession["frozen_v4_provisional_exact8"]["ordered_members"],
        "rejected_prepublication_v13_supersession_receipt_validated":
            sha(by_path[V13_SUPERSESSION_RECEIPT].raw) ==
        ...
        "both_receipts_held_and_terminally_replayed_across_full_consumer_run":
            by_path[V13_TO_V14_TRANSITION].fd >= 0 and
            by_path[STATIC_AUDIT_V14].fd >= 0,
...
def _static_freeze_is_valid(proof: Mapping[str, Any]) -> bool:
    ...
    return (set(proof) == {
        ...
        "historical_rejection_exact_keyset_witness",
        "append_only_history_unique_file_identity_count",
        "v13_to_v14_transition_identity", "static_audit_identity",
        ...
        proof.get("v7_publication_lock_continuity_incident") ==
            _validated_v7_publication_lock_continuity_incident() and
        proof.get("v13_to_v14_transition_identity", {}).get("file_sha256") is not None and
...
def read_verification_surface(
    ...
    need(set(value) == {
         ...
         value.get("status") ==
             "PASS_INDEPENDENT_C79G_V14__EXACT_137_ATTACKS__STANDALONE_ZERO_CREDIT" and
...
def preseal_root(surface_guard: HeldInputSet, c42_guard: HeldInputSet,
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_domain": "CM2_C79G_V14_PRESEAL_ROOT_V2",
    }
    ...
    body["preseal_root_sha256"] = sha(
        b"CM2_C79G_V14_PRESEAL_ROOT_V2" +
...
def independent_consumer_proof(
    ...
    need(isinstance(_INCIDENT_AUTHORITY_HOLD,
                    HeldInheritedIncidentAuthorityExact17),
         "independent consumer retains inherited exact17 authority")
    _INCIDENT_AUTHORITY_HOLD.terminal_replay()
    ...
    return close_object({
        ...
        "consumer_exec_bytes_equal_installed_source_bytes":
            ...
            self_guard.exec_file_sha256 == self_guard.file_sha256,
        "consumer_exec_and_installed_source_terminal_replayed": True,
        "current_v14_producer_source_content_opened_read_decoded_parsed_compiled_imported_or_executed": False,
        "inherited_incident_authority_exact17_held_and_terminally_replayed": True,
...
def construct_authority_seal(
    ...
    return close_object({
        ...
        "published_then_officially_rejected_predecessor_v12": copy.deepcopy(
            _expected_published_then_rejected_v12_proof()),
        "v13_to_v14_transition_file_sha256":
            freeze_proof["v13_to_v14_transition_identity"]["file_sha256"],
        "v13_to_v14_transition_object_sha256":
...
def binding_equalities_object(
    ...
    transition_identity = freeze_proof.get("v13_to_v14_transition_identity", {})
    ...
    values: dict[str, bool] = {
        ...
        "seal_contract_and_schema_hashes_equal_live_hashes":
            ...
            seal.get("v4_rejection_supersession_object_sha256") ==
                V4_REJECTION_SUPERSESSION_OBJECT_PIN and
            seal.get("v13_to_v14_transition_file_sha256") ==
                transition_identity.get("file_sha256") and
            seal.get("v13_to_v14_transition_object_sha256") ==
        ...
        "preseal_root_recomputed_from_checkpoint_completion_order_replay_and_rejection":
            ...
            preseal.get("preseal_root_domain") == "CM2_C79G_V14_PRESEAL_ROOT_V2",
        "authority_root_recomputed_from_preseal_root_and_seal_object":
            authority_root_sha256 == sha(
                b"CM2_C79G_V14_AUTHORITY_ROOT_V1" +
...
def authority_root(
    ...
    need(postseal_live_replay is True and no_later_rejection is True and
         ...
         preseal.get("v4_rejection_supersession_object_sha256") ==
             V4_REJECTION_SUPERSESSION_OBJECT_PIN and
         seal.get("v13_to_v14_transition_file_sha256") ==
             freeze_proof.get("v13_to_v14_transition_identity", {}).get("file_sha256") and
         seal.get("v13_to_v14_transition_object_sha256") ==
             freeze_proof.get("transition_object_sha256") and
         ...
         consumer_proof.get("consumer_SELF_identity", {}).get("path") ==
             str(SELF.relative_to(ROOT)) and
         consumer_proof.get(
             "current_v14_producer_source_content_opened_read_decoded_parsed_compiled_imported_or_executed") is False and
         consumer_proof.get(
             "inherited_incident_authority_exact17_held_and_terminally_replayed") is True and
         consumer_proof.get(
    ...
    body: dict[str, Any] = {
        ...
        "preseal_root_sha256": preseal["preseal_root_sha256"],
        "authority_root_domain": "CM2_C79G_V14_AUTHORITY_ROOT_V1",
    }
    ...
    try:
        ...
        if target_state is not None:
            ...
            rejection_guard = HeldPinnedInput(
                LATER_REJECTION, "existing permanent C79g v14 rejection", 0o444)
            value = strict_json(rejection_guard.raw, "permanent C79g v14 rejection")
            verify_object(value, "permanent C79g v14 rejection")
    ...
    try:
        ...
        if seal_state is not None:
            seal_guard = HeldPinnedInput(
                AUTHORITY_SEAL, "committed C79g v14 zero-credit authority seal",
                0o444)
            seal = strict_json(seal_guard.raw, "C79g v14 authority seal")
            verify_object(seal, "C79g v14 authority seal")
            need(seal.get("schema") == AUTHORITY_SEAL_SCHEMA and
                 ...
                 seal.get("v7_publication_lock_continuity_incident") ==
                     _validated_v7_publication_lock_continuity_incident() and
                 seal.get("v13_to_v14_transition_file_sha256") ==
                     freeze_proof["v13_to_v14_transition_identity"]["file_sha256"] and
                 seal.get("v13_to_v14_transition_object_sha256") ==
...
def main(argv: list[str] | None = None) -> int:
    ...
    if V14_DRAFT_RUNTIME_DISABLED and not FINAL_CURRENT_V14_PINS_INSTALLED:
        raise Reject(
    ...
    incident_guard: HeldInheritedIncidentAuthorityExact17 | None = None
    ...
    try:
        self_guard = HeldSelf()
        incident_guard = HeldInheritedIncidentAuthorityExact17()
        producer_guard = HeldOpaqueMetadata(
