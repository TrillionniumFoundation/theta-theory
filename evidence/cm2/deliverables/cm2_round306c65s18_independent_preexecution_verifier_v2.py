#!/usr/bin/env python3
"""Independent preexecution audit for the final C65s18 v2 shard chain.
...
EXECUTOR = OUT / "cm2_round306c65s18_depth18_64shard_executor_v2.py"
...
VERIFY_OUT = OUT / "cm2_round306c65s18_independent_preexecution_verification_final_v2.json"
SELFTEST_OUT = OUT / "cm2_round306c65s18_independent_preexecution_self_test_final_v2.json"
...
PIN = {
    ...
    "executor_file": "fdb3e4eea8f0e45f5a332e3d153109663f9e31d1661e16c63fd27d6736d582ba",
...
def source_audit(raw: bytes, role: str) -> dict[str, Any]:
    ...
    if role == "executor":
        ...
        need(argparse_options == ["--shard"] and
             "_leaf_ledger_v2.jsonl.gz" in text and "_receipt_v2.json" in text,
             "executor shard-only explicit-v2 targets")
...
def verify() -> dict[str, Any]:
    ...
    value: dict[str, Any] = {
        "schema": "cm2.round306c65s18.independent-preexecution-verifier.v2.verification",
        "status": "PASS_INDEPENDENT_FINAL_V2_EXECUTION_CHAIN__20879_TO_64_GLOBAL_BIJECTION__ATOMIC_NO_REPLACE_AST__ZERO_CREDIT",
...
def self_test() -> dict[str, Any]:
    ...
    need(len(tests) == 53, "exactly 53 self-tests")
    value: dict[str, Any] = {
        "schema": "cm2.round306c65s18.independent-preexecution-verifier.v2.self-test",
        "status": "PASS_53_OF_53_ATOMIC_RACE_SYMLINK_LINK_SCHEMA_AND_INVARIANT_TESTS",
        "verification_object_sha256": baseline["object_sha256"],
        "tests": tests, "passed": 53, "failed": 0,
