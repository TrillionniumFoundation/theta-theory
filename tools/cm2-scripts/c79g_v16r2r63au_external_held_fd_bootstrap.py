#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63au launcher."""
...
LAUNCHER_SHA256 = "ce1e5482d70a7d463af568ca813702cbae6bb1b5f5eb7f89270179084dff5da6"
...
def load_impl() -> ModuleType:
    ...
    text = raw.decode("utf-8").replace(
        ...
        LAUNCHER_SHA256)
    text = text.replace("r63an", "r63au").replace("R63AN", "R63AU")
    module = ModuleType("_c79g_v16r2r63au_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AU_EXTERNAL_BOOTSTRAP_REJECT: " +
