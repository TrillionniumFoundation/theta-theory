#!/usr/bin/env python3
"""Run the r63as positive authorize through a blocking held stdout pipe."""
...
BOOTSTRAP = ROOT / "scripts/c79g_v16r2r63as_external_held_fd_bootstrap.py"
...
def main() -> int:
    ...
    env = {
        ...
        "PYTHONNOUSITE": "1",
        "PYTHONNOUSERSITE": "1",
        "CM2_R63AS_AUTHORIZE_APPROVED": "1",
    }
    ...
    report: dict[str, object] = {
        "schema": "cm2.c79g.v16r2r63as-positive-wrapper-run-report.v1",
