#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63v successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63v_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "716fefe5298037ee88071485a3e9391488c5063869c7ff8b66bb7375e04f8888"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63v"), ("v16r2r34", "v16r2r63v"),
        ("V16R2R34", "V16R2R63V"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63V_AUTHORIZE_APPROVED"),
        ("R34", "R63V"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63v_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63V_EXTERNAL_BOOTSTRAP_REJECT: " +
