#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63s successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63s_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "435ae17e56f6bd3bc69982d6ef617b30ca83282986d0697a9525a120538fa880"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63s"), ("v16r2r34", "v16r2r63s"),
        ("V16R2R34", "V16R2R63S"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63S_AUTHORIZE_APPROVED"),
        ("R34", "R63S"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63s_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63S_EXTERNAL_BOOTSTRAP_REJECT: " +
