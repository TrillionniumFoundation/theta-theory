#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63f successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63f_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "a69f963de80434ba6d604499fe618ae83baf266b96b998e60b29063efe3dc187"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63f"), ("v16r2r34", "v16r2r63f"),
        ("V16R2R34", "V16R2R63F"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63F_AUTHORIZE_APPROVED"),
        ("R34", "R63F"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63f_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63F_EXTERNAL_BOOTSTRAP_REJECT: " +
