#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63ap launcher."""
...
LAUNCHER_SHA256 = "388ab75b4a873e356dd310511d867d8c479d77dbbd3c0e90775e1ebf22baba18"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    text = text.replace("r63an", "r63ap").replace("R63AN", "R63AP")
    module = ModuleType("_c79g_v16r2r63ap_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AP_EXTERNAL_BOOTSTRAP_REJECT: " +
