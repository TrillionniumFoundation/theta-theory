#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63aq launcher."""
...
LAUNCHER_SHA256 = "6272054ca2c85cdda65429b9ec70cd7ba1af7943f53a8f21c742d2ded16be151"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    text = text.replace("r63an", "r63aq").replace("R63AN", "R63AQ")
    module = ModuleType("_c79g_v16r2r63aq_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AQ_EXTERNAL_BOOTSTRAP_REJECT: " +
