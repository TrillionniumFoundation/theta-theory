#!/usr/bin/env python3
"""Run the r63aq positive authorize through a blocking held stdout pipe."""
...
BOOTSTRAP = ROOT / "scripts/c79g_v16r2r63aq_external_held_fd_bootstrap.py"
...
def main() -> int:
    ...
    env = {
        ...
        "PYTHONNOUSITE": "1",
        "PYTHONNOUSERSITE": "1",
        "CM2_R63AQ_AUTHORIZE_APPROVED": "1",
    }
    ...
    report: dict[str, object] = {
        "schema": "cm2.c79g.v16r2r63aq-positive-wrapper-run-report.v1",
