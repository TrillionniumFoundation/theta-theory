#!/usr/bin/env python3
"""Seal r60's version-neutral launcher-helper evidence.
...
ANCHOR_FILE_SHA = "b260d3547653a6f2f0ca2bebeb1adff26efcb9cc232e63fe4e69c6fa4da8777b"
...
REVIEW_A = ROOT / "scripts/c79g_v16r2r60_role_aware_reviewer.py"
REVIEW_B = ROOT / "scripts/c79g_v16r2r60_helper_reviewer_b.py"
...
def preflight() -> tuple[dict[str, Any], bytes]:
    ...
    body: dict[str, Any] = {
        ...
        "status": "PASS_R60_DUAL_INDEPENDENT_VERSION_NEUTRAL_HELPER_REVIEW__ZERO_CREDIT",
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({"schema": f"cm2.c79g.{TAG}.helper-evidence-sealer.failure.v1",
                          "status": "FAIL_CLOSED_R60_HELPER_EVIDENCE", "error": f"{type(exc).__name__}:{exc}",
                          "formal_global_closure_credit": 0, "D02_unlock": False,
