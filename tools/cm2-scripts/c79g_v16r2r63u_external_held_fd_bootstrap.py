#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63u successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63u_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "36d20ce71d19186860a2974e665649475eaace929d024e8571ea30266647ebb0"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63u"), ("v16r2r34", "v16r2r63u"),
        ("V16R2R34", "V16R2R63U"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63U_AUTHORIZE_APPROVED"),
        ("R34", "R63U"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63u_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63U_EXTERNAL_BOOTSTRAP_REJECT: " +
