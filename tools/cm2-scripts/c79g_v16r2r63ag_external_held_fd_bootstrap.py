#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63ag launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63ag_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "26a291efc800add6048d76d97d6dff71ec3c895b5d8786e81d4b841f8efa9b89"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r63ab", "r63ag"), ("v16r2r63ab", "v16r2r63ag"),
        ("V16R2R63AB", "V16R2R63AG"),
        ("CM2_R63AB_AUTHORIZE_APPROVED", "CM2_R63AG_AUTHORIZE_APPROVED"),
        ("R63AB", "R63AG"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63ag_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AG_EXTERNAL_BOOTSTRAP_REJECT: " +
