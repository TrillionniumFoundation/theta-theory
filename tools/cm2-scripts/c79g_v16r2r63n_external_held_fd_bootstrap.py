#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63n successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63n_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "e0c31c87e39c8520f5158b1ca18128265874488f090f39811179a2ce6ff73605"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63n"), ("v16r2r34", "v16r2r63n"),
        ("V16R2R34", "V16R2R63N"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63N_AUTHORIZE_APPROVED"),
        ("R34", "R63N"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63n_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63N_EXTERNAL_BOOTSTRAP_REJECT: " +
