#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63g successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63g_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "a2e07a46ae35ef8346ee96aa11fdf52faef4c1c306033cd589f34e03db992c62"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63g"), ("v16r2r34", "v16r2r63g"),
        ("V16R2R34", "V16R2R63G"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63G_AUTHORIZE_APPROVED"),
        ("R34", "R63G"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63g_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63G_EXTERNAL_BOOTSTRAP_REJECT: " +
