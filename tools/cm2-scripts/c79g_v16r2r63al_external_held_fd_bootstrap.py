#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63al launcher."""
...
LAUNCHER_SHA256 = "14b8b536c42484849c1a3148b08a99389055be03b24ac7129fbd780e42b6c1b2"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r63ab", "r63al"), ("v16r2r63ab", "v16r2r63al"),
        ("V16R2R63AB", "V16R2R63AL"),
        ("CM2_R63AB_AUTHORIZE_APPROVED", "CM2_R63AL_AUTHORIZE_APPROVED"),
        ("R63AB", "R63AL"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63al_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AL_EXTERNAL_BOOTSTRAP_REJECT: " +
