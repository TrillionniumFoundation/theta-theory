#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63r successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63r_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "8ed6e27f1f95aa205fbf99124dc98d1e8c89b04fbc99e97477ed7d5555f0f6c5"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63r"), ("v16r2r34", "v16r2r63r"),
        ("V16R2R34", "V16R2R63R"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63R_AUTHORIZE_APPROVED"),
        ("R34", "R63R"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63r_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63R_EXTERNAL_BOOTSTRAP_REJECT: " +
