#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63ai launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63ai_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "7cec27011625a637a5b15d31863a95b2ebf7f84ceb31c096c09650e840034019"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r63ab", "r63ai"), ("v16r2r63ab", "v16r2r63ai"),
        ("V16R2R63AB", "V16R2R63AI"),
        ("CM2_R63AB_AUTHORIZE_APPROVED", "CM2_R63AI_AUTHORIZE_APPROVED"),
        ("R63AB", "R63AI"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63ai_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AI_EXTERNAL_BOOTSTRAP_REJECT: " +
