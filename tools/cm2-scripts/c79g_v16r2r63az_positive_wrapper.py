#!/usr/bin/env python3
"""Run the r63az positive authorize through a blocking held stdout pipe."""
...
BOOTSTRAP = ROOT / "scripts/c79g_v16r2r63az_external_held_fd_bootstrap.py"
...
def main() -> int:
    ...
    env = {
        ...
        "CM2_R63AZ_AUTHORIZE_APPROVED": "1",
    }
    ...
    report: dict[str, object] = {
        "schema": "cm2.c79g.v16r2r63az-positive-wrapper-run-report.v1",
