#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63az launcher."""
...
LAUNCHER_SHA256 = "f3734cecbfce194051dfc76c6bbb078c0d1b44bd90601479233b59a80a66da3d"
...
def load_impl() -> ModuleType:
    ...
    text = raw.decode("utf-8").replace(
        ...
        LAUNCHER_SHA256)
    text = text.replace("r63ax", "r63az").replace("R63AX", "R63AZ")
    module = ModuleType("_c79g_v16r2r63az_external_bootstrap_impl")
...
# Keep the stable root replay projection at this outer boundary.  The base
# recipe's own __main__ hook is not run when loaded as a module.
_ROOT_REPLAY_OLD = (
    ...
    def patched_compile(source, filename, mode, *args, **kwargs):
        ...
        if "class HeldLauncher" in source_text and _ROOT_REPLAY_OLD in source_text:
            if source_text.count(_ROOT_REPLAY_OLD) != 1:
                raise RuntimeError("r63az root replay anchor multiplicity drift")
...
if __name__ == "__main__":
    ...
    try:
        ...
        os.write(2, ("C79G_R63AZ_EXTERNAL_BOOTSTRAP_REJECT: " +
