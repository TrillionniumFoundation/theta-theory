#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63ak launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63ak_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "54de79b15d27e1f1238d5eeb722c7b2bd059418c9679f48e84bf9fcc73059f91"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r63ab", "r63ak"), ("v16r2r63ab", "v16r2r63ak"),
        ("V16R2R63AB", "V16R2R63AK"),
        ("CM2_R63AB_AUTHORIZE_APPROVED", "CM2_R63AK_AUTHORIZE_APPROVED"),
        ("R63AB", "R63AK"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63ak_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AK_EXTERNAL_BOOTSTRAP_REJECT: " +
