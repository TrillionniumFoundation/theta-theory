#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63h successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63h_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "c6281cd30cf5893523371a080ed9cffae8474def4c8eed59b5579447fab1c109"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63h"), ("v16r2r34", "v16r2r63h"),
        ("V16R2R34", "V16R2R63H"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63H_AUTHORIZE_APPROVED"),
        ("R34", "R63H"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63h_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63H_EXTERNAL_BOOTSTRAP_REJECT: " +
