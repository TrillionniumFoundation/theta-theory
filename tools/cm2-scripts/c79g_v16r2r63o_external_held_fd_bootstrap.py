#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63o successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63o_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "19f97c712a1df8971c333e7d078de86d8e57549aae9848ba4abec23847f224c7"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63o"), ("v16r2r34", "v16r2r63o"),
        ("V16R2R34", "V16R2R63O"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63O_AUTHORIZE_APPROVED"),
        ("R34", "R63O"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63o_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63O_EXTERNAL_BOOTSTRAP_REJECT: " +
