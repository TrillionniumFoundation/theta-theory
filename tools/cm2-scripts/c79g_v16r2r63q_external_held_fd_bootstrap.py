#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63q successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63q_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "65c14b5dad939867a41af96dffdb69712b2e07dfe583af896778d19d1ce5892e"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63q"), ("v16r2r34", "v16r2r63q"),
        ("V16R2R34", "V16R2R63Q"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63Q_AUTHORIZE_APPROVED"),
        ("R34", "R63Q"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63q_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63Q_EXTERNAL_BOOTSTRAP_REJECT: " +
