#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63ao launcher."""
...
LAUNCHER_SHA256 = "538d6ce03803081282724fc5f7df7f9c61c17b3ebccbf5756c1f3bb83d053492"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    text = text.replace("r63an", "r63ao").replace("R63AN", "R63AO")
    module = ModuleType("_c79g_v16r2r63ao_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AO_EXTERNAL_BOOTSTRAP_REJECT: " +
