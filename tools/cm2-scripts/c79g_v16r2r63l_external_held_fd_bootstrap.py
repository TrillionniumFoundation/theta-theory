#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63l successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63l_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "da10f4a12ade7df2d0ae68c8daa12d32c278b6c0e4f1d18e8b313c201a48bef3"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63l"), ("v16r2r34", "v16r2r63l"),
        ("V16R2R34", "V16R2R63L"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63L_AUTHORIZE_APPROVED"),
        ("R34", "R63L"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63l_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63L_EXTERNAL_BOOTSTRAP_REJECT: " +
