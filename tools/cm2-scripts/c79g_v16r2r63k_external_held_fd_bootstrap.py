#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63k successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63k_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "f5538049020c6e9d32d5ff0cbc04fb3aa872b769149c90726c8b011e88ee90d4"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63k"), ("v16r2r34", "v16r2r63k"),
        ("V16R2R34", "V16R2R63K"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63K_AUTHORIZE_APPROVED"),
        ("R34", "R63K"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63k_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63K_EXTERNAL_BOOTSTRAP_REJECT: " +
