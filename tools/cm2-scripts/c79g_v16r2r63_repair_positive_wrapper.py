#!/usr/bin/env python3
"""Run the r63 publication-repair positive authorize through a blocking FD."""
...
BOOTSTRAP = ROOT / "scripts/c79g_v16r2r63_repair_external_held_fd_bootstrap.py"
...
def _drain(proc: subprocess.Popen[bytes], read_fd: int) -> tuple[bytes, bytes, bool]:
    ...
    out = bytearray(); err = bytearray(); deadline = time.monotonic() + TIMEOUT_SECONDS
    timed_out = False
    try:
...
def main() -> int:
    ...
    env = {"PATH": "/usr/bin:/bin", "LANG": "C.UTF-8", "LC_ALL": "C.UTF-8",
           "TZ": "UTC", "PYTHONDONTWRITEBYTECODE": "1", "PYTHONNOUSERSITE": "1",
    ...
    report: dict[str, object] = {
        "schema": "cm2.c79g.v16r2r63.publication-repair-positive-wrapper-run-report.v1",
