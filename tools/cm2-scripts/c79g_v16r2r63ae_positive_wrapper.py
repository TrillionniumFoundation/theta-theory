#!/usr/bin/env python3
"""Run the r63ae positive authorize through a blocking held stdout pipe."""
...
BOOTSTRAP = ROOT / "scripts/c79g_v16r2r63ae_external_held_fd_bootstrap.py"
...
def main() -> int:
    ...
    env = {
        ...
        "CM2_R63AE_AUTHORIZE_APPROVED": "1",
    }
    ...
    report: dict[str, object] = {
        "schema": "cm2.c79g.v16r2r63ae-positive-wrapper-run-report.v1",
