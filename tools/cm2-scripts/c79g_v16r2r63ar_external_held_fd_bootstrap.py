#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63ar launcher."""
...
# Pinned to the r63ar generated launcher.
LAUNCHER_SHA256 = "7a21739b46185ebaab5a49e8b15c6f52ad95ebf8cea28e66a1fe559eb688bf7f"
...
def load_impl() -> ModuleType:
    ...
    text = raw.decode("utf-8").replace(
        ...
        LAUNCHER_SHA256)
    text = text.replace("r63an", "r63ar").replace("R63AN", "R63AR")
    module = ModuleType("_c79g_v16r2r63ar_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63AR_EXTERNAL_BOOTSTRAP_REJECT: " +
