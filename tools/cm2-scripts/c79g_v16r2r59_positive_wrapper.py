#!/usr/bin/env python3
"""Run the r59 positive cold-launch through a real blocking held FD.
...
BOOTSTRAP = ROOT / "scripts/c79g_v16r2r59_external_held_fd_bootstrap.py"
LAUNCHER_SHA256 = "323bced6d33ec437b8a175f82c557bcbd9ce1831411d698643b1dce1537ade80"
...
def main() -> int:
    ...
    report: dict[str, object] = {
        "schema": "cm2.round306c79g.true-global-no-producer-consumer.v16r2r59-positive-wrapper-run-report.v1",
        "command": "authorize",
        "returncode": rc,
        "timed_out": timed_out,
