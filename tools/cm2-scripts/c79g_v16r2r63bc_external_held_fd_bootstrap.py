#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the append-only r63bc launcher."""
...
def load_impl() -> ModuleType:
    ...
    text = text.replace("r63ba", "r63bc").replace("R63BA", "R63BC")
    module = ModuleType("_c79g_v16r2r63bc_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63BC_EXTERNAL_BOOTSTRAP_REJECT: " +
