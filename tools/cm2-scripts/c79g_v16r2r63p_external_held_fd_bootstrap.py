#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63p successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63p_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "1d6d3ba7cf81702436d77e1742924170b442e9b50dca12a3942b53df761ffa9b"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63p"), ("v16r2r34", "v16r2r63p"),
        ("V16R2R34", "V16R2R63P"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63P_AUTHORIZE_APPROVED"),
        ("R34", "R63P"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63p_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63P_EXTERNAL_BOOTSTRAP_REJECT: " +
