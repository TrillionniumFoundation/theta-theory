#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63t successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63t_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "be53edf8e514a8402f908617fabcdc9bb4b149f750717f95cdcd98cb2faae5f7"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63t"), ("v16r2r34", "v16r2r63t"),
        ("V16R2R34", "V16R2R63T"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63T_AUTHORIZE_APPROVED"),
        ("R34", "R63T"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63t_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63T_EXTERNAL_BOOTSTRAP_REJECT: " +
