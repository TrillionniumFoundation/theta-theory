#!/usr/bin/env python3
"""Externally pinned held-FD bootstrap for the r63m successor launcher."""
...
LAUNCHER_RELATIVE = (
    ...
    "cold_launch_v16r2r63m_repair_semantic_source.py"
)
LAUNCHER_SHA256 = "ca659eca4971e4bde793f1b6b635becf4842eb44085a48c8983a8c29d3cea565"
...
def load_impl() -> ModuleType:
    ...
    text = text.replace(
        ...
        LAUNCHER_SHA256)
    for old, new in (
        ("r34", "r63m"), ("v16r2r34", "v16r2r63m"),
        ("V16R2R34", "V16R2R63M"),
        ("CM2_R34_AUTHORIZE_APPROVED", "CM2_R63M_AUTHORIZE_APPROVED"),
        ("R34", "R63M"),
    ):
        text = text.replace(old, new)
    module = ModuleType("_c79g_v16r2r63m_external_bootstrap_impl")
...
if __name__ == "__main__":
    try:
        ...
        os.write(2, ("C79G_R63M_EXTERNAL_BOOTSTRAP_REJECT: " +
