#!/usr/bin/env python3
"""Run the r63ax positive authorize through a blocking held stdout pipe."""
...
BOOTSTRAP = ROOT / "scripts/c79g_v16r2r63ax_external_held_fd_bootstrap.py"
...
def main() -> int:
    ...
    env = {
        ...
        "CM2_R63AX_AUTHORIZE_APPROVED": "1",
    }
    ...
    report: dict[str, object] = {
        "schema": "cm2.c79g.v16r2r63ax-positive-wrapper-run-report.v1",
